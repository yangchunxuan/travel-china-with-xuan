      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            "@type": "ListItem",
            position: 4,
            name: "China visa-free for Canadian citizens",
...
function OfficialLink({ sourceIndex }: { sourceIndex: number }) {
  const source = CANADA_VISA_GUIDE_SOURCES[sourceIndex];
...
export function CanadaVisaFreeGuidePage() {
  const structuredData = createStructuredData();

  return (
    <div className={styles.pageRoot} lang="en-CA">
      <a className={styles.skipLink} href="#canada-visa-main">
        Skip to the guide
      </a>
      ...
      <main id="canada-visa-main" tabIndex={-1}>
        <article>
            ...
            <div className={styles.heroCopy}>
              <nav className={styles.breadcrumb} aria-label="Breadcrumb">
                <ol>
                  ...
                  <li aria-current="page">Canada entry guide</li>
                </ol>
              </nav>
              ...
              <p className={styles.heroLead}>
                ...
                for every Canadian passport, purpose or date, and the window
            ...
            <figure className={styles.heroVisual}>
              <picture>
                <source
                  ...
                  srcSet="/images/guides/china-visa-free-canadian-citizens-2026/skyline-hero-720.jpg"
                />
                <img
                  src="/images/guides/china-visa-free-canadian-citizens-2026/skyline-hero-1200.jpg"
                  alt={guide.heroAlt}
                  width="1200"
                  height="1800"
                  fetchPriority="high"
          ...
          >
            <div className={styles.sectionIntro}>
              ...
              <p>
                China’s current policy covers holders of valid ordinary
                Canadian passports entering between 17 February and 31 December
                2026 for an eligible purpose, for no more than 30 days. It is
                not a blanket exemption for every Canadian travel document, and
                it is not confirmed to continue past that date.
              </p>
            ...
            <dl className={styles.factGrid}>
              {CANADA_VISA_AT_A_GLANCE.map((fact) => (
                <div key={fact.label}>
                  <dt>{fact.label}</dt>
                  <dd>
            ...
            <div className={styles.articleContent}>
              <section id="visa-needed" aria-labelledby="visa-needed-title">
                <div className={styles.sectionHeading}>
                  ...
                  <h2 id="visa-needed-title">
                    When a Canadian traveller still needs a visa
                  </h2>
                  <p>
                ...
                <div className={styles.numberedGrid}>
                  {CANADA_VISA_NEEDED_CASES.map((item) => (
              ...
              >
                <div className={styles.sectionHeading}>
                  ...
                  <h2 id="passport-types-title">
                    “Canadian passport” is not precise enough
                  </h2>
                  <p>
                    The Chinese notice says “ordinary passport holders from
                    Canada”. That word “ordinary” is doing real work — it is
                    what rules out emergency travel documents, and it is why
                    a few less common passport situations are worth
                    confirming directly rather than assuming.
                  </p>
                </div>
                <div className={styles.passportList}>
                  {CANADA_PASSPORT_CASES.map((item) => (
              ...
              <section id="trip-examples" aria-labelledby="trip-examples-title">
                ...
                <div className={styles.scenarioList}>
                  {CANADA_VISA_SCENARIOS.map((scenario) => (
                ...
                <div className={styles.checklist}>
                  <article>
                    ...
                    <p>
                      ...
                      passport must remain valid for the intended stay. The
                      Government of Canada advises a passport valid for at
                      least six months on entry. Unless the Chinese Embassy
                      and your carrier confirm otherwise, follow the stricter
                      advice.
                    </p>
                  </article>
                  <article>
                    ...
                    <p>
                      Canadian travel advisories tell you to be ready to show
                      proof of onward travel, and the Chinese Embassy
                      recommends carrying documents that match your purpose:
                      return or onward flights, accommodation bookings and,
                      where relevant, an invitation letter.
                    </p>
                  </article>
                  <article>
                ...
                <div className={styles.splitNotes}>
                  <article>
                    ...
                    <p>
                      ...
                      Canadian ordinary passport holders currently get up to
                      90 days visa-free in Hong Kong and visa-free entry to
                      Macao, under long-standing arrangements of their own —
                      neither is part of the 2026 mainland waiver. When you
                      return to mainland China, you make a new entry, examined
                      again at the border.
                    </p>
                    <p>
                  ...
                  <article>
                    ...
                    <h3>
                      Most eligible Canadian tourists do not need 240-hour
                      transit or Hainan’s regional waiver
                    </h3>
                    <p>
                      The 30-day national waiver is broader for an eligible
                      Canadian passport. Canada is also named on the 240-hour
                      transit list and on Hainan’s separate 59-country
                      regional list, but both are narrower policies with their
                      own eligible ports, geographical limits and onward-ticket
                      requirements.
                    </p>
                    <p>
              ...
              >
                ...
                <p>
                  ...
                  the local Public Security Bureau — Canadian travel advisories
              ...
              <section className={styles.faqSection} id="faq">
                <div className={styles.sectionHeading}>
                  ...
                  <h2>China visa-free entry for Canadian citizens: FAQ</h2>
                </div>
                <div className={styles.faqList}>
                  {CANADA_VISA_FAQS.map((item) => (
              ...
              <section className={styles.sourcesSection} id="sources">
                ...
                <ol className={styles.sourceLedger}>
                  {CANADA_VISA_GUIDE_SOURCES.map((source, index) => (
                    <li key={source.id}>
