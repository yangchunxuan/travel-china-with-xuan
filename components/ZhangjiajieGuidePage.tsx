...
> = {
  ...
  ko: {
    ...
    body:
      "천문호선, 매력상서, 장가계 천고정을 입장권이나 평점이 아니라 저녁 전체 일정으로 비교합니다.",
    action: "장가계 야간 공연 비교하기",
  },
};
...
> = {
  ...
  ko: {
    ...
    body:
      "역·공항 접근과 대기, 도착 시각까지 포함해 베이징 → 장가계와 장가계 → 상하이 구간의 기차와 항공편을 비교합니다.",
  },
};
...
> = {
  ...
  ko: {
    ...
    body:
      "쿠알라룸푸르 항공편, 첫 숙박, 기차역과 숙박 거점이 실제 장가계 관광일을 어떻게 바꾸는지 확인해 보세요.",
  },
};
