...
const korean: TransportGuideCopy = {
  ...
  breadcrumbHome: "홈",
  breadcrumbCurrent: "베이징–장가계–상하이 교통",
  metadata: {
    title: "베이징에서 장가계: 비행기 vs 기차, 다음은 상하이",
    description:
      "베이징에서 장가계까지는 알맞은 직항편이 대체로 유리합니다. 장가계에서 상하이 구간은 실제 출발 시각과 호텔까지의 총이동 시간으로 따로 비교하세요.",
  },
  hero: {
    eyebrow: "교통 선택 · 호텔에서 호텔까지",
    headlineTail: "베이징→장가계는 보통 항공, 상하이 구간은 별도 판단",
    lead:
      "일정이 짧은 첫 중국 여행이라면 베이징에서 장가계까지는 시간이 알맞은 직항편부터 보세요. 장가계에서 상하이까지는 출발 시각, 도착 공항·역, 호텔 이동을 합쳐 따로 판단해야 합니다.",
  ...
  quick: {
    ...
    intro:
      "첫 중국 여행이 10박이라면 적절한 직항이 있는 날짜에는 베이징에서 장가계까지 비행기를 권합니다. 장가계에서 상하이까지는 실제 출발 시각과 호텔 도착 시각을 비교해야 합니다. 너무 늦게 푸둥에 도착하는 항공편보다 가장 빠른 직행 열차가 더 유용할 수 있습니다.",
    cards: [
      {
        route: "베이징 → 장가계",
        verdict: "대부분 비행기",
  ...
  visuals: {
    ariaLabel: "베이징·장가계·공항 이동 사진",
    midpoint: {
      alt: "장가계서역과 역 앞 광장의 넓은 전경.",
      title: "장가계서역",
      caption:
        "역에 도착해도 호텔까지 끝난 것은 아닙니다. 시내 또는 무릉원으로 가는 이동을 확인해야 합니다.",
    },
    rail: {
  ...
  comparison: {
    ...
    tableLabel: "베이징, 장가계, 상하이 호텔 간 교통 비교",
    ...
    rows: [
      {
        ...
        planningTime: "장가계 지역 호텔까지 약 6–8시간",
        dayCost: "약 반나절",
      ...
      },
      {
        ...
        publishedTime: "날짜별 상이—실제 운항 항공사 확인",
        planningTime: "푸둥 도착 기준, 무릉원 출발 약 6–8시간",
        dayCost: "약 반나절",
    ...
    calculations: [
      {
        route: "베이징 호텔 → 장가계 지역 호텔",
        formula:
          "베이징 공항까지 60–90분 + 공항 여유 90–120분 + 항공편 시간 계획치 약 150분 + 도착 절차 30–45분 + 도심 또는 무릉원 기준 현지 이동 20–75분",
        result: "Homeground 계획 범위: 약 6–8시간",
      },
      {
        route: "무릉원 호텔 → 상하이 호텔, 푸둥 도착 기준",
        formula:
  ...
  legs: [
    {
      ...
      number: "01",
      eyebrow: "첫 번째 구간",
      title: "베이징 → 장가계: 대부분 비행기가 낫습니다.",
      verdict:
        "직행 열차는 실제로 있지만 ‘직행’이 곧 시간 효율을 뜻하지는 않습니다. 확인한 고속열차는 아침에 베이징 서역을 떠나 밤늦게 장가계 서역에 도착합니다.",
      body:
        "적절한 직항은 베이징의 반나절이나 장가계에서 활용할 수 있는 저녁 시간을 지켜주는 경우가 많습니다. 다만 수도공항(PEK)과 다싱공항(PKX) 중 어디서 출발하는지, 실제 운항일, 장가계 호텔에 언제 들어갈 수 있는지를 함께 확인해야 합니다.",
      chooseFlightTitle: "비행기를 선택할 때",
      chooseFlight: [
        "전체 여행이 10–12박일 때.",
        "적절한 시간의 직항이 운항할 때.",
        "다음 날을 온전한 장가계 관광일로 쓰고 싶을 때.",
      ...
      watch: [
        ...
        "장가계 서역은 국가삼림공원 입구가 아니므로 마지막 이동이 남습니다.",
    ...
    },
    {
      ...
      number: "02",
      eyebrow: "두 번째 구간",
      title: "장가계 → 상하이: 도착 시각이 선택을 좌우합니다.",
      verdict:
        "대부분 항공편이 더 빠르지만 무릉원에서 공항까지의 이동, 공항 여유, 수하물과 푸둥에서 시내까지를 더하면 표면적인 차이는 줄어듭니다.",
      body:
      ...
      watch: [
        ...
        "무릉원에서 공원을 온종일 본 뒤 같은 날 오후 항공편이나 열차를 일정에 무리하게 넣을 수 없습니다.",
        "별도 항공권으로 국제선을 탈 경우 최소 전날 상하이에 도착하세요.",
      ],
    },
  ],
  base: {
    sectionLabel: "장가계의 변수",
    title: "장가계에서 마지막 밤을 어디서 보내느냐에 따라 두 구간의 판단이 달라집니다.",
    intro:
      "‘장가계를 떠난다’는 말은 천문산 근처 호텔에서 출발할 수도, 무릉원 공원 관광 뒤 출발할 수도 있습니다. 두 계획은 같지 않습니다.",
    cards: [
      {
        place: "무릉원",
        title: "국가삼림공원 관광일에 유리",
        body:
          "Homeground의 계획용 추정치로 장가계 서역 또는 허화 국제공항까지 약 45–75분을 잡고 교통과 날씨 여유를 더하세요. 후난성 정부의 2024년 4월 안내에는 서역, 도심과 관광지를 잇는 관광버스가 소개되어 있으므로, 현재 노선과 시간표를 다시 확인해야 합니다.",
      },
      {
        place: "장가계 도심",
        title: "천문산 또는 다음 날 출발에 유리",
        body:
    ...
    options: [
      {
        ...
        body:
          "국제선은 베이징 도착, 상하이 출발로 구성하고 장가계의 온전한 관광일을 확보하며 베이징 구간은 대체로 비행기를 이용하세요. 숙박 거점을 하나 더 추가하면 시간 충돌이 생깁니다. 희망 장소는 요청서에 그대로 남기되, 무엇을 더 빠르게 하거나 줄이거나 선택 일정으로 바꿔야 하는지는 플래너가 설명합니다.",
      ...
      },
      {
        ...
        body:
          "열차가 핵심 관광을 희생하는 선택이 아니라 실제 취향이 될 수 있습니다. 다른 도시 추가는 순서, 국제선과 장가계 숙박 거점을 먼저 맞춘 뒤 판단합니다.",
        rule: "기본: 속도만이 아니라 편안함과 도착의 질을 최적화.",
      },
    ],
    linkLead: "장가계 안의 일정이 필요하신가요?",
  ...
  travellers: {
    ...
    groups: [
      ...
      {
        label: "비행을 피하는 여행자",
        recommendation: "전 구간을 기차로 이동할 수는 있지만 베이징–장가계를 온전한 이동일로 기록하고 가장 합리적인 상하이 직행열차를 고르세요.",
      },
      {
        label: "상하이에서 국제선 출국",
  ...
  evidence: {
    ...
    items: [
      {
        type: "공식 시간표 표본",
        title: "베이징에서 장가계까지 직행 고속열차가 있습니다.",
        finding:
          "2026년 7월 23일 12306 조회에서 G3649는 베이징 서역 10:23 출발, 장가계 서역 22:24 도착으로 12시간 1분이었습니다.",
        sourceIndices: [0, 1],
      },
      {
        type: "공식 시간표 표본",
        title: "장가계에서 상하이까지 여러 직행 고속열차가 있습니다.",
        finding: "같은 날짜 조회에서 상하이 훙차오 직행은 7시간 18분에서 9시간 49분이었습니다.",
        sourceIndices: [0, 2],
      },
      {
        type: "공식 교통 기준",
        title: "장가계 도착 지점은 국가삼림공원 입구가 아닙니다.",
        finding:
  ...
  faq: {
    ...
    items: [
      {
        question: "베이징에서 장가계까지 직행 열차가 있나요?",
        answer:
          "네. 2026년 7월 23일 공식 조회 표본에는 베이징 서역에서 장가계 서역까지 약 12시간의 직행 고속열차가 있었습니다. 직행이지만 하루 전체를 사용하며 여행 날짜에는 다시 확인해야 합니다.",
      },
      {
        question: "베이징–장가계 침대열차로 호텔 1박을 아낄 수 있나요?",
        answer:
          "호텔 1박을 대신할 수는 있지만 베이징 관광일은 보존하지 못합니다. 2026년 7월 23일 표본에서 Z295는 베이징 서역을 11:13에 출발해 다음 날 05:20에 장가계 서역에 도착했습니다.",
      },
      {
        question: "장가계발 상하이행 항공편은 어느 공항을 이용하나요?",
        answer:
          "도시 이름만 보고 공항을 판단하지 마세요. 실제 항공편이 푸둥(PVG)인지 훙차오(SHA)인지 확인한 뒤 해당 공항에서 상하이 호텔까지의 이동시간을 더해 열차와 비교하세요.",
      },
      {
        question: "장가계를 관광하고 같은 날 상하이로 갈 수 있나요?",
        answer:
          "오전 일정을 의도적으로 줄이고 늦은 교통편을 선택할 때만 가능합니다. 무릉원 국가삼림공원 온종일 관광과 같은 날 오후 공항 또는 역 이동을 무리 없이 함께 넣기는 어렵습니다.",
      },
      {
      ...
      {
        question: "상하이–장가계–베이징 역방향이 더 쉬운가요?",
        answer:
          "가능하지만 국제선 도시와 당일 국내 교통편을 알아야 판단할 수 있습니다. 역방향도 호텔 간 시간을 비교하고 장가계의 온전한 관광일을 지키는 원칙은 같습니다.",
      },
    ],
  },
  sources: {
    ...
    names: [
      ...
      "12306 수동 조회 기록: 2026년 7월 23일 베이징 서역–장가계 서역, 7월 22일 확인",
      "12306 수동 조회 기록: 2026년 7월 23일 장가계 서역–상하이 훙차오, 7월 22일 확인",
      "후난공항그룹: 2026년 5월 연휴 장가계–베이징·상하이 노선 증편",
  ...
  structuredData: {
    homeName: "Homeground China",
    aboutName: "베이징–장가계–상하이 교통 계획",
    mentions: ["베이징", "장가계", "상하이", "베이징 서역", "장가계 서역", "장가계 허화 국제공항", "상하이 훙차오역", "상하이 푸둥국제공항"],
  },
};
