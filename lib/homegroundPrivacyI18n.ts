...
> = {
  en: {
    ...
    status: {
      ...
      body:
        "Homeground uses the route and contact details you submit to review and answer your travel request. An enquiry is not consent to unrelated marketing, and it is not handled by an AI chat service.",
      ...
      blockers: [
        ...
        "WhatsApp intake, non-essential analytics and AI chat are disabled.",
      ],
    },
    hero: {
      ...
      intro:
        "Homeground asks for contact details only after a traveller has seen a starting route and chooses a human review. The form is for replying to that active request, not for automatic booking or unrelated marketing.",
      reviewedLabel: "Last reviewed",
      reviewedValue: "18 July 2026",
    },
    currentFlow: {
      title: "From the website to a human reply",
      paragraphs: [
        "The route finder may keep the four route answers in this browser’s session storage so progress can be restored. It does not store the traveller’s email address, WhatsApp number or optional note there.",
        "When a traveller submits the form, Supabase validates and saves the route context, email address and optional trip note. The page shows a received state only after that save succeeds.",
    ...
    collection: {
      ...
      intro:
        "A traveller can use the route finder without contacting Homeground. If they later submit the form, these are the relevant information groups.",
      items: [
        {
          name: "Route context",
          stage: "Browser session and submitted enquiry",
          purpose:
            "Party, travel style, total nights, pace, proposed cities, route version and page language let a planner understand the starting route.",
        },
        {
        ...
        },
        {
          ...
          stage: "Submitted only when entered",
          purpose:
        ...
        },
        {
          ...
          stage: "Inquiry service",
          purpose:
            "A public reference, time, form version, route revision and limited anti-abuse data support reliable submission and duplicate prevention.",
        },
      ],
    },
    providers: {
      ...
      rows: [
        ...
        },
        {
          ...
          value: "Disabled",
          detail:
            "This reply option stays hidden until a studio business account passes a real cross-border send-and-receive test.",
        },
        {
          label: "Analytics and AI chat",
          value: "Disabled",
          detail:
            "The current site does not use non-essential analytics, marketing tracking or an AI chat widget.",
        },
      ],
    },
    configuration: {
      ...
      rows: [
        ...
        },
        {
          ...
          value: "Supabase Seoul · Resend Tokyo · Gmail global infrastructure",
          detail:
            "These are the configured primary regions; delivery, security and support may involve provider infrastructure in other countries.",
        },
        {
    ...
    choices: {
      ...
      paragraphs: [
        "The route finder can be used without giving Homeground an email address. Submitting the form is a separate, deliberate action.",
      ...
      items: [
        ...
        "Continue using the route finder without WhatsApp, analytics or AI chat.",
        "Receive a human reply by email; WhatsApp intake is currently disabled.",
      ],
    },
    contact: {
    ...
    footer:
      "This notice covers Homeground’s current route finder and human enquiry service. It does not provide marketing consent or enable AI chat, analytics or WhatsApp intake.",
  },
  zh: {
    htmlLang: "zh-Hans",
    pagePath: "/zh/privacy/",
    ...
    status: {
      ...
      title: "你的信息只用于人工回复",
      body:
        "Homeground 使用你主动提交的路线与联系方式来人工复核和回复本次旅行需求。提交咨询不代表同意无关营销，也不会交给 AI 聊天服务处理。",
      blockersTitle: "关键规则",
      blockers: [
        "咨询存储在 Supabase 首尔地区，并由 Resend 东京地区发送通知到 Homeground 持续查看的 Gmail。",
        "Homeground 控制的咨询、通知与邮件对话记录，最多保留到最后一次实质联系后的 12 个月；形成客户或合同关系、或法律另有要求时除外。",
        "经过密钥哈希的标识只用于 24 小时限流窗口；超过 24 小时后，通常会在下一次每分钟清理任务运行时删除。",
        "WhatsApp 咨询、非必要统计和 AI 聊天均处于关闭状态。",
      ],
    },
    hero: {
      ...
      title: "一次咨询会如何被处理",
      intro:
        "只有在访客已经看到初步路线并主动要求人工复核后，Homeground 才会索取联系方式。表单只用于回复当前咨询，不代表自动预订，也不等于同意无关营销。",
      reviewedLabel: "最近复核",
      reviewedValue: "2026 年 7 月 18 日",
    },
    currentFlow: {
      title: "从网页表单到人工回复",
      paragraphs: [
        "路线工具可能把四项路线答案保存在当前浏览器会话中，以便恢复进度；访客的邮箱、WhatsApp 号码和选填说明不会存入这里。",
        "访客提交表单时，Supabase 会验证并保存路线背景、邮箱和选填旅行说明。只有保存成功后，网页才会显示已收到。",
    ...
    collection: {
      ...
      title: "只收集当前咨询需要的信息",
      intro:
        "访客可以只使用路线工具而不联系 Homeground。之后主动提交表单时，以下几类信息才会进入咨询流程。",
      items: [
        {
          name: "路线背景",
          stage: "浏览器会话与已提交咨询",
          purpose:
            "同行者、旅行偏好、总晚数、节奏、建议城市、路线版本和页面语言，帮助规划师理解初步路线。",
        },
        {
          name: "访客邮箱",
        ...
        },
        {
          ...
          stage: "咨询服务",
          purpose:
            "公开咨询编号、时间、表单版本、路线修订和有限的防滥用信息，用于可靠提交与避免重复。",
        },
      ],
    },
    providers: {
      ...
      rows: [
        ...
        },
        {
          ...
          value: "关闭",
          detail:
            "工作室企业账号完成真实跨境收发测试前，不显示该回复方式。",
        },
        {
          label: "统计与 AI 聊天",
          value: "关闭",
          detail:
            "当前网站不使用非必要统计、营销追踪或 AI 聊天组件。",
        },
      ],
    },
    configuration: {
      ...
      rows: [
        ...
        {
          label: "处理与存储地区",
          value: "Supabase 首尔 · Resend 东京 · Gmail 全球基础设施",
          detail:
            "首尔和东京是当前配置的主要地区；投递、安全和技术支持可能使用服务商在其他国家或地区的基础设施。",
        },
        {
          label: "咨询信息保留",
    ...
    choices: {
      ...
      title: "是否联系始终由访客决定",
      paragraphs: [
        "访客无需提供邮箱也可以使用路线工具。提交咨询表单是一项单独、主动的操作。",
        "处理当前咨询与营销许可相互独立。未经单独同意，Homeground 不会把咨询邮箱用于无关营销。",
      ],
      items: [
        "选择不提交咨询表单。",
        "在合理核验身份后，查询已保存的信息并申请访问、更正或删除。",
        "无需使用 WhatsApp、统计或 AI 聊天也能继续使用路线工具。",
        "通过邮箱接收人工回复；WhatsApp 咨询目前关闭。",
      ],
    },
    contact: {
      eyebrow: "隐私联系方式",
    ...
    footer:
      "本说明适用于 Homeground 当前的路线工具和人工咨询服务，不构成营销许可，也不启用 AI 聊天、统计或 WhatsApp 咨询。",
  },
  ko: {
    htmlLang: "ko",
    pagePath: "/ko/privacy/",
    ...
    status: {
      ...
      body:
        "Homeground는 여행자가 직접 제출한 동선 및 연락처 정보를 이번 여행 요청을 검토하고 답변하는 데 사용합니다. 문의 제출은 관련 없는 마케팅 동의가 아니며 AI 채팅 서비스가 처리하지 않습니다.",
      blockersTitle: "핵심 원칙",
      blockers: [
        "문의는 Supabase 서울 리전에 저장되고 Resend 도쿄 리전에서 Homeground가 확인하는 Gmail로 알림을 보냅니다.",
        "Homeground가 관리하는 문의·알림·이메일 대화 기록은 마지막 실질적인 연락 후 최대 12개월 동안 보관합니다. 고객 또는 계약 관계가 형성되었거나 법적 의무가 있는 경우는 예외입니다.",
        "비밀 키로 해시한 식별자는 24시간 속도 제한 창에만 사용하며 24시간이 지나면 일반적으로 다음 1분 주기 정리 작업에서 삭제합니다.",
        "WhatsApp 문의, 필수적이지 않은 분석 및 AI 채팅은 사용하지 않습니다.",
      ],
    },
    hero: {
      ...
      intro:
        "여행자가 첫 동선을 확인한 뒤 사람의 검토를 직접 요청할 때만 연락처를 받습니다. 문의 양식은 현재 요청에 답하기 위한 것이며 자동 예약이나 관련 없는 마케팅 동의를 의미하지 않습니다.",
      reviewedLabel: "최근 검토일",
      reviewedValue: "2026년 7월 18일",
    },
    currentFlow: {
      title: "웹 문의에서 사람의 답장까지",
      paragraphs: [
        "여행 동선 찾기는 진행 상태를 복원하기 위해 네 가지 답변을 현재 브라우저 세션에 보관할 수 있습니다. 이메일, WhatsApp 번호와 선택 메모는 여기에 저장하지 않습니다.",
        "여행자가 양식을 제출하면 Supabase가 여행 동선 정보, 이메일 주소와 선택 여행 메모를 검증하고 저장합니다. 저장에 성공한 뒤에만 화면에 접수 완료가 표시됩니다.",
    ...
    collection: {
      ...
      intro:
        "Homeground에 연락하지 않고 여행 동선 찾기만 이용할 수 있습니다. 이후 문의 양식을 직접 제출할 때 다음 정보가 문의 과정에 포함됩니다.",
      items: [
        {
          name: "여행 동선 정보",
          stage: "브라우저 세션과 제출된 문의",
          purpose:
            "일행, 여행 취향, 총 숙박일수, 속도, 추천 도시, 동선 버전과 페이지 언어로 플래너가 첫 동선을 이해합니다.",
        },
        {
          name: "여행자 이메일",
        ...
        },
        {
          ...
          stage: "문의 서비스",
          purpose:
            "공개 문의 번호, 시간, 양식 버전, 동선 수정 정보와 제한된 악용 방지 데이터로 안정적인 제출과 중복 방지를 지원합니다.",
        },
      ],
    },
    providers: {
      ...
      rows: [
        ...
        },
        {
          ...
          value: "사용 안 함",
          detail:
            "스튜디오 비즈니스 계정의 실제 해외 송수신 테스트가 끝나기 전까지 숨깁니다.",
        },
        {
          label: "분석 및 AI 채팅",
          value: "사용 안 함",
          detail:
            "현재 사이트는 필수적이지 않은 분석, 마케팅 추적 또는 AI 채팅 위젯을 사용하지 않습니다.",
        },
      ],
    },
    configuration: {
      ...
      rows: [
        ...
        {
          label: "처리 및 저장 지역",
          value: "Supabase 서울 · Resend 도쿄 · Gmail 글로벌 인프라",
          detail:
            "서울과 도쿄는 현재 설정된 주요 리전이며 전송, 보안 및 기술 지원에는 다른 국가의 제공업체 인프라가 사용될 수 있습니다.",
        },
        {
          label: "문의 정보 보관",
    ...
    choices: {
      ...
      paragraphs: [
        "이메일을 제공하지 않고 여행 동선 찾기만 사용할 수 있습니다. 문의 양식 제출은 별도의 명시적인 행동입니다.",
      ...
      items: [
        ...
        "WhatsApp, 분석 또는 AI 채팅 없이 여행 동선 찾기를 계속 이용할 수 있습니다.",
        "이메일로 사람의 답장을 받을 수 있으며 WhatsApp 문의는 현재 사용하지 않습니다.",
      ],
    },
    contact: {
      eyebrow: "개인정보 문의",
    ...
    footer:
      "이 안내는 Homeground의 현재 여행 동선 찾기와 사람의 문의 답변 서비스에 적용되며 마케팅 동의가 아니고 AI 채팅, 분석 또는 WhatsApp 문의를 사용하지 않습니다.",
  },
};
