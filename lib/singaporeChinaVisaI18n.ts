...
const koreanCopy: Omit<SingaporeChinaVisaCopy, "htmlLang" | "homePath" | "guidesPath"> = {
  ...
  heroAlt: "장가계 국가삼림공원의 짙푸른 계곡 위로 겹겹이 솟은 사암 기둥.",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "주말마다 도시 여행을 다니는 데 익숙한 싱가포르 여행자라면 ‘30일’이라는 말에 시간이 넉넉하다고 느낄 수 있습니다. 하지만 중국의 크기를 마주하면 이야기가 달라집니다. 베이징에서 장가계까지는 짧은 기차 이동이 아니라 비행기를 타야 하는 거리입니다. 시안이나 청두를 더하면 국내선 구간과 호텔도 하나씩 더 필요합니다. 잘 고른 한 지역만 천천히 둘러봐도 같은 풍경을 반복하지 않고 일주일을 알차게 보낼 수 있습니다.",
