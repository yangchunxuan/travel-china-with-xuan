...
const chengdu: PrivateTourProduct = {
  ...
  heroImage: image("/images/destinations/chengdu/hero-1600.webp", l("Chengdu city scenery", "成都城市风景", "청두 도심 풍경"), l("Chengdu is the relaxed base for three focused touring days.", "以成都为基地，舒适安排三天重点游览。", "청두를 거점으로 세 번의 핵심 당일 여정을 떠납니다."), 1600, 1000),
  gallery: [
...
const xian: PrivateTourProduct = {
  ...
  bookingNote: commonBookingNote,
  heroImage: image("/images/destinations/xian/hero-1600.webp", l("Xi'an city wall and historic skyline", "西安城墙与古城风景", "시안 성벽과 역사 지구"), l("Five days connecting Xi'an's layers of history.", "用五天串起西安不同历史层次。", "시안의 여러 시대를 잇는 5일 여정."), 1600, 1000),
  gallery: [
...
const chongqingWulong: PrivateTourProduct = {
  ...
  heroImage: image("/images/destinations/chongqing/hero-1600.webp", l("Chongqing's layered riverside skyline", "重庆层叠的两江城市景观", "충칭의 층층이 이어진 강변 스카이라인"), l("Begin in the vertical city before heading into Wulong.", "从立体山城出发，再深入武隆。", "수직 도시에서 시작해 우룽으로 들어갑니다."), 1600, 1000),
  gallery: [
...
const shanghaiSuzhou: PrivateTourProduct = {
  ...
  heroImage: image("/images/destinations/shanghai/hero-1600.webp", l("Shanghai skyline seen across the river", "隔江远眺上海天际线", "강 건너 보이는 상하이 스카이라인"), l("Use Shanghai as one comfortable base for city and Suzhou touring.", "以上海为固定住宿点，兼顾城市与苏州游览。", "상하이를 편안한 거점으로 도심과 쑤저우를 함께 둘러봅니다."), 1600, 1000),
  gallery: [
    image("/images/tours/shanghai-suzhou-5-day-private-tour/zhujiajiao-water-town.jpg", l("Canal and stone bridge in Zhujiajiao", "朱家角水乡河道与石桥", "주자자오 수로와 돌다리"), l("A water-town day within reach of Shanghai.", "从上海出发，轻松进入江南水乡。", "상하이에서 가까운 강남 수향마을."), 1920, 1280),
...
const beijing: PrivateTourProduct = {
  ...
  heroImage: image("/images/destinations/beijing/hero-1600.webp", l("Beijing's imperial axis and historic architecture", "北京中轴线与历史建筑", "베이징 중축선과 역사 건축"), l("Five days for Beijing's imperial landmarks and the Great Wall.", "用五天游览北京皇城地标与长城。", "베이징의 황실 유적과 만리장성을 위한 5일."), 1600, 1000),
  gallery: [
