  ...
  },
  {
    ...
    locales: {
      ...
      ko: {
        ...
        h1: "장가계: 시내, 무릉원과 서로 다른 산악 체계를 나누세요",
        description:
          "2·3·4일의 온전한 관광일과 장가계 시내 또는 무릉원 거점을 정한 뒤 국가삼림공원, 천문산, 대협곡과 다음 도시를 연결합니다.",
        navTitle: "장가계",
        summary:
          "장가계라는 목적지 이름은 도시 관문과 입구를 공유하지 않는 여러 산악 체계를 함께 가리킵니다. 첫 여행은 보통 온전한 관광일 3일과 명확한 숙소 거점 선택이 필요합니다. 시내는 천문산, 공항과 철도역을 맡고 무릉원은 국가삼림공원의 이른 출발을 지켜 줍니다. 대협곡과 봉황은 남는 시간에 넣는 곳이 아니라 별도 동선 결정입니다.",
        heroAlt: "장가계 국가삼림공원의 사암 봉우리 사이로 흐르는 안개.",
        heroCaption:
          "봉우리는 여행 이유를 보여 주지만 게이트, 숙소 거점과 환승 사슬은 알려 주지 않습니다. 이 체계를 나눠야 장가계 일정이 실행 가능합니다.",
        openGraphLocale: "ko_KR",
        searchTerms: [
          "장가계 여행 가이드",
          "장가계 며칠",
        ...
        geography: {
          ...
          nodes: {
            city: { label: "장가계 시내", note: "천문산 거점, 공항·철도와 늦은 도착" },
            wulingyuan: { label: "무릉원", note: "공원 쪽 주요 거점과 동문 권역" },
            yuanjiajie: { label: "원가계", note: "상부 고원; 교통 사슬로 접근" },
            tianzi: { label: "천자산", note: "별도의 상부 경관 구역" },
            tianmen: { label: "천문산", note: "시내 쪽 독립 티켓 체계; 별도 하루" },
            grandcanyon: { label: "대협곡", note: "유리다리 권역; 삼림공원 안이 아님" },
            dyg: { label: "DYG 공항", note: "시내 쪽 관문" },
            weststation: { label: "장가계서역", note: "시내 중심 북쪽의 철도 관문" },
          },
        },
      },
    },
