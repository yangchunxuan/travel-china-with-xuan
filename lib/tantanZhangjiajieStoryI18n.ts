...
const copies: Record<HomegroundLocale, TantanZhangjiajieStoryCopy> = {
  en: {
    ...
    ctaTitle: "Talk to a planner about the trip you are considering.",
    ctaBody:
      "Use WhatsApp or leave your email. You can then discuss your available days, priorities and preferred pace with a planner. The service, scope, price or quote and delivery timing are confirmed before any paid work begins.",
  ...
  zh: {
    ...
    ctaTitle: "和规划师聊聊你正在考虑的行程。",
    ctaBody:
      "可以通过 WhatsApp 直接聊，或只留下一个邮箱。旅行天数、最想去的地方和喜欢的节奏可再和规划师沟通；任何付费工作开始前都会先确认服务、范围、价格或报价与交付时间。",
    ctaAction: "联系旅行规划师",
    relatedEyebrow: "继续规划",
  ...
  ko: {
    ...
    eyebrow: "관광지 선택 · 장가계",
    title: "장가계 대협곡 유리다리·천문산 유리잔도·국가삼림공원 구분하기",
    metadataTitle: "장가계 유리다리 vs 천문산 잔도 vs 삼림공원",
    dek:
      "서로 다른 세 곳입니다. 유리다리는 장가계 대협곡, 유리잔도는 천문산, 사암 봉우리 풍경은 장가계 국가삼림공원에 있습니다.",
    authorLabel: "현장 경험",
    authorName: "Tantan",
    ...
    heroAlt: "숲이 우거진 협곡을 가로지르는 장가계 대협곡 유리다리.",
    heroCaption:
      "사진은 장가계 대협곡 유리다리입니다. 천문산 유리잔도나 장가계 국가삼림공원과는 다른 곳입니다.",
    intro: [
    ...
    ctaTitle: "검토 중인 여행을 플래너와 이야기해 보세요.",
    ctaBody:
      "WhatsApp으로 바로 문의하거나 이메일을 남겨 주세요. 여행 기간, 가장 가고 싶은 장소와 편안한 속도는 플래너와 이어서 확인할 수 있습니다. 유료 작업 전에는 서비스, 범위, 가격 또는 견적과 납기를 먼저 확인합니다.",
    ctaAction: "중국 여행 플래너와 상담하기",
