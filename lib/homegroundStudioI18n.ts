  ...
  ko: {
    ...
    members: [
      ...
      },
      {
        ...
        value: "장가계 지역의 실제 현장 조건을 일정 설계에 반영합니다.",
        bio:
          "Tantan은 일정 설계와 후난 지역 현지 운영에 함께 참여하며 장가계, 창사, 봉황 일대의 실제 여행 흐름을 잘 압니다. 지도에서는 간단해 보이는 이동도 교통, 대기 시간, 날씨에 따라 달라질 수 있음을 고려합니다. 계획이 화면에서만 그럴듯한 것이 아니라 현장에서도 실행 가능하도록 조정합니다.",
        tags: ["장가계", "창사", "봉황", "후난 현지 운영"],
        image: {
          ...images.tantan,
