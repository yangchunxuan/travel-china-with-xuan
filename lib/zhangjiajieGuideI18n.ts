...
const korean: ZhangjiajieGuideCopy = {
  ...
  breadcrumbHome: "홈",
  breadcrumbCurrent: "장가계 일정 가이드",
  metadata: {
    title: "장가계는 며칠이 필요할까? 첫 여행은 온전한 3일",
    description:
      "첫 장가계 여행은 국가삼림공원 2일과 천문산 1일, 총 3일을 기준으로 계획하세요. 2일 또는 4일일 때의 선택도 비교합니다.",
  },
  hero: {
    eyebrow: "일정 가이드 · 현지에서 온전히 보내는 날짜 기준",
    lead:
      "첫 방문은 온전한 관광일 3일을 기준으로 잡으세요. 국가삼림공원에 2일, 천문산에 1일이 기본입니다. 2일이면 선택이 필요하고, 4일이면 깊이를 더하거나 봉황고성으로 이동할 수 있습니다.",
    preparedBy: "Homeground China 작성 · 현지 배경: Xuan은 장가계에서 자랐습니다",
    publishedLabel: "게시",
  ...
  quick: {
    ...
    summaryBeforeEmphasis: "2일이면 선택이 필요하고, 3일이면 첫 방문의 핵심을 볼 수 있습니다. 4일이면 장가계를 더 깊게 볼 수 있고, ",
    summaryEmphasis: "또는",
    summaryAfterEmphasis: " 봉황고성으로 이동할 수 있습니다.",
    ...
    decisions: [
      {
        ...
        href: "#itinerary-2-days",
        label: "깊이와 다양성 중 선택",
        detail: "공원을 이틀 보거나, 공원 하루와 천문산 하루를 선택합니다.",
      },
      {
        days: "3일",
        href: "#itinerary-3-days",
        label: "첫 방문에 가장 알맞음",
        detail: "국가삼림공원 이틀과 천문산 하루를 배정합니다.",
      },
      {
        days: "4일",
        href: "#itinerary-4-days",
  ...
  routeLogic: {
    ...
    intro: "무릉원 → 장가계 시내 → 서쪽. 반대로 이동하면 숙박 순서도 달라집니다.",
    figureCaption: "일정 구성도 · 실제 거리 비율과 다름",
    zones: [
      {
        number: "01",
        name: "무릉원",
        sights: "장가계 국가삼림공원 · 대협곡 · 황룽동",
        role: "국가삼림공원 관광일의 숙박 거점입니다.",
      },
      {
        number: "02",
        name: "장가계 시내",
        sights: "천문산 · 장가계 72기루 · 장가계서역",
        role: "천문산 관광 전에 시내로 숙소를 옮깁니다.",
      },
      {
        number: "03",
        name: "부용진",
  ...
  twoDay: {
    ...
    intro: "2일 안에 국가삼림공원, 천문산, 주변 도시까지 모두 넣을 수는 없습니다. 완결된 소규모 동선 하나를 고르세요.",
    whatStaysOut: "제외되는 곳",
    options: [
      {
        label: "선택 A · 공원을 깊게",
        ...
        stops: [
          ...
          },
          {
            day: "2일 차",
            zone: "무릉원",
            coreVisit: "남문 → 황스자이 → 금편계 → 동문",
            sleepBase: "무릉원",
            condition: "공식 도보 예상 시간 외에 전망, 대기, 휴식과 젖은 길을 위한 시간을 더 둡니다.",
          },
        ],
        tradeoff: "천문산, 대협곡, 황룽동, 부용진, 봉황고성.",
      },
      {
        label: "선택 B · 첫 핵심 보기",
        title: "공원 한 구역과 천문산을 각각 하루씩",
        stops: [
          {
            day: "1일 차",
            zone: "무릉원",
            coreVisit: "동문 → 천자산 → 원가계 → 백룡엘리베이터",
            sleepBase: "공원 관광 후 장가계 시내로 이동",
          ...
          },
          {
            ...
            condition: "알맞은 천문산 입장 시간대가 있어야 합니다.",
          },
        ],
  ...
  threeDay: {
    sectionLabel: "온전한 3일",
    title: "첫 방문의 정석: 국가삼림공원 이틀 + 천문산.",
    intro: "국가삼림공원을 서두르는 하루짜리 순환 코스로 압축하지 마세요.",
    timelineLabel: "장가계 3일 일정",
    stops: [
      {
        day: "1일 차",
        zone: "무릉원",
    ...
    replacementBody: "천문산 대신 대협곡을 선택하세요. 공원 이틀은 유지하고 대협곡 동선과 입장 시간을 최신 정보로 확인합니다.",
  ...
  fourDay: {
    ...
    intro:
      "온전한 관광일 4일은 장가계 주변을 더 깊게 보는 데 쓰거나, 4일 차를 봉황으로 이동하고 도착하는 날로 씁니다. 달력상 4일 안에 두 방향을 모두 할 수는 없습니다.",
    ...
    branches: [
      {
        id: "stay-deeper",
        label: "방향 A · 장가계를 더 깊게",
        title: "4일 모두 장가계 주변에서 보내기",
        ...
        tradeoff: "부용진과 봉황고성은 이 4일 일정에서 제외됩니다.",
      },
      {
        id: "continue-west",
        label: "방향 B · 서쪽으로 이동",
        title: "4일 차에 봉황고성 도착",
        intro: "봉황고성은 다음 숙박지로만 자연스럽게 들어갑니다.",
        stops: [
          {
            day: "3일 차",
            zone: "장가계 시내",
          ...
          },
          {
            day: "4일 차",
            zone: "장가계 → 봉황고성",
            coreVisit: "서쪽 이동 · 오후와 저녁의 봉황고성",
            sleepBase: "봉황고성",
            condition: "장가계로 돌아오지 않으며, 가장 빨라도 5일 차에 봉황을 떠납니다.",
          },
        ],
        tradeoff: "대협곡, 황룽동, 부용진은 제외됩니다. 부용진을 더하려면 시간이 더 필요합니다.",
      },
    ],
  },
  figures: {
    tianmen: {
      alt: "낮은 구름 아래 천문산의 가파른 계단을 따라 천문동으로 오르는 여행객들.",
      title: "천문산",
      caption: "장가계 시내를 숙박 거점으로 삼아 별도의 관광일로 계획합니다.",
    },
    fenghuang: {
      alt: "해 질 무렵 퉈장강과 다리가 내려다보이는 봉황고성의 항공 전경.",
      title: "해 질 무렵의 봉황고성",
      caption: "장가계 당일 왕복이 아니라 다음 숙박 목적지로 계획합니다.",
    },
  },
  combination: {
    sectionLabel: "조합 원칙",
    ...
    groups: [
      {
        ...
        items: [
          {
            title: "천문산 + 장가계 72기루",
            detail: "천문산 입장 시간, 대기, 체력이 저녁에 충분한 여유를 남길 때 가능합니다.",
          },
          {
            title: "대협곡 + 황룽동",
            detail:
    ...
    items: [
      {
        ...
        fact: "세계지질공원의 공식 2일 코스는 고지대 전망 구간과 황스자이·금편계를 나눕니다. 금편계 도보 구간만 7.5km, 약 2시간으로 안내합니다.",
      ...
      },
      {
        ...
        fact: "후난성 관광 안내는 장가계 시내에서 무릉원까지 도로 이동을 약 40분으로 제시합니다.",
        calculation: "40분 × 호텔–공원 4구간 ≈ 160분",
        consequence: "공원 이틀을 무릉원에서 숙박하면 반복 이동을 줄일 수 있습니다.",
        sources: [{ index: 2, label: "후난성 교통 안내" }],
      },
      {
        type: "일정 판단",
        title: "봉황고성은 다음 숙박지로 넣는 편이 맞습니다",
        fact: "철도는 부용진과 지서우를 거쳐 서쪽 봉황으로 이어지며, 역에서 고성까지는 다시 현지 이동이 필요합니다.",
        consequence: "장가계 당일 왕복이 아니라 다음 숙박지로 이용합니다.",
        sources: [
          { index: 5, label: "서쪽 철도 구간 안내" },
          { index: 6, label: "봉황역 환승 안내" },
        ],
      },
      {
        type: "예약 전 확인",
  ...
  faq: {
    ...
    items: [
      ...
      {
        question: "장가계는 중국 지도에서 어디에 있고, 어느 지점을 저장해야 하나요?",
        answer:
          "장가계는 중국 후난성 북서부에 있습니다. 천문산을 방문할 때 이용하는 시내·융딩구와 무릉원·국가삼림공원을 구분하세요. 대협곡은 별도 명소이며 삼림공원 입구가 아닙니다. 도착 공항이나 역, 호텔, 첫 입장 매표소를 각각 저장하세요. 장가계만 검색하면 원하는 명소 대신 도시 중심이 나올 수 있습니다. 위의 구성도는 전체 여행 순서를 잡는 데, 공원 안내도는 내부 경로를 확인하는 데 사용합니다.",
      },
      {
        question: "장가계에는 기차와 비행기 중 무엇으로 가고, 도착 후에는 어떻게 이동하나요?",
        answer:
          "실제 여행 날짜의 장가계 서역(张家界西站)행 열차와 장가계 허화국제공항(张家界荷花国际机场)행 항공편을 비교하세요. 장가계역(张家界站)은 서역과 다른 역이므로 표에 적힌 전체 역명을 확인해야 합니다. 첫날 호텔까지의 이동 시간과 비용도 함께 계산합니다. 삼림공원을 먼저 보면 보통 무릉원 숙박부터, 천문산을 먼저 보면 시내 숙박부터 시작할 수 있습니다. 저녁 도착은 이동일로 잡고, 직항이나 직통열차는 실제 운행편을 확인한 뒤 일정에 반영하세요.",
      },
      {
        question: "장가계 여행 계획은 어떤 순서로 세우면 되나요?",
        answer:
      ...
      {
        question: "장가계는 이틀이면 충분한가요?",
        answer: "처음 핵심을 보는 일정이라면 가능합니다. 국가삼림공원 핵심 하루와 천문산 하루로 구성하세요. 국가삼림공원이 여행의 주목적이라면 이틀 모두 공원에 쓰는 편이 낫습니다. 이틀 안에 대협곡, 황룽동, 서쪽 옛 마을까지 함께 넣을 수는 없습니다.",
      },
      {
        question: "천문산과 대협곡을 같은 날 볼 수 있나요?",
      ...
      },
      {
        ...
        answer: "경우에 따라 가능하지만 기본 일정이 아니라 조건부 긴 하루입니다. 무릉원에서 일찍 출발하고, 서로 맞는 입장 시간과 차량을 확인하며, 그날 저녁 기차나 항공편을 두지 마세요. 대기, 날씨나 보행 능력 때문에 여유가 줄면 대협곡만 남깁니다.",
      },
      {
        question: "무릉원과 장가계 시내 중 어디에 숙박해야 하나요?",
        answer: "국가삼림공원, 대협곡, 황룽동은 무릉원에서 접근하기 좋습니다. 천문산, 72기루, 주요 철도 연결은 장가계 시내가 편리합니다. 숙박지를 나누면 반복 왕복을 줄일 수 있습니다.",
      },
      {
        question: "희망 명소 일곱 곳을 4일 안에 모두 볼 수 있나요?",
        answer: "불가능합니다. 희망지는 모두 남기되 4일 동선은 하나를 선택해야 합니다. 장가계에 머물며 깊게 보거나, 봉황고성으로 이동해 숙박하세요. 이후 담당자가 중국 전체 일정과 함께 충돌을 검토할 수 있습니다.",
      },
    ],
  },
  sources: {
    ...
    names: [
      "무릉원구: 2025년 여름 시간대별 입장 안내(과거 운영 참고)",
      "장가계 유네스코 세계지질공원: 공식 2일 코스",
      "후난성 문화관광청: 장가계 교통 기본 정보",
      "후난성 문화관광청: 3일 일정 안내",
      "후난성 정부: 장가계 72기루 야간 체험",
      "중국 문화여유부: 장가계–부용진–봉황 철도 연결",
      "후난성 정부: 봉황역 환승 안내",
      "장가계 대협곡: 공식 관광 코스와 예상 소요 시간",
      "후난성 도로운수관리국: 장가계 대협곡 관광 교통 구간",
      "후난성 문화관광청: 황룽동 안내",
      "후난성 정부: 장가계 위치·공항·기차역",
    ],
  },
  finalCta: {
    sectionLabel: "중국 전체 일정",
    title: "장가계를 중국 전체 희망 일정과 함께 확인하세요.",
    body:
