...
const ko: ChinaHotelValueCopy = {
  ...
  metadata: {
    ...
    inLanguage: "ko",
    heroAlt: "해질 무렵 불이 켜진 장가계의 숙소·식당 거리에 사람들이 모여 있다.",
  ...
  hero: {
    ...
    imageCaption:
      "장가계 무릉원 인근의 숙소·식당 거리. 어느 구역에 묵느냐가 그날의 나머지 일정을 바꿉니다.",
    imageAlt: "해질 무렵 불이 켜진 장가계의 숙소·식당 거리에 사람들이 모여 있다.",
  },
  ...
  questions: {
    ...
    items: [
      ...
      },
      {
        ...
        paragraphs: [
          "장가계에서 “장가계 근처”는 시내일 수도, 천문산일 수도, 기차역일 수도, 국가삼림공원과 가까운 무릉원일 수도 있습니다. 서로 다른 거점이고, 잘못된 구역에서 아낀 요금은 반복되는 택시비, 더 이른 출발, 불필요한 숙소 이동으로 되돌아옵니다. 대도시도 마찬가지입니다.",
  ...
  zhangjiajie: {
    title: "장가계에서 특히 두드러지는 이유",
    intro:
      "장가계는 숙소를 동선과 따로 고르면 안 되는 이유를 잘 보여 줍니다. 이런 선택지들을 놓고 비교하게 됩니다:",
    options: [
      "장가계 시내 — 천문산, 공항, 일부 기차 연결에 유리;",
      "무릉원 — 국가삼림공원 접근에 유리;",
    ...
    imageAlt: "흐린 아침, 장가계 무릉원 공원 입구로 걸어가는 방문객들.",
    imageCaption:
      "무릉원 입구. 여기에 묵는지 장가계 시내에 묵는지에 따라 공원 가는 날의 첫 시간과 마지막 시간이 달라집니다.",
  },
  ...
  imageCreditLabel: "사진",
  imageCredit:
    "장가계에서 Homeground가 직접 촬영. 거리와 주변 환경을 보여 주기 위한 사진이며, 확인을 마쳤거나 추천 중인 숙소가 아닙니다.",
};
