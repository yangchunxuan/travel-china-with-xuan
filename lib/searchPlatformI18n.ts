...
const copies: Record<HomegroundLocale, SearchPlatformCopy> = {
  en: {
    ...
    sections: {
      ...
      plan: {
        navLabel: "Plan Your Trip",
        shortLabel: "Planning",
        eyebrow: "Time · pace · budget",
        title: "Turn a China wishlist into a route that fits.",
        description:
          "Itineraries, city order, trip length, pace, budget and traveller-specific decisions for building a workable China journey.",
        scopeTitle: "This section will connect",
        scope: ["Trip length and city order", "Traveller and theme itineraries", "Budget and pace decisions"],
      },
      transport: {
  ...
  zh: {
    ...
    sections: {
      ...
      plan: {
        ...
        shortLabel: "行程规划",
        eyebrow: "时间 · 节奏 · 预算",
        title: "把愿望清单变成真正走得通的路线。",
        description: "围绕天数、城市顺序、旅行节奏、预算与同行人，建立可执行的中国行程。",
        scopeTitle: "本栏目将连接",
        scope: ["旅行天数与城市顺序", "人群与主题行程", "预算、节奏与取舍"],
      },
      transport: {
        navLabel: "中国交通",
        shortLabel: "交通",
  ...
  ko: {
    ...
    sections: {
      ...
      plan: {
        ...
        shortLabel: "일정",
        eyebrow: "시간 · 속도 · 예산",
        title: "가고 싶은 곳을 실제로 가능한 일정으로 바꾸세요.",
        description: "여행 일수, 도시 순서, 이동 강도, 예산과 동행자에 맞춰 실행 가능한 중국 여행을 설계합니다.",
        scopeTitle: "이 섹션이 연결할 내용",
        scope: ["여행 일수와 도시 순서", "동행자·테마별 일정", "예산·속도·선택 기준"],
      },
      transport: {
        navLabel: "중국 교통",
        shortLabel: "교통",
