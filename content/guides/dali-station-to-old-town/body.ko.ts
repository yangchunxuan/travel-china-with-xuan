...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "도착 전 자주 묻는 질문", items: [
    { question: "기사에게 ‘다리고성’이라고만 말해도 되나요?", answer: "안 됩니다. 열차가 도착하기 전에 숙소에 차량이 가장 가까이 갈 수 있는 성문이나 도로 만남 지점을 묻고, 중국어 답변을 그대로 저장해 두세요. 남문, 동쪽 얼하이문, 서쪽 창산문·서문, 북문은 마지막 보행이 전혀 다릅니다. 저장할 동선은 다리역→확인된 성문→차량이 닿는 숙소 입구입니다." },
    { question: "다리고성의 어느 성문에서 내려야 하나요?", answer: "숙소가 알려 준 성문입니다. 방향만 놓고 보면 남문 방문자센터는 푸싱루 남쪽·원셴루 일대, 얼하이문은 런민루 동쪽·위얼루 동쪽, 창산문·서문은 고성 서쪽·창산 방향, 북문은 고성 북쪽 주소에 맞습니다. 당일 차량 접근은 숙소에 확인해야 합니다." },
    { question: "다리역에서 고성까지 버스가 있나요?", answer: "여행 당일에 확인해야 합니다. 다리와 윈난 교통 당국은 역–고성 서비스와 남문·서문·얼하이문 방향을 안내했고 혼잡기에는 수송력을 늘립니다. 다만 이는 미래의 특정 출발, 요금, 정류장, 운영 시간을 보장하지 않으므로 여행일에 역 화면, 공식 대중교통 채널, 직원 안내 데스크를 확인하세요." },
    { question: "잘못된 성문에서 내렸을 때는 어떻게 하나요?", answer: "불이 밝고 식별 가능한 도로 지점에 머물며 호텔에 연락하세요. 짐을 끌고 고성을 가로지르는 것을 기본안으로 삼지 마세요. 공식 택시·호출차 지점에서 올바른 성문으로 다시 이동하고 새 차량 기록을 저장합니다. 출발 전 기사가 다른 성문을 말하면 짐을 싣지 말고 호텔 메시지를 먼저 보여 주세요." },
    { question: "늦게 도착하는데 짐이 많습니다. 버스와 택시 중 무엇이 나을까요?", answer: "불확실한 환승이 가장 적은 방식을 고르세요. 짐이 크면 용량이 확인된 차량을 쓰고, 숙소 쪽에서 가장 접근하기 쉬운 지점을 숙소에 물어보세요. 늦게 도착한다면 체크인과 전화 연락이 되는지 먼저 확인하세요. 호텔에서 먼 성문을 시험 삼아 고르지 말고, 도착 전에 호텔 지원을 요청해 두세요." },
    { question: "기사에게 보여 줄 중국어 목적지 카드는 어떻게 쓰나요?", answer: "네 항목으로 씁니다. 目的地에 호텔 전체 중국어명, 下车点에 확인된 성문, 联系电话에 호텔 전화, 备注에 짐 개수와 차량이 갈 수 있는 가장 가까운 지점으로 가 달라는 요청을 씁니다. 호텔이 준 표현을 그대로 쓰고 확인 없이 임의로 성문을 고르지 마세요." },
  ] },
