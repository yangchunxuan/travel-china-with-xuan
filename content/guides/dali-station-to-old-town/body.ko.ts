...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "before", type: "list", ordered: true, items: [
    ...
    "합의한 지점 화면과 차량 통행이 제한된 고성 거리 밖의 두 번째 만남 지점을 저장합니다."
  ]},
  ...
  { id: "travellers", type: "comparison", title: "짐과 보행 능력이 교통수단을 바꿉니다", columns: [
    ...
    { heading: "늦은 도착·느린 보행", items: ["불확실한 환승이 가장 적은 방식", "체크인과 전화 연락 확인", "먼 성문을 시험하지 않음"] }
  ]},
  ...
  { id: "recovery-heading", type: "heading", level: 2, text: "잘못 내렸을 때 해야 할 일" },
  { id: "recovery", type: "table", caption: "짐을 끌고 고성을 가로지르는 것을 기본안으로 삼지 마세요", columns: ["문제", "즉시 대응", "다음 단계"], rows: [
  ...
  { id: "help", type: "callout", title: "다리역 도착과 호텔 성문을 맞춰 볼까요?", tone: "decision", body: "날짜, 열차, 호텔, 인원, 짐, 보행 제한을 Homeground에 보내 주세요. 주소와 만남 지점을 정리하고 현실적이지 않은 하차 지점을 찾을 수 있습니다. 실시간 버스, 도로 접근, 차량 공급은 운영자 안내가 기준입니다." },
  { id: "links", type: "internal-links", title: "다음 계획", items: [
    ...
    { label: "중국 일정이 너무 빠듯한가요?", href: "/ko/guides/is-your-china-itinerary-too-rushed/", description: "역에서 고성 호텔까지 충분한 이동 시간을 둡니다." }
  ]},
