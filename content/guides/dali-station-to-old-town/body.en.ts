...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "before", type: "list", ordered: true, items: [
    ...
    "Screenshot the agreed meeting point and a second fallback point outside the controlled old-town streets."
  ]},
  ...
  { id: "travellers", type: "comparison", title: "Luggage and walking tolerance change the mode", columns: [
    ...
    { heading: "Late arrival or slower walker", items: ["Prefer the fewest uncertain handoffs", "Confirm check-in and phone coverage", "Do not experiment with a distant gate"] }
  ]},
  ...
  { id: "recovery-heading", type: "heading", level: 2, text: "Wrong drop-off recovery" },
  { id: "recovery", type: "table", caption: "Do not start a long cross-town walk by default", columns: ["Problem", "Immediate response", "Recovery"], rows: [
    ...
    ["Vehicle cannot enter the lane", "Confirm that this is the agreed reachable point before unloading", "Request the hotel cart/porter or a precise walking escort; otherwise reroute to the fallback point"],
  ...
  { id: "verify", type: "list", items: [
    ...
    "A second gate/roadside fallback is saved if access changes."
  ]},
  { id: "help", type: "callout", title: "Need the station arrival matched to the hotel gate?", tone: "decision", body: "Send Homeground the date, train, hotel, group size, luggage and walking limits. We can prepare the handoff fields and flag an implausible drop-off; live buses, road access and vehicle availability remain with the operators." },
  { id: "links", type: "internal-links", title: "Continue planning", items: [
    ...
    { label: "Is your China itinerary too rushed?", href: "/guides/is-your-china-itinerary-too-rushed/", description: "Protect station and old-town handoff time." }
  ]},
