...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask before arriving in Dali", items: [
    { question: "Can I just tell the taxi driver ‘Dali Old Town’?", answer: "No. Before the train arrives, ask your accommodation for the closest vehicle-accessible gate or roadside meeting point, and save its Chinese reply. South Gate, Erhai Gate on the east side, Cangshan/West Gate and North Gate each lead to a different final walk. The route to save is Dali Railway Station, then a confirmed gate, then a reachable hotel entrance." },
    { question: "Which gate of Dali Old Town should I be dropped at?", answer: "The one your hotel names. As directional guidance only: the South Gate Visitor Centre suits the south Fuxing Road and Wenxian Road side, Erhai Gate the east Renmin Road or east Yuer Road side, Cangshan/West Gate the west old town or Cangshan side, and North Gate northern old-town addresses. Current access still needs a hotel check." },
    { question: "Is there a bus from Dali Railway Station to the old town?", answer: "Check it on the day. Dali and Yunnan transport authorities have described station-to-old-town services and the South, West and Erhai Gate corridors, and authorities add capacity in peaks. That evidence does not guarantee a future departure, fare, stop or operating hour, so read the current station display, official public-transport channel or staffed desk on the travel date." },
    { question: "What do I do if the driver leaves me at the wrong gate?", answer: "Stay at a lit, identifiable roadside point and contact the hotel. Do not start a long cross-town walk by default. Use a marked taxi or ride-hailing pickup for the corrected gate and save the new vehicle record. If the driver names a different gate before departure, keep the luggage unloaded and show the hotel's message first." },
    { question: "We arrive late with heavy luggage — bus or taxi?", answer: "Prefer whichever option has the fewest uncertain transfers. With large cases, use a vehicle whose capacity is confirmed in advance and ask the hotel for the most reachable point on its side of the old town; for a late arrival, check first that reception and phone coverage will work. Do not experiment with a gate far from the hotel, and arrange hotel help before arrival." },
    { question: "What should the Chinese destination card for the driver say?", answer: "Use four fields: 目的地 with the hotel's full Chinese name, 下车点 with the agreed gate, 联系电话 with the hotel's phone number, and 备注 with the number of cases and a request to be taken to the closest point a vehicle can reach. Keep the hotel's own wording and do not choose a gate without confirmation." },
  ] },
  ...
  { id: "sources", type: "sources", title: "Official sources", items: [
    ...
    { label: "Dali station–old town route description", url: "https://jtyst.yn.gov.cn/", publisher: "Yunnan Department of Transport", reviewedAt: "2026-08-13" },
    { label: "2025 Dali peak transport capacity measures", url: "https://jtyst.yn.gov.cn/", publisher: "Yunnan Department of Transport", reviewedAt: "2026-08-13" },
