...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "到达前常见问题", items: [
    { question: "可以只对司机说“大理古城”吗？", answer: "不可以。火车到站前先问住宿方：离酒店最近、车辆可以到达的城门或路边会合点是哪个，并保存酒店的中文回复。南门、东侧洱海门、西侧苍山门/西门和北门，留下的最后一段步行完全不同。要保存的路线是大理站→已确认城门→酒店可达入口。" },
    { question: "应该在大理古城哪个门下车？", answer: "以酒店说的城门为准。以下只说明方向：大理古城南门游客中心对应复兴路南段、文献路一带，洱海门对应人民路东段或玉洱路东段，苍山门/大理古城西门对应古城西侧或苍山方向，大理古城北门对应古城北侧地址。当天能否通车，仍要问酒店。" },
    { question: "大理站到古城有公交吗？", answer: "要看出行当天的信息。大理和云南交通主管部门曾公布车站到古城服务，以及南门、西门和洱海门方向，高峰期还会增加运力，但这些资料不能保证未来某一班、票价、站点或运营时间。出行当天要看车站显示、官方公交渠道或人工服务台。" },
    { question: "在错误的城门下车了怎么办？", answer: "留在有灯光、可识别的路边点并联系酒店，不要默认拖箱横穿古城。再到正规出租车/网约车点，重新去正确的城门，并保存新车记录。如果出发前司机说的是另一个门，先别装行李，给司机看酒店消息，或让酒店与司机通话、在平台内改目的地。" },
    { question: "晚到、行李多，坐公交还是坐出租车？", answer: "选择不确定换乘最少的一条。行李多就选容量已经确认的车辆，并询问酒店一侧最可达点；晚到则先确认入住和电话畅通。不要尝试一个离酒店很远的城门，到达前先安排酒店协助。" },
    { question: "给司机看的中文目的地卡怎么写？", answer: "写四项：目的地〔酒店完整中文名〕、下车点〔已确认的城门〕、联系电话〔酒店电话〕、备注〔行李数量，以及请送到车辆可以到达、离酒店最近的位置〕。务必保留酒店自己的表述，不要在没有确认时随便选一个门。" },
  ] },
