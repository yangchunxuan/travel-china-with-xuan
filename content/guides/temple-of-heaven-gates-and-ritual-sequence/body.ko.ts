...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "tickets", type: "comparison", columns: [
    ...
    { heading: "통합권", body: "공원 입장과 세 주요 유료 명소를 포함합니다. 유명 제례 건축이 중심인 첫 방문에는 일반적으로 이 입장권이 맞습니다." },
    { heading: "핵심 구역 개별 입장권", body: "운영자는 세 명소의 개별 입장권도 안내합니다. 실제 구매 화면이나 서비스 창구 설명을 읽어 공원 입장을 중복 결제하지 마세요." },
  ] },
  ...
  { id: "sequence", type: "list", items: [
    ...
    "별도 운영시간과 입장권, 체력이 허용할 때만 재궁이나 신악서를 더하세요.",
  ] },
  { id: "hours-heading", type: "heading", level: 2, text: "공원이 늦게 닫혀도 기념 건축은 일찍 닫힙니다" },
  { id: "hours", type: "paragraph", text: "외부 공원은 현재 22:00 폐장, 21:00 입장 마감입니다. 세 유료 핵심 구역은 화~일요일에 운영하며 4월 1일~10월 31일 08:00~18:00(17:30 입장 마감), 11월 1일~3월 31일 08:00~17:00(16:30 입장 마감)입니다. 법정 공휴일을 제외하면 보통 월요일 문을 닫습니다. 저녁 공원 산책과 핵심 건축 관람은 운영시간이 다르므로 별개 일정으로 생각해야 합니다." },
  { id: "pace", type: "callout", title: "Homeground의 계획 판단: 2~3시간", body: "2시간이면 되돌아오지 않고 다른 문으로 나가는 일방향 동선으로 세 핵심을 볼 수 있습니다. 3시간이면 축을 천천히 걷고 쉬며 보조 공간 하나를 더할 수 있습니다. 보안, 혼잡, 사진, 우회가 속도를 바꾸므로 공식 소요시간은 아닙니다.", tone: "decision" },
  { id: "mistakes-heading", type: "heading", level: 2, text: "자주 생기는 동선 실패" },
  { id: "mistakes", type: "list", items: ["공원 입장권만 사고 세 유명 건축에 추가 입장이 필요하다는 사실을 뒤늦게 압니다.", "지하철 때문에 동문으로 들어가 남쪽 끝까지 걸은 뒤 다시 동문으로 돌아가려 합니다.", "공원이 22시에 닫힌다는 이유로 늦게 와 핵심 구역을 놓칩니다.", "붐비는 공공 공간에서 회음벽 음향을 보장된 체험으로 기대합니다.", "앉아 쉬어야 할 때 보조 건축 두 곳을 모두 추가합니다."] },
  { id: "faq", type: "faq", title: "출발 전 자주 묻는 질문", items: [
    { question: "외국인도 여권으로 천단을 예약할 수 있나요?", answer: "네, 가능합니다. 베이징시의 2026년 공식 안내를 보면 외국인은 천단 위챗 계정에서 예약한 뒤 입장할 때 전자표 QR과 예약에 쓴 여권 등 신분증을 함께 보여 주면 됩니다. 시립공원 공식 채널도 여권 구매를 지원합니다. 해외 전화번호로 실명 인증이 되지 않으면 비공식 대행 대신 여권 원본을 가지고 종합 서비스 창구로 가세요." },
    { question: "공원 입장권만 사면 기년전에 들어갈 수 있나요?", answer: "들어갈 수 없습니다. 공원 입장권으로는 넓은 외부 공원과 고목, 공공 녹지까지만 이용할 수 있고 기년전·회음벽·원구단 입장은 포함되지 않습니다. 통합권이 이 세 유료 명소를 더해 주고 세 명소의 개별 입장권도 따로 안내되니, 구매 화면을 확인해 공원 입장을 두 번 결제하지 마세요." },
    { question: "천단은 어느 문으로 들어가는 게 좋나요?", answer: "남문입니다. 제례 순서대로 걸으려면 원구단에서 시작해 회음벽과 황궁우, 단폐교를 지나 기년전에서 끝내고 동문이나 북문으로 나가면 되며, 8호선 톈차오역에서 접근하면 편합니다. 지하철 편의가 더 중요하면 5호선 톈탄둥먼역 바로 옆 동문으로 들어가도 되지만, 중심축의 의례 순서는 거꾸로 걷게 됩니다." },
    { question: "천단의 핵심 건축은 몇 시에 닫나요?", answer: "4월 1일부터 10월 31일까지는 18:00에 닫고 입장은 17:30까지, 11월 1일부터 3월 31일까지는 17:00에 닫고 입장은 16:30까지입니다. 세 유료 핵심 구역은 화요일부터 일요일까지 08:00에 열고, 법정 공휴일을 빼면 보통 월요일에 문을 닫습니다. 외부 공원은 22:00 폐장, 21:00 입장 마감이라 저녁 산책과는 다른 일정입니다." },
    { question: "천단 관람에는 시간이 얼마나 필요한가요?", answer: "2~3시간입니다. 2시간이면 되돌아오지 않고 다른 문으로 나가는 동선으로 세 핵심을 볼 수 있고, 3시간이면 중심축을 천천히 걷고 제대로 쉬면서 보조 공간을 하나 더할 수 있습니다. 보안, 혼잡, 사진, 우회가 속도를 바꾸므로 공식 소요시간이 아니라 계획을 세우는 기준으로 보세요." },
    { question: "세 유명 건축 말고도 볼 만한 곳이 있나요?", answer: "재궁과 신악서가 있지만, 별도 운영시간과 입장권, 남은 체력이 허용할 때만 한 곳을 더하세요. 두 곳 모두 중심축에서 벗어나 있고, 서문으로 들어가면 이 조용한 녹지를 먼저 지나게 됩니다. 앉아 쉬어야 할 때 두 곳을 모두 넣는 것은 자주 생기는 동선 실패입니다." },
  ] },
  ...
  { id: "sources", type: "sources", title: "확인한 공식·이미지 출처", items: [
    ...
    { label: "공식 공원 동선, 지하철 접근과 입장권 범위", url: "https://english.beijing.gov.cn/specials/parktours/guidevisitors/templeofheaven/", publisher: "Beijing Municipal Government", reviewedAt: "2026-08-12" },
