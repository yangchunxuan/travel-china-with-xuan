...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "参观天坛前的常见问题", items: [
    { question: "外籍游客可以用护照预约天坛吗？", answer: "可以。北京市2026年的官方指南写明，外籍游客能通过“天坛”微信公众号预约，入园时出示电子票二维码和预约时用的护照等证件，“畅游公园”官方渠道同样支持用护照购票。万一境外手机号做不了实名验证，就带护照原件到综合服务窗口办理，别找未经授权的代购。" },
    { question: "公园门票包含祈年殿吗？", answer: "不包含。公园门票只能进外坛公园、古树和公共园林空间，祈年殿、回音壁、圜丘都要另外的权限。联票在公园门票之外加上这三个主要收费景点，官方也单独列出三个景点的门票，所以下单前看清购票页面，别把公园门票买重了。" },
    { question: "天坛该从哪个门进？", answer: "从南门进。想按祭祀空间由南向北读，就走圜丘、回音壁和皇穹宇、丹陛桥，最后到祈年殿，再从东门或北门出园，地铁8号线天桥站是实用的入口。更看重地铁方便，也可以从东门进，5号线天坛东门站就在旁边，只是中轴的仪式顺序会反过来。" },
    { question: "天坛的核心景点几点关门？", answer: "4月1日到10月31日18:00关门、17:30停止进入；11月1日到3月31日17:00关门、16:30停止进入。三个收费核心景点周二至周日08:00开放，除法定节假日外，周一通常关闭。外坛公园现在22:00关门、21:00停止入园，所以晚上逛公园和看坛庙是两回事。" },
    { question: "逛天坛要留多少时间？", answer: "留两到三小时。两小时够按直线异门路线走完三个核心点；三小时可以把中轴走慢一点、真正坐下来休息，再加一处次要空间。安检、客流、拍照和绕路都会改变节奏，所以这是规划判断，不是官方规定的时长。" },
    { question: "除了三个著名建筑，还有别的值得看吗？", answer: "还有斋宫和神乐署，但只在它们单独的开放时间、门票和你的体力都允许时再加一处。两处都不在中轴线上，从西门进会先走到这片较安静的园林。旅客其实更需要坐下休息时还把两处都塞进去，是常见的路线失误。" },
  ] },
