...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  { id: "answer-first", type: "lead", text: "Foreign visitors can book the Temple of Heaven with a passport through the official channels, or use the comprehensive service counter with the original passport if phone verification fails. For a first visit, buy access to the three charged core sights; a park-only ticket does not include them. Enter at the South Gate for the clearest south-to-north ritual sequence, or use the East Gate for easier Metro Line 5 access and walk the sequence in reverse." },
