...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "乘坐前常见问题", items: [
    { question: "乘坐公益性慢火车需要实名购票吗？", answer: "需要。全国原则是旅客列车和车站实行实名制。只有铁路运输企业提前公开公告并说明理由时，公告中的特定非长途公益性慢火车及相关车站才可以暂不实行。出行前先在 12306 核对准确车次、日期和乘车区间。" },
    { question: "坐这种列车要自己带什么？", answer: "按已核实的旅程准备饮食、饮水和电源，因为车上设施因线路而异。这类列车停靠许多小站，旅程较长，准确时刻比速度更重要。先算清楚自己这一段要坐多久，再按这个时间准备，而不是按城际快车来准备。" },
    { question: "12306 上查不到这段行程，是不是已经停运？", answer: "不一定。某段行程没有显示可售时，既不要断定列车已经停运，也不要以为可以直接上车，仍应向 12306 或车站核对准确服务。一次在线搜索查不到不能证明已经停运；反过来，只有旧报道提供车次，也不能证明现在仍在开行。" },
    { question: "这种列车票价多少？", answer: "本文不给出票价。这类列车属于低价公共服务定位，目的是让基本出行更容易负担，但旧报道里的票价不是今天的报价。不要把旧票价、旧时刻或某一条线路的社会功能当成全国永久规则，出行前在官方渠道查当前价格。" },
    { question: "列车会在我想上车的小站停吗？", answer: "这一点要单独核对。列车可能经过当地，却不在你需要的站办理客运停靠；所选的上车站和下车站都必须为该车办理乘降。先在铁路官方系统确认准确车次、日期、出发站和到达站，再确认车站确实为该车办理旅客乘车。" },
    { question: "车上可以拍照吗？", answer: "可以拍，但要克制，也不要在未经同意时拍人。拍摄他人，尤其是儿童，先征得同意，被拒绝就直接接受。不要占用过道、车门、学习区和指定货品空间。如果拍摄可识别的乘客本身就是这趟出行的主要目的，就不要去。" },
  ] },
