...
{"id":"faq","type":"faq","title":"预订前常见问题","items":[{"question":"染好的布当天能带走吗？","answer":"不一定。看似完成的布料仍可能潮湿或释放浮色，所以预订前先问清作坊的干燥和取件方案。当天马上继续旅行，就应选小件或安排延后取件；潮湿布料要与浅色衣服和证件分开放，并按作坊建议透气或包装。"},{"question":"染缸里的蓝色是真的植物靛吗？","answer":"只看蓝色不能判断染料。国家非遗资料把植物蓝靛列为主要传统染料，但周城的机构调查也记录了化学染料的历史使用和作坊实践变化。植物靛、合成染料或混合工艺都能产生蓝色，所以要直接询问材料名称，让作坊解释当天染缸，不要通过气味、装饰或颜色自行推断。"},{"question":"我自己能动手做多少步骤？","answer":"取决于体验形式，付款前先问清楚。短时入门常用预描图案、有限绞扎和少量染色循环；想理解防染与多次浸染，通常更适合半日动手。短体验只要明确说明哪些是演示或预制，依然可以诚实且有价值。"},{"question":"图案染得不均匀，是不是做坏了？","answer":"不一定，防染工艺本来就会产生差异。绞扎张力、折叠、纤维、染缸状态和循环次数都会影响结果，渐变色晕和细微差异往往呈现的是工艺，而不是失败。高质量游客体验会解释这些变量、示范安全技法，并让你比较扎结前后的布料。"},{"question":"参加扎染体验该穿什么？","answer":"穿能承受飞溅的衣服和包脚鞋，摘下松动饰品并收好包。预订时可以先问作坊是否提供手套、围裙和安全放置物品的地方；到场后遵守染缸、湿滑地面、工具和接触染料的规则，儿童必须直接看护。"},{"question":"可以拍作坊和制作者吗？","answer":"先征得同意。拍摄制作者、家庭空间、工艺笔记或其他游客前都要询问；没有邀请不要进入工作区，也不要触摸染缸、工具和晾晒布料。发帖时标注作坊与实践者，说明自己完成哪些步骤，不要宣称已经掌握白族扎染。"}]},
{"id":"links","type":"internal-links","title":"继续规划工艺体验与大理时间","items":[{"label":"雕版还是活字","href":"/zh/guides/woodblock-and-movable-type-printing-decisions/","description":"看另一项传统工艺怎样随任务、工具与劳动改变。"},{"label":"你的中国行程是不是太赶","href":"/zh/guides/is-your-china-itinerary-too-rushed/","description":"给体验和干燥方案留出真正可用的时间。"},{"label":"外国游客如何在中国付款","href":"/zh/guides/how-to-pay-in-china-as-a-tourist/","description":"预订小作坊前准备付款与凭据。"}, { label: "比较宣纸参观方式", href: "/zh/guides/jingxian-xuan-paper-museum-workshop-choice/", description: "按实际能看见或参与的工序，比较泾县宣纸博物馆、生产区域与短时体验，并说明真实性边界。" }]},
