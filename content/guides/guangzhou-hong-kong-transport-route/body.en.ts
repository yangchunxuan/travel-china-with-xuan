...
const body = {
  ...
  blocks: [
    ...
    { id: "time-heading", type: "heading", level: 2, text: "Build one door-to-door clock" },
    ...
    { id: "people-comparison", type: "comparison", title: "When convenience outweighs the shortest ride", columns: [
      ...
      { heading: "Large luggage or fixed event", items: ["Count station corridors and border handling", "Protect the fixed check-in or flight", "Choose recoverability over a fragile saving"] },
    ]},
    ...
    { id: "recovery-heading", type: "heading", level: 2, text: "If the plan breaks" },
    { id: "recovery-list", type: "list", ordered: true, items: [
      "Read the full station or coach-stop name from the booking, not from memory.",
      "Protect the most expensive fixed item: flight, hotel cutoff or event.",
    ...
    { id: "fact-check", type: "callout", title: "Dynamic transport facts checked August 12, 2026", tone: "neutral", body: "MTR's High Speed Rail planner currently treats Hong Kong West Kowloon as the Hong Kong endpoint and date-specific mainland stations as separate searches. Direct services, fares, station calls, coach stops, border hours and entry requirements can change. This page publishes no permanent timetable or fare." },
    { id: "help-callout", type: "callout", title: "Want the two doors checked by a person?", tone: "decision", body: "Send the travel date, exact Guangzhou and Hong Kong addresses, group size, luggage and the next fixed booking. Homeground can compare the transfer chain and identify facts to recheck without selling a ticket or guaranteeing live operations." },
