...
const body = {
  ...
  blocks: [
    ...
    { id: "faq", type: "faq", title: "Guangzhou to Hong Kong questions answered", items: [
      { question: "What is the best way from Guangzhou to Hong Kong?", answer: "Check a direct high-speed train first when Guangzhou South and Hong Kong West Kowloon fit your itinerary, and search Guangzhou East separately on the exact date, because 12306 recognises both stations in cross-boundary products but not every station pair has inventory every day. Compare a licensed cross-boundary coach only when its confirmed pickup and drop-off remove enough transfers to offset road and border uncertainty." },
      { question: "Do trains to Hong Kong leave from Guangzhou East or Guangzhou South?", answer: "Both stations appear in 12306's cross-boundary products, but direct inventory differs by date. Guangzhou South suits Panyu, south Guangzhou or a through rail connection; Guangzhou East can save a long cross-city transfer when a current direct train exists. Match the full ticketed station name to your hotel before comparing train duration." },
      { question: "How long does the Guangzhou to Hong Kong journey really take?", answer: "Longer than the scheduled ride. Count hotel checkout to the correct station entrance, walking, security and the operator's pre-departure margin, the rail or road time, exit and entry formalities at the station or control point, the arrival-hall walk and the final MTR, taxi or bus leg in Hong Kong, plus a disruption margin for the next fixed booking. This page publishes no permanent timetable or fare." },
      { question: "Is West Kowloon convenient for every Hong Kong hotel?", answer: "No. West Kowloon is useful for Kowloon and connects into the wider urban network, but the station complex and onward walk are not zero, and a Central, Causeway Bay, airport-side or New Territories address needs its own last-mile calculation." },
      { question: "Should I go via Shenzhen instead of taking a direct train?", answer: "Only when direct inventory fails or Shenzhen is genuinely part of the itinerary. Routing through Shenzhen adds a second ticket, a station or border transfer and more ways to miss a connection; if you do, choose one named border and verify both sides before moving." },
    ] },
