...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "Let the two hotel locations choose the shortlist", tone: "decision", body: "A ferry deserves the first check when a current sailing links useful terminals. The HZMB shuttle is a port-to-port service, so add local transport on both sides. A licensed through coach can remove a handoff only when its exact dated stops match the trip." },
  ...
  { id: "matrix", type: "table", caption: "Crossing time is not door-to-door time", columns: ["Option", "Strong fit", "Hidden work", "Verify"], rows: [
    ...
    ["Licensed through coach", "Confirmed stops reduce local transfers", "Operator route, intermediate procedures and road delay", "Licensed operator, pickup, drop-off, crossing and change terms"],
  ]},
  ...
  { id: "clock-heading", type: "heading", level: 2, text: "Build six legs" },
  { id: "clock", type: "list", ordered: true, items: ["Hotel to terminal or Hong Kong Port.", "Check-in, waiting and departure clearance.", "Ferry, shuttle or coach crossing.", "Arrival clearance and baggage recovery.", "Macao terminal or port to the exact hotel.", "Return inventory and a weather/road fallback."] },
  ...
  { id: "recovery", type: "table", caption: "Recalculate from the current terminal", columns: ["Failure", "Response"], rows: [
    ["Ferry cancelled", "Use the operator notice, then price and time the entire HZMB chain"],
    ...
    ["Through coach stop changed", "Contact the licensed operator; do not follow an unofficial replacement vehicle"],
  ]},
  { id: "facts", type: "callout", title: "Dynamic transport facts checked August 12, 2026", tone: "neutral", body: "Hong Kong Marine Department currently lists the Hong Kong–Macao Ferry Terminal and cross-boundary ferry operators. HZMB official guidance describes shuttle, cross-boundary coach and hire-car options. Sailings, bridge transport, fares, terminal hours, baggage and entry requirements can change; verify the date." },
  { id: "help", type: "callout", title: "Need the complete crossing compared?", tone: "decision", body: "Send the date, both hotels, people, luggage and any fixed flight or show. Homeground can compare the handoffs and recovery plan without guaranteeing live border or carrier operations." },
  { id: "links", type: "internal-links", title: "Continue planning", items: [
    ...
    { label: "Protect the last night before a flight", href: "/guides/china-last-night-before-international-flight/", description: "Do not leave a cross-border return unprotected." },
