...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "让两家酒店先决定候选", tone: "decision", body: "当天航班能连接实用码头时先看轮渡；港珠澳大桥口岸巴士是口岸到口岸服务，两侧都要加本地交通；持牌直通巴士只有准确站点与日期匹配时才会减少交接。" },
  ...
  { id: "matrix", type: "table", caption: "跨越海面的时间不是门到门时间", columns: ["方案", "合适", "隐藏工作", "核对"], rows: [
    ["跨境轮渡", "港澳码头都符合酒店位置", "码头手续、海况、行李与后续交通", "运营方、准确码头、航班、行李与中断条款"],
  ...
  { id: "groups", type: "comparison", title: "什么会改变选择", columns: [
    ...
    { heading: "机场或Lantau一侧", items: ["大桥香港口岸可能更合适", "不要假设空侧中转", "留出入境与行李时间"] },
  ...
  { id: "facts", type: "callout", title: "动态交通信息核验于2026年8月12日", tone: "neutral", body: "香港海事处目前列出港澳码头与跨境轮渡运营方；大桥官方指引说明口岸巴士、跨境巴士与出租车辆。航班、大桥交通、票价、码头时间、行李与入境要求都会变化，按日期核对。" },
