...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "跨境前常见问题", items: [
    { question: "香港到澳门，坐轮渡还是大桥穿梭巴士？", answer: "先让两家酒店的位置决定候选方案。当天船班连接的码头符合两端酒店位置时，先看轮渡；港珠澳大桥穿梭巴士是口岸到口岸服务，两侧都要另加本地交通；持牌跨境巴士只有准确站点与日期匹配时，才会真正减少换乘。" },
    { question: "怎么去坐大桥穿梭巴士？", answer: "要自己先到香港口岸。大桥官方指引写明：先乘本地交通到香港口岸，再乘穿梭巴士到澳门口岸，之后再乘本地交通去目的地，穿梭巴士不会到酒店接你。全程要换三次车，所以不能只拿中间一段去和轮渡比时间。" },
    { question: "有中国内地签证，就能进澳门吗？", answer: "不够。中国内地签证本身不能回答能否进入香港或澳门。香港和澳门分别实施出入境管理，请为每本护照核对当下的入境条件，并携带订票时使用的旅行证件。有票不代表获准入境；同行者资格不同时，应先按这一限制设计全组路线，再买不可退改的交通。" },
    { question: "带着大件行李和老人，选择会不一样吗？", answer: "会。购票前先核对电梯、路缘、行李限制、巴士储物空间和酒店入口；同行者行动不便时，还要看码头内步行距离、登乘台阶、候车座位和无障碍本地交通。名义上的直达仍可能包含多次电梯、排队和换车，过境时间最短的方案，门到门可能最费力。" },
    { question: "轮渡取消了怎么办？", answer: "先看运营方通知，再计算完整大桥行程的时间与成本，而不是只比中间一段。如果人已经在错误的码头，先查该码头实时出发，再决定是否穿越香港前往另一个码头；一切都从当前码头重新计算。" },
    { question: "从澳门回香港后还要赶国际航班，要留多少时间？", answer: "过境和航班是两张独立订单，要留出保守缓冲，不能把公布抵达时间当成机场值机时间。澳门酒店到口岸、离境手续、过境、香港入境手续和最终接驳要分开计算，不要只看一个总数。当天再查看运营方公告，因为海况、道路和口岸运行都可能改变可用路线。" },
  ] },
