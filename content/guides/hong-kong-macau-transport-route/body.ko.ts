...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "return-plan", type: "list", ordered: true, items: ["단순히 홍콩의 아무 터미널이 아니라 다음 일정에 맞는 홍콩 쪽으로 돌아오는지 확인합니다.", "마카오 호텔에서 항구, 출경, 통과, 홍콩 입경, 최종 이동을 각각 더합니다.", "이후 국제선이 있다면 별도 예약에 보수적인 여유를 두고, 공시 도착 시각을 공항 체크인 시각으로 보지 않습니다.", "출발 전에 대체 수단과 정확한 대체 터미널, 일행이 그곳까지 가는 방법을 저장합니다.", "해상·도로·출입경 운영이 경로를 바꿀 수 있으므로 당일 운송사 공지를 다시 확인합니다."] },
