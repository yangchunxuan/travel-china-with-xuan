...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "두 호텔의 위치로 후보를 고른다", tone: "decision", body: "당일 페리가 양쪽 호텔과 가까운 터미널을 잇는다면 먼저 확인한다. HZMB 셔틀은 출입경 시설 사이만 오가므로 양쪽에 현지 교통을 더해야 한다. 정식 직행버스는 정확한 날짜의 승하차 지점이 맞을 때만 환승을 줄인다." },
  ...
  { id: "matrix", type: "table", caption: "바다를 건너는 시간만으로 전체 이동을 판단하지 않는다", columns: ["선택", "잘 맞음", "숨은 일", "확인"], rows: [
    ...
    ["정식 직행버스", "확인된 정류장이 현지 환승을 줄임", "운영사 노선, 중간 절차와 도로 지연", "정식 운영사, 승하차 지점, 출입경과 변경 규정"],
  ]},
  ...
  { id: "recovery", type: "table", caption: "현재 터미널에서 다시 계산", columns: ["실패", "대응"], rows: [
    ["페리 취소", "운영사 공지를 보고 전체 HZMB 연결 시간과 비용 계산"],
  ...
  { id: "facts", type: "callout", title: "동적 교통 정보 확인일: 2026년 8월 12일", tone: "neutral", body: "홍콩 해사처는 현재 홍콩-마카오 페리 터미널과 국경 간 페리 운영사를 안내한다. HZMB 공식 안내는 셔틀, 국경 간 직행버스와 정식 영업 차량을 설명한다. 페리 운항, 다리 교통, 요금, 터미널 운영 시간, 짐과 입국 조건은 바뀔 수 있어 날짜별 확인이 필요하다." },
