...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "구매 전 자주 묻는 질문", items: [
    { question: "검색 화면에서 가장 싼 운임이 정말 가장 저렴한 항공권인가요?", answer: "반드시 그렇지는 않습니다. 검색 화면에서 가장 싼 가격이 실제로 쓸 수 있는 가장 저렴한 항공권은 아닙니다. 같은 승객을 기준으로 최종 결제액, 위탁·기내 수하물, 꼭 필요한 좌석, 변경·환불 조건, 늦게 도착해 다음 예약을 놓칠 때의 손실을 함께 비교하세요. 결제 화면에서 이 다섯 가지가 확인된 뒤에 구매하세요." },
    { question: "중국 국내선 항공권에는 위탁 수하물이 포함되나요?", answer: "정확한 운임 상품에 따라 다르며 항공사만으로 정해지지 않습니다. 중국 민용항공국의 여객 서비스 규정은 판매자가 수하물 크기·무게·무료 허용량을 고지하도록 하지만, 모든 항공사와 운임에 적용되는 하나의 허용량이나 변경 수수료를 정하지는 않습니다. 구매할 상품의 운임 조건을 열고 기내와 위탁 수하물을 따로 확인하세요." },
    { question: "운임에 변경 가능이라고 적혀 있으면 무료로 바꿀 수 있나요?", answer: "아닙니다. ‘변경 가능’을 ‘무료 변경’으로 이해하는 것은 흔한 오류이며 운임 차액이나 시간 구간 수수료가 남을 수 있습니다. 상품 자체 조건을 열어 수수료, 운임 차액, 시간 구간, 노쇼 처리와 신청 채널을 포함한 실제 계산식을 기록하세요. 규칙이 끝까지 불명확하면 더 명확한 상품을 고르세요." },
    { question: "어떤 경우에 더 유연한 운임에 돈을 쓸 가치가 있나요?", answer: "운항 이상 시 손실이 훨씬 클 때입니다. 다섯 가지 경우가 있습니다. 국제선 출국 전 마지막 중국 국내선일 때, 같은 날 별도 발권 항공편이나 지정 열차를 이어 탈 때, 환불 불가 행사·허가·크루즈·시간 지정 관광지가 도착에 달려 있을 때, 여권·비자·업무 일정·건강 결정이 확정되지 않아 날짜가 바뀔 수 있을 때, 위탁 수하물이 많거나 어린이·이동 제약이 있을 때입니다." },
    { question: "한 예약에 항공편 두 개가 함께 보이면 연결편인가요?", answer: "판매자가 연결편으로 명확히 고지하는지 확인하세요. 아니라면 결제 전에 셀프 환승 위험을 별도로 평가해야 합니다. 두 항공편이 함께 표시돼도 연결편 확인이 없으면 앞편에 이상이 생겨도 뒷표는 그대로일 수 있습니다. 보호되는 연결편과 비교한 뒤 결정하세요." },
    { question: "싼 운임이 제가 계획한 공항과 다른 공항을 쓰는데 괜찮을까요?", answer: "결제 전에 다시 계산하세요. 공항 코드나 터미널이 계획과 다르면 지상 이동이 절감분을 전부 없앨 수 있으므로, 표 가격이 아니라 문 앞에서 문 앞까지 비용으로 비교해야 합니다. 결제 화면에서 공항, 터미널, 실제 운항사와 날짜를 확인하세요. 비슷한 도시·공항 이름은 서로 바꿀 수 없습니다." },
  ] },
