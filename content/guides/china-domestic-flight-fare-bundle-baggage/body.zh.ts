  ...
  "blocks": [
    {
      "id": "lead-answer",
      "type": "lead",
      "text": "搜索页上最低的国内票价，未必是最低的可用成本。民航局提醒旅客仔细阅读退票、改期和行李规则，因为不同产品条件不同。所有选项都用同一套项目比较：旅客、行李、座位需求、最终支付额，以及后续预订依赖抵达时的改签成本。"
    },
    {
      "id": "decision-frame",
      "type": "comparison",
    ...
    },
    {
      "id": "cut-rule",
      "type": "paragraph",
      "text": "先删可选座位或不必要行李，不要先买会危及昂贵后续路线、限制过多的票价。若抵达后没有固定预订，灵活性的价值可能较低；这是行程条件，不是航空公司排名。"
    },
    {
      "id": "scope",
      "type": "callout",
