...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "购票前常见问题", items: [
    { question: "搜索页上最便宜的票价，真的是最省钱的选择吗？", answer: "不一定。搜索页上最便宜的国内航班价格，未必是你真正能用的最低成本机票。应以同一组旅客比较最终付款总额、托运和随身行李、真正需要的座位、退改条件，以及晚到会让后续预订损失多少。只有结算页把这五项都说清楚，才适合付款。" },
    { question: "中国国内机票是不是都含托运行李？", answer: "要看具体票价产品，不能只看航空公司。民航局旅客服务规定要求销售方告知行李尺寸、重量和免费额度等信息，但没有给所有航空公司、所有票价设定统一行李额或统一退改费。打开即将购买产品的票价条件，并把随身和托运行李分开核对。" },
    { question: "票价写着“可改”，是不是就能免费改签？", answer: "不是。把“可改”理解成“免费改”是常见错误，仍可能收取票价差额或时间档手续费。应打开产品自身条件，记录手续费、票价差额、时间档、误机处理和办理渠道的实际公式；规则不清楚就选择规则更清晰的产品。" },
    { question: "什么情况下值得多花钱买更灵活的票价？", answer: "异常造成的损失明显更大时。五种情况：这是国际离境前最后一段国内航班；同一天还要接一张独立出票的航班或固定火车；不可退款的活动、许可、邮轮或限时景区依赖准时抵达；护照、签证、工作安排或健康决定未落实，日期可能变化；全组有多件托运行李、儿童或行动不便者。" },
    { question: "一个订单里显示两个航班，它们算联程吗？", answer: "先确认销售方是否明确标为联程。如果不是，付款前必须另做自转机风险评估：两个航班一起展示但没有确认是联程时，前段异常，后段票可能完全不变。可以先和受保护的联程比较，再决定。" },
    { question: "低价票用的机场和我计划的不一样，有影响吗？", answer: "有，付款前重新算一遍。机场代码或航站楼与计划不同时，地面转移可能吃掉全部节省，所以要按门到门成本比较，而不是只看票面价。结算时确认机场、航站楼、实际承运人和日期——相似的城市名、机场名不可互换。" },
  ] },
