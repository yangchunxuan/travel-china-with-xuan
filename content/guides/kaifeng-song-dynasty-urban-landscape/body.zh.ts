...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "园区门票多少钱？包含演出吗？",
          answer: "我们能访问的2026年官方资料，仍不足以确认一个可靠的当前票价、外国护照处理流程、各票种所含项目，或日夜产品之间的关系，付款前请核对运营方当前的销售渠道。园区适合想看画卷大尺度转译、需要家庭友好空间或喜欢演出的游客。",
        },
        {
          question: "能在开封看到《清明上河图》原作吗？",
          answer: "不能。原作是故宫博物院的馆藏，不要指望在开封看到，也不要假定故宫当前正在展出它。故宫把它定为北宋张择端所作绢本长卷，纵24.8厘米、横528厘米；园内的浮雕是现代复制品，不能当成原作。",
        },
        {
          question: "普通游客能进州桥考古遗址吗？",
          answer: "不要假定它一定开放。考古报告足以确立州桥的重要性，却没有说明一套可靠的2026年普通游客入场、预约、票务和外国护照处理流程，请向运营或保护单位确认。进不去时，留在合法的公共空间，用开封博物馆补充更广的物质史，绝不要跨越围挡。",
        },
        {
          question: "园区的演出到底是什么样的？",
          answer: "是当代娱乐系统，不是北宋生活录像：现行节目混合历史人物场景、杂技、武侠、科技型娱乐、游乐项目和夜间产品。选一个你感兴趣的形式就够了；看运营方当前的节目页，不要用旧博客的时间表，当天确认场地和所购票种是否包含该节目，只有真正想看夜间产品时才留到晚上。",
        },
        {
          question: "只有不到两小时，怎么走？",
          answer: "在园内只走“浮雕—虹桥—城门”，或者只去一个已确认开放的物证地点，不要在无关的证据类型之间赶路。完整顺序是定位15—20分钟、虹桥25—35分钟、城门与街道40—50分钟，所以先把扩展区域那一段压缩掉。",
        },
        {
          question: "可以拍演员和孩子，再发到网上吗？",
          answer: "不是拍了就能发：允许拍摄和允许公开发布是两回事。遵守现行标识，把可识别的演员或儿童作为主要拍摄对象前先取得同意；公开演出不会自动给你特写的发表权。自己的照片要准确记录日期和地点，绝不要把园内浮雕、复制品或后建的桥标成原件。",
        },
      ],
    },
    {
