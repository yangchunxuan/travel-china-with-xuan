  ...
  blocks: [
    {
      ...
      type: "lead",
      text:
        "청명상하원(Qingming Riverside Landscape Garden)은 청명상하도를 걸으며 체험하는 연출 공간과 공연을 원한다면 입장료를 낼 가치가 있습니다. 다만 북송 카이펑이 그대로 남은 곳은 아닙니다. 그림은 선택된 이동과 상업 활동을 기록하고, 현대 공원은 그 모티프를 오락 공간으로 바꾸며, 저우차오(州桥)는 원래 교차점의 물질적 증거를 제공합니다. 세 가지를 함께 읽되 서로의 증거로 대신 쓰지 마세요. 이 글은 3~4시간 공원 동선, 물질 증거 중심 대안, 공연이나 유적 공개가 바뀔 때의 복구 방안을 제시합니다.",
    },
    {
      id: "names-heading",
      type: "heading",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "아닙니다. Qingming Riverside Landscape Garden, Millennium City Park, Qingming Shanghe Garden은 모두 카이펑의 같은 명소, 중국어 청명상하원(Qingming Shanghe Yuan)을 가리킵니다. 1998년 개장한 이곳은 장쩌돤의 《청명상하도》(영문명 Along the River During the Qingming Festival)에서 영감을 받은 현대 테마파크입니다. 건축물은 온전히 보존된 북송 구역이 아니며 그림도 시공 도면이 아닙니다. 공원의 가치는 물길, 다리, 성문, 거리의 규모를 걸으며 이해하는 데 있습니다. 복원된 원형이 아니라 해석 공간으로 보세요.",
    },
    {
      id: "evidence-layers",
      type: "table",
      ...
      rows: [
        ...
        [
          ...
          "테마 건축물이 원형이거나 인증된 일대일 복원이라는 사실.",
        ],
        [
          "Homeground의 여행 계획 판단",
          "어떤 순서가 질문에 답하고 변화에 어떻게 대처할지.",
          "새로운 역사 사실이나 개방 보장.",
        ],
      ],
    },
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "고궁박물원은 이 작품을 북송 화가 장쩌돤이 비단에 그린 가로 두루마리로 기록하며, 크기는 24.8×528센티미터입니다. 공식 설명은 교외에서 변하(汴河)와 홍교를 지나 성문과 거리로 이어집니다. 배, 짐꾼, 수레, 동물, 상점은 화가가 선택한 장면을 기록합니다. 그러나 두루마리에는 하나의 고정 시점이 없습니다. 시선을 연속되고 압축된 장면으로 이끕니다. 고궁박물원 연구자 위후이는 이를 한 장면의 문자 그대로의 복제가 아니라 실제 상황을 반영한 방식으로 봅니다. 이는 출처가 있는 해석이지, 모든 세부를 상상으로 치부해도 된다는 뜻은 아닙니다.",
    },
    {
    ...
    },
    {
      ...
      height: 853,
      caption:
        "공원 부조는 두루마리의 다리 장면을 확대해 여러 사람이 볼 수 있게 합니다. 방향을 잡는 데는 유용하지만, 북송 유물도 고궁박물원 원본도 아닙니다.",
    },
    {
      id: "scroll-boundary",
      type: "callout",
      ...
      body:
        "연구자들은 작품의 지리, 계절, 목적을 논의합니다. 안전한 결론은 더 좁습니다. 구체적인 도시 관찰이 예술적 선택으로 배열됐습니다. 이동과 교역에 관한 질문은 던질 수 있지만, 그림 하나로 건물을 한 채씩 복원할 수는 없습니다.",
      tone: "warning",
    },
    {
      id: "bridges-heading",
    ...
    },
    {
      ...
      rows: [
        [
          "그림 속 홍교",
          "장쩌돤의 구성 중심에 놓인 목조 아치교. 고궁박물원은 상토교(上土桥)라고도 부릅니다.",
    ...
    },
    {
      ...
      height: 853,
      caption:
        "공원의 홍교는 현대 방문객용 구조물입니다. 물 위로 사람을 건너게 하는 방식을 비교하되, 살아남은 북송 다리나 저우차오라고 설명해서는 안 됩니다. Photo: Windmemories / Wikimedia Commons, CC BY-SA 4.0; resized.",
    },
    {
      id: "bridge-reading",
      type: "paragraph",
      text:
        "두 기관 설명이 차이를 세웁니다. 고궁박물원은 그림의 다리를 홍교 또는 상토교라고 부르고, 허난성 고고학 기관은 저우차오를 어가 교차점에 놓습니다. 공원은 세 번째인 현대 홍교를 더합니다. 이는 공식 증거에 따른 편집적 판단이며 그림의 지리 논쟁이 모두 끝났다는 뜻은 아닙니다.",
    },
    {
      id: "zhouqiao-heading",
      type: "heading",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "저우차오는 원래 좌표와 지층 관계를 더합니다. 고고학자들은 어가와 변하의 교차점에 다리가 있었고, 여러 왕조에 걸쳐 사용되거나 다시 지어진 뒤 1642년 홍수 퇴적물에 묻혔다고 기록합니다. 2018년 이후 발굴로 하천, 교량, 호안 유구가 드러났습니다. 허난성 문물고고연구원은 북송 다리를 기둥과 보를 쓴 평교로 추정하지만 본체는 남아 있지 않습니다. 발굴된 주요 아치는 송대 기초 위에 세운 명 초기 구조입니다. 북송 석축 호안에는 파도 속 상상의 해마·학·상서로운 구름이 새겨져 있습니다. 모든 것을 완전한 송대 다리라고 부르기보다 ‘어느 지층인가?’라고 물으세요.",
    },
    {
      ...
      items: [
        ...
        "조각이 보이면 원물·이전품·복제품인지, 보존 때문에 관람 거리가 제한되는지 확인하세요.",
      ],
    },
    {
      id: "zhouqiao-figure",
    ...
    },
    {
      ...
      body:
        "발굴 보고서는 저우차오의 중요성을 입증하지만, 일반 입장·예약·티켓·외국 여권 처리에 관한 2026년 운영 정보를 완결해 확인하지는 못했습니다. 운영·보호 기관에 문의하세요. 입장할 수 없으면 합법적인 공공 공간에 머물고 카이펑박물관에서 더 넓은 물질사를 보세요. 통제선을 넘지 마세요.",
      tone: "warning",
    },
    {
      id: "park-heading",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "룽팅구 정부 기록에 따르면 공원은 1998년 개장했고, 2005년 두 번째 단계에서 거리 이미지가 도심·황실 정원 테마로 확장됐으며, 2023년 세 번째 단계에는 현대 놀이기구가 추가됐습니다. 이 역사는 두루마리를 한 번에 완전 복제한 공간이 아님을 보여 줍니다. 정부와 운영자가 쓰는 ‘1:1 복원’은 프로젝트 포지셔닝 언어이지, 모든 평면·재료·높이가 그림과 같다는 고고학적 인증이 아닙니다.",
    },
    {
      id: "park-growth",
      type: "list",
      items: [
        ...
        "황실·오락 테마: 후기 단계의 궁궐 이미지, 놀이기구, 야간 상품은 유효한 테마파크 콘텐츠이지 원래 유구가 아닙니다.",
    ...
    },
    {
      ...
      height: 960,
      caption:
        "임수대전은 공원이 확장한 테마 경관에 속합니다. 이곳에서 명소가 두루마리 범위를 어떻게 넘어서는지 보되, 살아남은 송대 건축이나 그림 속 대상의 정확한 대응물이라고 주장하면 안 됩니다. Photo: Yumeto / Wikimedia Commons, CC BY-SA 4.0.",
    },
    {
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "공연표가 바뀌어도 유지되는 증거 동선을 쓰세요. 부조, 현대 홍교, 성문과 거리, 확장된 궁궐풍 경관 순입니다. 이차원 작품에서 걸을 수 있는 해석, 후기 창작으로 이동합니다. 각 지점의 근거가 그림·다른 자료·현대 설계·운영 중 무엇인지 물으세요. 건물 이름만으로 복원 근거가 생기지는 않습니다.",
    },
    {
      id: "relief-stop-heading",
      type: "heading",
      level: 3,
      text: "1단계: 공원 부조를 시각적 색인으로 활용하기",
    },
    {
      id: "relief-stop",
      type: "paragraph",
    ...
    },
    {
      ...
      type: "heading",
      level: 3,
      text: "2단계: 현대 홍교에서 움직임 비교하기",
    },
    {
      id: "bridge-stop",
      type: "paragraph",
      text:
        "25~35분 동안 사람이 건너고 멈추는 모습을 본 뒤 물 쪽을 보세요. 그림은 충돌 직전의 배, 내려가는 돛대, 관중을 압축하지만 현대 다리는 안전한 통행을 관리합니다. 각각이 움직임을 조직하는 방식을 비교할 뿐, 윤곽으로 구조적 정확성을 증명하지 마세요. 붐비면 멈추지 말고 건넌 뒤 허용된 강둑에서 보세요.",
    },
    {
      id: "gate-stop-heading",
      type: "heading",
      level: 3,
      text: "3단계: 상선문에서 명칭을 검증하기",
    },
    {
      id: "gate-stop",
      type: "paragraph",
      text:
        "고궁박물원은 그림 속 성문을 동각자문(东角子门)이라 하고, 공원 구조물은 상선문(上善门)이라 합니다. 강에서 도시로 넘어가는 비슷한 기능이 둘을 동일하게 만들지는 않습니다. 안내된 근거를 읽고 입면과 상점이 오늘날 군중을 유도하는 방식을 보세요. ‘송대 양식’은 양식적 참조일 수 있으며, 현존하는 송대 목구조나 고고학적 복원과 같지 않습니다. 목구조 가이드를 이용하면 외형으로 연대를 추측하지 않고 구조를 물을 수 있습니다.",
    },
    {
      id: "shangshan-figure",
      type: "figure",
      ...
      height: 853,
      caption:
        "상선문은 공원이 테마 도시 안쪽으로 넘어가는 전환을 만드는 데 쓰입니다. 그림 속 동각자문으로 이름을 바꾸거나 살아남은 북송 성문으로 소개해서는 안 됩니다. Photo: Windmemories / Wikimedia Commons, CC BY-SA 4.0; resized.",
    },
    {
      id: "extension-stop-heading",
      type: "heading",
      level: 3,
      text: "4단계: 공원이 의도적으로 그림 너머로 가는 지점 알아보기",
    },
    {
      id: "extension-stop",
      type: "paragraph",
      text:
        "궁궐풍·오락 구역이 궁금할 때만 약 30분을 쓰세요. 전각, 정원, 놀이기구는 공원이 더 넓은 ‘송대 수도’ 이야기로 확장됐음을 보여 줍니다. 모든 건물을 그림과 맞추지 말고 안내판의 출처와 오늘날 볼거리·동선을 위한 설계를 구분하세요. 그림 중심 여행자는 성문과 거리 뒤에 돌아가도 됩니다.",
    },
    {
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "공연은 갈등, 의상, 몸짓을 기억하게 하고 공원의 우선순위를 드러냅니다. 현 프로그램은 역사 인물 장면, 곡예, 무협, 기술, 놀이기구, 야간 상품을 섞습니다. 현대 오락 시스템이지 북송 생활의 기록이 아닙니다. 관심 있는 형식 하나를 고르고, 현대 관객을 위해 무엇을 각색하거나 창작했는지, 공식 소개가 출처를 밝히는지 물으세요.",
    },
    {
      ...
      items: [
        ...
        "촬영 표지를 따르세요. 공개 공연도 근접 사진의 출판 권리를 주지는 않습니다.",
      ],
    },
    {
      ...
      body:
        "운영자는 날씨나 기타 상황으로 공연이 변경·취소될 수 있다고 알립니다. 고른 공연이 사라져도 부조—홍교—성문—확장 경관 순서를 계속하세요. 공간 비교에는 출연진이나 고정 시각이 필요하지 않습니다.",
      tone: "warning",
    },
    {
      id: "decision-heading",
      type: "heading",
      level: 2,
      text: "3~4시간 관람으로 만드는 방법과 입장권이 맞는 사람은 누구인가요?",
    },
    {
      id: "sequence",
      type: "list",
      ...
      items: [
        ...
        "유동적인 공연 한 구간: 당일 길이·장소·포함 여부를 확인하고 변경되면 건너뜁니다.",
        "확장 구역, 약 30분: 공원이 그림을 넘어서는 지점을 찾고 피곤하면 먼저 단축합니다.",
        "유동 시간, 30~45분: 줄, 날씨, 휴식을 흡수합니다. 정말 원하는 최신 야간 상품이 있을 때만 밤까지 머뭅니다.",
      ],
    },
    {
    ...
    },
    {
      ...
      body:
        "그림을 대규모 공간으로 옮긴 방식, 가족 친화적 공간, 공연을 원하는 사람에게 맞습니다. 원래 송대 물질만 찾거나 테마파크 소리와 상호작용을 피한다면 적합도가 낮습니다. 2026년 공식 자료만으로 현재 가격, 여권 처리, 포함 내역, 주·야간 상품 관계를 완결해 확인하지 못했습니다. 결제 전 운영자의 최신 판매 채널을 확인하세요.",
      tone: "decision",
    },
    {
      id: "mistakes-heading",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "촬영 허가와 출판 허가는 다릅니다. 현재 표지를 따르고 식별 가능한 공연자나 어린이를 주요 피사체로 삼기 전에 동의를 구하세요. 고궁박물원 웹 이미지는 출판에 자동 허가되지 않으므로 이 글은 원화를 싣지 않습니다. 직접 찍은 사진에는 날짜와 장소를 남기고 부조·복제품·후대 다리를 원물로 표기하지 마세요.",
    },
    {
      id: "recovery-heading",
      type: "heading",
    ...
    },
    {
      id: "recovery-table",
      type: "table",
      caption: "이 글의 핵심 과업을 유지하는 실패 복구 선택",
      columns: ["변경 상황", "복구 방법", "하지 말아야 할 주장"],
      rows: [
        [
          "고른 공연이 이동 또는 취소됨",
    ...
    },
    {
      ...
      items: [
        ...
        "저우차오 확정 전: 일반 공개, 예약, 관람 범위, 신분증을 확인합니다.",
