...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "공원 입장권은 얼마이고 공연이 포함되나요?",
          answer: "확인 가능한 2026년 공식 자료만으로는 신뢰할 만한 현재 가격도, 외국 여권 처리 절차도, 티켓별 포함 내역이나 주간·야간 상품의 관계도 확인할 수 없었습니다. 결제 전에 운영자의 최신 판매 채널을 확인하세요. 이 공원은 그림을 대규모 공간으로 옮긴 방식, 가족 친화적 공간, 공연을 원하는 사람에게 맞습니다.",
        },
        {
          question: "카이펑에서 《청명상하도》 원작을 볼 수 있나요?",
          answer: "아닙니다. 카이펑에서 원작을 기대하지 말고, 고궁박물원에 지금 전시 중이라고 단정하지도 마세요. 고궁박물원은 이 작품을 북송 장쩌돤이 비단에 그린 가로 두루마리로 기록하며 크기는 24.8×528센티미터입니다. 공원의 부조는 현대 복제품이지 고궁박물원의 원본이 아닙니다.",
        },
        {
          question: "일반 관람객도 저우차오 발굴 현장에 들어갈 수 있나요?",
          answer: "공개된다고 단정하지 마세요. 발굴 보고서는 저우차오의 중요성을 입증하지만, 일반 입장과 예약, 티켓, 외국 여권 처리에 관한 신뢰할 만한 2026년 절차는 확인되지 않았습니다. 운영·보호 기관에 문의하고, 들어갈 수 없으면 합법적인 공공 공간에 머물면서 카이펑박물관에서 더 폭넓은 물질문화사를 보완하세요. 통제선은 넘지 마세요.",
        },
        {
          question: "공원의 공연은 실제로 어떤가요?",
          answer: "북송 생활의 기록이 아니라 현대 오락 시스템입니다. 현 프로그램은 역사 인물 장면, 곡예, 무협, 첨단 기술 연출, 놀이기구, 야간 상품을 섞습니다. 관심 있는 형식 하나만 고르고, 오래된 블로그 시간표가 아니라 운영자의 최신 프로그램을 확인하세요. 당일 공연장과 포함 여부를 확인하고, 정말 원하는 야간 상품이 있을 때만 밤까지 머무세요.",
        },
        {
          question: "두 시간도 없는데 어떻게 돌아볼까요?",
          answer: "공원에서 부조—홍교—성문만 보거나 공개가 확인된 증거 우선 장소 한 곳을 고르고, 서로 다른 증거 유형 사이를 급히 오가지 마세요. 전체 순서는 방향 잡기 15~20분, 홍교 25~35분, 성문과 거리 40~50분이므로 확장 구역을 먼저 줄이면 됩니다.",
        },
        {
          question: "출연자나 아이를 찍어서 올려도 되나요?",
          answer: "찍을 수 있다고 해서 올릴 수 있는 것은 아닙니다. 촬영 허가와 공개 게시 허가는 다릅니다. 현재 안내를 따르고 식별 가능한 출연자나 어린이를 주요 피사체로 삼기 전에 동의를 구하세요. 공개 공연이라고 해서 클로즈업을 게시할 권한까지 생기지는 않습니다. 직접 찍은 사진에는 날짜와 장소를 남기고, 부조와 복제품, 후대의 다리를 원물로 표기하지 마세요.",
        },
      ],
    },
    {
