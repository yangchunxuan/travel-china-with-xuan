...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "平季日期常见问题", items: [
    { question: "中国的平季一定更便宜吗？", answer: "不一定。平季不是全国通用的低价窗口。只有路线核心体验仍然成立、法定假期压力可接受、日照与交通合适，而且真实的弹性预订组合比旺季方案更好——不只是更便宜——这个日期才有价值。要比较具体地区和日期，而不是购买“春季”或“秋季”标签。" },
    { question: "怎么确认我的日期是否紧邻中国法定假期？", answer: "查当年国务院公布的法定节假日安排；2026年通知列出了主要节假日及调休工作日。看似安静的一周，可能紧邻集中出行期；交通压力也可能早于或晚于官方放假日，所以还要看运营方公告，并留出时间余量。" },
    { question: "一个平季窗口能覆盖整条跨区域路线吗？", answer: "通常不能。中国气象局说明，中国气候受到纬度、海陆位置、季风和地形影响，一个“平季”标签不能描述所有路线。请逐站筛选：为每一站写一个不可替代理由，标为天气决定型、运营季节决定型或大体容忍型，再检查其他地区在每个候选窗口是否仍可接受。" },
    { question: "平季订不可退房价能省钱吗？", answer: "天气波动期不建议。闭园或低能见度的那一天无法移动，所以要给灵活性定价，并保持核心日可调。预订顺序按不可逆程度安排：先在理解条件后预订稀缺核心项目，再围绕它安排弹性住宿；天气敏感日保持可移动，不可退款的次要活动在可行情况下尽量晚订。" },
    { question: "什么时候值得为旺季多付钱？", answer: "某个季节性活动就是这趟旅行的核心理由、一旦落空整趟行程就失去意义时，值得为旺季付费。路线有替代、全组能承受不确定性、弹性预订能限制最坏情况下的损失时，选平季。现有日期会破坏核心体验时改选地区；没有折扣能修复一条已无法完成旅行目的的路线。" },
    { question: "深淡季是不是比平季更划算？", answer: "先确认四件事再说：营业时间、交通、你对天气的耐受度，以及更短、更安静的旅行日对你的真实价值。深淡季一样要付交通和酒店的钱，所以某一站已经过季时，应该替换那里的活动或直接删掉这一站，而不是花同样的钱去看缩水的版本。" },
  ] },
