...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask about shoulder-season dates", items: [
    { question: "Is shoulder season always cheaper in China?", answer: "No. China's shoulder season is not one nationwide bargain window. A date offers value only when the route's core activities still work, public-holiday pressure is acceptable, daylight and transport fit, and the actual flexible booking basket is better — not merely cheaper — than the peak alternative. Compare specific dates and regions rather than buying a generic spring or autumn label." },
    { question: "How do I know if my dates sit next to a Chinese public holiday?", answer: "Check the State Council's official holiday arrangement for the year; in 2026 it specifies the dates and adjusted workdays for major public holidays. A seemingly quiet week can border a concentrated travel period, and transport pressure may start before or end after the official days, so read operator notices too and leave margin." },
    { question: "Can one shoulder-season window cover a multi-region trip?", answer: "Often not. China Meteorological Administration explains that the country's climate varies with latitude, land–sea position, monsoon influence and topography, so one shoulder-season label cannot describe every route. Screen each stop separately: write one non-substitutable reason per stop, classify it as weather-critical, operating-season-critical or broadly tolerant, then check whether the other regions remain acceptable in each candidate window." },
    { question: "Is a non-refundable rate a good way to save money on shoulder dates?", answer: "Not when the weather is volatile. One closed or poor-visibility day cannot move, so price the flexibility and keep the anchor movable. Book in the order of irreversibility: reserve the scarce anchor with conditions you understand, build flexible nights around it, keep weather-sensitive days movable and delay non-refundable secondary activities where practical." },
    { question: "When is it worth paying peak-season prices?", answer: "When one seasonal activity is the trip's defining reason and failure would make the journey feel wasted. Choose shoulder dates when the route has substitutes, the group tolerates uncertainty and flexible bookings keep the downside small. Choose a different region when the available dates break the core experience; no discount repairs a route that no longer answers the traveller's task." },
    { question: "Is the deep off-season even better value than shoulder season?", answer: "Only after you check four things: operating hours, transport, your tolerance for the weather, and the value of shorter or quieter days. A deep off-season date still pays the full transport and hotel cost, so when a stop is out of season, replace the activity or remove the stop rather than paying those costs for a reduced experience." },
  ] },
