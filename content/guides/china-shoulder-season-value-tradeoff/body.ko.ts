...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "날짜 선택 자주 묻는 질문", items: [
    { question: "중국 숄더 시즌은 항상 더 싼가요?", answer: "아닙니다. 숄더 시즌은 전국 공통 할인 기간이 아닙니다. 핵심 활동이 여전히 가능하고, 공휴일 이동 압력이 감당 가능하며, 일조와 교통이 맞고, 실제 유연 예약 바구니가 성수기 대안보다 단순히 싸기만 한 것이 아니라 더 나을 때만 가치가 있습니다. 막연한 봄·가을 이름이 아니라 구체적인 날짜와 지역을 비교하세요." },
    { question: "제 날짜가 중국 공휴일과 붙어 있는지 어떻게 확인하나요?", answer: "국무원이 매년 발표하는 공식 공휴일 일정을 확인하세요. 2026년 자료에는 주요 공휴일과 조정 근무일이 나옵니다. 조용해 보이는 주가 집중 이동 기간과 맞닿을 수 있고, 교통 압력이 공식 휴일 전후로 이어지기도 합니다. 운영기관 공지도 함께 보고 일정에 여유를 두세요." },
    { question: "숄더 시즌 한 기간으로 여러 지역을 묶어도 될까요?", answer: "대개 어렵습니다. 중국기상국은 중국 기후가 위도, 해륙 위치, 계절풍과 지형에 따라 달라진다고 설명하므로, 하나의 숄더 시즌 이름으로 모든 동선을 표현할 수 없습니다. 지역마다 따로 검사해 대체 불가능한 이유를 하나씩 적고, 날씨 결정형·운영 시기 결정형·대체로 수용형으로 나눈 뒤 각 후보 기간을 확인하세요." },
    { question: "숄더 시즌에 환불 불가 요금으로 아끼는 게 좋을까요?", answer: "날씨가 변덕스러울 때는 권하지 않습니다. 휴장이나 저시정인 날은 옮길 수 없으니 유연성에 값을 매기고 핵심 날짜를 움직일 수 있게 두세요. 예약은 되돌리기 어려운 순서대로 합니다. 조건을 이해한 희소 핵심 활동을 먼저 잡고 그 주변 숙박은 유연하게 구성하며, 날씨 민감일은 옮길 수 있게 두고 가능하면 환불 불가 보조 활동 예약을 늦추세요." },
    { question: "언제 성수기 가격을 지불할 가치가 있나요?", answer: "계절 활동 하나가 여행의 핵심 이유이고, 그것이 어그러지면 여행 전체가 낭비처럼 느껴질 때입니다. 대안이 있고 일행이 불확실성을 견디며 유연 예약이 최악의 손실을 제한한다면 숄더 날짜를 고르세요. 가능한 날짜가 핵심 경험을 깨뜨린다면 지역을 바꾸는 편이 낫습니다. 어떤 할인도 여행자의 목적을 달성하지 못하는 동선을 고치지 못합니다." },
    { question: "깊은 비수기가 숄더 시즌보다 더 이득 아닌가요?", answer: "네 가지를 확인한 뒤에 판단하세요. 운영 시간, 교통, 날씨를 견딜 수 있는 정도, 그리고 짧고 조용한 날이 본인에게 주는 가치입니다. 비수기에도 교통비와 숙박비는 그대로 나가므로, 한 지역이 이미 철이 지났다면 줄어든 경험에 비용을 치르지 말고 활동을 바꾸거나 그 지역을 일정에서 빼세요." },
  ] },
