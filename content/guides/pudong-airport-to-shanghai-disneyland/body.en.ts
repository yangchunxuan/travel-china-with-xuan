...
const body = {
  ...
  blocks: [
    ...
    },
    {
      id: "endpoint-intro",
      type: "paragraph",
      text: "“Shanghai Disney” can mean the park entrance, one of the two Disney resort hotels or an independently operated hotel spread across the wider resort area. Those are not interchangeable pins. The option that looks fastest to a station may still leave a bus, hotel shuttle or substantial luggage handoff.",
    },
    {
      id: "endpoint-table",
      type: "table",
      caption: "Start with the destination that must receive the people and bags",
    ...
    },
    {
      ...
      items: [
        ...
        "Take the Airport Link one stop toward Hongqiao to Shanghai International Resort Station (上海国际旅游度假区站). Check the live platform display: Airport Link trains can use four- or eight-car formations, so the open platform-door section can differ.",
    ...
    },
    {
      ...
      columns: ["Stage", "Official snapshot reviewed August 10, 2026", "Planning consequence"],
      rows: [
        [
          "Airport Link",
    ...
    },
    {
      id: "fact-check-box",
      type: "callout",
      title: "Dynamic transport facts reviewed August 10, 2026",
      tone: "neutral",
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Current Pudong Airport ground-transport information",
          url: "https://www.shairport.com/pudong/dmjt/index.html",
          publisher: "Shanghai Airport Authority",
          reviewedAt: "2026-08-10",
        },
        {
          label: "Shanghai Disney transportation overview for airport, taxi hubs and resort hotels",
