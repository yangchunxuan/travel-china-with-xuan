...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "阿诗玛石是人工雕像吗？在哪里？",
          answer: "它是天然岩体，不是人工雕像；景区机构把它的位置标在小石林。可以先在石柱更密集的大石林读懂岩石，再到小石林检验视角、故事和命名如何共同造就一处文化地标。",
        },
        {
          question: "换个位置就看不出人形轮廓，是我站错了吗？",
          answer: "换个位置看不出来，并不是你站错了。辨认依赖公共步道上的有利观看角度：站在一个位置，上部轮廓会让人联想到侧脸、头饰、姿态和背负物；换一个位置，它又变回一根形态不规则的石柱。这不是景点失效，在允许通行的步道上比较两个安全视角即可。",
        },
        {
          question: "阿诗玛是真实存在的历史人物吗？",
          answer: "没有能证明某一位可辨识历史女性的记录。国家级非物质文化遗产项目资料把《阿诗玛》认定为撒尼人的叙事传统；撒尼是与石林密切相关的彝族支系，这一传统以撒尼语创作，通过口头讲述和演唱传承。非遗认定关注的是仍在延续的传统，不是目击式传记。",
        },
        {
          question: "1964年电影讲的是原版故事吗？",
          answer: "不是，那是一次改编。汉语搜集和整理出版始于20世纪50年代初，1964年的电影又改编了一次。一项学术比较显示，抽样的代表性口传和整理文本把阿黑写作阿诗玛的哥哥，电影则改成恋人；香港电影资料馆的节目资料可独立确认影片信息和银幕爱情情节。",
        },
        {
          question: "石林是世界遗产吗？",
          answer: "这里其实有两种不同的称号。石林世界地质公园提供的是整体地质框架；中国南方喀斯特世界遗产则是另一个系列遗产，石林范围内的组成部分是乃古石林和所各邑。因此不要假定每一处有名字的岩石，包括阿诗玛石，都单独属于世界遗产组成部分。",
        },
        {
          question: "时间和体力有限，最少看什么才算看懂？",
          answer: "保留一组地质比较和阿诗玛观看点，不必收集每一处有名字的岩体。对大多数游客来说，不额外安排博物馆、表演或长篇讲解也能完成这项观察；当天没有演出，核心任务也并未失败。省力或无障碍路线应向运营方确认当期状况，本文不承诺全程无台阶。",
        },
      ],
    },
    {
