...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "步行线常见问题", items: [
    { question: "南明老城该按什么顺序走？", answer: "趁建筑立面和历史细节还有日光，先走老城街巷；天黑前抵达甲秀楼，让南明河承接蓝调时刻，入夜后以青云市集收尾。一条实用顺序是：曹状元街→甲秀楼与翠微巷→选一小段公众河岸→青云路和青云市集。这只是顺序，不是对每个室内、摊位或灯光都营业的承诺。" },
    { question: "曹状元街上有什么可看？", answer: "南明官方游客资料把它定义为历史文化展示区，包含曹维城状元府原址、老南门遗址、王伯群故居与戴蕴珊别墅等。这份名单不是必进清单：挑一两处当前可读的点，尊重私人或关闭的门，把街道本身当作旧城肌理、当下商铺与居民生活的连接。" },
    { question: "甲秀楼几点关门？", answer: "当天查。这些资料并不能说明每处历史室内都有固定不变的营业时间，所以本页不发布未核实的最晚入场时间，请看官方或场馆当天的通知。尽量在建筑仍有日光时到达；若室内关闭，就保留昼夜顺序，从公众空间去看桥、楼与河的关系。" },
    { question: "青云市集在哪里？怎么点单比较好？", answer: "用青云路83号作为官方英文游客信息里的地址参考，再按现场当前标识找可用入口。先走一圈，比较菜单、队伍、座位、通风和付款方式，再逐道菜问辣度、过敏原和配料，“不辣”之后仍要追问有没有辣油或点缀；分轮点单，一道不合适也不会毁掉晚餐。" },
    { question: "下雨了，这条线还走得成吗？", answer: "不一定要取消，下雨只是路线分叉。小雨、地面安全时，缩短历史分支，保留甲秀楼与青云；遇上大雨、雷电、河岸湿滑或防洪管控，就删掉河边步行，用两个经核实的上下车点转移。这条线路靠昼夜反差成立，不靠一步不断。" },
    { question: "带长辈能走这条线吗？", answer: "可以，但要减掉一条分支。曹状元街与甲秀楼只深看一处，中间坐下休息，再乘车去青云；一出现疲劳就删掉河岸段，并在晚餐前安排好上车点。保留更重要的那一处，这条线的昼夜反差就还在。" },
  ] },
