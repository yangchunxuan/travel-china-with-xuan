...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "table",
      caption: "Homeground 节气转旅行判断表：先翻译一条节气主张，再调整行程",
      columns: ["你遇到的说法", "证据层", "现在要核验什么", "安全用法"],
      rows: [
        ["今天进入某个节气", "天文历法", "当年的权威日历", "把它当时间节点，不当天气阈值"],
        ["这个节气意味着雨、热或冷", "季节记忆", "当地预报、预警、海拔和路线", "按当前实况准备，不按名称准备"],
        ["人们会为这个节气吃某种食物", "活态实践", "具体地区、社群、场所和日期", "描述有记录的一例，不写成全国规则"],
        ["正在举办节气主题活动", "当前节目", "具名主办方、地址、准入和取消渠道", "节气只提供语境，实际到访听从当日通知"],
      ],
    },
    {
      id: "names-heading",
    ...
    },
    {
      ...
      items: [
        {
          question: "二十四节气到底是什么？",
          answer: "它既是太阳周年运动中的固定标记，也是中国人记忆季节变化、农事节奏与社区实践的一套活态框架。对旅客来说，节气名适合用来追问这个地方在此时观察什么、做什么，却不表示旅行当天一定下雨、结霜、降雪或转暖。",
        },
        {
          question: "原本要看的节气活动没有举行，怎么办？",
          answer: "非遗名录是文化记录，不是运营日历。公告过的活动没有举行时，可以改看博物馆或有文献依据的展览，并复核社区官方通知。如果是节气菜已经售罄，那本来就是节气的意思：请当地人解释另一种当季食材，不要硬找一份所谓全国等价菜。",
        },
        {
          question: "可以按节气决定带什么衣服吗？",
          answer: "不可以，穿什么要看旅行日期对应城市的天气预报。中国横跨多种纬度、海拔与海陆环境，季风影响也不相同，中国气象局明确指出各地四季变化差异很大。一项使用1960—2008年549个气象站资料的同行评议研究也发现，以气候阈值定义的“气候节气”时间会变化。",
        },
        {
          question: "每个节气是不是都有一道全国统一的菜？",
          answer: "不是。中国气象局的冬至资料记录了多地不同吃法，这证明的是多样性，不是一份全国统一菜单。带节气名的菜品可能是当季食材，可能是某地食俗，也可能只是餐馆的限时主题菜单；可以体验，但不能把营销名称当成古老或全国性传统的证据。",
        },
        {
          question: "游客能参加节气活动吗？",
          answer: "先核对当年的主办方。教科文组织的资料举到九华立春祭、壮族霜降节，国家级非遗数据库还记录了安仁赶分社。这些不能证明每天都有游客演出，也不能证明所有人都能进入。出发前向当地文旅部门、博物馆或场馆核对当年安排，并尊重仪式空间与拍摄限制。",
        },
        {
          question: "节气菜对身体有好处吗？",
          answer: "把它当作文化语言看待。菜单和地方说明中可能出现“滋补”“祛湿”或“防病”等表达，本文只把这些当作文化语言记录，不推荐任何食物、草药或生活方式用于治疗或预防疾病。健康决定应遵循适当的临床建议。",
        },
      ],
    },
    {
