...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "example", type: "callout", tone: "neutral", title: "这是方法示例，不是固定行程", body: "一家人看到铁路运行时间很短，就为了一个著名景点增加一座城市。真实转场却包含退房、大车站、两个行李箱、一辆婴儿车，以及尚未能入住的房间。如果新城市只有这一个项目，失去的可用时间可能多于得到的时间。从稳定基地集中访问，或直接删除这一站，都可能在不增加完整转场日的情况下保护核心体验。" },
  {
    ...
    "type": "heading",
    "level": 2,
    "text": "带幼儿的10天例子：北京与上海"
  },
  {
    "id": "family-ten-days-intro",
    "type": "paragraph",
    "text": "北京住第1至5晚，上海住第6至9晚：10天9晚，只换一次酒店。可以比较北京入境、上海回国的航班。这是节奏示例，不是婴儿车通行保证或固定套餐。"
  },
  {
    "id": "family-ten-days-plan",
    "type": "list",
    "items": [
      "D1：抵达北京，先到酒店，余下时间不排固定活动。北京第1晚。",
      "D2：天坛公园短时游览，午餐后保留平常的休息时段。北京第2晚。",
      "D3：按已确认时段参观故宫，提前选一条较短路线，不再接第二个大景点；遇闭馆或票没约到就调换日期。北京第3晚。",
      "D4：住处附近散步或逛公园，留作恢复日。北京第4晚。",
      "D5：只有完整往返交通与步行适合孩子时才安排长城，否则留在市区；晚上不赶行程。北京第5晚。",
      "D6：按实际预订的火车或航班转到上海，安顿后休息，不接定时景点。上海第1晚，即全程第6晚。",
      "D7至9：一天短逛外滩，一天选附近公园或街区，另留一天机动；需要午睡就回酒店。上海同一家酒店住全程第7至9晚。",
      "D10：前往机场回国。遇抵达、睡眠或交通不顺，删掉一次出游，不用临时加夜间换酒店。"
    ]
  },
  ...
  { id: "faq", type: "faq", title: "带幼儿出行常见问题", items: [
    { question: "孩子在中国坐火车需要单独买票吗？", answer: "按12306当前说明，年满6周岁、未满14周岁的儿童应购买儿童优惠票；每位持票成人可以免费带一名未满6周岁、且不单独占座的儿童。年龄按乘车日期计算，免费乘车的儿童也要用有效身份证件提前申明；需要单独座位，就得买对应车票。购票前必须再核对一次规则。" },
    { question: "带幼儿的10天行程，安排几座城市合适？", answer: "换一次酒店通常就够了。10天9晚可以这样安排：北京住第1至5晚，上海住第6至9晚，中间只换一次酒店。还可以比较北京入境、上海回国的航班。这是节奏示例，不是婴儿车通行保证或固定套餐。" },
    { question: "火车运行时间很短，要不要为一个景点多加一座城市？", answer: "如果理由只有“火车很短”，就删掉这一站。真实转场包含退房、大车站、行李箱、婴儿车，以及可能还没准备好的房间；新城市只有这一个项目时，失去的可用时间可能多于得到的。从稳定基地集中访问，或者直接删掉这一站，都可能在不增加一整天转场的情况下保护核心体验。" },
    { question: "带幼儿时，一天能安排多少项目？", answer: "每天只保护一个核心项目。可选项目安排在附近，临时删掉也不会变成跨城失败；每次城际移动之后留一段恢复时间，别把定时核心项目接在计划抵达时间后面。路线过满时，先删掉整个基地，而不是压缩睡眠、用餐和转场余量。" },
    { question: "孩子睡过了定时项目怎么办？", answer: "事先约好的话，可以由一名成人单独去；没约好就放弃这个项目。结构上真正要改的是：别把不可替代的项目放在平时午睡或抵达的时间段。可预期的食物要放在核心项目之前，不是之后；随身再带一份熟悉的备用食物，以防长队前孩子不肯吃。" },
    { question: "中国的车站能顺利推婴儿车吗？", answer: "要逐个车站核实，不能默认。无障碍通行重要时，向具体运营方确认准确入口、电梯或协助服务，并保留抱行或替代交通方案。车站设施和临时通行路线都会变；一个车站顺利，并不能推断全国都适合推婴儿车。" },
  ] },
