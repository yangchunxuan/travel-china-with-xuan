...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "走完这条鲁迅路线要多久？",
          answer: "时间可长可短。截至2026年8月14日复核，现行官方资料并不能证明所有旅客都能走完固定的2—3小时动线；运营方网页上的一、二、三小时线路带着早年日期，只能当方位参考。排队或关闭改变了走法，也要保住“家族—求学—居住—记忆中的园子—纪念馆—小说与商业”的顺序。",
        },
        {
          question: "三味书屋能看到那张“早”字书桌吗？",
          answer: "要当天现场核对。浙江文旅部门2024年的报道和纪念馆工作人员采访都说，馆方认定的原物曾因保护撤出三味书屋，入库修缮后在纪念馆展出；后来的报道并没有始终说清三味书屋所见课桌是原物还是复制品。若当天看得到，应按展签原文记录，不要直接当成来源确凿。",
        },
        {
          question: "咸亨酒店就是《孔乙己》里的那家酒楼吗？",
          answer: "不是。《孔乙己》初刊于1919年，是短篇小说，鲁镇酒楼属于文学创作。酒店2025年发布的自述年表称，它于1981年恢复营业，后来扩建时保留了所谓的“堂吃”部分，其他区域拆除重建。今天的门面和雕像说明作品的接受力很强，而不是一处未经改变的晚清场景。",
        },
        {
          question: "周家新台门是鲁迅童年住过的原屋吗？",
          answer: "部分是。它与鲁迅出生、青少年生活的关系有官方资料支持，但绍兴市政协的史料记载，周家1918年出售房产，1920—1922年间较大范围改建，同时指出特定居室和厨房等部分得以保留；另有机构史料记录2003年的工程拆除旧展厅、恢复新台门环境，并建设新的纪念馆。",
        },
        {
          question: "百草园就是散文里的那个园子吗？",
          answer: "它既是真实地点，也是文学记忆。百草园位于故居后方，属于周家生活空间；《从百草园到三味书屋》则是收入《朝花夕拾》的回忆性散文，鲁迅1926年以成年作者的眼光重新组织童年经验。它不是当时的日记，也不是园林修缮报告，所以现有种植不必与课文一一对应。",
        },
        {
          question: "没读过鲁迅，这条路线哪几处值得花时间？",
          answer: "优先新台门、三味书屋和纪念馆。前后读一篇短文就够，不必摘句打卡，也不必把这天变成漫长的生平课；纪念馆正是在没有阅读基础时，也能读懂年表、版本、照片和出版脉络的地方。无论怎么选，都要带好护照证件，并给人工窗口询问留出时间。",
        },
      ],
    },
    {
