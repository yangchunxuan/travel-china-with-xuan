...
const body = {
  ...
  blocks: [
    ...
    },
    {
      id: "faq",
      type: "faq",
      title: "루쉰 사오싱 자주 묻는 질문",
      items: [
        {
          question: "루쉰 사오싱 산책은 얼마나 걸리나요?",
          answer: "상황에 맞춰 늘리거나 줄이면 됩니다. 2026년 8월 14일까지 재확인한 공식 자료만으로는 누구에게나 2~3시간이 걸리는 현행 동선을 말할 수 없고, 운영자 사이트의 1·2·3시간 코스는 날짜가 지난 참고 자료입니다. 대기열이나 폐쇄로 걷는 순서가 바뀌어도 가족–학교–집–기억 속 정원–기념관–소설과 상업의 순서는 지키세요.",
        },
        {
          question: "싼웨이수우에서 ‘早’ 글자 책상을 볼 수 있나요?",
          answer: "당일 현장에서 확인해야 합니다. 저장성 문화관광 당국의 2024년 보도와 기념관 직원 인터뷰는 기관이 원물로 귀속한 책상이 보존을 위해 싼웨이수우에서 철수되어 기념관에 전시됐다고 설명합니다. 이후 보도는 싼웨이수우에 보이는 책상의 지위를 늘 분명히 구분하지는 않으므로, 책상이 있다면 설명문 문구를 그대로 읽으세요.",
        },
        {
          question: "셴헝주뎬이 「쿵이지」에 나오는 그 주점인가요?",
          answer: "아닙니다. 1919년에 처음 발표된 「쿵이지」는 단편소설이고 루전의 주점은 허구입니다. 호텔이 2025년에 공개한 자체 연혁은 1981년 영업을 재개했고, 이후 확장 때 운영자가 ‘堂吃’이라고 부르는 홀 식사 구역은 남겼지만 나머지는 철거·재건했다고 적습니다. 현재 건물과 조각은 후대 수용을 보여 줄 뿐, 청말 모습 그대로가 아닙니다.",
        },
        {
          question: "저우자 신타이먼은 루쉰이 살던 원래 집 그대로인가요?",
          answer: "일부만 그렇습니다. 출생과 성장에 연결된 기록이 있는 거주지이지만, 사오싱시 정협 자료는 저우 가문이 1918년에 재산을 매각했고 1920~1922년에 넓은 범위의 개조가 있었으며 특정 거주 공간과 부엌이 남았다고 기록합니다. 다른 기관 자료는 2003년에 오래된 전시관을 철거하고 환경을 복원하며 새 기념관을 조성한 사업을 기록합니다.",
        },
        {
          question: "바이차오위안이 산문에 나오는 그 정원인가요?",
          answer: "실제 장소이자 문학적 기억입니다. 정원은 고거 뒤편의 가족 생활 경관에 속하고, 「바이차오위안에서 싼웨이수우까지」는 『아침 꽃을 저녁에 줍다』에 실린 회고 산문으로, 루쉰이 1926년에 성인 작가의 시선으로 어린 시절을 다시 구성했습니다. 당시의 일기도 보존 조사서도 아니므로 지금 자라는 식물이 문장과 맞을 필요는 없습니다.",
        },
        {
          question: "루쉰을 읽은 적이 없는데 어디에 시간을 쓰면 좋을까요?",
          answer: "신타이먼, 싼웨이수우, 기념관을 우선하세요. 앞뒤로 짧은 글 한 편만 읽으면 충분하고, 인용문 찾기나 긴 생애 강의로 만들 필요는 없습니다. 기념관은 사전 지식이 없어도 생애 연표와 판본, 사진, 출판 맥락을 읽을 수 있는 곳입니다. 어느 쪽을 고르든 여권 신분증을 지참하고 유인 창구에 질문할 시간을 남기세요.",
        },
      ],
    },
    {
