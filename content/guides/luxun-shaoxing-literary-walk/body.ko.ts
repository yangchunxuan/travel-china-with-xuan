...
const body = {
  ...
  blocks: [
    ...
    },
    {
      id: "layers-method",
      type: "paragraph",
      text: "이 구분은 ‘진짜 옛 도시’와 ‘가짜 현대 관광지’를 가르는 판정이 아니다. 복원된 방은 공간 규모를 이해하게 해 주고, 새 기념관에는 오래된 침실보다 더 나은 문헌 증거가 있을 수 있다. 상업 조각도 허구 인물이 공공 기억으로 들어온 방식을 보여 준다. 더 정확한 질문은 누가, 언제, 어떤 물질에 대해 무엇을 주장했는가이다. 문화재 표지, 보존 안내, 박물관 캡션, 문학 텍스트와 관광 문구에 서로 다른 증거 가중치를 주자."
    },
    {
      id: "sequence-heading",
      type: "heading",
    ...
    },
    {
      id: "sanwei-text",
      type: "paragraph",
      text: "싼웨이수우는 서우(寿) 가문의 저택 안에 있었고, 사오싱 공식 자료는 루쉰이 열두 살 무렵 들어가 약 5년 동안 공부한 서당으로 설명한다. 따라서 이 방과 그의 교육 이력의 관계는 영화 세트나 막연한 ‘옛 교실’보다 강하다. 방의 작은 규모, 선생과 학생 책상의 관계, 편액과 기관 설명을 먼저 본다. 이런 공간 정보만으로도 루쉰이 훗날 산문에서 정원의 관찰과 서당 생활을 어떻게 대비했는지 생각할 수 있으며, 현장에서 교과서 장면을 재연할 필요는 없다."
    },
    {
      id: "sanwei-figure",
      type: "figure",
    ...
    },
    {
      id: "fiction-text",
      type: "paragraph",
      text: "1919년에 처음 발표된 「쿵이지」(《孔乙己》)는 단편소설이다. 몰락한 독서인, 화자와 루전의 주점은 루쉰이 아는 사회 세계에서 재료를 얻었더라도 허구에 속한다. 훗날 제기된 한 사람의 ‘원형’ 후보가 쿵이지를 기록된 사오싱 주민으로 바꾸지는 않는다. 오늘날 인물이 간판, 조각과 음식 공간에 매우 눈에 띄게 등장하기 때문에 이 경계가 더 중요하다. 그런 물건은 작품의 강한 후대 수용을 증명하지만 소설을 지방 인물 전기로 만들지는 않는다."
    },
    {
      id: "xianheng-figure",
      type: "figure",
    ...
    },
    {
      ...
      items: [
        ...
        "동선이 허용하면 라오타이먼부터 시작한다. 가문과 사회 배경이라는 한 가지 역할만 맡긴다. 닫혀 있다면 그 맥락은 기념관에서 보충하고 신타이먼에 대신 덧씌우지 않는다.",
    ...
    },
    {
      ...
      body: "공개 전 실명이 확인되는 사오싱 현지 또는 루쉰 문화 검토자가 현재 방 순서, 기관의 물건 귀속 표현, 중국어·한국어 고유명, 회고 산문·소설·장소 해석의 경계를 검토해야 한다.",
      tone: "neutral"
    },
    {
      id: "links",
