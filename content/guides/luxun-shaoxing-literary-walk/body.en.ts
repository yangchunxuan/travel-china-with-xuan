...
const body = {
  ...
  blocks: [
    ...
    },
    {
      id: "dynamic-note",
      type: "paragraph",
      text: "Before travel, recheck regular opening hours, free or paid components, reservation and foreign-passport handling, construction closures, one-way circulation, step-free access, object rotation and interior photography with the direct operator. The current 2026 notices found were holiday-specific; one temporarily consolidated two entrances and suggested east-to-west flow, so it cannot establish ordinary rules. The operator website was unreachable in the 14 August recheck. Keep the plan flexible, carry the physical passport, allow time for a staffed-counter question and regard Xianheng as optional. Do not let a dynamic failure erase the evidence boundaries."
    },
    {
      id: "local-review",
      type: "callout",
    ...
    },
    {
      id: "sources",
      type: "sources",
      title: "Core and correction sources checked through 14 August 2026",
      items: [
        ...
        {"label": "Xianheng Hotel operator chronology: 1981 reopening and later partial retention/rebuilding", "url": "https://www.xianheng.com/index.php?a=show&c=index&catid=151&id=1&m=content", "publisher": "Xianheng Hotel", "reviewedAt": "2026-08-14"},
        {"label": "June 2026 holiday entrance and circulation adjustment", "url": "https://news.10jqka.com.cn/20260619/c677587892.shtml", "publisher": "Public mirror of Shaoxing official-account notice", "reviewedAt": "2026-08-14"},
