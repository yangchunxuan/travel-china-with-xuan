...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "law-copy", type: "paragraph", text: "A widespread assumption is that hostels sit in some lighter regulatory tier than hotels. They do not. The current Measures for Public Security Administration of the Hotel Industry apply to establishments receiving guests for accommodation — hotels, guesthouses, inns, hostels and similar — regardless of whether they are state-owned, collectively run, partnerships, individually run or foreign-invested, whether accommodation is their main business or a sideline, and whether they operate year-round or seasonally. One rulebook, all of them." },
  { id: "law-list", type: "list", ordered: false, items: [
    ...
    "Necessary anti-theft security facilities are required. Other fire and building obligations come from their own laws and local rules; this page does not use the Measures to summarise them.",
  ...
  { id: "law-warning", type: "callout", title: "The national baseline is not a booking guarantee", tone: "warning", body: "National policy does set one clear baseline: accommodation operators must not refuse overseas guests merely because they claim to lack a \"foreign-related qualification\". That does not guarantee check-in at every property. A valid reservation, an accepted travel document, the usual lawful check-in conditions and the property's practical ability to complete registration still matter. Confirm the exact property in writing. If it refuses you because it says it has no foreign-guest qualification, use the foreign-guests guide linked at the foot for the full registration and escalation steps. Age limits, dormitory gender rules, deposits and front-desk hours remain property-level questions." },
  ...
  { id: "facts", type: "callout", title: "Reviewed 23 August 2026", tone: "neutral", body: "The regulatory statements above are drawn from the current text of the Measures for Public Security Administration of the Hotel Industry in the Ministry of Justice's national administrative regulations database. The Measures were approved in 1987 and amended in 2011, 2020 and most recently on 29 March 2022. National policy also says accommodation operators must not refuse overseas guests merely for lacking a claimed \"foreign-related qualification\". Beyond that baseline, provincial implementing rules and individual property practice still matter. This page makes no nationwide promise that a particular hostel can complete check-in for a particular traveller or document, and it makes no nationwide claim about age, dormitory gender rules, deposits or opening hours. Confirm those with the property for your dates." },
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask before booking", items: [
    { question: "Is a hostel always cheaper than a budget hotel in China?", answer: "No. Compare the price of the room you would actually accept: for two people, two dormitory beds often approach the price of one private room, and a hostel private room is not budget-priced by definition. A hostel private room and a budget hotel room are close relatives, and their nightly rates often land in the same range." },
    { question: "Can a hostel turn me away because I am a foreign guest?", answer: "Not for that reason alone. National policy says accommodation operators must not refuse overseas guests merely because they claim to lack a “foreign-related qualification”. That does not guarantee check-in at every property: a valid reservation, an accepted travel document, the usual lawful check-in conditions and the property's practical ability to complete registration still matter. Confirm the exact property in writing before you pay." },
    { question: "Does a hostel have to register my stay?", answer: "Yes. The Measures for Public Security Administration of the Hotel Industry require a property receiving a guest to register the stay, to inspect the guest's identity document and to record the prescribed fields truthfully. For overseas guests there is an additional step: the property must submit the accommodation registration form to the local public security authority within 24 hours." },
    { question: "Does “private room” mean the bathroom is inside the room?", answer: "Not always. A listing can call a room private when the bathroom is shared on the corridor, and a private bathroom is not universal in hostels or budget hotels. Ask the property directly: is the bathroom inside the room I am booking, and if it is shared, how many rooms or beds share it?" },
    { question: "I land at 01:00. What matters most when I book?", answer: "Whether someone can complete your registration at that hour. Registration is a legal step, not a nicety, so it cannot be skipped because the desk is closed. Confirm the staffed hours and what happens outside them, and ask whether check-in can be held for a late arrival and whether that requires a deposit or a card." },
    { question: "Can I leave my bags at the hostel before check-in or after check-out?", answer: "Ask, do not assume. A listing that says “luggage storage” can mean a corner of the lobby, unstaffed and at your own risk, so ask whether it is locked, whether it is staffed, and whether bags can be left before check-in and after check-out. For a dormitory, ask the locker dimensions rather than whether lockers exist." },
  ] },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    { label: "Measures for Public Security Administration of the Hotel Industry (current text, amended through 29 March 2022)", url: "https://xzfg.moj.gov.cn/mobile/law/detail?LawID=694", publisher: "Ministry of Justice, national administrative regulations database", reviewedAt: "2026-08-23" },
    { label: "Response on hotels refusing overseas guests because they lack a 'foreign-related qualification'", url: "https://web.archive.org/web/20250905070908/https://www.gov.cn/hudong/202405/content_6952770.htm", publisher: "State Council website; response from the Ministry of Public Security and National Immigration Administration", reviewedAt: "2026-08-23" },
    { label: "Notice on improving accommodation services for overseas visitors", url: "https://www.mofcom.gov.cn/xwfb/rcxwfb/art/2024/art_6e5fd351d24c460cad01512ce52d3f83.html", publisher: "Ministry of Commerce and six other departments", reviewedAt: "2026-08-23" },
