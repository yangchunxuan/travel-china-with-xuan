...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    ...
    { label: "Response on hotels refusing overseas guests because they lack a 'foreign-related qualification'", url: "https://www.gov.cn/hudong/202405/content_6952770.htm", publisher: "State Council website; response from the Ministry of Public Security and National Immigration Administration", reviewedAt: "2026-08-23" },
