...
const body: StructuredPageBody={schemaVersion:"1.0.0",blocks:[
 ...
 { id: "faq", type: "faq", title: "방문 전 자주 묻는 질문", items: [
   { question: "싼싱두이박물관은 미리 예약해야 하나요?", answer: "네. 방문 전 실명 입장권 예약이 필요하고, 당일에는 실명 예약과 일치하는 유효 신분증 원본을 가져가야 합니다. 화면 캡처만으로 예약 여권을 대신할 수 없습니다. 예약은 싼싱두이박물관 공식 웹사이트, 위챗 계정 또는 미니프로그램에서 시작하세요. 박물관과 광한시 정부가 비공식 채널을 경고합니다." },
   { question: "외국 여권으로 예약할 수 있나요?", answer: "광한시 정부가 공개한 해외 방문객 서비스 정보에 따르면 가능합니다. 박물관이 해외 방문객용 입장권과 영문 예약·결제 페이지를 제공하고 유효한 여권 등을 받는다고 설명합니다. 여권 정보는 원본 그대로 정확히 입력하세요. 방문일의 실제 예약 화면과 결제, 잔여 입장권은 직접 확인해야 합니다." },
   { question: "박물관 안에서 시간을 얼마나 잡아야 하나요?", answer: "주 동선만 골라 보면 2시간, 설명을 읽고 쉬면서 인기 유물을 서두르지 않으려면 약 3시간입니다. 청두 왕복 이동은 이 시간과 별도입니다. 공식 소요시간이 아니며 현장 분산 운영이 속도를 바꿀 수 있습니다." },
   { question: "전시실은 어떤 순서로 보나요?", answer: "유적의 지리와 고고학 연대부터 보고, 도자기·도구·취락 자료로 일상을 본 뒤 제례와 신앙을 보고, 큰 가면과 청동 입상은 마지막에 보세요. 유명 유물은 멀리서 형태와 크기를 본 다음 가까이서 출토 맥락과 복원 설명을 읽으세요. 현재 전시가 허용한다면 최근 발굴과 보존으로 마무리하세요." },
   { question: "청두에서 기차로 갈 수 있나요?", answer: "광한북역까지 열차를 쓰면 도시 간 이동은 줄지만 역이 박물관 입구는 아닙니다. 역 전체 이름을 확인하고 도로 이동 시간을 남기세요. 퇴장 즉시 귀환 열차에 탈 수 있다고 가정하고 표를 사지는 마세요. 전용차는 가족이나 고정 시간에 편하지만 입장권 확보 문제까지 해결해 주지는 않습니다. 기사 만남 장소와 대기 범위도 적어 두세요." },
