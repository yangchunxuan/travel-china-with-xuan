...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "direct-answer", type: "callout", title: "不只选交通工具，还要安排抵达后的第一晚", tone: "decision", body: "单纯从一座城市换到另一座城市，先在 12306 查出行日期的车次，再落实酒店接站和安静的第一晚。只有真正具有门到门优势或计划内中途停留时才选公路。若身体状态、天气或交通让原计划变得不现实，就取消晚间活动、推迟第二天出发，或留在较低海拔地区，不要为了完成清单硬撑。" },
  { id: "mode-heading", type: "heading", level: 2, text: "铁路和公路解决的是不同旅程" },
  { id: "mode-matrix", type: "table", caption: "本文不承诺实时班次或固定公路时长", columns: ["方式", "最适合", "主要难点", "什么条件会改变答案"], rows: [
    ["指定日期火车：丽江站→香格里拉站", "直接换酒店、家庭出行，以及希望城市间移动更简单的人", "两端进出站、行李，以及较快的海拔上升", "没有合适余票、重大中断，或必须中途停留"],
    ...
    ["继续住丽江，稍后再走", "身体不适、很疲惫、天气受阻或尚不适合前往更高海拔地区", "会用掉一晚，也可能要改票", "当继续前进已不现实，这是更安全的选择"]
  ]},
  { id: "altitude-heading", type: "heading", level: 2, text: "铁路抵达也是一次海拔变化" },
  { id: "altitude", type: "comparison", title: "让第一晚保持简单", columns: [
  ...
  { id: "base", type: "table", caption: "“香格里拉酒店”不是接站指令", columns: ["基地类型", "接驳指令", "第一晚含义"], rows: [
    ...
    ["城区外度假酒店或乡村住宿", "书面确认接站范围、车辆信息、行李容量和晚到规则", "最后一段公路可能是当天最难临时调整的一段"],
    ["第二天景区出发点", "它与车站接驳和酒店地址分开确认", "不要默认抵达用车第二天会自动变成包车"]
  ]},
  { id: "chain-heading", type: "heading", level: 2, text: "把每一段移动安排清楚" },
  ...
  { id: "scenarios", type: "table", caption: "同一班火车也会带来不同的第一晚", columns: ["旅客", "可行方案", "避免"], rows: [
    ...
    ["家庭带年长父母", "选不确定换乘最少的一条，行李跟车，并提前确认车辆到客房之间的动线", "把“古城”理解成车辆可到门口或地面平坦"],
    ["本来就要停虎跳峡", "把正规公路行程单独安排，核查天气、白天时段和最后一段指定接人", "把临时路边下车包装成交通优势"],
  ...
  { id: "downgrade-heading", type: "heading", level: 2, text: "原计划无法执行时的更安全选择" },
  { id: "downgrade", type: "list", ordered: true, items: [
    "先删掉抵达当晚的可选活动，但保留已确认的酒店接站。",
    "把第二天上午的出发推迟，休息后重新判断。",
    "铁路或公路中断时，保留丽江房间，或在另一处较低海拔地区多住一晚。",
  ...
  { id: "help", type: "callout", title: "需要把火车、酒店和第一晚一起检查？", tone: "decision", body: "把日期、丽江出发点、香格里拉酒店、人数、行李和大致舒适需求发给 Homeground。我们可以检查各段接驳和时间余量。个体健康问题请咨询临床人员；交通与天气运营仍以官方机构为准。" },
  ...
  { id: "sources", type: "sources", title: "官方与权威来源", items: [
    ...
    { label: "头图：香格里拉站夜景——祝鱼贵（CC BY-SA 4.0）", url: "https://commons.wikimedia.org/wiki/File:20260224_Shangri-La_Railway_Station_02.jpg", publisher: "维基共享资源", reviewedAt: "2026-08-13" },
