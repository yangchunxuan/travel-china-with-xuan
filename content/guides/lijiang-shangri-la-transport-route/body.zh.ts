...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "出发前常见问题", items: [
    { question: "丽江到香格里拉，坐火车还是包车？", answer: "铁路是默认选择：公路暴露更少，城市间这一段也更容易控制。只有行程本来就要停中途景点，或准确的酒店位置让门到门车辆明显更顺时，正规公路接驳才更合适。决定之前，先在 12306 查出行日期有没有合适车次。" },
    { question: "香格里拉比丽江高多少？", answer: "丽江站约 2,400 米，香格里拉站约 3,274 米。所以铁路抵达同时也是一次海拔变化：车站到房间怎么走、第一晚安排多满，都属于同一个交通决定，不能当成两件事分开处理。" },
    { question: "可以坐长途班车去香格里拉吗？", answer: "只有当前正规班线、而且当天线路和上车点都合适时才考虑。预算优先的行程适合坐班线，难点在于去客运站、行李处理和运营变化。唯一证据是一张旧时刻表就不算数；到站后已经错过酒店接驳，这条也不再是正确答案。" },
    { question: "从香格里拉站怎么去酒店？", answer: "离开丽江前就安排好。把车次记录、人数、行李和可联络电话发给香格里拉酒店；到站后走正规接人或出租车区域，核对车辆再装行李。目的地要写酒店实际可达的入口或约定好的路边点，不要只发一个“古城”定位。" },
    { question: "路上可以顺便停虎跳峡吗？", answer: "可以，但要把它当成一段单独安排的正规公路行程，不是临时在路边下车。要核查天气和白天时段，指定最后一段接人的地点，并给计划中的停留留足白天时间。与火车相比，公路的主要难点是山区天气、路况、司机质量和久坐。" },
    { question: "到了之后有人不舒服怎么办？", answer: "停止游览并接受医疗评估，出现严重信号就使用急救服务。严重呼吸困难、剧烈头痛或意识障碍需要立即就医，不要拿旅游文章给自己下诊断。临床人员建议下撤，或团队已无法安全继续时，就改线留在低处，不为预付订单冒险。" },
  ] },
