...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask before the Shangri-La leg", items: [
    { question: "Should I take the train or a private car from Lijiang to Shangri-La?", answer: "Take the train for a direct move. It reduces time on mountain roads and makes the intercity leg straightforward. A licensed private vehicle can be better when the journey deliberately includes an intermediate stop or offers a clear door-to-door advantage for the exact hotel. Search 12306 for your travel date before deciding." },
    { question: "How much higher is Shangri-La than Lijiang?", answer: "The station elevation rises from about 2,400 metres in Lijiang to about 3,274 metres in Shangri-La. That makes the railway arrival an altitude change as well as a transport leg, so the hotel transfer and a restful first night belong inside the transport plan rather than being treated as separate questions." },
    { question: "Can I take a long-distance coach instead of the train?", answer: "Only on a currently authorised route that fits your travel date. A coach suits a budget-led trip when the dated official route and boarding point work, and its difficulties are terminal access, baggage handling and changing operations. An old timetable on its own is not evidence, and the coach stops being the right answer when the arrival misses the hotel transfer." },
    { question: "How do I get from Shangri-La Station to my hotel?", answer: "Arrange it before you leave Lijiang. Send the Shangri-La hotel the train record, group size, luggage and a reachable phone number, then use the official pickup or taxi area at the station and match the vehicle before loading. Go to the exact lodging entrance or agreed roadside point, not a generic old-town map pin." },
    { question: "Can I stop at Tiger Leaping Gorge on the way?", answer: "Yes, but plan it as a licensed road journey in its own right rather than an improvised roadside stop. That means weather and daylight checks plus a named final pickup, and enough daylight for the stop you intend. Compared with the train, the road's main difficulties are mountain-road weather, traffic, driver quality and longer sitting." },
    { question: "What should I do if someone feels unwell after arriving?", answer: "Stop sightseeing and seek medical assessment; use emergency services for severe signs. Severe breathing difficulty, severe headache or altered consciousness requires urgent medical care, and you should not diagnose yourself from a travel article. If clinicians advise descent or the group cannot continue safely, change the route and stay lower rather than preserving prepaid plans." },
  ] },
