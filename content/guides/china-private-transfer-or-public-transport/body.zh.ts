  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "司机会在到达口等我吗？",
          answer: "不能这样默认。北京首都国际机场按航站楼和停车楼层公布网约车上车点，所以“司机在到达口接我”并不是安全假设。付款前先说清在第几航站楼、哪个出口、哪座停车楼、哪一层会合，以及落地后谁先联系谁。",
        },
        {
          question: "包含的等待时间从什么时候开始算？",
          answer: "付款前就要问清楚。它可能从计划到达、实际到达、落地、行李送出或联系司机开始算，起算方式不同，免费等待的长短差很多。把答案和航班延误、司机未出现、取消与退款条件一起写进书面条款。",
        },
        {
          question: "航班深夜落地，接近地铁收班，要不要订车？",
          answer: "按运营时段判断，不按快慢判断。抵达时间接近或已经超出公共交通的有效运营时段时，先把司机条款和备用官方出租车点都确认好，再选私人接送或官方出租车。如果公共交通已经停运，就改用当前官方巴士、出租车或机场酒店，并删除后续非必要活动。",
        },
        {
          question: "司机没出现，该怎么办？",
          answer: "留在官方上车区，保存好订单记录，再转到机场官方出租车或网约车点。不要跟着陌生揽客者离开有标识的交通区域，也不要因为 App 失效就坐进没有核实过的车。",
        },
        {
          question: "对轮椅旅客来说，私人车是不是更方便？",
          answer: "不自动等于方便。私人车不自动等于无障碍，一个电梯标志也不能证明公共链完整。要把公共交通的电梯和站务协助，与车门宽度、轮椅尺寸、是否需要转移、固定装置和司机协助逐项比较，再选运营方能端到端确认的那条链。",
        },
        {
          question: "落地后很快要赶火车，订车能保住衔接吗？",
          answer: "不能。买一辆车并不能把没有保护的独立联程变成有保护的衔接，应该先重做结构。如果抵达后没有经过检验的恢复空间，却紧接一张另行购买的火车票、机票或定时活动，就换酒店、加一个缓冲夜，或者在机场、车站酒店把链条拆开。",
        },
      ],
    },
    {
