  ...
  blocks: [
    {
      id: "lead-answer",
      type: "lead",
      text: "私人接送值得付费的前提，是它能消除一个已经核实、而且失败后果明显的弱环节：反复搬运行李、无法完成的最后一段、行动限制、公共交通运营缺口，或代价很高的误接。若公共交通是一程直达、仍在运营，而且每位旅客都能完成首末两段，它通常更简洁。反过来，上车点、容量、等待和取消条款都不明确的车，也不是低摩擦方案。"
    },
    {
      id: "single-segment",
      type: "callout",
    ...
    { id: "chain-heading", type: "heading", level: 2, text: "比较完整的摩擦链" },
    {
      id: "friction-chain",
      type: "table",
    ...
    { id: "exclusion-heading", type: "heading", level: 2, text: "先排除不可用方案，再比较舒适度" },
    {
      ...
      items: [
        ...
        "若无法识别合法经营者或订单相对方、上车点、车型和行李容量，就排除私人服务。",
    ...
    { id: "decision-heading", type: "heading", level: 2, text: "用条件判断，不制造“便利指数”" },
    {
      ...
      columns: ["条件", "倾向", "原因"],
      rows: [
        ["一程直达公共交通；行李轻且可控；最后步行可用；后面没有立即发生的定时连接", "公共交通", "预约车辆消除不了多少摩擦，反而增加会合点依赖"],
    ...
    },
    {
      ...
      tone: "warning",
      title: "本指南不声称什么",
      body: "它不做供应商排名，不发布全国价格表，不保证哪种方式最快，也不替代具体机场路线页。它只判断：对于一个高摩擦抵达或离开段，花钱买帮助能否消除足够多的已核实风险，从而值得该次书面报价。"
    },
    {
      id: "help",
      type: "callout",
