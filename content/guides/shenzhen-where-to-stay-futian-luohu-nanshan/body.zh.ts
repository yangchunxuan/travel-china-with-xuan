...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "stay-quote-handoff", type: "callout", title: "需要人工核对候选住宿？", tone: "neutral", body: "如需人工比较候选物业，请提供旅行日期、人数、房间数量与床型组合、准确的抵离机场航站楼、火车站或口岸、住宿预算及币种、行李情况、儿童年龄，以及老人或无障碍需求，并说明对区域、房型或备用酒店的调整空间。规划师可以按这些条件核对物业当前的书面回复，并协助组织供应商中立的询价。每家物业、每种房型、外籍住客护照登记流程和完整无障碍通路仍须人工复核；这不保证实时价格、房态、接待资格、房型或无障碍适用性。" },
