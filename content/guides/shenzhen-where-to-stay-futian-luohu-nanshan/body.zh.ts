...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "住宿常见问题", items: [
    { question: "深圳该住福田、罗湖还是南山？", answer: "让固定锚点决定，不要看区名。想要均衡的中心商务基地，或福田站、福田口岸确实在行程里，就住福田；要用深圳站、罗湖口岸、东门和东侧中心，就住罗湖；有好几天在西侧的科技商务地址、华侨城、后海、海上世界／蛇口或深圳湾，就住南山，代价是去东侧要更久。" },
    { question: "福田站和福田口岸是同一个地方吗？", answer: "不是。深圳官方交通资料把福田站列在益田路与深南大道交会处，接2、3、11号线；福田口岸则由地铁4号线服务。两个名字相近，解决的却是不同旅程，为其中一个订的酒店不会自动方便另一个。先确认行程真正要用哪一个。" },
    { question: "住得靠近香港，就等于过关方便吗？", answer: "不等于，先定口岸。深圳官方口岸资料区分罗湖、福田、深圳湾等口岸，它们不会把旅客送到同一个香港铁路或道路网络。先定好香港终点、运营时段、行李和返回时间，再选口岸。住福田不代表罗湖口岸近，南山地址也不自动代表深圳湾口岸最好。" },
    { question: "车票上只写深圳，我到底到哪个站？", answer: "先看票面全名。深圳北站、福田站和深圳站是不同的铁路枢纽，应按票面完整名称搜索，并带着行李实时比较到最后两家酒店的路线。直达线路也可能包含很长的站内通道或酒店步行，晚到或一行人箱子多时，要留一条合规的道路接驳备选。" },
    { question: "南山靠一条地铁线够用吗？", answer: "不够。南山包含华侨城／世界之窗、高校与科技园、后海、南头、海上世界／蛇口等不同节点。11号线适合部分机场和中心旅程，其他组团可能依赖1、2／8、9、12或13号线。先标出反复要去的办公室或景点，再看最新官方线路图，不要只看区名。" },
    { question: "外国护照能在任何深圳酒店办入住吗？", answer: "不能默认可以。旅馆要为外国住客登记，所以要确认具体这家物业在你实际抵达的时段有员工能处理每一本护照；混合用途大楼里有个服务台，本身还不够。晚到之前，先请前台确认实际抵达时段能否办理护照入住。" },
  ] },
  { id: "links", type: "internal-links", title: "继续规划", items: [{ label: "深圳到香港交通", href: "/zh/guides/shenzhen-hong-kong-transport-route/", description: "选择口岸和完整跨境旅程。" }, { label: "如何判断靠近地铁", href: "/zh/guides/china-hotel-near-metro/", description: "检验准确入口和最后步行。" }, { label: "核验真正可用的无障碍酒店房", href: "/zh/guides/china-accessible-hotel-room-verification/", description: "检验经过车站、综合楼与房间的完整通路。" }, { label: "外国旅客能住中国任何酒店吗？", href: "/zh/guides/foreigners-china-hotel/", description: "晚到前核验具体物业的护照登记执行。" }, { label: "国际航班前中国最后一晚", href: "/zh/guides/china-last-night-before-international-flight/", description: "按实际机场和航班选择末晚，而不是只看区名。" }, { label: "广州、深圳、香港顺序", href: "/zh/guides/guangzhou-shenzhen-hong-kong-route-order/", description: "决定深圳是基地还是中转。" }] },
