  ...
  "blocks": [
    ...
    },
    {
      ...
      "rows": [
        [
          "乡村道路、天气、行李搬运与村寨最后步行",
          "携带大行李时，先问车辆在所选村寨哪里停、房间前还有多少台阶；必要时只带一晚行李上山。",
        ...
        [
          ...
          "同日返回桂林必须预先约定村寨内上车点并留山路余量，日落拍照不能代替返程安排。",
    ...
    },
    {
      ...
      "ordered": true,
      "items": [
        "停在有人值守的上车点或检查点，读清平安、金坑大寨或古壮寨；三者道路不同。",
        "致电所订住宿，描述车辆所在的地标，由住宿判断正确交接。",
        "另付司机费用前询问原运营方能否调整或返回，不预设退费权利。",
        "只有住宿确认道路、前台、行李和剩余天色都可用时，才继续上山。",
        "告知桂林酒店或下一位司机住宿夜或返程是否移动，以及取消了哪个村寨接送。",
        "没有可负责的交接方时，让全体旅客与行李留在有人值守处，调整村寨预订而不是分组。"
      ]
    },
    {
      "id": "changes-heading",
