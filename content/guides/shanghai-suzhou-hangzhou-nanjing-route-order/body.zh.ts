...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "group-size-heading", type: "heading", level: 3, text: "四人或六人同行，还要算房间和行李" },
  { id: "group-size", type: "table", caption: "公开起价对应的基础安排；付款前按实际日期和人数核对", columns: ["要确认的事", "五天：上海—苏州", "六天：上海—苏州—杭州"], rows: [
    ["房间", "四人两间、六人三间，四晚都在上海同一家酒店。", "四人每地两间、六人每地三间；从上海换到苏州，再换到杭州，共搬两次酒店。"],
    ["行李与跨城", "去苏州的大件行李留在上海酒店。四人和六人仍乘高铁二等座往返，两端有私车接驳。", "行李随团转城。四至九人通常安排门到门车辆，但要按实际行李数量核对车型和装载。"],
    ["核价前", "确认每个人的年龄、床型需求、苏州车次及实际全团总价。", "确认三地酒店、车辆装载、上海抵达与杭州离开的安排及全团总价。返沪另做方案。"],
  ] },
  {"id":"faq","type":"faq","title":"路线顺序常见问题","items":[{"question":"南京、苏州、上海、杭州该按什么顺序走？","answer":"航班允许使用不同口岸时，南京→苏州→上海→杭州或反向最实用。长途往返都用上海时，不要硬追“单向”：可以以上海为一个基地，再加一个战略性第二基地；也可以在比较完整的门到门时间之后接受折返。真正决定顺序的是机场、准确铁路车站，以及每座城市要完成什么。"},{"question":"苏州应该集中访问还是住一晚？","answer":"重点集中、实际用得上的车站与活动片区匹配，而且固定返程不会过早截断访问时，选择集中访问。本地清晨或晚间很重要、重点跨越多个片区，或者下一段前移能省掉返回上海时，选择住宿。不要因为苏州有名就自动住一晚，先决定看什么、需要多久。"},{"question":"必须少去一座城市时，删哪一座？","answer":"删掉独特目的最弱的那一座。只因为铁路区段看起来短而加进来的南京，通常是第一个删减项。不要为了保住四个名字，把每座城市都缩成抵达的晚上加一个仓促的早晨；留下的城市，各自都要有一个经受删减的目的。"},{"question":"苏州只有一个车站吗？","answer":"不是。苏州站、苏州北站和新的南部走廊车站不能互换。苏州市交通运输局记录苏州南站与盛泽站随沪苏湖高铁启用，在传统的苏州站、苏州北站之外多了新的路线可能。在酒店和活动旁写下准确车站，再按出行日期在12306搜索这一组站对。"},{"question":"往返机票都在上海，就一定要折返吗？","answer":"不一定。先用同一套门到门计算测试上海基地和双基地混合，再决定要不要接受重复的铁路通勤或最后折返机场。双基地往往一次移动就能拿到大部分地理收益，又不制造四次入住。最后返回上海很脆弱时，可以比较开口程，或者把最后一晚放在上海。"},{"question":"转场那天的下午，可以订定时门票吗？","answer":"转场抵达的那一天，不要安排不可替代的定时重点。退房、行李移动、进站和可能的延误都排在它前面；当天访问一旦有一半时间花在进站上，就只能保住最高优先级那一项。把定时票放在不用赶火车的那一天。"}]},
