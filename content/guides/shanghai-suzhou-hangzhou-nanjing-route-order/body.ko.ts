...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  {"id": "short-trip-heading", "type": "heading", "level": 2, "text": "5~6일이라면 무엇을 뺄지 먼저 정하세요"},
  {"id": "short-trip-routes", "type": "table", "caption": "두 가지 기존 프라이빗 일정으로 보는 선택", "columns": ["일정", "숙박과 실제 관광일", "선택의 의미"], "rows": [["상하이·쑤저우 4박 5일", "상하이 같은 호텔 4박, 도착·출발일 사이 온전한 관광일 3일", "쑤저우 당일치기와 주자자오, 상하이타워 118층을 포함합니다. 숙소를 옮기지 않는 상하이 왕복 일정이며 항저우는 포함하지 않습니다."], ["상하이·쑤저우·항저우 5박 6일", "상하이 2박·쑤저우 1박·항저우 2박, 가이드 관광 4일, 이 중 이틀은 도시 간 이동 포함", "쑤저우에 더 머물고 항저우의 호수·사찰·차 문화를 봅니다. 호텔을 두 번 옮기고 항저우에서 끝나며 주자자오와 상하이타워 입장권은 포함하지 않습니다."]]},
  {"id": "short-trip-choice", "type": "paragraph", "text": "같은 호텔에 머무는 것이 중요하면 5일 일정을, 항저우가 필수이고 그곳에서 출발할 수 있으면 6일 일정을 비교하세요. 6일 일정은 5일 일정에 하루만 더한 상품이 아닙니다. 두 일정 모두 난징을 포함하지 않으므로 네 번째 도시 추가, 역방향 이동, 항저우에서 상하이로의 복귀는 별도 확인이 필요합니다."},
  {"id": "short-trip-products", "type": "internal-links", "title": "두 일정 비교", "items": [{"label": "상하이 거점 4박 5일 프라이빗 투어", "href": "/ko/tours/shanghai-suzhou-5-day-private-tour/", "description": "같은 호텔에 머물며 쑤저우는 고속철도로 당일 왕복합니다."}, {"label": "항저우까지 이어지는 5박 6일 프라이빗 투어", "href": "/ko/tours/shanghai-suzhou-hangzhou-6-day-private-tour/", "description": "세 도시에서 숙박하고 확인된 항저우 공항 또는 역에서 끝납니다."}]},
