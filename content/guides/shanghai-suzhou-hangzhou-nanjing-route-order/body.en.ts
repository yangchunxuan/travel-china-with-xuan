...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  {"id": "short-trip-heading", "type": "heading", "level": 2, "text": "Only five or six days? Decide what to leave out"},
  {"id": "short-trip-routes", "type": "table", "caption": "Two existing private routes show the trade-off", "columns": ["Route", "Stay and usable days", "What the choice gives you"], "rows": [["5-day Shanghai–Suzhou", "Four nights in the same Shanghai hotel; three full touring days between arrival and departure", "Suzhou as a day trip, plus Zhujiajiao and Shanghai Tower’s 118th floor. A Shanghai return without moving hotels; Hangzhou is outside this route."], ["6-day Shanghai–Suzhou–Hangzhou", "Shanghai 2 nights, Suzhou 1, Hangzhou 2; four guided touring days, including two intercity travel days", "More Suzhou time and Hangzhou’s lake, temple and tea stops, with two hotel changes and departure from Hangzhou. Zhujiajiao and Shanghai Tower admission are outside this route."]]},
  {"id": "short-trip-choice", "type": "paragraph", "text": "Choose the five-day route when staying in one hotel matters more than adding Hangzhou. Choose the six-day route when Hangzhou is a priority and you can finish there. It is a different itinerary, not the five-day tour with an extra day. Neither includes Nanjing; adding a fourth city, reversing the route or returning from Hangzhou to Shanghai needs a separately confirmed plan."},
  { id: "group-size-heading", type: "heading", level: 3, text: "For four or six people, count rooms and bags as well as days" },
  { id: "group-size", type: "table", caption: "Published starting arrangements; confirm the actual dates and group before paying", columns: ["Question", "5 days: Shanghai–Suzhou", "6 days: Shanghai–Suzhou–Hangzhou"], rows: [
    ["Rooms", "Four share two rooms; six share three. All four nights are at the same Shanghai hotel.", "Four share two rooms; six share three at each hotel. The group changes hotels twice: Shanghai to Suzhou, then Hangzhou."],
    ["Bags and city travel", "Leave the main bags at the Shanghai hotel for Suzhou. Four- and six-person groups still take second-class return rail, with private transfers at both ends.", "Bags move with the group. For four to nine people, a door-to-door vehicle is usually planned for city moves, but its capacity must be checked against the actual bags."],
    ["Before accepting a price", "Check each traveller's age and bed needs, the Suzhou train, and the total for the exact party.", "Check three hotels, vehicle capacity, arrival in Shanghai, departure from Hangzhou and the full-group total. A Shanghai return is a separate plan."],
  ] },
  {"id":"faq","type":"faq","title":"Questions travellers ask about the four-city order","items":[{"question":"What order should I visit Nanjing, Suzhou, Shanghai and Hangzhou in?","answer":"Nanjing, Suzhou, Shanghai, Hangzhou, or the reverse, when flights allow different gateways. If both long-haul flights use Shanghai, do not force a one-way label: use Shanghai as one base, add one strategic second base, or accept a return only after comparing complete door-to-door blocks. Airports, exact railway stations and each city's job decide it."},{"question":"Should Suzhou be a day visit or an overnight?","answer":"A day visit when the priorities are concentrated, the useful station matches the activity area and the fixed return does not cut the visit short. An overnight when early or late local time matters, priorities span more than one area, or the next forward train removes a return to Shanghai. Do not add a night just because Suzhou is famous."},{"question":"If I have to drop a city, which one goes?","answer":"Cut the city with the weakest distinct purpose. Nanjing is often first when it is in the plan only because the rail segment looks short. Do not keep four names by reducing every city to an arrival evening and a rushed morning; each city that stays needs a purpose that survives the cut."},{"question":"Is there just one Suzhou station?","answer":"No. Suzhou, Suzhou North and the newer southern-corridor stations are not interchangeable. Suzhou's transport authority records Suzhou South and Shengze opening with the Shanghai–Suzhou–Huzhou line, which adds route options beyond the familiar central and northern names. Write the exact station beside the hotel and the activity, then search that exact station pair on 12306."},{"question":"Both my flights use Shanghai. Does that force a return trip?","answer":"Not necessarily. Test the Shanghai base and the two-base hybrid on the same door-to-door ledger before accepting repeated rail commutes or a final return to the airport. Two bases often capture most of the geographical gain with one move and without four check-ins. If the final return to Shanghai looks fragile, compare open-jaw gateways or a final Shanghai night."},{"question":"Can I book a timed ticket for the afternoon I change cities?","answer":"Keep move-day arrivals free of an irreplaceable timed highlight. A checkout, a luggage transfer, a station approach and a possible delay all sit in front of it, and a day visit that loses half its time to station access leaves only the highest priority standing. Put the fixed booking on a day that does not start with a train."}]},
  {"id": "short-trip-products", "type": "internal-links", "title": "Compare the two route structures", "items": [{"label": "Stay in Shanghai: 5-day private tour", "href": "/tours/shanghai-suzhou-5-day-private-tour/", "description": "Keep one hotel and visit Suzhou by return high-speed rail."}, {"label": "Continue to Hangzhou: 6-day private tour", "href": "/tours/shanghai-suzhou-hangzhou-6-day-private-tour/", "description": "Stay in three cities and finish at the confirmed Hangzhou airport or station."}]},
  ...
  { id: "more-planning", type: "internal-links", title: "Continue planning", items: [ { label: "Shanghai destination hub", href: "/destinations/shanghai/", description: "Decide complete days, which bank to stay on and the gateway before fixing this detail." },
    { label: "See the 6-day Shanghai–Suzhou–Hangzhou private route", href: "/tours/shanghai-suzhou-hangzhou-6-day-private-tour/", description: "Use this one-way route when Shanghai, Suzhou and Hangzhou all need full local time." },
