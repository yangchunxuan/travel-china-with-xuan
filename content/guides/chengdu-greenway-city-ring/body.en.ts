...
const body = {schemaVersion:"1.0.0",blocks:[
  {id:"lead",type:"lead",text:"Chengdu's city-ring greenway is easiest to misunderstand as a single scenic cycling attraction. It is better read as metropolitan infrastructure: a long ring embedded in the much larger Tianfu Greenway system, linking ecological space, parks, roads, communities and transport interfaces. The useful visitor task is rarely to finish the ring. It is to choose one segment that reveals how Chengdu manages growth, recreation and everyday movement, while keeping a reliable way out."},
  {id:"answer",type:"callout",title:"The short answer",body:"Plan an 8–20 kilometre segment, not an automatic full circuit. Confirm the exact entry, surface and exit on a current official or operator map; begin near public transport; keep a second exit halfway; and do not rely on bike rental, food, lighting or uninterrupted access until rechecked. Walkers can learn as much from a shorter segment connecting a park edge to a neighbourhood.",tone:"decision"},
  ...
  {id:"layers",type:"table",caption:"Three spatial layers",columns:["Layer","What it is","Visitor use","Mistake to avoid"],rows:[
    ...
    ["City-ring greenway","The approximately 100-kilometre loop reported complete by government sources, passing multiple districts and park landscapes.","Choose a section or, for trained riders, plan a separately supported circuit.","Treating completion length as a tourist obligation or guarantee of identical conditions."],
  ...
  {id:"mode",type:"comparison",title:"Select the movement mode",leftTitle:"Walk 4–8 kilometres",rightTitle:"Ride 8–20 kilometres",rows:[
    {label:"Best for",left:"Reading entrances, public space, planting, crossings and neighbourhood transitions.",right:"Comparing several landscapes and understanding the scale of the ring."},
    {label:"Main risk",left:"A distant exit feels deceptively close on a schematic map.",right:"Bike fit, mixed users, heat, mechanical trouble and an unverified return point."},
    {label:"Requirement",left:"Shade/rest plan and a road-connected exit.",right:"Confirmed bicycle source and return rules, helmet, lights if relevant, water and two exits."}
  ]},
  ...
  {id:"failure",type:"table",caption:"Exit early without losing the purpose",columns:["Change","Recovery","What remains useful"],rows:[
  ...
  {id:"sources",type:"sources",title:"Official and independent sources",items:[
    ...
    {label:"Current national sports-use reporting",url:"https://www.sport.gov.cn/n20001280/n20001265/n20067706/c29545336/content.html",publisher:"General Administration of Sport of China",reviewedAt:"2026-08-13"},
