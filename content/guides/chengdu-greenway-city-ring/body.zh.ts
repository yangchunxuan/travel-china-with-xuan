...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "绿道常见问题", items: [
    { question: "成都环城绿道有多长？", answer: "政府资料中的环城绿道约为 100 公里。2026 年报道里的 96 公里是一次赛事线路，既不是新的官方总长度，也不是固定游客路线。这条环线更接近城市基础设施：它属于更大的天府绿道体系，连接生态空间、公园、道路、社区和交通。" },
    { question: "一定要骑完整个环线吗？", answer: "不需要。先确认入口、路面和出口，再从公共交通附近出发，中途保留第二个出口。本文把步行 4–8 公里、骑行 8–20 公里当作实用的规划范围，它们不是官方路线分类、长度限制，也不是安全保证。出发前仍要重新核对租车、餐饮、照明、维修和通行情况。" },
    { question: "绿道是一直通到地铁口的独立自行车道吗？", answer: "不是。以为地图上的绿线一直是通到地铁门口的独立自行车道，正是本文提醒要避开的错误。环线是通过公园与社区连接段接入日常生活的：那些短路径、入口和地方道路，往往才是步行、吃饭、休息和退出最实用的一层。" },
    { question: "起点和终点到底怎么定？", answer: "做一张四点地图，而不是只画一条路线。A 点是准确的公共入口，包括它在道路、公园或桥的哪一侧；B 点是预定中点，也是第一个安全决策点；C 点是连接已确认后续交通的目标出口；D 点是无需跨越围栏、快速路、工地或水道就能到达的提前撤出点。" },
    { question: "遇到大雨或路段关闭怎么办？", answer: "从最近的已保存道路出口离开，把城市观察转到有遮蔽的社区或地铁空间。路段关闭或积水时，只有有标识的绕行能到达目标出口才跟着走，否则就离开，改去另一段短的公园路线。好计划体现在退出，而不是完成里程。" },
    { question: "第一次来成都，只有半天，值得去绿道吗？", answer: "可以走一段地铁相连的城市—公园路线，最后从社区退出。本文的判断规则是：只有当绿道能提供不同于中心城区公园的视角时，才在半天的计划里保留它；做不到就把这半天用在别处。这样才能让目标匹配条件。" },
  ] },
