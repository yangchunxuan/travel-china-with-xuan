...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "凤凰就是《边城》的现实原型吗？",
          answer: "不是。凤凰是沈从文的出生地，有受保护的故居和后来的纪念文化；学术研究则把小说主要的渡口空间联系到茶峒附近的碧溪岨。凤凰属于作者的生平与作品接受史，两地都不是从书中原封不动保存下来的实景片场。",
        },
        {
          question: "茶峒和边城镇是同一个地方吗？",
          answer: "是同一个地方。原名茶峒的行政建制镇在 2005 年改名为边城镇，所以两个名字指的是同一处。改名说明当地在现代公共叙事中与小说建立了强烈联系，却不能证明今天的行政边界、街道和景点与文学空间完全重合。",
        },
        {
          question: "在茶峒能坐渡船过河吗？",
          answer: "不要当成已经定下的事。本文核对到的稳定官方资料，无法证明茶峒每天固定运行某班游客渡船，也无法确认长期不变的票价和演出时刻，出发当天要再看镇区或运营方通知。若过不了河，受保护的古码头、两岸关系、导览牌和复建标签仍足以完成这次文学阅读。",
        },
        {
          question: "茶峒的翠翠居是真实的历史住宅吗？",
          answer: "不是。湖南省政府 2024 年发布的资料明确把翠翠居称为模拟小说场景的复建空间，所以人物主题空间要当作解释来看，而不是证据。它能说明旅游业怎样把人物变成可以走进去的场景，却不能让翠翠成为历史人物。",
        },
        {
          question: "去之前一定要先读过《边城》吗？",
          answer: "读过会更容易看懂，但不是必须。先了解翠翠、渡船家庭和边地小镇的基本关系，茶峒就更容易读懂；即使当天没有渡船或演出，愿意对照文本、地形和标牌的读者仍能从茶峒得到东西。不过这些梗概仍不能把现实小镇变成小说的证据。",
        },
        {
          question: "凤凰沈从文故居里的东西都是原物吗？",
          answer: "不都是原物。全国重点文物保护单位的身份能支持这处历史建筑的年代与价值，却不能证明每根梁木、每件生活器具、每张照片和每个展柜都来自沈从文童年。进门后依次看三样：官方保护牌、房间或修缮说明、展品标签；标签写明复制或修复，就保留这个限定。",
        },
      ],
    },
    {
