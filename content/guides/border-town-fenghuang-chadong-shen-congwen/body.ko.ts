  ...
  blocks: [
    {
      id: "lead",
      type: "lead",
      text: "선충원(沈從文)의 『변성(邊城)』을 실제 장소와 함께 읽고 싶다면 차둥(茶峒)이 문학 지리를 살피기에 더 알맞다. 다만 이는 Homeground의 편집 판단이지, 오늘날의 차둥이 작품 전체를 그대로 보존했다는 뜻은 아니다. 작가의 출생지와 국가 보호 옛집, 후대의 기념 문화를 보고 싶다면 봉황(鳳凰)을 고른다. 두 곳을 모두 갈 이유는 소설을 낳은 장소의 지리와 작가를 기억하는 고향의 방식을 비교하고 싶을 때다. 연구에서 작품의 핵심 나루 공간은 차둥 인근의 비시쥐(碧溪岨, Bìxījū)와 연결되지만, 봉황은 작가의 생애와 작품 수용사에 속한다. 어느 곳도 책 속 마을이 통째로 변하지 않은 채 남은 세트장이 아니다."
    },
    {
      id: "direct-answer",
      type: "callout",
      title: "짧은 결론",
      body: "한 곳만 가며 소설이 우선이면 차둥, 선충원의 삶이 우선이면 봉황을 고른다. 안내판과 강의 지리, 현대 복원 공간까지 비교할 시간과 여유가 있다면 두 곳을 간다. 봉황을 간다는 이유만으로 그곳을 곧바로 『변성』의 원형이라고 전제해서는 안 된다.",
      tone: "decision"
    },
    {
      id: "answer-heading",
    ...
    },
    {
      ...
      columns: [
        ...
        {
          heading: "두 곳",
          body: "창작과 기억을 비교하려는 독자에게 알맞다. 차둥에서는 소설과 강의 지리를 대조하고, 봉황에서는 작가의 생애와 공적 기억을 읽는다. 두 방문의 질문을 섞지 않는 것이 핵심이다."
        }
      ]
    },
    {
      id: "choice-caution",
      type: "paragraph",
      text: "남은 시간만으로 결정하지 않는 편이 좋다. 차둥은 당일 나룻배나 공연이 없어도 작품, 지형, 안내판을 함께 볼 독자에게 충분한 의미가 있다. 봉황은 작가와 문화유산을 한곳에서 보기 쉽지만, 눈에 잘 띄는 관광 상업이 오래돼 보이는 모든 골목을 『변성』의 일부로 오해하게 만들 수 있다. 작품을 읽지 않았다면 추이추이(翠翠), 나룻배 가족, 변경 마을의 기본 관계를 먼저 알아두면 차둥이 더 잘 보인다. 그래도 줄거리가 현실 마을을 작품의 증거로 바꾸지는 않는다."
    },
    {
      id: "chadong-heading",
      type: "heading",
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "그렇다면 봉황은 왜 선충원 독자에게 여전히 중요한가?"
    },
    {
      id: "fenghuang-biography",
      type: "paragraph",
      text: "봉황의 핵심 관계는 전기와 기념이다. 후난성 기록기관의 전기는 선충원이 1902년 봉황에서 태어났다고 기록한다. 후난성 문화재 당국은 그의 옛집을 청대 건축물로 분류하며 제6차 전국중점문물보호단위 목록에 올렸다. 따라서 봉황이 작가의 어린 시절 환경 및 그의 기억을 보존하는 후대 활동과 문헌상 연결된다는 점은 확인할 수 있다. 그러나 이 사실이 소설 속 나루, 추이추이, 비시쥐를 봉황으로 옮기지는 않는다."
    },
    {
      ...
      alt: "옛집 현판과 관람 안내가 보이는 봉황 선충원 옛집의 길가 출입구.",
      width: 1600,
      height: 1186,
    ...
    },
    {
      ...
      rows: [
        ["역사", "문헌으로 확인되는 선충원의 봉황 출생, 보호 옛집, 기관 자료와 날짜가 있는 선착장 또는 글씨", "소설 인물이 그곳에 살았다는 주장, 현재 보이는 모든 부재가 원형이라는 주장"],
        ...
        ["편집 판단", "문학 지리 독자에게 차둥, 작가 전기 독자에게 봉황을 우선 권하는 Homeground의 선택", "학계 합의 또는 두 여행지에 대한 공식 순위"]
      ]
    },
    {
      id: "guangtian-figure",
      ...
      alt: "봉황 고성 안에 ‘장톈광장(江天廣場)’이라고 적힌 현대 상업 공간 입구.",
      width: 1600,
      height: 1067,
    ...
    },
    {
      ...
      rows: [
        ["봉황 선충원 옛집", "지속적인 보존 관리 아래 있는 청대 건축물이며 전국중점문물보호단위", "모든 재료와 가구가 바뀌지 않은 채 남은 원형 주택"],
    ...
    },
    {
      ...
      items: [
        ...
        "작품 속 강의 구조를 찾기보다 선충원의 생애, 보호 옛집과 기념 문화가 중요하다면 봉황을 고른다.",
    ...
    },
    {
      ...
      body: "봉황은 단순히 ‘『변성』의 원형’이 아니다. 차둥도 작품이 건물별로 보존된 곳이 아니다. 비시쥐는 반드시 찾을 수 있는 현대 관광 좌표가 아니며, 재건한 추이추이 집은 역사적 주택이 아니다. 재현하거나 모사한 글씨도 원본이 아니다. 이 구분을 지키면 두 장소의 의미는 줄어드는 대신 더 선명해진다.",
      tone: "warning"
    },
    {
      id: "faq",
      type: "faq",
      title: "차둥·봉황 자주 묻는 질문",
      items: [
        {
          question: "봉황이 『변성』의 실제 무대인가요?",
          answer: "아닙니다. 봉황은 선충원의 출생지로, 보호 옛집과 후대의 기념 문화가 있는 곳입니다. 연구에서 작품의 핵심 나루 공간은 차둥 인근의 비시쥐(碧溪岨)와 연결됩니다. 봉황은 작가의 생애와 작품 수용사에 속하며, 어느 곳도 책 속 마을이 통째로 남은 세트장이 아닙니다.",
        },
        {
          question: "차둥과 볜청진은 같은 곳인가요?",
          answer: "같은 곳입니다. 원래 차둥으로 불리던 행정 단위가 2005년에 볜청진으로 이름을 바꿨기 때문에 두 이름은 한 마을을 가리킵니다. 이 개명은 현대의 공공 서사에서 마을과 소설의 연관성이 강해졌음을 보여 줄 뿐, 지금의 행정 경계와 거리, 관광 공간이 문학 공간과 일치한다는 증거는 아닙니다.",
        },
        {
          question: "차둥에서 나룻배로 강을 건널 수 있나요?",
          answer: "미리 확정할 수 없습니다. 이 글에서 확인한 안정적인 공식 공지로는 관광 나룻배의 매일 운항 시간, 요금, 공연 시간을 확정할 수 없었으니 방문 당일 마을이나 직접 운영 주체의 공지를 다시 확인하세요. 배를 타지 못해도 보호 선착장, 양안의 관계, 안내 표지, 재건 공간의 캡션으로 문학 지리 읽기는 가능합니다.",
        },
        {
          question: "차둥의 추이추이의 집은 실제 역사 주택인가요?",
          answer: "아닙니다. 후난성 정부가 2024년에 낸 자료는 추이추이의 집을 소설 장면을 모사한 재건 공간이라고 명시합니다. 인물 주제 공간은 증거가 아니라 해석 장치로 보세요. 관광이 인물을 걸어 들어갈 수 있는 공간으로 만드는 방식은 보여 주지만 추이추이를 실존 인물로 만들지는 않습니다.",
        },
        {
          question: "가기 전에 소설을 꼭 읽어야 하나요?",
          answer: "읽어 두면 도움이 되지만 필수는 아닙니다. 추이추이, 나룻배 가족, 변경 마을의 기본 관계를 먼저 알아 두면 차둥이 더 잘 보입니다. 당일 나룻배나 공연이 없어도 작품과 지형, 안내판을 함께 볼 독자에게는 충분한 의미가 있습니다. 다만 줄거리가 현실 마을을 작품의 증거로 바꾸지는 않습니다.",
        },
        {
          question: "봉황 선충원 옛집 안의 물건은 모두 원형인가요?",
          answer: "전부는 아닙니다. 전국중점문물보호단위라는 지위는 문화유산 건물의 시대와 중요성을 뒷받침하지만, 지금 보이는 모든 들보와 생활용품, 사진, 진열장이 선충원의 어린 시절부터 남았다는 뜻은 아닙니다. 공식 보호 표지, 방 또는 보존 설명, 전시품 캡션 순서로 읽고, 복제품이나 수리라고 적힌 한정은 그대로 두세요.",
        },
      ],
    },
    {
