...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "clock", type: "list", ordered: true, items: ["체크인·위탁 수하물과 탑승 마감.", "정확한 터미널 안 도보와 보안검색·출경.", "도로 또는 철도 이동과 운행 중단에 대비한 여유.", "베이징남역 승강장에서 출구와 승차·환승 지점까지.", "열차 지연에 대비한 여유와 원래 연결을 포기할 결정 시점."] },
