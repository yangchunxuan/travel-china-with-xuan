...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "베이징남역–공항 자주 묻는 질문", items: [
    { question: "베이징남역에서 다싱공항까지 지하철로 어떻게 가나요?", answer: "지하철 4호선을 톈궁위안 방향으로 타고 자오먼시(角门西)에서 10호선으로 갈아타 한 정거장 뒤 차오차오(草桥)에 내린 다음 다싱공항선을 타고 다싱공항(大兴机场)까지 갑니다. 환승 도보와 대기 시간은 탑승 시간과 따로 계산하고, 도착 당일 모든 노선이 운행하는지 확인하세요." },
    { question: "베이징남역에서 서우두공항(PEK)까지 지하철로 어떻게 가나요?", answer: "실용적인 방법 하나는 4호선을 안허차오베이 방향으로 타고 쉬안우먼(宣武门)에서 2호선으로 갈아타 둥즈먼(东直门)까지 간 뒤 서우두공항선을 타고 항공편에 맞춰 3터미널 또는 2터미널에 내리는 것입니다. 출발 전에 세 노선의 운행 공지를 확인하세요." },
    { question: "베이징남역에서 다싱공항까지 직행 버스가 있나요?", answer: "기대하지 마세요. 베이징남역–다싱공항 야간 2호선 버스는 2026년 4월 7일부터 운행이 중단됐습니다. 베이징의 2026년 4월 공지는 서우두공항–베이징남역 버스를 유지·조정했으므로, 다싱공항은 차오차오 환승 지하철과 택시·차량 호출을 비교하세요." },
    { question: "베이징남역 도착 열차와 항공편 사이에 3시간이면 충분한가요?", answer: "3시간은 공항에서의 3시간이 아니라 연결 전체입니다. 항공사의 체크인과 수하물 위탁 마감 기준으로 판단하고 승강장 나가기, 환승 도보, 대기, 이동, 지연 가능성을 모두 넣으세요. 안전한 여유가 계산되지 않으면 열차를 바꾸거나 공항 근처에서 하룻밤 묵으세요." },
    { question: "다싱공항과 서우두공항은 서로 대체할 수 있나요?", answer: "아닙니다. 다싱(PKX)은 서우두공항(PEK)의 새 터미널이 아니며 잘못된 공항에 가면 큰 이동을 한 번 더 해야 합니다. 기사에게 ‘베이징 공항’이라고 하지 말고 공항 코드와 터미널을 보여 주세요." },
  ] },
