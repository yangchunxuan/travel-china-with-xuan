...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "PEK와 PKX는 바꿀 수 없다", tone: "decision", body: "PKX는 지하철로 차오차오에서 다싱공항선에 잇는 방법과 도로 차량을 비교한다. PEK는 현재 베이징남역 공항버스, 지하철/공항철도와 도로 차량을 비교한다. 정확한 시각, 짐, 인원과 중단 여유가 답을 바꾼다." },
  ...
  { id: "matrix", type: "table", caption: "모든 선택은 열차에서 실제로 나온 뒤 시작한다", columns: ["연결", "잘 맞음", "부담", "확인"], rows: [
    ...
    ["합법 택시/호출차→어느 공항", "여러 명, 큰 짐 또는 철도 종료", "도로 변동, 승차 구역과 도로 비용", "공항 코드, 터미널, 합법 승차와 여유"],
  ]},
  { id: "warning", type: "callout", title: "베이징 공항이라는 말만 따르지 않는다", tone: "warning", body: "기사에게 PEK 또는 PKX와 터미널을 보여 준다. 다싱은 서우두공항의 새 터미널이 아니고 서우두도 다싱의 터미널이 아니다. 잘못 가면 작은 우회가 아니라 공항 사이 복구가 된다." },
  { id: "clock-heading", type: "heading", level: 2, text: "항공사 마감에서 거꾸로 계산" },
  { id: "clock", type: "list", ordered: true, items: ["체크인/위탁 수하물과 탑승 마감.", "정확한 터미널 도보와 보안/출경.", "도로 또는 철도와 중단 여유.", "베이징남역 승강장에서 출구와 승차/환승.", "열차 지연 여유와 원래 연결을 버릴 결정 시점."] },
  { id: "groups", type: "comparison", title: "여행자 조건이 바꾸는 선택", columns: [
    { heading: "가볍고 주간", items: ["철도 구조가 비교적 예측 가능", "모든 환승명 저장", "마지막 편 확인"] },
    { heading: "가족 또는 여러 가방", items: ["승강기와 통로 계산", "직접 도로 차량이 단순할 수 있음", "아동 좌석 요구를 명확히"] },
  ...
  { id: "recovery", type: "table", caption: "원래 계획보다 항공편을 먼저 보호", columns: ["문제", "대응"], rows: [
    ...
    ["마지막 철도 놓침", "공식 공항버스 플랫폼 또는 합법 택시 줄을 이용하고 호객을 피하기"],
  ]},
  { id: "facts", type: "callout", title: "동적 교통 정보 확인일: 2026년 8월 12일", tone: "neutral", body: "베이징의 2026년 4월 공지는 서우두공항-베이징남 버스를 조정해 유지하고 다싱공항-베이징남 야간 2선을 중단했다. 7월 공지는 서우두공항 노선의 늦은 시내 방향 운행을 연장했다. 지하철, 공항철도, 버스, 정류장과 시간은 날짜별로 달라진다." },
  ...
  { id: "links", type: "internal-links", title: "전체 일정을 보호", items: [
  ...
  { id: "sources", type: "sources", title: "공식 출처와 사진 표기", items: [
    ...
    { label: "대표 사진: N509FZ의 베이징남역, CC BY-SA 4.0, 일부 자름", url: "https://commons.wikimedia.org/wiki/File:North_square_of_Beijing_South_Railway_Station_(20180722170459).jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-12" },
  ]},
