...
const body = {
  ...
  blocks: [
    ...
    { id: "faq", type: "faq", title: "Mutianyu transfer questions answered", items: [
      { question: "How do I get to Mutianyu from Beijing by public transport?", answer: "Beijing's official visitor information currently describes Express Bus 916 from Dongzhimen to Huairou Beidajie, then a local H-line bus toward Mutianyu. Route numbers, stops and hours are dynamic, so save the Chinese stop names, check the same-day return and treat a long wait at the Huairou handoff as possible rather than exceptional." },
      { question: "Is there a direct bus from Beijing to Mutianyu?", answer: "Only as a dated tourist-bus product, not a permanent service. It can remove one transfer when its pickup and return fit your hotel and the length of your visit, but it has one fixed departure point and one fixed return. Verify the official operator, the exact stop, what is included and the travel date before booking." },
      { question: "Does a Mutianyu bus or car include the entrance ticket and cable car?", answer: "Treat them as separate purchases. A bus or vehicle normally solves only the road journey, while scenic-area admission, any internal shuttle and the chosen cable car, chairlift or walking access can have separate rules and queues. Never assume that a transport seller includes every ticket merely because its photo shows the wall." },
      { question: "Is a pre-arranged vehicle worth it for Mutianyu?", answer: "Often, for families, older parents, tight schedules or an airport or train connection, because the extra certainty matters more than the advertised time saving. Independent travellers with time and light bags can use the official public-transport route instead. A dated direct tourist bus sits between the two when its pickup and return fit." },
      { question: "Can I visit Mutianyu and catch an evening train the same day?", answer: "Prefer a controlled vehicle, or remove the same-day connection. Traffic, a station mismatch and security consume the margin. If you keep the connection, use an earlier leave-the-wall time and keep the city last leg visible instead of treating the bus arrival as arrival at the station." },
      { question: "What should I do if I miss the direct bus or get off at the wrong Huairou stop?", answer: "Check the operator's official change policy and the current public route first. At a wrong stop, show your saved Chinese destination to uniformed staff rather than boarding by route number without confirming the direction. Do not follow an unofficial caller offering an unnamed vehicle, and if the return itself is at risk, leave the attraction and secure the next verified link." },
    ] },
