...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "票上只写“北京”，是哪个站？",
          answer: "打开已出票的行程，看完整站名，不要自行简写成“北京”。先核对中文站名：北京站、北京西站、北京南站、北京北站、清河站、北京朝阳站、北京丰台站或北京通州站；英文界面可能把北京南站写成Beijing South或Beijingnan。车次和日期也要一起核对。",
        },
        {
          question: "去上海的高铁从北京哪个站发车？",
          answer: "去天津和京沪方向通常先比较北京南站；北京站也有部分开往南京、上海方向的列车。这只是判断是否合理的方向规律，不是购票规则。铁路运行图会调整，同一个目的地也可能由多个北京车站发车，付款前仍以实时行程上的中文站名为准。",
        },
        {
          question: "坐很早的车次，怎么去火车站？",
          answer: "不要默认地铁一定赶得上：先查酒店实际使用的地铁站首班服务、换乘是否开放、火车站内步行和正常进站余量。任何一环过紧，就安排前往已核实进站口的公路接驳，不要把计划建立在奔跑上。节假日延长运营是有日期的例外，不是日常时刻表。",
        },
        {
          question: "去八达岭长城应该用哪个火车站？",
          answer: "北京北站和清河站是主要的西北向组合，八达岭、张家口方向在两站都常见。北京北站紧邻西直门；清河站在海淀西北、上地附近，13号线和昌平线直达这座一体化车站。相近的西北目的地可能由不同车站发车，去长城仍要按出行日期确认真正的车次和发车站。",
        },
        {
          question: "北京朝阳站坐哪条地铁？",
          answer: "3号线。2026年8月11日核查时，朝阳站接驳地铁3号线，且已直达交通枢纽地下一层进站口，住三里屯或工人体育场附近优势最明显；从中西部或南部酒店出发，仍可能是较长的跨城路线。不要把北京朝阳站与面积很大的朝阳区或朝阳门混为一谈。",
        },
        {
          question: "走错北京火车站了，第一步该做什么？",
          answer: "先停止继续移动，打开已经出票的车票，核对中文出发站、车次、日期和发车时间。再把站名给铁路或地铁工作人员看，确认自己是在同一铁路枢纽的错误入口，还是到了完全不同的火车站。这是两种不同的问题；到了另一座车站时，也不存在类似机场空侧的内部换乘。",
        },
      ],
    },
    {
