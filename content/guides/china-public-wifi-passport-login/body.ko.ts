...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "접속 관련 자주 묻는 질문", items: [
    { question: "중국 번호가 없어도 중국 공항에서 인터넷을 쓸 수 있나요?", answer: "가능한 곳도 있지만 전국 공통 방식은 없습니다. 베이징 서우두공항 공식 안내는 AIRPORT-FREE-WIFI-NEW를 제시하며, 중국 번호가 없다면 아이디와 비밀번호를 인쇄해 주는 Wi-Fi 인증번호 발급기를 찾으세요. 더 최신인 다싱공항 안내는 BDIA-FREE-WIFI와 포털의 여권 사진 면 인증을 설명합니다. 다른 장소에서는 해외 번호 SMS, 여권 인증 또는 수동 코드 지원 여부를 물어보세요." },
    { question: "도착하면 공항 Wi-Fi만 믿어도 될까요?", answer: "공항 Wi-Fi가 도착 계획 전체를 떠받치게 하지 마세요. 출발 전에 중국어 호텔 주소, 공항 이동 안내, 예약 번호와 지도 화면을 오프라인으로 저장해 두세요. 로밍이나 eSIM은 안내에 따라 미리 개통하되 계정 복구에 쓰는 번호는 유지하고, 공항 Wi-Fi로 앱을 급히 내려받지 않아도 되는 결제·교통 방법을 준비하세요. 한 대만 연결될 때를 대비해 동행과 만날 장소도 정해 두세요." },
    { question: "발급기에서 출력한 접속 정보는 얼마나 쓸 수 있나요?", answer: "5시간이고, 유효 신분증 한 장으로 최대 세 번까지 출력할 수 있습니다. 베이징 안내에 나온 이 제한은 발급기 경로에만 해당하며 다싱 여권 포털이나 전국 규칙으로 확대하면 안 됩니다. 당일 화면을 확인하세요." },
    { question: "연결은 됐는데 로그인 페이지가 안 떠요.", answer: "모바일 데이터를 잠시 끄고 일반 브라우저 탭에서 공식 안내를 다시 열어 보세요. 한 번 시도해도 안 되면 확인한 SSID를 지웠다가 다시 연결하고 직원에게 포털 주소를 물어보세요. 로그인 뒤 같은 화면이 계속 돌아온다면 한 번만 깨끗하게 다시 시도하고, 그다음에는 반복 제출을 멈추고 다른 연결을 사용하세요." },
    { question: "중국 공공 Wi-Fi에서 은행 업무나 비밀번호 재설정을 해도 되나요?", answer: "자체 모바일 연결이 있다면 하지 마세요. 은행, 결제 복구, 비밀번호 재설정, 여권 업로드, 기밀 업무는 공공 Wi-Fi에서 피하세요. 자물쇠는 해당 사이트와의 연결을 보호할 뿐 사이트 자체가 정직하다는 증거는 아닙니다. 필요 없는 공유 기능을 끄고, 일반 게스트 Wi-Fi 때문에 구성 프로필이나 인증서를 설치하지는 마세요." },
    { question: "여권 키오스크가 제 여권을 읽지 못하면 어떻게 하나요?", answer: "커버를 벗기고 사진 면만 맞춰 화면 지시대로 한 번 시도하세요. 그래도 안 되면 공식 데스크에 문의하고 비공식 도움자에게 여권을 맡기지 마세요. 포털이 여권을 인증하지 못하면 여권 사진을 반복 업로드하지 말고 독립 모바일 데이터를 사용하세요." },
  ] },
