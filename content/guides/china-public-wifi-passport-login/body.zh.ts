...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "上网常见问题", items: [
    { question: "没有中国手机号，在中国机场能上网吗？", answer: "有时可以，但没有全国统一方式。首都机场官方指南列出 AIRPORT-FREE-WIFI-NEW，没有中国手机号就用取号机打印账号密码；大兴机场较新公告列出 BDIA-FREE-WIFI，可在门户拍护照信息页验证。其他场所要问是否支持境外短信、护照认证或人工发码。" },
    { question: "落地后直接用机场 Wi-Fi 可以吗？", answer: "不要让机场 Wi-Fi 承担整个落地计划。出发前把中文酒店地址、接送说明、预订号和地图截图离线保存；按说明提前开通漫游或 eSIM 再依赖它，同时保住用于账户找回的号码。准备好不需要临时下载应用的支付和交通方案，并和同行人约好会合地点，以防只有一部手机能上网。" },
    { question: "机器打印的账号能用多久？", answer: "有效 5 小时，一份有效证件最多打印 3 次。这是北京指南写明的限制，只适用于取号机这条路线，不能套用到大兴的护照页面验证，也不能写成全国规则；当天仍以界面显示为准。" },
    { question: "显示已连接却不弹登录页怎么办？", answer: "先短暂关闭移动数据，打开普通浏览器并重新查看官方说明。尝试一次仍不行，就忘记并重新加入已核实的网络，再向工作人员索取门户地址。如果是登录后循环跳转，则干净重试一次，之后停止重复提交，换用其他连接。" },
    { question: "能不能在中国的公共 Wi-Fi 上办网银或重置密码？", answer: "有自己的移动数据时就不要这样做。网银、恢复付款、重置密码、上传护照和保密工作都不要放在公共 Wi-Fi 上。小锁只能说明到该网站的连接被加密，不代表网站本身一定真实。关闭不需要的共享功能；普通访客 Wi-Fi 也不应该要求你安装描述文件或证书。" },
    { question: "护照终端扫不出我的护照怎么办？", answer: "取下保护套，只对齐照片页，按机器提示操作一次。仍然失败就找官方服务台，不要把护照交给非工作人员。门户无法认证证件时，改用独立移动数据，不要反复上传护照照片。" },
  ] },
