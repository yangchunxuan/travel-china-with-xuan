...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions about getting online in China", items: [
    { question: "Can I get online at a Chinese airport without a Chinese phone number?", answer: "Sometimes, but there is no single nationwide method. At Beijing Capital the official guide identifies AIRPORT-FREE-WIFI-NEW; without a Chinese number, ask for the official Wi-Fi credential dispenser, which prints a username and password. The newer Daxing notice identifies BDIA-FREE-WIFI and passport-photo-page verification on its portal. Elsewhere, ask whether the venue supports foreign SMS, passport authentication or a manual code." },
    { question: "Can I just rely on airport Wi-Fi when I land?", answer: "Do not let it carry the whole arrival plan. Before departure, save the hotel address in Chinese, airport-transfer instructions, booking numbers and a map screenshot offline. Activate roaming or an eSIM according to its instructions before you depend on it, while preserving access to the number used for account recovery, and agree on a meeting point in case only one phone connects." },
    { question: "How long does the printed airport Wi-Fi login last?", answer: "Five hours, and one valid ID can obtain no more than three printouts. The Beijing guide states those limits for that credential route only, not for every Daxing passport-page login and not as a national rule. Verify the current screen on the day." },
    { question: "I am connected but no login page appears. What now?", answer: "Turn off mobile data briefly, open a plain browser tab and revisit the official instructions. If that one attempt fails, forget and rejoin the verified SSID, then ask staff for the portal address. If the portal loops after login instead, make one clean attempt, then stop repeated submissions and use another connection." },
    { question: "Is it safe to bank or reset a password on public Wi-Fi in China?", answer: "Avoid it when your own mobile connection is available. Keep banking, payment recovery, password resets, passport uploads and confidential work off public Wi-Fi. A padlock protects the connection to that site; it does not prove the site itself is honest. Turn off sharing you do not need, and do not install a configuration profile merely to reach guest Wi-Fi." },
    { question: "The passport kiosk will not read my passport. What should I do?", answer: "Remove any cover, align only the photo page and follow the machine prompt once. If it still fails, ask the official desk and do not give the passport to an unofficial helper. If the portal cannot authenticate your document, use mobile data rather than uploading repeated passport images." },
  ] },
