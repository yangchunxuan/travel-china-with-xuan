# Source log — china-public-wifi-passport-login

- Status: READY
- Topic ID: hg-topic-0658
...
- Internal-link boundary: the eSIM guide owns the primary mobile-data decision and the payment guide owns wallet setup. This article owns only venue Wi-Fi login and fallback.
