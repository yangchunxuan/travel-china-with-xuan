...
{ id: "faq", type: "faq", title: "출발 전 자주 묻는 질문", items: [
  { question: "푸젠 토루를 하루에 다 볼 수 있나요?", answer: "아닙니다. 세계유산에는 융딩·난징·화안의 여섯 군락과 단독 건물 4채, 총 46채가 포함되며 46채가 모인 단일 공원이 아닙니다. 하루는 보통 한 지리 그룹에 머무는 편이 좋습니다. 다른 현을 하나 더 붙이면 방문의 질보다 차창 시간이 늘기 쉽습니다." },
  { question: "톈뤄컹과 윈수이야오는 무엇이 다른가요?", answer: "톈뤄컹은 다섯 건물의 위·아래 전망과 위창러우·타샤 연결이 중심입니다. 윈수이야오는 허구이러우·화이위안러우와 옛 마을길을 천천히 걷는 하루로, 분산되고 상업적일 수 있어 원형 건물 하나가 아니라 마을 전체를 걷기 위해 고르는 편이 좋습니다." },
  { question: "톈뤄컹과 윈수이야오는 같은 표인가요?", answer: "아닙니다. 푸젠성 공식 가격 문서는 톈뤄컹·윈수이야오·허컹을 별도 관광 상품으로 나누고 내부 교통도 자율·별도 판매로 규정합니다. 가격과 범위는 바뀔 수 있고 현재 가격을 보장하는 자료가 아니므로 실시간 운영자 화면을 확인하세요." },
  { question: "토루 안에 들어가 위층까지 올라갈 수 있나요?", answer: "모든 곳에서 가능하지는 않습니다. 일부 토루는 지금도 주민이 생활하는 공동체 공간이라 입장권이 모든 계단·방·주민 공간에 들어갈 권리를 주지는 않습니다. 현장 안내를 따르고 사람을 촬영하기 전 동의를 구하며, 명시적으로 허용되지 않은 드론은 띄우지 마세요. 상층 출입이 제한되면 마당·외부 구조·공식 해설을 이용하세요." },
  { question: "샤먼에서 가는 쉬운 당일치기인가요?", answer: "산길 이동 시간을 먼저 적어 봐야 알 수 있습니다. 샤먼은 도시 숙박이 단순하고 개인·단체 교통 선택이 넓지만, 그 시간을 확인하지 않은 채 모든 토루를 쉬운 당일치기라고 부르면 안 됩니다. 철도를 이용하면 역 전체 이름과 역 이후 도로 이동을 저장하세요. 난징현역은 톈뤄컹 마을이 아닙니다." },
  { question: "토루 마을에서는 얼마나 걸어야 하나요?", answer: "사진에서 보이는 것보다 많이 걷습니다. 전망대와 옛 마을길에는 경사, 계단, 고르지 않은 포장, 차량 하차 지점에서 시작되는 긴 보행이 있을 수 있어 이동이 가장 제한된 사람을 기준으로 계획해야 합니다. 비와 더위는 산길 속도, 마당 바닥, 먼 전망의 가치를 바꾸므로 같은 군락 안에 더 짧은 대안을 하나 준비하세요." },
] },
{id:"internal-links",type:"internal-links",title:"토루 하루 연결",items:[{label:"샤먼 출발 6일 토루·취안저우 동선",href:"/ko/guides/xiamen-tulou-quanzhou-six-day-route/",description:"두 토루 지역을 이틀로 나누고 밤마다 어디서 자는지 확인하세요."},{label:"샤먼 교통허브-구랑위 부두",href:"/ko/guides/xiamen-hubs-to-gulangyu-ferry-terminal/",description:"시골 토루 날과 샤먼 페리 과정을 분리합니다."},{label:"중국 고속철 첫 이용",href:"/ko/guides/china-high-speed-train-first-time-guide/",description:"도로 이동 전 역 이름과 여권을 확인합니다."},{label:"중국 여행에 가이드가 필요한가",href:"/ko/guides/do-you-need-a-tour-guide-in-china/",description:"해설과 농촌 교통 지원의 가치를 판단합니다."}]},
