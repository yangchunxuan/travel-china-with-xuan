...
{id:"whc",type:"callout",title:"‘푸젠 토루’는 연속 세계유산입니다",body:"융딩·난징·화안의 여섯 군락과 개별 네 건물, 총 46채가 포함됩니다. 톈뤄컹의 유명한 항공 구도는 한 구성 요소이지 모든 토루의 정의나 46채가 있는 단일 공원이 아닙니다.",tone:"neutral"},
{id:"compare-heading",type:"heading",level:2,text:"하루의 검색 과제로 고르세요"},
{id:"compare",type:"table",caption:"푸젠 토루 군락 비교",columns:["군락·동선","고를 이유","계획 비용"],rows:[
...
{id:"living",type:"callout",title:"생활 공동체이지 빈 세트가 아닙니다",body:"일부 토루는 여전히 주거·공동 공간입니다. 표가 모든 계단·방·주민 공간 접근을 주지 않습니다. 게시 규정을 따르고 사람 촬영은 묻고, 명시적 허가 없이 드론을 띄우지 마세요.",tone:"warning"},
...
{id:"consultation",type:"callout",title:"한 군락을 실제 동선에 맞춰야 하나요?",body:"Homeground 여행 상담가는 날짜별 도로, 마을 우선순위와 귀환을 비교할 수 있습니다. 기지, 시간, 보행 제한, 건축·풍경·공동체 중 우선순위를 알려 주세요.",tone:"neutral"},
