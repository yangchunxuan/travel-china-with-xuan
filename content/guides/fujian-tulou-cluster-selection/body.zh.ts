...
{id:"internal-links",type:"internal-links",title:"连接土楼这一天",items:[{label:"厦门枢纽到鼓浪屿码头",href:"/zh/guides/xiamen-hubs-to-gulangyu-ferry-terminal/",description:"把乡村土楼日与厦门轮渡流程分开。"},{label:"第一次坐中国高铁",href:"/zh/guides/china-high-speed-train-first-time-guide/",description:"道路接驳前先核对车站全名和护照记录。"},{label:"在中国旅行需要导游吗",href:"/zh/guides/do-you-need-a-tour-guide-in-china/",description:"判断讲解与乡村交通是否值得支持。"}, { label: "厦门出发六天串联土楼与泉州", href: "/zh/guides/xiamen-tulou-quanzhou-six-day-route/", description: "看两个土楼区域如何拆成两天，以及每天住在哪里。" }]},
