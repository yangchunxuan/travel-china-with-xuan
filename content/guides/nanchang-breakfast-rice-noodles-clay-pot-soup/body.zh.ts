  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "南昌早餐一般吃什么？",
          answer: "一顿典型的南昌早餐，是把两个独立项目放在一起：南昌拌粉，是煮好的米粉沥水后拌入底料和配菜；瓦罐汤，是在小陶罐里煨好、连罐上桌的汤。南昌政府餐饮介绍多次把两者列为代表性本地早餐，这能证明搭配有地方辨识度，却不能证明全城只有一种配方、一家店或一种汤。",
        },
        {
          question: "拌粉、炒粉和汤粉有什么区别？",
          answer: "三样不一样，而且常常挨着写在同一块菜单上。拌粉是米粉沥水后拌入调味底料和配菜；炒粉是在锅里炒制；汤粉是米粉直接放在汤里，作为一碗上桌。点单时直接指“南昌拌粉”或“拌粉”给店员看，只说“米粉”，可能端来炒粉或汤粉。",
        },
        {
          question: "怎么让拌粉不要那么辣？",
          answer: "要在店员拌匀之前说：想少一点就说“少辣”，完全不要就说“不要辣椒”，想自己掌握分量就说“辣椒另外放”，同时问清底料里是不是已经有辣椒油或辣酱。觉得味淡之前，先从碗底把粉彻底拌匀，另放的辣椒一点一点加。",
        },
        {
          question: "两个人该点多少？",
          answer: "食量正常的成人，一人一份拌粉加一罐汤最直观；食量小的两个人，可以先分享一组，试吃风险更低。不要自己假设有大小份，先问这家店能不能选；看过实际份量，再决定要不要加粉。",
        },
        {
          question: "想喝的汤卖完了怎么办？",
          answer: "先问哪些罐子实际还有：固定灯箱或线上产品页还挂着，不代表这罐汤当天没有售罄。可以在已知类别里换成另一种排骨汤或肉饼汤，但先确认新增的食材。所有瓦罐汤都卖完时，还想吃就保留拌粉，另选一天再把这一组补齐。",
        },
        {
          question: "有过敏或饮食限制，怎么问清汤里的食材？",
          answer: "直接问店员，不要看照片猜：“这个汤里有什么？有花生、蛋或者猪肉吗？”有饮食限制时，要问底料、配菜和汤的完整食材，不能只看菜名里写出来的那一样。厨房和共用器具仍可能发生交叉接触，必要时换成标签更清楚的选项。",
        },
      ],
    },
    {
