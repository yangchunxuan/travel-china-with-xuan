...
const body = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "type": "callout",
      "title": "简短答案",
      "body": "使用蹲厕前，先看具体器型、脚踏或防滑标记和现场说明；罩体、冲水点与管线布局可能不同。双脚保持稳定，并把衣物收好离地。无法安全判断位置，或平衡、关节、身体状态、衣物或行李让下蹲不安全时，换用坐厕或请工作人员帮助。绝不能站上坐便器座圈。无障碍或家庭卫生间应优先留给需要其设施的人。",
      "tone": "decision"
    },
    {
      "id": "matrix-heading",
    ...
    },
    {
      ...
      "items": [
        ...
        "使用蹲厕时，按具体脚踏/防滑标记和现场说明站位；不要把罩体、冲水点或管线布局当成通用方向规则。只下蹲到平衡允许程度，并仅使用设计为支撑的墙面或扶手。位置无法判断时，换一间或请工作人员帮助，不抓松动管线。",
    ...
    },
    {
      "id": "faq-2-answer",
      "type": "paragraph",
      "text": "没有通用方向。先看具体器型、脚踏或防滑标记和现场说明，因为罩体、冲水点与管线布局可能不同。无法安全判断或保持稳定时，换用坐厕或请工作人员帮助。"
    },
    {
      "id": "faq-3-question",
      "type": "heading",
