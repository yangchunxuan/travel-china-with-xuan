...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  {id:"links",type:"internal-links",title:"Plan nature access responsibly",items:[{ label: "Start with the Chongqing city guide", href: "/destinations/chongqing/", description: "Choose nights, accommodation base, gateway and whether Wulong or Dazu belongs before using this specialist guide." },
