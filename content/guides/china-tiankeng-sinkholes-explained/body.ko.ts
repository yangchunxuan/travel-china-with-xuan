...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "톈컹 방문 자주 묻는 질문", items: [
    { question: "싱크홀과 톈컹은 어떻게 다른가요?", answer: "규모와 형태가 다릅니다. 싱크홀·돌리네는 여러 크기와 기원의 닫힌 카르스트 함몰지를 아우르는 넓은 범주이고, 톈컹은 깊이와 체적이 매우 크고 측면이 가파른 카르스트 음지형으로 대체로 지하 배수와 이어지며 용식·붕괴 과정으로 형성됩니다. 대부분의 싱크홀은 톈컹이 아니며, 발표된 분류는 장관인 구멍이 아니라 측정 가능한 형태를 씁니다." },
    { question: "충칭 펑제 샤오자이 톈컹에 갈 수 있나요?", answer: "샤오자이 톈컹은 지금으로서는 지질·계획 맥락으로만 두는 편이 낫습니다. 과학적으로 중요한 톈컹이고 공식 계획·해설 자료도 있지만, 이번 검토에서는 현재 운영 중인 공개 경로를 확인하지 못했습니다. 이름이 확인된 운영자가 최신 공개 경로를 안내하기 전까지는 목적지가 아니라 배경 자료로 남기세요. 계획 의견수렴은 개장의 증거가 아닙니다." },
    { question: "혼자 톈컹 아래로 내려가도 되나요?", answer: "안 됩니다. 정식 관광지나 현재 지방 당국·운영자가 합법적 공개 경로를 게시한 곳만 이용하고, 전망대와 계단, 표시된 길을 벗어나지 마세요. 좌표, 드론 영상이나 탐사 글은 하강 허가가 아닙니다. 기술 탐사는 로프와 동굴 구조 역량, 공식 승인이 필요하며 개인 관광 범위 밖입니다." },
    { question: "관리 계단으로 내려가는 코스는 얼마나 힘든가요?", answer: "지속되는 하강과 상승, 높은 습도, 힘든 복귀 오르막을 각오해야 합니다. 출발 전에 계단 수나 고도, 난간, 휴식점, 일방통행 규칙과 최종 입장 시간을 확인하세요. 중단 규칙은 간단합니다. 무릎, 더위나 시간이 나빠지면 무리하지 말고 첫 공식 회귀점에서 돌아오세요." },
    { question: "부모님과 함께인데 톈컹을 봐도 괜찮을까요?", answer: "네, 가장자리와 방문자센터 층까지라면 충분합니다. 확인된 출입, 난간, 휴식, 화장실과 지상 대안을 먼저 챙기고, 계단과 복귀에 드는 힘을 확인한 뒤에만 하강을 생각하세요. 측정 가능한 출입 근거 없이 ‘쉽다’고만 적힌 경로라면, 출입 근거가 문서화된 다른 정식 카르스트 장소를 고르는 편이 낫습니다." },
    { question: "안개로 함몰지가 안 보이면 어떻게 하나요?", answer: "방문자센터, 지질 단면, 모형과 가장자리 식생을 보고 교통 여유 안에서만 기다리세요. 시야를 꾸며내지 않고도 형성 과정과 서식지를 이해할 수 있습니다. 비가 온 뒤 하부 경로가 폐쇄됐다면 명시적으로 열린 지상 경로에 머물거나 떠나고, 장벽 옆 발자국을 따라가지 마세요." },
  ] },
