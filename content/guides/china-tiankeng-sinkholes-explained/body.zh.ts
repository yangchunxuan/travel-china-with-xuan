...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "天坑参观常见问题", items: [
    { question: "落水洞和天坑有什么区别？", answer: "主要是规模与形态。落水洞／漏斗涵盖多种尺度和成因的封闭喀斯特凹地；天坑则指规模、深度和体积异常巨大、侧壁陡峭的喀斯特负地形，通常与地下水系相连，由溶蚀和坍塌过程形成。大多数落水洞不是天坑，发表的分类依靠可测量形态，而不只是“一个壮观大洞”。" },
    { question: "重庆奉节小寨天坑现在能去吗？", answer: "目前只适合把小寨天坑当作地质与规划背景。它科学意义明确，也有官方规划与解释资料，但本次审查尚未确认一条当前运营的公众路线。在具名运营方公布当前公众路线之前，先保持这个定位；规划征求意见不等于新的游客设施或路线已经开放。" },
    { question: "可以自己爬下天坑吗？", answer: "不可以。只去正式景区，或当前属地政府、运营方明确公布合法公共路线的场所，并且始终停留在平台、阶梯和标识路径上。坐标、航拍视频或探险帖子都不是自行下降的许可。技术探险需要绳索、洞穴救援能力和正式授权，不属于散客旅游范围。" },
    { question: "走管理阶梯下降有多累？", answer: "要做好持续上下、湿度大和回程爬升吃力的准备。出发前先核实台阶或高差、扶手、休息点、单向规则和最晚入场时间。停止规则很简单：膝盖、炎热或时间一旦恶化，就在第一个官方折返点返回，不要勉强继续下行。" },
