...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "제작·시험 자주 묻는 질문", items: [
    { question: "시속 600km 자기부상열차는 지금 승차권을 살 수 있나요?", answer: "아닙니다. 2026년 8월 13일 확인한 공식 자료는 연구, 공학 차량과 향후 시범 단계를 설명할 뿐 일반 승객용 노선·시간표·승차권 상품은 제시하지 않았습니다. 상업 운행 중인 상하이 공항 자기부상열차와 혼동하지 마세요. 전시된 시제품은 연구 또는 공학용 실물 차량이 존재한다는 뜻이지, 승차권이나 여객 노선이 존재한다는 뜻은 아닙니다." },
    { question: "새 열차가 출고됐다는데 곧 탈 수 있다는 뜻인가요?", answer: "그것만으로는 아닙니다. 열차 편성이 출고됐다는 것은 실물 편성이 공장 제작의 한 이정표에 도달했다는 뜻이며, 규제기관의 인수나 일반 운행 시작일을 확인해 주지는 않습니다. 상업 운행 시작은 별개의 단계로, 특정 운영사가 공식 시간표와 판매 채널을 통해 특정 노선을 운행하는 것을 말합니다." },
    { question: "시험 주행에서 아주 빠른 속도가 나왔는데 제가 탈 때도 그 속도로 달리나요?", answer: "기록된 시험 속도가 곧 영업 속도는 아닙니다. 시험 주행 완료는 명시된 조건에서 정해진 측정값을 수집했다는 뜻이지, 모든 시험이 통과됐거나 기록 속도를 영업 운행에 쓴다는 뜻은 아닙니다. 한 차례의 고속 주행 영상만으로 모든 하위 시스템과 운행 조건을 통과했다고 볼 수 없습니다." },
    { question: "차체를 왜 대형 알루미늄 압출재로 시작해서 만드나요?", answer: "긴 알루미늄 합금 압출재로 측벽·지붕·바닥의 큰 부분을 적은 부품으로 구성하면서 가벼움, 강성과 반복 생산성을 확보할 수 있기 때문입니다. 알루미늄 차체를 쓰는 많은 고속철도 차량의 방식이지만, 중국의 모든 열차 플랫폼이 알루미늄이나 같은 용접 순서를 쓴다는 뜻은 아닙니다." },
    { question: "같은 열차를 왜 반복해서 시험하나요?", answer: "열차는 서로 연결된 시스템이기 때문입니다. 출입문, 제동 제어기나 소프트웨어의 변경이 다른 접속부에 영향을 줄 수 있고, 동적 시험에서 발견된 결과에 따라 조정한 뒤 같은 기준의 시험을 다시 해야 할 수도 있습니다. 공장 제작 완료, 공학적 검증, 여객 운행 승인 또는 인수는 서로 다른 단계입니다." },
    { question: "열차를 만드는 동안 실제로 무엇을 검사하나요?", answer: "두 가지입니다. 먼저 차체 골조가 정확해야 합니다. 길이, 너비, 대각선과 접속 위치를 측정하고, 규정된 방법으로 용접부를 검사하며, 나중에 접근이 어려워지기 전에 밀폐와 구조 요건을 확인합니다. 다음으로 시스템이 함께 작동해야 합니다. 전원·데이터망·출입문·제동·경보를 검증하고, 대차와 차체의 접속 상태를 확인한 뒤, 정상 제어 명령, 보호 로직과 정해진 고장 조건을 시험합니다." },
  ] },
