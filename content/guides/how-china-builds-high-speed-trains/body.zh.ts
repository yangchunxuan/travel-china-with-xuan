...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "制造与试验常见问题", items: [
    { question: "600公里时速磁悬浮现在能买票坐吗？", answer: "不能。截至2026年8月13日，官方资料描述的是研究、工程车辆和未来示范路径，并未给出具名公众线路、时刻表或票务产品；不要把这些项目与已经商业运营的上海机场磁悬浮混为一谈。展会上的原型车只说明研究或工程车辆实体已经存在，不说明已有公众客运线路或车票。" },
    { question: "一列新车“下线”了，是不是很快就能坐？", answer: "不一定。整列车下线只能证明实体列车达到一个工厂里程碑，不能证明已通过监管验收，也不能证明已有公众开行日期。开始商业运营是另一个里程碑：具名运营方按照正式时刻表和售票渠道运营具名线路。" },
    { question: "试验跑出了很高的速度，我坐的时候也会这么快吗？", answer: "试验速度不等于运营速度。完成一次试验运行，只能证明在说明的条件下取得了规定测量结果，不能证明所有试验都已通过，也不能证明该速度会用于商业运营。一段高速运行画面，同样不能证明所有子系统、场景和运营条件均已通过。" },
    { question: "为什么车体要从大型铝合金型材开始做？", answer: "因为长大铝合金挤压型材可以用较少零件形成侧墙、车顶或地板的大面积结构，同时满足轻量、刚度和稳定重复制造的要求。这是许多铝合金车体高速车辆的做法，但不代表所有中国列车平台都使用铝合金或完全相同的焊接顺序。" },
    { question: "同一列车为什么要反复试验？", answer: "因为列车是彼此耦合的系统。车门、制动控制器或软件的一项改动，可能影响其他接口；动态试验发现的问题也会让列车返回调整，再按规定重新测试。工厂完工、工程验证，以及获准或验收用于载客，是不同的里程碑。" },
    { question: "造车过程中到底检查什么？", answer: "两类关口。一是车体本身必须准确：测量长宽、对角线和各接口位置，按规定方法检查焊缝，并在后续部件遮挡之前检查密封和结构要求。二是各系统必须协同工作：验证供电与数据网络、车门、制动和报警，确认转向架与车体接口，再测试正常指令、保护逻辑和规定的故障工况。" },
  ] },
