# B30 fact-check — How to book China's 600 km/h maglev
...
1. CRRC Sifang's normal-conducting system rolled off in Qingdao in 2021. Roll-out is a manufacturing milestone, not passenger operation.
2. Later official reports describe a superconducting electrodynamic prototype from CRRC Changchun. It is a different technical programme and likewise not a public service.
3. Shanghai's commercial airport maglev is a real passenger railway, but it does not prove either 600 km/h research vehicle has entered ticketed operation.
...
Do not create a booking page unless current primary evidence supplies all three: a named commercial operator, an operating passenger route and an official ticket channel. Until then, answer the query with the correction in this manufacturing owner or an existing transport FAQ.
