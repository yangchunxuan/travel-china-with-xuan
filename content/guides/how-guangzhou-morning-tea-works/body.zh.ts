...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "早茶要收茶位费吗？按人收还是按壶收？",
          answer: "通常按人收。茶位费一般按人数而不是按一壶收取，点单前要问清每位费用和包含的服务。按2026年《广州早茶传承保护规定》，经营者收取茶位费时，应提供红茶、绿茶、乌龙茶、普洱茶、菊花茶等供选择，并做好相应茶饮服务；规定没有统一全市价格。",
        },
        {
          question: "饮茶和点心是一回事吗？",
          answer: "不是。“饮茶”是粤语说法，日常邀请别人“去饮茶”，通常是去完成一顿茶配点心的聚会；“点心”指茶桌上的小份咸甜食物，可以蒸、焗、炸，也可以是肠粉、粥等形式。点心是饮茶的一部分，不是与饮茶完全同义的词。",
        },
        {
          question: "现在还会有点心车推到桌边吗？",
          answer: "不一定。服务员推着点心巡台、在点心卡上盖章，是很有辨识度的传统服务形式，有些大厅仍保留，但不能预设每家都有。许多餐厅现在用纸质勾选单、二维码菜单或服务员点单。到店后先问清楚当天用哪一种方式。",
        },
        {
          question: "两个人第一次去，大概点多少？",
          answer: "Homeground的保守起点是一壶茶配三至四份小点，再逐步加单。蒸笼或碟子常见二至四件，但数量和大小差别很大，不能套用一个万能公式。这只是防止浪费的点单经验，不是“一盅两件”的定义。",
        },
        {
          question: "别人给我斟茶时，一定要用手指叩桌吗？",
          answer: "可做可不做。扣指茶礼确实是广府饮茶习俗中有记录的动作：同桌人这样做时，你可以用弯曲的两指轻叩桌面回应；直接说一声谢谢也没有问题，游客不会因为少做一个手势而失礼。至于乾隆皇帝微服出行而产生此礼的说法，属于地方传说，不是可证明的起源。",
        },
        {
          question: "看外皮能判断点心是不是素的、有没有海鲜吗？",
          answer: "不能。猪油、虾米、鲜虾、蚝油、肉汤和共享加工环境，都可能藏在意想不到的点心里；外皮透明也不代表天然无麸质或一定不含猪肉成分。有食物过敏时，把过敏原用书面中文给餐厅看，同时询问配方与交叉接触。",
        },
      ],
    },
    {
