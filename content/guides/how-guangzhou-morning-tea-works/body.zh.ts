  ...
  blocks: [
    {
      ...
      type: "lead",
      text:
        "广州早茶不只是喝茶，也不只是吃早餐。它是一种把茶、广式点心和同桌相处的时间放在一起的共享餐食。粤语里的“饮茶”是整项活动，“点心”则是桌上的食物。第一次去时，要预期可能按人收取茶位费、餐厅各有不同点单方式，而且这顿饭通常比外带早餐慢得多。",
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "按餐厅当天使用的方式点心：纸质勾选单、盖章点心卡、二维码菜单、服务员点单，或少数传统大厅里的点心车。",
