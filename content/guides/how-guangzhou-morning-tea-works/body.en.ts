...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "“One tea vessel, two pieces” is a cultural shorthand, not an order rule",
    },
    {
      id: "one-bowl-explanation",
      type: "paragraph",
      text:
        "The phrase yizhong liangjian—一盅两件—evokes an economical tea accompanied by two dim sum items. It helps explain how deeply tea and small dishes belong together. It does not mean a restaurant will sell one standard package, that every steamer contains two pieces, or that a proper diner must stop at two dishes. Modern menus range from restrained classics to elaborate new creations.",
    },
    {
