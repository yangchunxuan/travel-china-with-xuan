...
Queries checked on 2026-08-13 included `Xixia Imperial Tombs UNESCO 2025 nomination`, `西夏陵 考古 6号陵 李德明 官方`, `西夏文 汉文 碑刻 北端建筑遗址`, and current museum/opening searches. Results often collapse a confirmed World Heritage inventory, proposed tomb identities, and visual reconstructions into one smooth narrative. Traveller questions are more practical: what the mounds actually prove, where the script connects to the site, whether a named tomb owner is certain, and which parts of a reconstructed view are archaeological evidence.
...
- **Official inventory fact:** inscription date, property composition, setting and recorded excavation campaigns.
- **Documented archaeological fact:** an object or structure’s stated find context, when tied to an official excavation account.
- **Research attribution:** Mausoleum 6’s association with Li Deming and the northern complex as an ancestral temple. Both retain explicit inference language.
- **Homeground editorial judgment:** museum first, then one mausoleum zone and the wider landscape; use a five-level confidence vocabulary in field notes.
- **Cannot infer:** every tomb occupant, every ceremony, the beliefs of all Xixia people, or untouched medieval fabric on every visitor-facing surface.

## Dynamic items

- World Heritage status checked 2026-08-13; the inscription itself dates to 2025.
- Museum naming, ticketing, shuttle routes, open mausoleum areas, conservation closures and display rotations were checked 2026-08-13 and must be verified again close to publication/travel.
- The numbers 9, 271 and 32 are property inventory figures, not visitor-access counts.

## Information-object count

The English body contains 40 independently useful objects: 3 evidence classes, 6 confidence labels, 6 field-sequence actions, 12 case-specific fact/boundary pairs, 2 traveller scenarios, 6 failure-recovery actions and 5 final-note fields.

## Future inbound owners

- `liangzhu-ruins-park-and-museum-sequence`
- `ritual-bronze-vessels-and-inscriptions`
- `yungang-grottoes-cave-order-and-museum`
- A future Yinchuan transport and day-plan owner
