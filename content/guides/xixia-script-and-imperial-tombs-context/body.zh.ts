...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "西夏文到今天还是没人能读吗？",
          answer: "不是。学者已经能够阅读大量西夏文献，它并不是一种至今无人释读的文字。陵区真正的困难通常在残片保存和语境：残片只能支持可辨读的那几句话和有记录的出土语境，博物馆里的译文是释读，不是原物表面本身。",
        },
        {
          question: "西夏陵的世界遗产范围里都有什么？",
          answer: "包括帝陵9座、陪葬墓271座、北端建筑遗址和32处防洪工程，该遗产于2025年列入《世界遗产名录》。它们的分布可以显示贺兰山麓经过规划的使用方式，但平面布局本身不能给每一位使用者、每一场活动命名。建议先看遗址总图，不要一上来就追最上镜的那座陵塔。",
        },
        {
          question: "每一座陵的墓主人都已经确定了吗？",
          answer: "并非每一座都确定，而且措辞很重要。6号陵在1972—1975年和2007—2008年进行过发掘，相关铭文被用来推定它与李德明有关；这应当写成“推定”或“归属判断”，而不是毫无争议的认定。现存资料无法解决时，就写“尚无可靠认定”。",
        },
        {
          question: "只有两小时，先看什么？",
          answer: "先在博物馆读证据，而不是先去看地平线。学会读一件文字残片，再挑一件出土地点清楚、有墓号或遗址号的器物，然后去一处帝陵区域和一个能看见贺兰山环境的观察点。到了现场先问工作人员当天开放哪些区域和展厅；本文的运营信息最后核对于2026年8月13日。",
        },
        {
          question: "户外看到的都是西夏时期的原物吗？",
          answer: "不都是。到了户外，要把原有遗存、保护加固和参观栈道分开看：整齐的边缘、台阶或平台很可能是现代管理设施，而不是西夏时期的材料。复原图、模型和补出的轮廓必须标注为复原，你也可以追问哪些部分依据发掘基址，哪些来自比较研究，哪些只是为了说明而做的选择。",
        },
        {
          question: "博物馆里有哪件器物特别值得找？",
          answer: "通常是那件鎏金铜牛。它出土于MIII-107号陪葬墓，既能证明精湛的金属工艺，也带着明确的墓葬语境。不过一件精英随葬器不能代表普通家庭，也不能证明存在单一固定的“民族风格”，所以看的时候记下材质和出土地点，并确认展出的是原件、复制品还是复原品。",
        },
      ],
    },
    {
