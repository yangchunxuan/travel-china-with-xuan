...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "车次以 D 或 G 开头的夜车，一定有床位吗？",
          answer: "不一定。客流高峰期间，铁路可能临时增加深夜高铁，这些列车可能全部是座席。不要从发车时间或 D/G 字头推断有卧铺；要看库存里明确写着卧铺或铺位，而不是二等座、硬座或无座。",
        },
        {
          question: "列车 00:30 发车，应该订哪一天？",
          answer: "订新的一天。00:30 发车属于新的日历日期，即使你前一天晚上就离开了酒店，所以零点以后的车次一定要看清日期。把酒店退房、到站候车、列车发车和目的地到达写在同一条时间线上，零点前后就不会对错。",
        },
        {
          question: "硬卧和软卧有什么区别？",
          answer: "硬卧通常是价格最低的真正铺位，隐私也最少；软卧通常每个隔间铺位更少、隐私更高，票价也更高。付款前要核对开放还是封闭布局、上中下铺、行李空间和实际车体；选软卧还要看是否有门、铺位怎么分配，以及溢价是否仍低于酒店方案。",
        },
        {
          question: "中国的夜间列车上有淋浴吗？",
          answer: "可能没有。设施取决于实际车体和席别，可能没有淋浴、没有独立洗手间、没有大行李间，也可能不是每个铺位都有充电口，隔音更不像酒店。有官方布局时先查看；除非运营方明确确认更多设施，否则按基础洗漱条件准备。",
        },
        {
          question: "带儿童坐卧铺，需要单独买铺位吗？",
          answer: "“免费儿童”不等于免费的独立床位。中国铁路规则会区分不单独占用席位、购买儿童票和购买独立铺位，当前动车组儿童优惠还会随席别变化。请在 12306 按正确年龄和证件录入每位儿童，再算真正需要的铺位价格；成人和儿童共用一个铺位，要当成认真判断后的选择，不是默认做法。",
        },
        {
          question: "清晨六点到站，可以直接去酒店吗？",
          answer: "不要默认可以，订票前先把这个早晨测一遍。确认酒店能否寄存行李、提供洗漱空间或付费提前入住，以及那个时间有没有地铁、公交或可实际使用的出租车。房间还没准备好时，全体同行人要有地方吃饭和等待，清晨到站才有价值。",
        },
      ],
    },
    {
