...
const body = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "items": [
        {
          "question": "《黑神话：悟空》是根据《西游记》改编的吗？",
          "answer": "游戏科学的发布资料说游戏灵感来自《西游记》和中国神话。这一官方表述支持“受启发”这一层，但不能把游戏的世界、剧情或角色设计当成这部十六世纪小说的逐字复制。"
        },
        {
          "question": "哪个版本的孙悟空才是“原版”？",
          "answer": "不存在唯一原版。《西游记》是重要的文学锚点，但学术研究追踪悟空经历了叙事、戏曲、电影、图像和国际再诠释，所以同一个形象可以是恶作剧者、守戒的取经人、反叛者、舞台角色或现代主角。讨论时先说明是哪个版本：小说的某个版本、戏曲角色、动画、游戏还是博物馆藏品。"
        },
        {
          "question": "动画电影里的哪吒和庙里供奉的哪吒是同一个吗？",
          "answer": "名字和属性相同，但所属机构不同，所作的主张也不同。研究追踪哪吒经历佛教、道教、民间信仰、文学、戏剧和电影语境；《封神演义》是重要的文学版本，1979、2019 和 2021 年的动画各自为不同观众重写了命运、家庭与人物。在寺庙里，请使用该机构给出的神号和说明。"
        },
        {
          "question": "能去《黑神话：悟空》里的真实取景地吗？",
          "answer": "先分清四种说法：制作方明确说扫描或参考了某建筑；政府或目的地机构在有日期的活动中把景点和作品联系起来；某地本来就有更早的文献关联；粉丝发现的画面相似。文化和旅游部 2025 年的一篇文章证实山西举办过涉及文化遗产景点的悟空主题旅游活动，但这不等于开发商编写的取景地目录，也不能证明当前可以进入——把景点写进行程前，先向景点管理方核实。"
        },
        {
          "question": "我可以在旅行帖子里用游戏截图或电影剧照吗？",
          "answer": "没有授权就不可以。截图、剧照、海报、预告片和同人作品都可能包含受保护的表达，官网是事实来源而不是图片授权。发布时请使用公共领域或开放许可的历史文物图片、另行授权的照片，或仅依据有出处事实制作的原创对比，并附署名和许可链接。"
        }
      ]
    },
    {
