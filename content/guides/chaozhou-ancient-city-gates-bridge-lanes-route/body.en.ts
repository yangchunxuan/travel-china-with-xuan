...
const body = { schemaVersion: "1.0.0", blocks: [
  { id: "lead", type: "lead", text: "Start at the northern end of the riverside wall, walk south through the sequence of gates, make the bridge decision at Guangji Gate, then continue through the arch street and finish near the lower water gate. Chaozhou's old city has an unusually legible shape: one surviving stretch of wall along the Han River, one central street carrying the memorial arches, and a living grid of lanes between them. The route below is a north-to-south line; short lane visits are optional side trips, not part of a promised loop." },
  ...
  { id: "route-heading", type: "heading", level: 2, text: "The main route: a north-to-south line" },
  { id: "route-copy", type: "paragraph", text: "Allow roughly half a day at an unhurried pace. The route starts in the north because the wall is easier to read walking downstream, with the river on your left and the city on your right. It finishes in the south rather than returning to the starting point." },
  { id: "route-list", type: "list", ordered: true, items: [
    ...
    "Pause at the bamboo-and-timber gate and look inland at the old trading quarter, then stay with the wall and continue south.",
    "Stop at Guangji Gate. This is the pivot of the walk and the point at which you check the bridge's current admission and crossing status before deciding whether to add it.",
    "Enter the city through Guangji Gate, walk inland to Taiping Road, then turn south along the arch street. Twenty-three stone arches stand along the full axis; this route follows its southern direction rather than trying to collect every arch.",
    "If you want to see the residential lanes, choose one or two clearly public entrances. A short visit may require returning to the axis; do not force a through-route through residential access.",
    "Continue south on public streets and finish near the lower water gate, where the surviving wall runs toward the South Gate and river dyke.",
  ]},
  ...
  { id: "bridge-copy", type: "paragraph", text: "Guangji Bridge is not a fixed crossing. Provincial reporting citing the city's ancient-city heritage management centre describes a structure combining beam, arch and pontoon forms. Stone piers carry spans from each bank toward the middle, where eighteen linked boats can join the crossing or be drawn aside for navigation. The published pattern describes a daytime connection and an evening opening for river traffic, but current admission and operating practice still need to be checked on the day." },
  ...
  { id: "bridge-table", type: "table", caption: "What to do at Guangji Gate, depending on what the bridge is doing", columns: ["What you find", "What it means", "How the route changes"], rows: [
    ["The pontoon is connected and the bridge is admitting visitors", "A through-crossing may be possible under the operator's current rules", "Confirm admission and tickets, then add the crossing only if it fits your day"],
    ["The pontoon is drawn aside and the middle is water", "There is no through-crossing", "View the structure from the bank and do not enter the bridge deck"],
    ...
    ["You want to see it from outside", "The structure reads clearly from the riverbank", "Use the publicly accessible bank or wall section and follow any local closure signs"],
  ]},
  ...
  { id: "lanes-list", type: "list", ordered: false, items: [
    ...
    "If someone offers tea and you are comfortable accepting, follow their lead and do not assume the invitation includes photographs or access beyond the place where you are seated.",
  ...
  { id: "short-comparison", type: "comparison", title: "Three versions of the same walk", columns: [
    { heading: "Full linear route", items: ["Wall from the north end toward the lower water gate", "Guangji Gate and the bridge decision", "The southern direction of Taiping Road", "One or two optional lane visits"] },
  ...
  { id: "fallback-table", type: "table", caption: "Nothing here requires the plan to be abandoned", columns: ["What has gone wrong", "What to do instead"], rows: [
    ...
    ["You came in at the southern end of the city", "Reverse the linear sequence and finish in the north rather than crossing the city just to reach the suggested start"],
  ...
  { id: "facts", type: "callout", title: "Reviewed 23 August 2026", tone: "neutral", body: "The wall's history, surviving extent, flood-dyke role and four gates are drawn from Guangdong provincial and Chaozhou municipal chronicles. Provincial reporting citing the city's ancient-city heritage management centre supports the bridge's combined structure, eighteen-boat pontoon and daytime-connection/evening-navigation pattern. The central axis, twenty-three arches, quarter layout and named lanes come from the same official reporting. Opening times, admission, gate access and bridge operation can change; check the operator on the day." },

  { id: "help", type: "callout", title: "Want the walk fitted around your arrival and the light?", tone: "decision", body: "Tell us when you arrive, how long you have, and whether crossing the bridge matters to you. Homeground can fit the linear route around your actual hours and tell you what to drop if the bridge is not available. Current bridge and gate status stays with the operators." },

  { id: "faq", type: "faq", title: "Walking the old city: common questions", items: [
    { question: "Can I walk across Guangji Bridge?", answer: "It depends on the day. Guangji Bridge is not a fixed crossing: stone piers carry spans from each bank toward the middle, where eighteen linked boats can join the crossing or be drawn aside for navigation. The published pattern describes a daytime connection and an evening opening for river traffic, but current admission and operating practice still need to be checked on the day." },
    { question: "Is Paifang Street a different street from Taiping Road?", answer: "No, they are the same street. 牌坊街 is the arch street along the central axis, and the easy mistake is to look for a separate street when it is 太平路 itself — the old north-to-south axis through the middle of the city. Older residents may call it simply the main street, so the name you hear and the name on the map can differ." },
    { question: "How long does the old-city walk take?", answer: "Allow roughly half a day at an unhurried pace. It is a line from north to south rather than a loop: it starts in the north because the wall is easier to read walking downstream, with the river on your left and the city on your right, and it finishes in the south rather than returning to the starting point." },
    { question: "Is there a shorter version if it rains or I only have ninety minutes?", answer: "Yes. The ninety-minute version enters at Guangji Gate, spends ten minutes on the wall in each direction for the view and the dyke, walks Taiping Road in one direction only, and adds one lane. In rain, skip the wall, which is exposed and slippery, use the covered arcaded frontages along the arch street, and keep to lanes that are paved and lit." },
    { question: "Do I need a ticket to enter Chaozhou Ancient City?", answer: "The old city itself is not a ticketed enclosure. 潮州古城 is the walled old-city area as a whole and a living district, and assuming it is a ticketed enclosure is the listed mistake. The Guangji Gate tower (广济门城楼) and Guangji Bridge (广济桥) are separate named places; the bridge is also called Xiangzi Bridge locally, so both names appear." },
    { question: "Is it all right to walk into the residential lanes and take photographs?", answer: "Go in from the arch street, look, and come back out rather than using the lanes as a through route. Photograph the street, the roofline and the carved door frames, but do not photograph into courtyards or through windows; an open doorway is not an invitation. If a passage narrows to shoulder width it is private access, so turn round." },
  ] },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    { label: "Poetic Chaozhou: the ancient city wall — history, surviving extent, the four east gates and the wall as flood dyke", url: "http://dfz.gd.gov.cn/zjgd/content/post_3058024.html", publisher: "Guangdong Provincial People's Government Local Chronicles Office and Chaozhou Municipal Local Chronicles Compilation Committee Office", reviewedAt: "2026-08-23" },
    { label: "Chaozhou's Guangji Bridge: structure, the eighteen-boat pontoon, its daytime connection and evening opening for navigation, and the 2003-2007 restoration", url: "http://www.qb.gd.gov.cn/jrqx/content/post_1250040.html", publisher: "Overseas Chinese Affairs Office of the People's Government of Guangdong Province", reviewedAt: "2026-08-23" },
    ...
    { label: "Hero: Guangji Bridge with the pontoon section opened, by Windmemories, CC BY-SA 4.0; cropped and converted to WebP", url: "https://commons.wikimedia.org/wiki/File:20230206_Guangji_Bridge_01.jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-23" },
    { label: "Hero derivative licence: CC BY-SA 4.0", url: "https://creativecommons.org/licenses/by-sa/4.0/", publisher: "Creative Commons", reviewedAt: "2026-08-23" },
  ]},
