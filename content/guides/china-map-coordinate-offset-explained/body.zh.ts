...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "订单页上的酒店标记在马路对面，该信哪一个？",
          answer: "以酒店给出的中文门址为准。先把订单页上的标记当作未经核验的信息，在中国本地地图里搜索中文分店名和门牌号，再请前台发来同一个地图 App 的链接，并说明从哪个入口进。文字不完整时，结果可能只落在城市、道路、商圈或大致中心；拼音名或翻译名也可能匹配到另一家分店。",
        },
        {
          question: "能不能给经纬度加减一个固定修正量？",
          answer: "不能。地图平台的官方开发文档确实区分多种坐标输入，却没有给旅行者一个全国通用的固定方向或距离。手动加减数值，往往只是把标记从一个错误位置移到另一个错误位置，也发现不了同名分店、旧地址或关闭的入口。请核对地址和入口，不要依赖未公开的算法。",
        },
        {
          question: "上出租车时该给司机看什么？",
          answer: "给司机看中文目的地卡，再看司机地图里的那个 POI，不要只给英文截图。指出区县、分店和入口，并在车辆开动前请司机确认区县。如果路线指向场所中心点，就改搜已确认的车辆入口或上车点；行车途中不要一边让司机分心，一边改终点。",
        },
        {
          question: "在商场或车站里蓝点一直跳动，是目的地标记错了吗？",
          answer: "不一定。蓝点跳动通常是手机实时定位、权限或室内信号的问题，固定的目的地 POI 并没有移动。先按楼层和出口标识走到一个清晰锚点，再到室外或入口附近重新定位，然后再判断标记本身是否有误。",
        },
        {
          question: "一个地图标景区中心，另一个标东门，该用哪个？",
          answer: "两者可能都在描述同一个场所。大型场所可能同时有中心点、子 POI 和单独的导航入口，可用入口还会随时段、票种、车辆通行或施工通知改变。以景点当天为你的票种和到达方式指定的入口为准，并把这个入口当作一个独立地点来搜索。",
        },
        {
          question: "步行导航要我跨越围栏或快速路，还要跟着走吗？",
          answer: "不要跟。标记要求你跨越围栏、快速路、铁路、水道、施工区或私人入口时，立刻停下，把中文路牌、楼号、门名和附近地标与目的地卡逐项对一遍。然后退回一个明确锚点，比如有工作人员的地铁出口、主路路口、车站问询处或酒店前台，再直接搜索入口或门名。",
        },
      ],
    },
    {
