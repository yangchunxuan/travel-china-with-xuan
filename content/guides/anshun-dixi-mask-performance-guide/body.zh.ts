...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "脸子戴在额头上，是不是戴错了？",
          answer: "没有戴错。演员先用青巾蒙住头脸，再把木雕脸子置于额上；角色是由雕刻、唱腔、帮腔、锣鼓、兵器和全身动作一起生成的。这个佩戴关系可以直接看到，但它最初为何形成并不是已经解决的历史事实，先别急着采信某一种起源说法。",
        },
        {
          question: "天龙的地戏折子戏大概多长？",
          answer: "大约十分钟。国家民委2026年7月3日的报道提到，天龙屯堡景区演武堂每天定时上演约十分钟的地戏折子戏（信息复核于2026年8月15日）。报道没有写具体时刻、取消规则和语言支持，所以当天节目和准确场地还是要向当前运营方问清楚。",
        },
        {
          question: "游客看的短场和村寨里的地戏是一回事吗？",
          answer: "不是一回事，但这不是真假排名。关于天龙的同行评审研究记录了旅游如何让地戏在不同空间中移动，也改变了演员、社区和运营主体之间的关系。游客短场可以是有价值的入门窗口，同时仍然不同于村寨仪式序列，所以记笔记时把地点、时长、观众和主办方一起写下来。",
        },
        {
          question: "能靠脸子的颜色判断是哪个角色吗？",
          answer: "光看颜色判断不了。研究与实践者介绍常把地戏脸子归入文将、武将、老将、少将、女将等角色类型，但这带来的是一个问题，不是一张速查表，京剧脸谱的规则也不能直接套到木雕脸子上。需要准确识别时，就查剧目、角色名和这支戏堂自己的说明。",
        },
        {
          question: "地戏演的是真实历史吗？",
          answer: "演的是英雄征战文学，不是历史原始档案。国家非遗项目页列举的题材包括三国、杨家将、岳家将等英雄征战传统。一个舞台人物可能同时来自历史、传奇、通俗文学和地方传承，所以不能把舞台上的动作当成事情当年就是这样发生的证据。",
        },
        {
          question: "可以拍照或者摸一摸脸子吗？",
          answer: "先问再拍。除非负责的实践者明确邀请，不要触摸脸子、兵器、戏服箱或仪式物件；村寨活动即使从公共道路看得到，也不等于可以走进去。拍摄可识别人物、录制完整演出或复制节目单之前都要另外询问，场馆规则、参与者同意和版权是三种彼此独立的许可。",
        },
      ],
    },
    {
