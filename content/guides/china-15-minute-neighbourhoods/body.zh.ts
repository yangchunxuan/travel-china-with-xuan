...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "table",
      caption: "Homeground 路线阻力工作表：核验一段真实步行，不给社区打总分",
      columns: ["路线分段", "现场记录", "时间或准入成本", "决策"],
      rows: [
        ["锚点到第一个过街点", "实际步行分钟、等灯时间、路缘或地下通道", "加入亲自经历的等待，不用直线距离", "返程同样可行时再继续"],
        ["过街点到服务入口", "坡度、遮阴、休息点、临街界面和实际使用的门", "计入围墙、小区或关闭入口造成的绕行", "未核验的入口标为未知，不标成可达"],
        ["进入服务设施后", "公众资格、开放时段、排队、支付和厕所", "记录完整停留时间，不只算走路", "每项必要服务都保留附近的公众备选"],
        ["返程或下一站", "连续人行道、照明、天气暴露和同行者体力", "按组内较慢者的步速计算", "能让全组安全完成的环线才有用"],
      ],
    },
    {
      id: "access-heading",
    ...
    },
    {
      ...
      items: [
        {
          question: "“15分钟社区”是不是什么都在15分钟内？",
          answer: "不是。它首先是一套规划和服务组织思路，并不表示每个人恰好走15分钟就能获得全部服务。一套官方框架更侧重居民身边的商业与便民服务；更广义的社区生活圈还会考虑教育、医疗、照护、文化、公园和就业。可以借它读懂普通城市生活，但真实路线、开放时间和准入对象要自己核对。",
        },
        {
          question: "全国是不是都已经建好了？",
          answer: "没有。国家层面采用试点、评估和分批扩围：2023年行动计划面向“有条件的地级以上城市”，要求“一圈一策”；2026年7月的通知仍把不同批次放在建设、验收或推广阶段，并把2026年完成一万个便民生活圈列为年度目标，而不是已完成的数量。该通知也主张渐进式更新。",
        },
        {
          question: "有没有可以去看看的具体社区？",
          answer: "有三处可以参考：上海曹杨、重庆民主村、雄安文华社区。把它们当例子，不当全国模板。曹杨在成熟社区结合公共空间更新、不同年龄服务和本地数字地图；民主村通过老社区微更新组合市场、维修、助餐和阅读空间；文华社区在较新的社区里统筹教育、健康、文化、照护和日常商业。",
        },
        {
          question: "以游客身份逛居民社区会不会不礼貌？",
          answer: "只要留在公共空间就不会。从地铁口、公共公园、普通街道或市场入口等公共锚点开始，不要把试图进入居民小区作为第一步。只在允许时拍建筑和公共导视，避免拍到可识别居民，尤其是儿童和正在接受照护的人。普通观察已经回答问题时就结束。",
        },
        {
          question: "游客能在社区食堂吃饭吗？",
          answer: "不要默认可以。社区食堂不一定对公众开放，也不一定给游客优惠，应当先问非本社区居民能否按普通价格用餐。沿街商店和公共市场则不同：营业时可以像普通顾客一样使用，只要这个入口和支付方式现在可用。",
        },
        {
          question: "如果坐轮椅，或者带着老人走，怎么办？",
          answer: "看路线，不看半径。针对中国城市的研究发现，中心城区与郊区、不同城市和人群的服务可达性存在差异，真正有用的尺度是连续可用的路线，以及这个具体的人需要多少时间。陡坡、路缘和绕行过街点会打断地图上看似很近的路线；改为核验更短的无台阶公共路段，把附近普通商店当作备用。",
        },
      ],
    },
    {
