...
5. Infographic: recommended later as a source-checked, not-to-scale east–west crossing diagram. Do not encode live hours or fares in the graphic.

Asset provenance is recorded in `source-log.md`. No AI documentary image is used.
