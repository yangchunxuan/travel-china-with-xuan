...
const body = {
  ...
  blocks: [
    ...
    { id: "fact-check", type: "callout", title: "动态交通信息核验于2026年8月12日", tone: "neutral", body: "香港官方目前把西九龙高铁、罗湖和落马洲支线列为铁路客运口岸，并另列深圳湾、落马洲／皇岗等公路口岸。车次、票价、口岸开放时间、节假日延时、巴士站点和入境要求均按日期变化，出发前须向对应运营方复核。" },
