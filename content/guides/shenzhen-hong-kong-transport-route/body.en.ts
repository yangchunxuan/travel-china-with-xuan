...
const body = {
  ...
  blocks: [
    ...
    { id: "decision-matrix", type: "table", caption: "Compare the complete chain, not only the cross-border segment", columns: ["Crossing", "Usually worth checking first when", "Friction people miss", "Do not assume"], rows: [
      ...
      ["Lok Ma Chau Spur Line ↔ Futian Checkpoint", "Futian-side metro access and the East Rail Line make a continuous chain", "The rail crossing is not Huanggang/Lok Ma Chau road control point", "The word Futian alone identifies the correct station"],
    ...
    { id: "door-steps", type: "list", ordered: true, items: [
      "Pin the exact hotel entrance, airport terminal or railway station on the Shenzhen side.",
      "Pin the exact Hong Kong endpoint and identify its nearest useful MTR station or road drop-off.",
      ...
      "Add station walking, queues, toilets, ticket collection where applicable and a recovery margin.",
    ]},
    ...
    { id: "people-comparison", type: "comparison", title: "How common constraints change the answer", columns: [
      { heading: "Light luggage, flexible time", items: ["Rail crossings can be easy to compare", "A metro interchange may be acceptable", "Keep a second open crossing as recovery"] },
    ...
    { id: "late-table", type: "table", caption: "What to verify when the journey is early, late or disrupted", columns: ["Situation", "Check first", "Fallback"], rows: [
      ...
      ["Last Hong Kong train is at risk", "Whether the control point and the local connection both remain open", "Stop before the border if the onward chain has already failed"],
      ["Holiday or major event", "Official temporary hours and transport notices", "Use a less convenient but confirmed crossing only if both sides of the chain work"],
    ...
    { id: "recovery-list", type: "list", ordered: true, items: [
      ...
      "If the remaining chain is unsafe, protect the hotel, flight or train booking before attempting another crossing.",
    ]},
    { id: "fact-check", type: "callout", title: "Dynamic transport facts checked August 12, 2026", tone: "neutral", body: "Hong Kong's official system currently identifies West Kowloon high-speed rail, Lo Wu and Lok Ma Chau Spur Line as rail passenger crossings and several separate road-based crossings, including Shenzhen Bay and Lok Ma Chau/Huanggang. Schedules, fares, control-point hours, holiday extensions, coach stops and entry requirements remain date-specific. Verify those fields through the responsible operator before departure." },
    ...
    { id: "internal-links", type: "internal-links", title: "Continue the parts this page does not own", items: [
      ...
      { label: "Protect the last night before an international flight", href: "/guides/china-last-night-before-international-flight/", description: "Do not leave a cross-border chain unprotected before departure." },
      { label: "Plan payment recovery in mainland China", href: "/guides/how-to-pay-in-china-as-a-tourist/", description: "Prepare more than one way to pay for the mainland legs." },
    ]},
