...
const body = {
  ...
  blocks: [
    ...
    { id: "faq", type: "faq", title: "Questions travellers ask before crossing to Hong Kong", items: [
      { question: "What is the fastest way from Shenzhen to Hong Kong?", answer: "There is no single answer; choose by the two doors. High-speed rail is often the cleanest comparison for Shenzhen North or Futian to Kowloon and central Hong Kong. Lo Wu usually deserves the first check for Luohu and the East Rail corridor, Lok Ma Chau Spur Line for Futian-side metro connections, Shenzhen Bay for Nanshan and western Shenzhen." },
      { question: "Are Lo Wu and Lok Ma Chau the same crossing?", answer: "No, and Lok Ma Chau itself has two meanings. Lok Ma Chau Spur Line is the rail passenger crossing connected to Futian Checkpoint; the Lok Ma Chau road control point connects with Huanggang. Save the full English and Chinese endpoint, not only 'Lok Ma Chau' or 'Futian', or it is easy to arrive on the wrong side." },
      { question: "Should I take the high-speed train from Futian or Shenzhen North?", answer: "Search both for your exact date, because the better one depends on where you are staying. Futian can be more convenient for central Shenzhen, while Shenzhen North can offer a different train pattern and onward network. West Kowloon combines rail and boundary processing in one station complex, but it is still a reserved intercity journey, so compare the hotel-to-platform and arrival-hall-to-hotel legs too." },
      { question: "Can I just take a taxi across the border?", answer: "Not without the correct cross-boundary arrangement; do not assume an ordinary taxi simply drives through. With several large cases, a direct cross-boundary coach may beat multiple trains, but confirm that the vehicle serves your exact endpoint, and count every corridor and check into the time." },
      { question: "My flight lands late in Shenzhen. Can I still cross to Hong Kong tonight?", answer: "Treat it as a border-hours problem before a route problem. Check a realistic airport exit time, the crossing's operating hours and the Hong Kong onward service. If the connection after the border no longer works, stop before the border: an airport-area night or a verified road crossing beats heading for a closed rail point." },
      { question: "Which crossing is easiest with children or older parents?", answer: "The one with fewer lifts, queues and network changes, which is rarely the one that looks closest on the map. Keep the group together at immigration and keep documents with the traveller who needs assistance. Then check the connection after the crossing, because the steps on the far side shape the day as much as the border itself." },
    ] },
