...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "ATM 没出钞但手机银行显示扣款，可以再试一次吗？",
          answer: "不要再试。第二次尝试可能产生另一笔授权或扣账，也会让两笔证据更难区分。先让本次交易流程完全结束，阅读最终屏幕，保留纸质凭条，即使上面写着失败也不要丢；安全时拍下 ATM 所属银行、机器或终端编号、网点或场所，以及屏幕错误。",
        },
        {
          question: "应该先联系 ATM 所属银行还是自己的发卡行？",
          answer: "先联系 ATM 所属行，通过核验过的官方号码请其登记事件并取得设备事件编号。随后联系自己的发卡行，确认该记录是待处理还是已入账，并按“未收到现金”类别正式立案。两边案件编号都要保存；手机提醒和机器状态都不能单独决定最终结果。",
        },
        {
          question: "银行卡也被机器吞了，该怎么报？",
          answer: "向 ATM 所属行报告吞卡，同时告诉发卡行卡片已不在本人控制中。按发卡行指示锁卡或换卡，不要接受陌生人代取。这件事要和“未收到现金”的案件分开记录，两边证据才不会混在一起。",
        },
        {
          question: "只拿到一部分现金，应该申报多少？",
          answer: "分别说明申请金额、收到金额和缺失金额。Visa 与 Mastercard 材料都承认部分现金问题。在私密处清点一次，保留钞票和凭条；除非发卡行另有指示，只申报缺失部分。后来的尝试也要分别列出时间、金额和参考号，不要合成一个数字。",
        },
        {
          question: "案件处理期间怎么拿到现金？",
          answer: "先用已经设置并测试过的移动支付，不要在事故当下用未知网络重配敏感账户。确实需要现金时，先记录第一笔故障，再选择有工作人员的银行网点或另一台明确支持的 ATM。外币现金可在带官方兑换标识的商业银行、合规兑换点或自助兑换机兑换，可受理币种和营业时间因地点而异。",
        },
        {
          question: "这笔钱多久能拿回来？",
          answer: "没有能写死的日期或结果。官方材料复核于 2026 年 8 月 13 日；待处理与已入账、零出钞与部分出钞、发卡行、卡组织、ATM 记录、发行国家和适用法律都会改变路径。投诉规则说明的是投诉处理，不等于资金在某日返还，要按发卡行最新的申报期限和证据要求办。",
        },
      ],
    },
    {
