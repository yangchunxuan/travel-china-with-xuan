  ...
  "blocks": [
    {
      "id": "lead",
      "type": "lead",
      "text": "7일이라면 장자제·우링위안을 먼저, 푸룽전을 두 번째, 펑황을 마지막에 두세요. 우링위안 3박은 공원 종일 일정 두 번을 지켜 주고, 푸룽전 1박은 야경을 단순 경유지로 만들지 않으며, 펑황 2박은 가이드와 도착하는 날과 자유 일정 하루를 나눠 줍니다. 마지막에는 장자제로 되돌아가지 않고 펑황고성역에서 출발합니다."
    },
    {
      "id": "order-heading",
      "type": "heading",
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          "D3",
          "우링위안 3박째",
          "가이드와 십리화랑·금편계 확정 구간을 보고 칠십이기루 일반 야간 회차를 방문합니다."
        ],
        [
          "D4",
          "푸룽전 이동; 1박",
        ...
        [
          "D7",
          "펑황 출발",
          "기사 차량으로 펑황고성역 이동. 장자제 귀환은 사전 서면 확인이 필요합니다."
        ]
      ]
    },
    {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "answer": "이 일정의 목적에는 충분합니다. 수하물과 함께 도착해 포함된 첫 입장 구역을 보고 저녁 시간을 보낸 뒤 다음 날 펑황으로 이동합니다. 푸룽전 자체가 핵심 관심지일 때만 1박을 더하세요."
        },
        {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "description": "교통 거점, 호텔 주소와 마지막 승차권을 연결하세요."
        },
        {
