...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions about Guiyang's airport and stations", items: [
    { question: "Which Guiyang station is the main high-speed rail hub?", answer: "Guiyang North is the city's main high-speed rail hub and connects with Metro Line 1. Central Guiyang Railway Station is also on Line 1 and serves conventional trains plus some high-speed services, while Guiyang East is a separate east-side station that usually needs more road travel. These hubs are not interchangeable." },
    { question: "Is there a railway station at Guiyang airport?", answer: "Yes. Longdongbao is an airport complex with Metro Line 2, coaches and a separate 龙洞堡 railway station below the terminal. Use it for a rail transfer only when 12306 shows a workable call at 龙洞堡. The railway station and the airport terminals share a complex but use different tickets, checks and boarding processes." },
    { question: "My ticket says 贵阳东 — is that the east coach station?", answer: "No. 贵阳东站 means Guiyang East Railway Station, while 贵阳东客站 has been used for the Longdongbao road coach terminal near Zhongxing Road. They are different transport records. Save the Chinese railway-station name, and if a driver heads for the coach terminal, stop the trip before unloading and show 贵阳东站 on the ticket." },
    { question: "I went to the wrong Guiyang station — what should I do first?", answer: "Check the ticket before moving across the city. In 12306, look at the departure status and change rules, and tell staff you are at the wrong station. Only take a cross-city vehicle if the verified margin works; otherwise change the ticket legally, and do not board a random train assuming all services link the stations." },
    { question: "I have a very early departure or a late arrival — can I rely on the metro or airport coach?", answer: "Not at every hour. Metro, buses, airport coaches and custom tourist lines change by date and do not all run through the night. Check the official Guiyang transport channel and the flight or train record on the travel date, and check that a legal taxi or ride-hailing pickup, hotel desk coverage and luggage capacity work at that hour." },
    { question: "Which part of Guiyang should I stay in for an easy transfer to my station?", answer: "Match the side of the city to the hub on the ticket. From Guanshanhu and the north-west, Guiyang North usually gives the simplest city transfer. From Nanming and the central city, Guiyang Railway Station is convenient when the booked train calls there, and Metro Line 1 also reaches Guiyang North. For a flight night, Longdongbao keeps it simple, while Guiyang East remains a separate road transfer." },
  ] },
