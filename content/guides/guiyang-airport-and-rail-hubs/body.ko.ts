...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "거점 관련 자주 묻는 질문", items: [
    { question: "구이양에서 주요 고속철도 거점은 어느 역인가요?", answer: "구이양북역이 가장 큰 고속철도 거점이며 지하철 1호선과 연결됩니다. 도심 구이양역도 1호선에 있고 일반열차와 명시적으로 정차하는 일부 고속열차를 다룹니다. 구이양동역은 도시 동쪽의 별도 철도역이라 도로 이동 부담이 더 큽니다. 서로 마음대로 대체할 수 없습니다." },
    { question: "구이양공항에 기차역이 있나요?", answer: "있습니다. 룽둥바오는 지하철 2호선, 장거리버스, 터미널 아래의 룽둥바오 철도역이 있는 공항 복합 거점입니다. 12306에 적합한 룽둥바오 정차가 있을 때만 철도 환승으로 쓰세요. 철도역과 공항 터미널은 같은 복합체에 있지만 표와 보안검색, 탑승 절차가 다릅니다." },
    { question: "표에 贵阳东이라고 적혔는데 버스터미널인가요?", answer: "아닙니다. 贵阳东站은 구이양동 철도역이고, 贵阳东客站은 중싱루 인근 룽둥바오 쪽 도로 버스터미널 명칭으로 쓰여 왔습니다. 서로 다른 교통 기록이므로 표의 贵阳东站을 저장해 두고, 기사가 버스터미널로 향하면 짐을 내리기 전에 멈춰 표를 보여 주고 앱 목적지를 철도역으로 고치세요." },
    { question: "역을 잘못 찾아갔습니다. 무엇부터 해야 하나요?", answer: "도시를 가로지르기 전에 표부터 확인하세요. 12306에서 출발 상태와 변경 규칙을 보고 직원에게 잘못 왔다고 알립니다. 검증된 여유가 있을 때만 도시를 횡단하고, 아니면 합법적으로 표를 변경하거나 구이양에서 묵으세요. 모든 열차가 두 역을 연결한다고 생각해 임의로 타지 않습니다." },
    { question: "아주 이르거나 늦은 시간인데 지하철이나 공항버스를 믿어도 되나요?", answer: "모든 시간대에 기대기는 어렵습니다. 지하철, 버스, 공항버스, 맞춤 관광 노선은 날짜에 따라 바뀌며 모두 밤새 운행하지는 않습니다. 여행일에 구이양 공식 교통 채널과 항공·열차 기록을 확인하고, 합법적인 택시·호출차 승차장과 호텔 프런트 운영, 짐 용량이 그 시간대에도 가능한지 확인하세요." },
    { question: "역 이동이 편하려면 구이양 어디에 묵는 게 좋을까요?", answer: "표에 적힌 거점에 맞춰 숙소 지역을 고르세요. 관산후와 북서부에 묵으면 구이양북역 이동이 대체로 단순하고, 난밍과 도심에서는 예약한 열차가 구이양역에 설 때 가장 편리하며 지하철 1호선으로 구이양북역에도 갈 수 있습니다. 항공편 전후에는 룽둥바오 인근이 편하고, 구이양동역은 여전히 별도의 도로 이동이 필요합니다." },
  ] },
