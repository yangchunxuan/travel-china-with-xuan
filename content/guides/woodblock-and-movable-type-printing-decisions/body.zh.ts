...
{"id":"links","type":"internal-links","title":"继续读工艺与证据","items":[{"label":"选择周城白族扎染作坊","href":"/zh/guides/zhoucheng-bai-tie-dye-workshop-choice/","description":"把原物、演示和游客体验的区分应用到另一项手工艺。"},{"label":"从里耶秦简读地方行政","href":"/zh/guides/liye-qin-slips-local-government-records/","description":"把印刷复制与更早的行政书写材料进行比较。"},{"label":"中国旅行需要导游吗","href":"/zh/guides/do-you-need-a-tour-guide-in-china/","description":"判断技术型博物馆何时值得专业讲解。"}, { label: "理解今天的大运河", href: "/zh/guides/grand-canal-everyday-urban-history/", description: "分清世界遗产、仍在运行的水道与今天的街区生活，再选择能看见三者关系的公共河段。" }, { label: "比较宣纸参观方式", href: "/zh/guides/jingxian-xuan-paper-museum-workshop-choice/", description: "按实际能看见或参与的工序，比较泾县宣纸博物馆、生产区域与短时体验，并说明真实性边界。" }]},
