...
{"id":"faq","type":"faq","title":"印刷史常见问题","items":[{"question":"活字印刷取代了中国的雕版印刷吗？","answer":"没有。活字出现后并没有简单淘汰雕版。雕版固定了一整页、可以保存后重印，而活字要重新拣字组版，需要庞大且可检索的字库、准确的排版和印后归字，所以两者长期并存。哪种更好，取决于文本、印数、劳动组织和机构条件。"},{"question":"为什么汉字没有让活字变得无用？","answer":"字符众多的文字系统让拣字、分类和储存成为繁重的操作任务，但陶活字、木活字和金属活字的长期历史证明它并非不可能。真正的比较是实际的组织成本与收益，而不是“字母文字必然成功、汉字必然失败”的神话。"},{"question":"什么情况下雕版比活字更有优势？","answer":"当一页稳定的版面会长期重印、文字与插图共用一块版面，或者短印数、专门印刷可以复用现成版片时。文本频繁修订、单个字可以替换重排时，活字往往更有帮助。"},{"question":"中国现在还在用木活字吗？","answer":"还在用。联合国教科文组织的保护名录记录了浙江瑞安的木活字印刷，用于编修和印刷宗谱，每页拆版后字模归位重复使用。它是通过家族传承的活态实践，不是冻结的中世纪作坊。"},{"question":"参观中国的印刷博物馆该看什么？","answer":"先辨认印刷面是整页雕版、单个活字、已排好的活字版还是后来的复制品；核对展品是原物、复原品还是可上手的教学设备；找一块反向的印刷面和它的正向印张对照；再找字盘或版片库，因为检索本身就是这项技术的一部分。"}]},
