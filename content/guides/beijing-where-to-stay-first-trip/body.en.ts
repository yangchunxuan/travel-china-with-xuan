...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      alt: "A real Beijing hutong hotel entrance showing the lane width, paving and distance from vehicle access.",
      width: 1440,
      height: 960,
      caption: "For a hutong stay, the useful photograph shows the approach to the actual door—not only the courtyard after check-in.",
    },
    {
      id: "map-traps",
      type: "heading",
    ...
    },
    {
      ...
      alt: "Travellers with luggage walking between a Beijing vehicle drop-off point and a hotel near Qianmen.",
      width: 1440,
      height: 960,
      caption: "A central map pin can still hide a pedestrian last mile, a major crossing or the wrong side of an attraction.",
    },
    {
      id: "arrival-station",
      type: "heading",
