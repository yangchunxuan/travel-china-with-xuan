...
const body = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "ordered": true,
      "items": [
        "PEK 또는 PKX, 실제 터미널과 항공편 번호가 적힌 일정 페이지를 보관하고 차량 배차에 중국어 공항명을 알리세요.",
        ...
        "베이징 북동쪽 또는 남쪽 이동, 터미널 내부 이동과 짐 운반을 각각 별도 시간으로 계산하세요.",
    ...
    },
    {
      ...
      "rows": [
        [
          ...
          "짐이나 이동 제약이 있으면 숙소에서 공항철도, 철도 환승과 터미널 도보를 따로 세세요. 베이징 환승 한 번을 줄이는 편이 낮은 운임보다 나을 수 있습니다.",
        ...
        [
          ...
          "항공편 뒤 열차라면 입국, 수하물, 터미널 출구와 지정 베이징역의 재입장을 넣은 뒤 표를 사세요.",
    ...
    },
    {
      ...
      "ordered": true,
      "items": [
        "항공사 일정에서 PEK 또는 PKX와 터미널을 읽어 현재 공항의 서비스 데스크에 보여 주세요.",
        "터미널 변경인지 완전히 다른 공항인지 먼저 구분하세요. 두 복구 방식은 다릅니다.",
        "수도공항과 다싱 사이 차량을 사기 전에 항공사가 제공하는 처리를 확인하세요.",
        "확인된 도착이 수하물 마감보다 충분히 빠를 때만 공항 횡단을 시도하세요.",
        "숙소나 철도 연결에 최종 공항을 알리고 살릴 수 없는 마감은 취소하세요.",
        "당일 항공편을 복구할 수 없으면 짐과 함께 올바른 공항에 남아 직원이 있는 숙박을 확보하세요."
      ]
    },
    {
      "id": "changes-heading",
