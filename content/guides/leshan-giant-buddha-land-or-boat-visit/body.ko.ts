...
{ id: "faq", type: "faq", title: "출발 전 자주 묻는 질문", items: [
  { question: "러산대불은 육로 관람과 낮 유람선 중 무엇이 좋나요?", answer: "사찰과 절벽길을 걷고 가까이에서 대불의 크기 변화를 느끼고 싶다면 육로 관람을 고르세요. 대불의 전신과 절벽·강이 이루는 전체 관계가 우선이라면 낮 유람선이 맞습니다. 두 방식은 입구와 이동, 표가 모두 따로이므로 예매하기 전에 어느 쪽인지 먼저 정하세요." },
  { question: "유람선은 산길 입장권에 포함되나요?", answer: "포함되지 않습니다. 공식 운영 자료는 산길 입장과 낮 수상 관광을 표와 승선 지점이 다른 별개 상품으로 설명하고, 두 구역 사이에는 지상 이동도 필요합니다. 실시간 공식 구매 페이지를 직접 읽으세요. 제3자 묶음 상품은 실제로 산 상품과 부두, 환불 규정을 가릴 수 있습니다." },
  { question: "대불 발치까지 내려갈 수 있나요?", answer: "대불 발치 관람 구역이 열리고, 일행 모두가 가파르고 좁은 계단과 그 뒤의 오르막을 감당할 수 있을 때만 가능합니다. 당일 계단 방향과 개방 여부, 귀환 흐름을 확인하세요. 보존과 관람객 분산 운영에 따라 달라지고, 일방 구간에서는 되돌아가지 못할 수 있습니다." },
  { question: "하루에 육로 관람과 낮 유람선을 모두 할 수 있나요?", answer: "하루를 온전히 쓸 수 있고 당일 운영을 확인한 뒤에만 넣으세요. 입장과 이동, 표가 각각 따로이므로 사이에 도로 이동과 표 수령, 대기, 식사·휴식 시간을 더하고, 귀로가 아직 살아 있을 때 두 번째 상품을 포기할 마지막 시각도 정해 두세요. 청두행 열차 시각이 고정된 짧은 방문이라면 한 방식만 고릅니다." },
  { question: "제 여행일에 유람선이 뜨지 않을 수도 있나요?", answer: "수위와 안개, 바람, 폭풍, 안전 통제, 부두 변경, 대기와 운항 중단이 모두 영향을 줍니다. 러산 공식 방문 자료는 출항 시각이 수위와 날씨에 따라 바뀔 수 있다고 밝히고, 정부 공지는 개별 부두나 횡단 상품이 중단될 수 있음을 보여 줍니다. 여행 당일 아침에 공식 포털과 위챗을 확인하고 부두에서 한 번 더 확인하세요." },
  { question: "야간 유람선도 낮 대불 관람 상품과 같은 건가요?", answer: "같지 않습니다. 이름이 비슷한 야간 유람이나 지역 도선은 낮 대불 관람 상품을 대신하지 않으므로, 예매한 것이 낮 강 유람인지 먼저 확인하세요. 정확한 상품명과 부두 이름을 중국어로 저장하고 예약 서류를 지니고, 그날이 수시 출발인지 고정 출발인지도 물어보세요." },
] },
