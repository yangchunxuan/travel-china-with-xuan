...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask about the Yunnan corridor", items: [
    { question: "In what order should I visit Kunming, Dali, Lijiang and Shangri-La?", answer: "Kunming → Dali → Lijiang → Shangri-La, or the reverse when flights and traveller readiness support it. That one-way corridor reduces geographical backtracking. It does not mean all four cities belong in one trip: give every stop a distinct job, test the higher-elevation extension separately, and cut a whole stop before reducing every place to a rushed check-in." },
    { question: "Is there a direct train from Lijiang to Shangri-La?", answer: "Yes. The National Railway Administration records the Lijiang–Shangri-La railway opening in November 2023, creating a direct rail link and a continuous Kunming–Dali–Lijiang–Shangri-La chain. Yunnan's transport authority describes the line climbing from Lijiang Station at about 2,400 metres to Shangri-La Station at about 3,274 metres. A rail link is not a timetable, so search exact dates in 12306." },
    { question: "Do I need to spend a night in Kunming?", answer: "Not necessarily. Kunming can stay an air and rail gateway rather than a rushed one-night sightseeing stop, if you have no Kunming priority and current transport permits a calm onward connection. If the international arrival is late or the group needs recovery, the Kunming night earns a practical role even without a full city programme." },
    { question: "Do I have to fly back out of Kunming at the end?", answer: "Return only when the same-city international flight is materially better. Coming back to Kunming repeats part of the corridor and needs enough time to justify it, while open-jaw endpoints can remove the return over the same ground, so compare flight price, baggage and reliability as a complete basket. Fix the arrival and departure airports before assigning city nights." },
    { question: "What should I plan for the first day in Shangri-La?", answer: "Keep it flexible and avoid attaching an irreplaceable activity to arrival. Identify a lower-elevation fallback and a credible exit before committing non-refundable northern bookings, and do not use one traveller's past response to predict another person's experience. Travellers with health concerns should seek appropriate professional advice; route order is not medical clearance." },
    { question: "Are Dali and Lijiang too similar to keep both?", answer: "Only when their planned experiences duplicate each other. Compare them by the activities you will actually do rather than treating both as generic old-town stays: Dali can be a slower base for lake, town and surrounding-area priorities, while Lijiang offers an old-town area choice, a regional base and the bridge to the northern corridor. If the plans still overlap, keep the stronger local priorities and remove one base." },
  ] },
