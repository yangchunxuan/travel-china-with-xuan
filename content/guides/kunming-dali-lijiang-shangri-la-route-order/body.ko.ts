...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "출발 전 자주 묻는 질문", items: [
    { question: "쿤밍, 다리, 리장, 샹그릴라를 어떤 순서로 가야 하나요?", answer: "쿤밍→다리→리장→샹그릴라의 한 방향 통로가 기본이고, 항공편과 여행자 상태가 맞으면 반대로 돌아도 됩니다. 이 순서는 지리적 역주행을 줄여 줄 뿐, 네 도시를 모두 한 여행에 넣으라는 뜻은 아닙니다. 지역마다 다른 역할을 주고 고지대 연장은 따로 검사하세요. 일정이 넘치면 모든 곳을 짧게 줄이지 말고 도시 하나를 통째로 빼는 편이 낫습니다." },
