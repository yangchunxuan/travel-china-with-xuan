...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  {"id": "arranged-transport-heading", "type": "heading", "level": 2, "text": "Train or private vehicle for a three-city trip?"},
  {"id": "arranged-transport-context", "type": "paragraph", "text": "In Homeground’s 6-day Shanghai–Suzhou–Hangzhou route, transport is arranged around the party rather than assumed to be one car throughout. It travels via an overnight in Suzhou and finishes in Hangzhou; it is not a direct Shanghai–Hangzhou day trip."},
  {"id": "arranged-transport-options", "type": "table", "caption": "Usual transport on the six-day route; confirm for your party and luggage", "columns": ["Party size", "Usual intercity arrangement", "Practical benefit"], "rows": [["2–3 travellers", "High-speed rail with private transfers at both ends", "The station-to-hotel connections are part of the plan, so you do not have to piece them together separately."], ["4–9 travellers", "A suitable licensed vehicle for door-to-door intercity travel", "Usually removes station changes and carrying cases onto a train; the vehicle must fit the actual party and luggage."]]},
  {"id": "arranged-transport-scope", "type": "paragraph", "text": "Confirm the transport version, full station names where relevant and luggage capacity in the written itinerary. A private tour does not mean a porter service or a vehicle on standby at all hours. If you need to finish at a Shanghai airport, that return lies outside this route’s standard Hangzhou departure."},
  {"id": "arranged-transport-product", "type": "internal-links", "title": "See the complete three-city arrangement", "items": [{"label": "6-day Shanghai–Suzhou–Hangzhou private tour", "href": "/tours/shanghai-suzhou-hangzhou-6-day-private-tour/", "description": "Compare the included transfers, hotel nights and touring days alongside the transport choice."}]},
