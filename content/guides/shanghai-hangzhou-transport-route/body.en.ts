...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "Search more than one station pair, then compare the doors", tone: "decision", body: "Shanghai Hongqiao often deserves the first check for a Hongqiao airport or west-side start. Shanghai Station or Shanghai South can be better for other city addresses when a usable direct train exists. In Hangzhou, compare East and West only through live inventory and the exact final address." },
  { id: "matrix-heading", type: "heading", level: 2, text: "A route is a pair, not two city names" },
  { id: "matrix", type: "table", caption: "The shortest train may carry the longest access legs", columns: ["Station choice", "Good fit", "Friction", "Verify"], rows: [
    ...
    ["Hangzhou East or West", "One has a better hotel/attraction last mile on your date", "Large station exits and very different urban positions", "Arrival station, exit, last metro and hotel route"],
  ]},
  ...
  { id: "clock-heading", type: "heading", level: 2, text: "Build one complete clock" },
  ...
  { id: "facts", type: "callout", title: "Dynamic transport facts checked August 12, 2026", tone: "neutral", body: "Shanghai's official guide currently distinguishes Shanghai, Shanghai South, Shanghai Hongqiao and other stations with different metro access. The Yangtze Delta timetable changed in January 2026, demonstrating why train calls must be checked on 12306. Inventory, fares and urban last services remain date-specific." },
  { id: "help", type: "callout", title: "Need the station pair checked against both hotels?", tone: "decision", body: "Send the date, Shanghai start, Hangzhou address, people, luggage and fixed flight or event. Homeground can compare the complete clock and recovery plan; live rail inventory stays with 12306." },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    ...
    { label: "Hero: Hangzhou East by Staeiou, CC BY-SA 4.0; cropped", url: "https://commons.wikimedia.org/wiki/File:Hangzhou_East_railway_station_interior.jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-12" },
  ]},
