...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "matrix", type: "table", caption: "The shortest train may carry the longest access legs", columns: ["Station choice", "Good fit", "Friction", "Verify"], rows: [
    ...
    ["Hangzhou East, Hangzhou Station or Hangzhou West", "One has a better hotel or attraction last mile and a usable dated train", "Large station exits, different urban positions and date-specific rail inventory", "Full arrival station, exit, current local connection and hotel route"],
  ]},
