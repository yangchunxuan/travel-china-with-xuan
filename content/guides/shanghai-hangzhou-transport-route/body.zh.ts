...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "搜索多个车站组合，再比较两扇门", tone: "decision", body: "从虹桥机场或上海西侧出发，通常先查上海虹桥；其他市区地址若有合适直达车，上海站或上海南站可能更好。杭州端只通过实时余票和最终地址比较杭州东与杭州西。" },
  ...
  { id: "matrix", type: "table", caption: "最短列车可能带来最长首尾接驳", columns: ["车站选择", "合适", "摩擦", "核对"], rows: [
    ...
    ["杭州东或杭州西", "其中一站到酒店/景点最后一段更好", "大站出口与完全不同的市内位置", "到达站、出口、末班地铁与酒店路线"],
  ]},
  ...
  { id: "facts", type: "callout", title: "动态交通信息核验于2026年8月12日", tone: "neutral", body: "上海官方指引目前区分上海站、上海南、上海虹桥及其他车站，各自地铁接入不同。长三角运行图在2026年1月调整，说明停站必须在12306核对。余票、票价与市内末班均按日期变化。" },
  ...
  { id: "sources", type: "sources", title: "官方来源与图片署名", items: [
    ...
    { label: "首图：Staeiou拍摄杭州东站，CC BY-SA 4.0，已裁切", url: "https://commons.wikimedia.org/wiki/File:Hangzhou_East_railway_station_interior.jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-12" },
  ]},
