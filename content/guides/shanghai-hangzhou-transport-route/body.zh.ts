...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  {"id":"faq","type":"faq","title":"车站与购票常见问题","items":[{"question":"去杭州应该从上海哪个车站出发？","answer":"看你从哪里出发。从虹桥机场或上海西侧出发，通常先查上海虹桥；其他市区地址，当天有合适直达车时，上海站或上海南站可能更好。只比较12306当天实际给出的站点组合，叫车前从票面读出完整的中英文车站名。"},{"question":"应该到杭州哪个车站？","answer":"按准确日期分别查杭州东、杭州站、杭州南和杭州西。杭州当前铁路信息把它们列为位置不同的独立客站，所以由酒店或景点的最后一段来定，再核对完整到达站名、出口和当前的市内接驳与酒店路线。"},{"question":"可以从上海当天往返杭州吗？","answer":"可以，但要先设计返程再买去程。先定下离开杭州景点的时间，再加上公路或地铁的波动、正确的车站入口、安检和登车。后一班列车只有确实到达一个还能继续回酒店或机场的上海车站，才算有效备选；否则留宿杭州更合理。"},{"question":"落地浦东机场，能在机场直接坐去杭州的火车吗？","answer":"不能。虹桥火车站不在浦东机场里。浦东落地后，入境、行李和前往上海铁路站的时间都要留够。就算走虹桥，航站楼、铁路站厅和另一张独立车票也各自需要缓冲，不要安排很紧的空铁衔接。"},{"question":"到了错误的上海车站怎么办？","answer":"先别急着穿城赶站。先用官方渠道查退改和余票，再和穿城所需时间比较。如果原车次完全搜不到，就按日期和车站组合重新查12306，因为运行图会调整。进站前再确认一次票面完整站名和入口。"},{"question":"很晚才到杭州，需要先确认什么？","answer":"按到酒店的最后一段选车站，不是按车程最短选。末班地铁要按线路和方向单独核对，并把官方出租车队列和酒店接待留作备选。晚到还要先确认酒店接待和最后一段交通，再把这一天定下来。"}]},
