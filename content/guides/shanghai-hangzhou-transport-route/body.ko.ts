...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "여러 역 조합을 검색하고 양쪽 문을 비교", tone: "decision", body: "홍차오공항이나 상하이 서부에서 시작하면 상하이홍차오를 먼저 본다. 다른 시내 주소에는 쓸 수 있는 직통편이 있을 때 상하이역이나 상하이남역이 나을 수 있다. 항저우에서는 날짜별로 항저우동·항저우역·항저우서와 그 밖의 표에 표시된 터미널을 검색한 뒤, 한 곳을 도시 전체의 기본역으로 가정하지 말고 최종 주소까지 비교한다." },
  ...
  { id: "matrix", type: "table", caption: "가장 짧은 열차에 가장 긴 접근이 붙을 수 있다", columns: ["역 선택", "잘 맞음", "부담", "확인"], rows: [
    ...
    ["항저우동·항저우역·항저우서", "해당 날짜 열차가 있고 한 역의 호텔/관광지 마지막 구간이 더 좋음", "큰 역 출구, 서로 다른 시내 위치와 날짜별 좌석", "전체 도착역명, 출구, 현재 시내 연결편과 호텔 노선"],
  ]},
  ...
  { id: "facts", type: "callout", title: "동적 교통 정보 확인일: 2026년 8월 12일", tone: "neutral", body: "상하이 공식 안내는 상하이역, 상하이남역, 상하이홍차오역과 다른 역을 서로 다른 지하철 접근 지점으로 구분한다. 현재 항저우 철도 안내도 항저우역·항저우동역·항저우남역·항저우서역을 별도 여객역으로 안내하며 표에 적힌 역과 열차를 12306에서 확인하도록 한다. 좌석, 요금과 시내 마지막 교통은 날짜별로 달라진다." },
