...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Puzhehei questions before you book", items: [
    { question: "Is the lotus in bloom at Puzhehei right now?", answer: "This guide publishes no bloom date. Treat the question as four separate checks: broad seasonal context, recent flower updates for this year, current official notices, and the weather warnings and actual access on your travel day. Use the first two as context only, and build the day around the latest notice and the operator's same-day confirmation." },
    { question: "Do I need to reserve the boat and Qinglong Hill in advance?", answer: "Yes, both. Boat boarding times can be reserved through the operator's official mini-programme, and after booking you arrive on time at the matching wharf to have the ticket checked. Qinglong Hill also needs a free advance reservation through the mini-programme, and a successful reservation lets you climb when the entrance is open that day. Reserving does not decide whether a route runs." },
    { question: "What kinds of boat trip does Puzhehei have?", answer: "There are several, and the operator's own list shows they are not interchangeable. The East line uses a willow-leaf small boat, the Middle line a covered pleasure boat and the West line a bamboo raft. Water-village visiting uses a black-awning or oar boat through the village waterways, the night tour is a separate evening product, and Swan Lake is entry rather than a line, ticketed separately." },
    { question: "Will I get wet on the boat in summer?", answer: "Possibly. Summer at Puzhehei includes organised water-splashing, and the operator publishes etiquette for it: do not splash the elderly, children, crew or anyone who does not want to be splashed, and do not use the boat's oars for water fights. Bring a change of clothes and waterproof your electronics; damp, falling in and loss are the visitor's own responsibility." },
    { question: "What can I do if the boat route is suspended?", answer: "Use only the land access the operator says is open, rather than waiting at a wharf for a suspended route. Qinglong Hill is a useful land alternative when its entrance is open, and the reservation is free. The shuttle network reaches the lake's north, west, east and south entrances and a number of shore points. The night tour is not an automatic rain fallback." },
    { question: "Can my elderly parents or young children go on the boat?", answer: "The operator requires elderly visitors and children to be accompanied by an adult, warns that boarding and alighting can be slippery, and says anyone unwell should not board. If someone in your group is uncomfortable with those conditions, choose a land-based visit instead, and only when the operator confirms that the relevant shore or hill access is open." },
  ] },
