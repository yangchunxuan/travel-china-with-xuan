...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "플러그·전압 자주 묻는 질문", items: [
    { question: "중국의 전압과 플러그 타입은 무엇인가요?", answer: "중국 본토는 220V, 50Hz입니다. 상하이 정부 안내는 A·C·I형 플러그를 들고 있고 호텔에는 다용도 소켓이나 USB 콘센트가 흔하지만, 특정 호텔 소켓 하나에 기대어 계획하지는 마세요." },
    { question: "중국에 갈 때 변압기가 필요한가요?", answer: "INPUT 표시에 110V 또는 120V만 적힌 기기에만 필요합니다. 100–240V, 50/60Hz라고 적힌 충전기는 중국 전압을 그대로 받으므로 플러그 모양 어댑터만 있으면 되고, 플러그 어댑터는 전압을 낮추지 못합니다." },
    { question: "내 휴대전화나 노트북 충전기가 중국에서 작동하나요?", answer: "최신 휴대전화·태블릿·카메라·노트북 충전기는 대부분 100–240V 광역 입력이라 플러그 어댑터만으로 씁니다. 충전기마다 INPUT 줄을 읽어 확인하고, 읽을 수 있는 표시가 없으면 추측하지 말고 제조사에 정확한 모델을 확인하세요." },
    { question: "싱가포르나 말레이시아의 Type G 플러그를 가져가도 되나요?", answer: "네. 직사각형 핀 세 개짜리 Type G를 받으면서 사용할 본토 소켓에 맞는 어댑터를 준비하세요. 충전기 INPUT이 220V를 포함하면 모양 어댑터로 충분하며, 필요한 접지를 유지하고 어댑터 정격을 넘기지 말고 핀을 억지로 끼우지 마세요." },
    { question: "헤어드라이어나 고데기를 중국에서 쓸 수 있나요?", answer: "확인된 듀얼 전압 모델이나 호텔 비품을 우선하세요. 110V 전용 고출력 기기는 실제 소비 전력보다 높은 정격의 변압기가 필요하며, 한 번의 여행이라면 변압기를 들고 다니기보다 기기를 바꾸는 편이 더 깔끔한 경우가 많습니다." },
  ] },
