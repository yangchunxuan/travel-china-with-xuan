...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask before visiting Yuanyang", items: [
    { question: "Which Yuanyang viewpoint is best for sunrise?", answer: "Duoyishu is the sunrise-oriented choice. It suits an eastern-side sunrise attempt, steep terrace geometry and a direct relationship with nearby villages. The cost is very early mountain-road travel, darkness, fog and concentrated arrival, so ask the current site management about the entrance, ticket and safe drop-off the previous day." },
    { question: "Can I see Duoyishu, Bada and Laohuzui in one day?", answer: "Not in one rushed loop. To compare terrace form, pair Duoyishu with Bada, or Laohuzui with one village, after confirming which roads and entrances are in use. Laohuzui sits on a separate southern or western road, so treat it as a deliberate alternative rather than an automatic add-on, and do not bolt it on only to collect another famous name." },
    { question: "Will the terraces be filled with water and reflective when I go?", answer: "Sometimes, but treat it as a condition rather than a fixed feature. Colour depends on sky, water and season. When the fields are not reflective or blue, read crops, channels, villages and contour instead, and work from the agricultural season actually present rather than an edited colour or another season." },
    { question: "Should I stay in Nansha or up near the terraces?", answer: "Choose from your first viewpoint and arrival time. For an early viewpoint, an upper-area hotel or homestay near the chosen road can be more useful than sleeping in Nansha. Confirm legal registration, vehicle access, luggage handling and the exact Chinese address before booking." },
    { question: "What should I do if it is foggy at sunrise?", answer: "Wait only inside the managed safe area. If visibility remains poor, return for breakfast and use a public village or interpretation visit instead. Do not race to another viewpoint on dark, wet bends, and do not infer from one phone image that another valley is clear." },
    { question: "Can I walk into the terraces and the villages to take photos?", answer: "Not into the fields. Do not step onto narrow terrace ridges or irrigation channels for composition, because they carry crops, water and workers. In a village, enter through the current public visitor route, ticket point or local guide system, follow signs, and ask before photographing a person, doorway activity, ceremony, child, meal or interior; a general scenic ticket is not consent." },
  ] },
