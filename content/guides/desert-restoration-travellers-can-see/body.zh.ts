...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "table",
      caption: "Homeground 公众观察剖面：从看得见的现象走到仍需证据的结论",
      columns: ["剖面区段", "从合法观察点能看到什么", "可支持的问题", "不能证明什么"],
      rows: [
        ["上风向开放地表", "地表、流沙迹象、受风情况和现有植被", "什么压力可能抵达被保护边缘？", "历史基线或全年输沙量"],
        ["草方格带", "方格朝向、状态、补铺和截留物", "这里是否在减缓近地表风沙？", "长期生态恢复"],
        ["植被或防护林", "物种组合、密度、缺口、死株和灌溉痕迹", "下风向保护什么，能看到哪些维护？", "成活率、地下水平衡或场外影响"],
        ["光伏足迹", "组件、运维道路、沙障和管理地表", "发电以外配套了哪些治理措施？", "光伏板单独修复了场地"],
        ["围栏或作业边界", "标牌、门禁、工作人员指引和指定公众路线", "公众观察在哪里结束？", "可以进入、飞无人机或检查设备"],
      ],
    },
    {
      id: "access-boundary",
