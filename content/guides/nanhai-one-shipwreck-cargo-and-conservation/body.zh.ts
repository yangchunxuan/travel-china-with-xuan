...
{"id":"links","type":"internal-links","title":"继续读物质证据","items":[{"label":"青铜礼器与铭文怎么看","href":"/zh/guides/ritual-bronze-vessels-and-inscriptions/","description":"在博物馆器物中同时使用形制、语境和文字。"},{"label":"从里耶秦简读地方行政","href":"/zh/guides/liye-qin-slips-local-government-records/","description":"把行政档案与沉船考古组合进行比较。"},{"label":"你的中国行程是不是太赶","href":"/zh/guides/is-your-china-itinerary-too-rushed/","description":"检查专题博物馆绕行是否有足够时间才值得。"}, { label: "在考古遗址博物馆使用一条完整证据链", href: "/zh/guides/how-to-visit-an-archaeological-site-museum/", description: "把发掘语境、保护、器物标签和复原连起来，再判断一处沉船展陈能支持多大的历史结论。" }, { label: "从沉船到自动化港口追踪中国海运货物", href: "/zh/guides/yangshan-automated-port-explained/", description: "比较历史沉船与现代运营系统中货物如何被记录、移动和保护，但不混用两类证据。" }, { label: "按证据层读湄洲妈祖祖庙", href: "/zh/guides/meizhou-mazu-ancestral-temple-reading-guide/", description: "从海洋物质史转向一处活态海洋文化机构，同时分开信俗、建筑沿革与旅游展示。" }]},
