...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Robotaxi questions answered", items: [
    { question: "Can tourists ride a robotaxi in China?", answer: "Sometimes, but only inside a locally approved combination of city, operator, operating zone, time window and pilot stage. Treat it as usable only when the operator's current passenger channel accepts your exact pickup and destination for the date and time, you can complete its account, contact and payment steps, and a normal taxi or metro remains available as a fallback." },
    { question: "Are Chinese robotaxis fully driverless?", answer: "Not all of them. Under the national transport safety guide, a robotaxi classified as conditional or highly automated must carry one safety operator; a fully automated robotaxi may use remote safety operators only with the relevant city government's approval for a designated area." },
    { question: "Can a robotaxi take me anywhere in the city?", answer: "No. China's transport ministry requires autonomous-vehicle passenger operations to stay within approved service areas, and local authorities approve specific routes, zones and operating hours. A vehicle can be legal on one side of a district boundary and not the other, and a road opened for testing may have no public passenger service at all." },
    { question: "Which Chinese cities have paid driverless robotaxi services?", answer: "Availability is local and dated. As one example, on 5 August 2025 Shanghai's official English portal reported public, paid driverless ride-hailing by Pony.ai and Jinjiang in designated parts of Jinqiao and Huamu, bookable through Pony.ai's WeChat mini-program; that is not evidence of citywide access. Recheck the city authority and operator on the travel day." },
    { question: "Should I rely on a robotaxi to reach the airport or a train?", answer: "No. Do not make a pilot service the critical link to an airport, last train, timed ticket or late-night hotel arrival, especially with children, a wheelchair, several suitcases or a language barrier. A social-media airport ride may be a road test or media demonstration rather than normal passenger operation." },
  ] },
