...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  {id: "stages", type: "comparison", title: "도로 상태와 승객 이용 가능 여부를 구분하세요", columns: [
    {heading: "도로시험 또는 시범 적용", items: ["국가 규정상 지정 도로에서 이루어지는 시험 또는 시범 활동입니다.", "시범 과정에서 사람을 태울 수는 있지만, 그 명칭만으로 일반 택시처럼 누구나 이용할 수 있는 것은 아닙니다.", "실제 이용 가능 여부는 지방 규정과 사업자의 현재 승객 채널이 정합니다."]},
  ...
  {id: "safety-details", type: "paragraph", text: "국가 운송 안전 지침에 따르면 조건부 자율주행 또는 고도 자율주행 로보택시에는 안전운행요원 1명이 반드시 탑승해야 합니다. 완전 자율주행 로보택시는 해당 도시 정부가 지정 구역 운행을 승인한 경우에만 원격 안전운행요원으로 대체할 수 있으며, 원격 요원 1명이 동시에 맡을 수 있는 차량은 최대 3대입니다. 따라서 운전석이 비어 있다고 해서 차량이 감독받지 않는 것도, 당신을 태울 수 있도록 승인된 것도 아닙니다."},
  {id: "scenario-one", type: "callout", title: "실제 교통수단으로 고려해도 되는 경우", body: "사업자의 현재 승객 채널이 필요한 날짜와 시간에 정확한 출발지와 목적지를 받아들이고, 계정·연락처·결제 절차를 완료할 수 있을 때만 이용 가능한 수단으로 보세요. 호출이 취소되거나 운행 구역 경계에서 끝날 경우를 대비해 일반 택시나 지하철도 남겨 두어야 합니다. 길에서 로고가 붙은 차량을 봤다는 사실은 이 조건 가운데 어느 것도 증명하지 않습니다.", tone: "decision"},
  ...
  {id: "ride-checks", type: "list", ordered: true, items: [
    "사업자의 현재 승객 채널에서 사업자명, 승차 지점, 목적지, 안내된 운행 시간과 구역의 끝점을 확인합니다.",
  ...
  {id: "sources", type: "sources", title: "공식 및 독립 자료", items: [
    ...
    {label: "특정 구역·시간대 상업 시범 정책 해설", url: "https://big5.mot.gov.cn/gate/big5/www.mot.gov.cn/gongkai/zcjd/202512/t20251226_4191175.html", publisher: "중국 교통운수부", reviewedAt: "2026-08-13"},
