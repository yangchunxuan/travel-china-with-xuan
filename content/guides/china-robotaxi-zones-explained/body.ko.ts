...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "로보택시 자주 묻는 질문", items: [
    { question: "여행자도 중국에서 로보택시를 탈 수 있나요?", answer: "가능할 때도 있지만, 지역에서 승인한 도시·사업자·운행 구역·시간대·시범 단계의 조합 안에서만 그렇습니다. 사업자의 현재 승객 채널이 해당 날짜와 시간에 정확한 승하차 지점을 받아 주고, 계정·연락처·결제 단계를 마칠 수 있으며, 취소될 때 일반 택시나 지하철이 남아 있을 때만 이용 가능한 교통수단으로 보세요." },
    { question: "중국 로보택시는 완전히 무인인가요?", answer: "모두 그렇지는 않습니다. 국가 교통 안전 지침에 따르면 조건부 또는 고도 자동화로 분류된 로보택시에는 안전운행요원 한 명이 타야 하고, 완전 자동화 로보택시는 해당 시 정부가 지정 구역에 승인했을 때만 원격 안전운행요원으로 대신할 수 있습니다." },
    { question: "로보택시로 도시 어디든 갈 수 있나요?", answer: "아닙니다. 중국 교통운수부는 자율주행 승객 운행이 승인된 서비스 구역 안에 머물도록 요구하고, 지방 당국이 구체적인 노선·구역·운행 시간을 승인합니다. 차량이 구 경계의 한쪽에서는 합법이고 다른 쪽에서는 아닐 수 있으며, 시험 운행이 허용된 도로에 공개 승객 서비스가 전혀 없을 수도 있습니다." },
    { question: "중국의 어느 도시에 유료 무인 로보택시가 있나요?", answer: "이용 가능 여부는 지역별이며 날짜가 붙습니다. 한 예로 2025년 8월 5일 상하이 공식 영문 포털은 진차오와 화무의 지정 구역에서 Pony.ai와 진장이 공개 유료 무인 호출 서비스를 운영하며 Pony.ai 위챗 미니프로그램으로 예약한다고 보도했지만, 이는 도시 전역에서 이용 가능하다는 증거가 아닙니다. 여행 당일 시 당국과 사업자에게 다시 확인하세요." },
    { question: "공항이나 열차에 가는 데 로보택시에 의존해도 될까요?", answer: "안 됩니다. 시범 서비스를 공항, 막차, 시간 지정 입장권, 심야 호텔 도착의 핵심 연결로 삼지 마세요. 어린이, 휠체어, 여러 개의 짐, 언어 장벽이 있을 때는 더욱 그렇습니다. 소셜 미디어의 공항 탑승 영상은 정상 승객 운행이 아니라 도로 시험이나 언론 시연일 수 있습니다." },
  ] },
