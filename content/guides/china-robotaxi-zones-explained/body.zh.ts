...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "无人驾驶出租车常见问题", items: [
    { question: "游客能在中国坐无人驾驶出租车吗？", answer: "有时可以，但只限于当地批准的城市、运营企业、运营区、服务时段和试点阶段的组合之内。只有当运营方当前的乘客渠道接受你在该日期和时间的准确上下车点、你能完成账户、联系方式和支付步骤，而且普通出租车或地铁仍可作为备选时，才把它当作可用的交通方式。" },
    { question: "中国的无人驾驶出租车真的没有人监管吗？", answer: "不全是。按国家运输安全指南，被归为有条件自动驾驶或高度自动驾驶的车辆必须配一名安全员；完全自动驾驶的车辆只有在相关城市政府批准的指定区域内，才可改用远程安全员。" },
    { question: "无人驾驶出租车能送我到全城任何地方吗？", answer: "不能。交通运输部要求自动驾驶载客运营留在批准的服务区内，地方政府再批准具体线路、区域和运营时段。一辆车可能在区界一侧合法、另一侧不合法；一条开放测试的道路也可能完全没有面向公众的载客服务。" },
    { question: "中国哪些城市有付费的无人驾驶出租车？", answer: "可用性是地方性的、有日期的。举一个例子：2025 年 8 月 5 日，上海官方英文门户报道小马智行与锦江在金桥、花木的指定区域提供公开收费的无人驾驶网约车，可通过小马智行微信小程序预约；这不代表全市可用。出行当天请重新核对城市主管部门和运营企业的信息。" },
    { question: "可以靠无人驾驶出租车赶飞机或火车吗？", answer: "不可以。不要把试点服务当作去机场、赶末班车、定时门票或深夜抵达酒店的关键环节，带小孩、轮椅、多件行李或有语言障碍时尤其如此。社交媒体上的机场乘车视频可能只是道路测试或媒体演示，而不是正常的载客运营。" },
  ] },
