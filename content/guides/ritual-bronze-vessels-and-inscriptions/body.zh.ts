...
{"id":"links","type":"internal-links","title":"继续用证据读遗产","items":[{"label":"从语境理解红山玉器","href":"/zh/guides/hongshan-jade-context-and-symbols/","description":"比较形制与出土语境怎样支持史前解释。"},{"label":"从里耶秦简读地方行政","href":"/zh/guides/liye-qin-slips-local-government-records/","description":"从一件古代文字器物进入一批行政档案。"},{"label":"兵马俑自由行指南","href":"/zh/guides/terracotta-warriors-without-tour/","description":"在大型考古遗址应用证据优先的观看方法。"}, { label: "读懂悟空与哪吒的改编", href: "/zh/guides/wukong-nezha-games-animation-myth-guide/", description: "在游戏、动画与旅行场景中遇见悟空或哪吒时，区分具名文献、信仰实践、表演传统与现代创作选择。" }, { label: "建立西夏证据三角", href: "/zh/guides/xixia-script-and-imperial-tombs-context/", description: "用三层证据读懂西夏陵，区分铭文、出土物、陵区规划能够确认的内容，以及墓主人和建筑用途等仍属推断的问题。" }, { label: "参观考古遗址博物馆时，不要过度解读一件器物", href: "/zh/guides/how-to-visit-an-archaeological-site-museum/", description: "把出土来源、地层、复原情况和标签确定度记录清楚，再用青铜器或铭文支持结论。" }]},
