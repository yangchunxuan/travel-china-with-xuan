...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask about power banks", items: [
    { question: "Can I put a power bank in my checked bag in China?", answer: "No. On a China domestic flight the power bank must travel in carry-on or on your person, never in checked baggage. Do not put it into a bag that might be gate-checked, and remove it before handing over any cabin bag: a gate tag does not change the checked-baggage prohibition." },
    { question: "My power bank says 20,000mAh. Is that within the limit?", answer: "At a nominal 3.7V that works out to 74Wh, which is under the railway's 100Wh ceiling and inside aviation's band that needs no airline approval. The official formula is Wh = V × Ah, and Ah = mAh ÷ 1,000. This is an arithmetic example, not an acceptance certificate: the unit still needs a readable label, no recall and an intact case." },
    { question: "What is the CCC mark, and is a CE or FCC logo the same thing?", answer: "They are not the same mark. CCC is the China Compulsory Certification mark; a CE, FCC, airline icon or recycle symbol is not it. From 28 June 2025, domestic flights prohibit units without a CCC mark, with an unclear CCC mark, or from recalled models or batches. Security needs the original product marking." },
    { question: "Can I take a power bank on a Chinese high-speed train?", answer: "Yes, if the marking is clear and the rated energy is no more than 100Wh. Keep it protected and easy to show at security, follow the onboard safety instructions, and stop using any unit that becomes hot, swollen, damaged or smells unusual. Clearing train security does not prove it will clear airport security, where the domestic-flight CCC rule also applies." },
    { question: "Can I use my power bank to charge my phone during the flight?", answer: "Not in flight. Do not use the power bank to charge devices during the flight, and keep its switch off throughout when it has one. Carry an intact cable and charge your devices before boarding so the plan does not depend on using the power bank in the air." },
    { question: "Security refused my power bank. What now?", answer: "Accept the instruction and ask whether the airport has an official surrender or storage route. CAAC asked airports to provide appropriate voluntary-disposal or temporary-storage areas, but whether a given airport offers one, and its eligibility, hours, fees and collection procedure, is airport-specific. When departure is close, protecting the flight matters more than an unofficial courier or leaving the unit with a stranger." },
  ] },
