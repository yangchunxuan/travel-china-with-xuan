...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "보조배터리 자주 묻는 질문", items: [
    { question: "보조배터리를 위탁수하물에 넣어도 되나요?", answer: "안 됩니다. 중국 국내선에서는 보조배터리를 기내 수하물에 넣거나 몸에 지녀야 하고 위탁수하물은 금지입니다. 탑승구에서 위탁될 수 있는 가방에도 넣지 말고, 가방을 넘기기 전에 먼저 꺼내세요. 탑승구에서 붙이는 위탁 표가 위탁 금지 규정을 바꾸지는 않습니다." },
    { question: "본체에 20,000mAh라고 적혀 있으면 한도 안인가요?", answer: "정격 3.7V 기준이면 74Wh이고, 철도의 100Wh 한도 아래이며 항공에서도 항공사 승인이 필요 없는 구간에 들어갑니다. 계산식은 Wh = V × Ah, Ah = mAh ÷ 1,000입니다. 다만 이는 계산 예시일 뿐 승인 증서가 아니므로 표시가 선명하고 리콜 대상이 아니며 케이스가 손상되지 않아야 합니다." },
    ...
    { question: "중국 고속열차에 보조배터리를 가지고 탈 수 있나요?", answer: "됩니다. 표시가 선명하고 정격 에너지가 100Wh 이하이면 가지고 탈 수 있습니다. 보안검색 때 바로 보여 줄 수 있게 보호해 보관하고 차내 안전 안내를 따르며, 발열·팽창·파손·이상 냄새가 있으면 사용을 중지하세요. 열차 보안검색을 통과했다고 공항에서도 통과하는 것은 아니고, 국내선에는 CCC 조건도 적용됩니다." },
    { question: "비행 중에 보조배터리로 휴대전화를 충전해도 되나요?", answer: "비행 중에는 안 됩니다. 보조배터리로 기기를 충전하지 말고 스위치가 있으면 계속 꺼 두세요. 정상 케이블을 준비하고 탑승 전에 기기를 충전해 두면 비행 중 보조배터리에 의존하지 않아도 됩니다." },
    { question: "보안검색에서 보조배터리를 거부당하면 어떻게 하나요?", answer: "현장 지시에 따르고 공항에 공식 포기나 임시 보관 방법이 있는지 물어보세요. CAAC는 공항이 여건에 따라 자진 폐기나 임시 보관 장소를 마련하도록 했지만, 제공 여부와 조건, 시간, 비용, 회수 절차는 공항마다 다릅니다. 출발이 임박했다면 비공식 택배를 찾거나 낯선 사람에게 맡기기보다 항공편을 지키는 편이 낫습니다." },
  ] },
