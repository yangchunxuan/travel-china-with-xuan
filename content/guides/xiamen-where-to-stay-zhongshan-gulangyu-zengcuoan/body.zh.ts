...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "订房前常见问题", items: [
    { question: "中山路、鼓浪屿、曾厝垵，到底该订哪一个？", answer: "第一次来厦门、行程混合、希望本岛灵活又进出简单，就订中山路。愿意为安静的岛上清晨和夜晚去订对轮渡、轻装步行、接受车辆受限，才值得在鼓浪屿住一晚。海岸散步和慢节奏街区会反复出现时选曾厝垵；如果每天都从铁路枢纽或轮渡码头开始，就别住那里。" },
    { question: "为了一晚鼓浪屿，折腾轮渡和行李值得吗？", answer: "要看你会不会真的用上岛上的时间。打算认真走一趟清晨、留一段安静的夜晚，或者把参观拆成两段，才值得过夜。如果午后才上岛，入住、吃饭，第二天一早就走，轮渡和行李多半会把这点好处抵消掉。真要住，就准备一只岛上过夜包、一条从码头到住处的路线，再留一个天气备选。" },
    { question: "带着大行李箱或婴儿车，还能住鼓浪屿吗？", answer: "先让酒店把整条路线说清楚，再决定订不订。鼓浪屿靠步行，不像本岛酒店区那样车能开到门口，所以要问码头路面、坡度、台阶、门宽和电梯，一直问到房间。厦门官方资料提到三丘田、内厝澳设有行李揽收点，岛内也有配送点，但当前的服务时段、适用对象和送达范围仍需确认。" },
    { question: "去鼓浪屿该订哪一班轮渡？", answer: "按你的日期和旅客类型订官方游客航线。厦门港的官方航线表把游客航线和居民航线、本岛的几个码头和鼓浪屿的不同码头都分开了，照抄本地人的走法或旧时刻表基本会订错。用你到码头时会带的那本有效护照订票，并把本岛出发码头和岛上到达码头的中文名都存下来。" },
    { question: "住曾厝垵，走路就能到能游泳的海滩吗？", answer: "不一定，要从那家酒店的大堂问清楚“靠海”指什么：过几条马路、能不能走到公共岸线、下不下得了沙滩、当天能不能游泳，是四个不同的问题。东南海岸、街巷和慢节奏的夜晚会反复出现，住这里才合适。也要看道路拥堵、下客点、房间噪音，以及去轮渡、火车站和赶早班车的整段路程。" },
    { question: "赶早班飞机或火车，最后一晚住哪里？", answer: "住本岛、车能开到门口的酒店。厦门站和厦门北站不是同一个站，要按票面全名和你订单上的航站楼来安排。如果轮渡的不确定会威胁到这趟火车或航班，就提前一天从岛上搬回本岛，别把固定的出发押在某一班船上。" },
  ] },
