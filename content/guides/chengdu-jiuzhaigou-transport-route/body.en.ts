...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "links", type: "internal-links", title: "Continue planning", items: [ { label: "Chengdu destination hub", href: "/destinations/chengdu/", description: "Decide the city days, the base and which Sichuan trips are separate branches." },
