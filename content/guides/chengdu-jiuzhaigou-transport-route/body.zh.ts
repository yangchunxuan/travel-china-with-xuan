...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "前往九寨沟常见问题", items: [
    { question: "从成都坐火车能直接到九寨沟景区吗？", answer: "不能。黄龙九寨是火车站，不是景区门口。计划里要分开保存三个定位：火车站、九寨沟住宿，以及将要使用的景区入口。能到其中一个地点的接驳票，不一定能到另外两个。" },
    { question: "从黄龙九寨站怎么去景区？", answer: "要提前预订后续接驳。九寨沟管理局 2026 年 7 月公告要求通过“九旅悦行”提前购买黄龙九寨站接驳，并说明班车按动车到站衔接，约 2 小时到景区门口。松潘站只有在同一渠道查到当日匹配接驳时才成立。" },
    { question: "坐飞机去九寨沟是不是更快？", answer: "只有实时航班和落地后的明确接驳同时存在时才成立。机场方案仍有约 88 公里剩余公路段，还要加上机场交通、天气和行李，所以要比较完整行程，而不是比较飞行时间。日期、实际成都机场、航班、接机与中断条款都要核对。" },
    { question: "火车晚点的话，接驳车会等我吗？", answer: "不能默认会等。除非卖家明确书面说明保护，铁路或航班订单与车站到景区接驳属于不同合同；围绕列车抵达安排的班线接人，不等于私人车辆无限期等候。先读退改和未乘规则，把准确车次交给运营方，并留出足够余量。" },
