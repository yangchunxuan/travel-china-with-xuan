...
- `asset`: `public/images/guides/chengdu-jiuzhaigou-transport-route/hero-1600.webp`
- `source`: https://commons.wikimedia.org/wiki/File:1_jiuzhaigou_valley_wu_hua_hai_2011b.jpg
- `author`: Chensiyuan
- `licence`: CC BY-SA 4.0 — https://creativecommons.org/licenses/by-sa/4.0
- `location`: Five Flower Lake, Jiuzhaigou Valley, Sichuan
- `source capture date`: 2011
- `crop`: centre crop from 3:2 to 16:10; resized to 1600 × 1000 and converted to WebP

The image establishes the destination, not current transport or access.
