...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "怎么确认这场演出真的有长调？",
          answer: "在主办方自己的节目页上找到“长调”“长调民歌”或 Urtiin Duu，并且至少看到歌者或一首曲名。若页面上只有“马头琴”，你确认的是一件乐器，不是长调。没有公布曲目时，直接问这一场是否确定包含长调节目。",
        },
        {
          question: "呼麦和长调是一回事吗？",
          answer: "不是。呼麦是以泛音效果为核心的另一种声乐实践，它可以和长调同场出现，但一段泛音演唱并不能证明该节目就是长调。短调也是另一类主要的蒙古族歌曲形式，旋律和歌词推进更紧凑，不该被当成“没唱好的”或被缩短的长调。",
        },
        {
          question: "《千古马颂》是长调专场吗？",
          answer: "不是，它是综合演出。内蒙古艺术剧院把《千古马颂》介绍为综合运用马术、蒙古族歌舞乐、杂技和舞台技术的全景式综艺演出。这份主办方说明能确认它是综合作品，却不能证明它是长调专场；只有你那一场次的节目单明确列出长调，才把那一段当作入门。",
        },
        {
          question: "不懂蒙古语，一定要有译词吗？",
          answer: "只在确有需要时才去确认语言服务。译词当然有帮助，但没有完整字幕，也能从气息、旋律轮廓和装饰音听下去。现场没有译词时，就跟着乐句长度、音区、装饰、停顿和伴奏听，演后再找官方文本，不要用自动字幕去猜蒙古语歌词。",
        },
        {
          question: "第一条长乐句应该听什么？",
          answer: "听持续的气息、旋律的扩展，以及中文常说的“诺古拉”那种装饰性转折。第一声之前先记下曲名、歌者和地域语境；中段听音区变化、张力与释放，若有马头琴，还要听两个声部怎样互动。不要认定所有装饰都服从全国同一个模板。",
        },
        {
          question: "公布的歌者被换掉了，怎么办？",
          answer: "先索取新的节目单，再判断剩下的内容是否还符合你的目的。若活动取消，回到官方剧院或文旅机构的日历找下一场具名活动，不要接受没有来源的转售者随口给的替代承诺。出行前一天重查日期、场地、开演时间、座位、退改和实名票规则。",
        },
      ],
    },
    {
