...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "Replace one authenticity question with seven material labels",
    },
    {
      id: "labels",
      type: "table",
      caption: "Seven labels for what is physically in front of you",
    ...
    },
    {
      id: "jiankou-warning",
      type: "callout",
      title: "Current status checked 14 August 2026",
      body:
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "The historic Yongdingmen complex at the southern end of Beijing's Central Axis was dismantled in the 1950s; UNESCO and ICOMOS records commonly use 1957 for the gate's demolition. The present tower was reconstructed in the twenty-first century, using archival surveys, photographs, archaeological work and traditional construction references. Project dates describe stages rather than contradictions: work took shape in 2004, the reconstruction was completed in October 2005, and later administrative acceptance records followed. The visible upper structure is not a surviving 1553 building.",
    },
    {
      id: "yong-figure",
      type: "figure",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "Yongdingmen also demonstrates why “rebuilt” is not the end of a biography. Dongcheng District reported in March 2026 that the 2005 reconstruction had begun its first systematic repair because of cracked components, roof leakage and ageing electrical systems. The works covered roof, timber structure, walls, finishes, fire safety and monitoring. A July report still referred to the repair construction site, and no completion notice was found by 14 August. This is conservation of a modern reconstruction. It should not be captioned as repairing original Ming tower fabric.",
    },
    {
      id: "yong-field",
      type: "callout",
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "Choose the right recovery when the site is unclear",
    },
    {
      id: "scenario-table",
      type: "table",
      caption: "Failure and recovery in the field",
      columns: ["What goes wrong", "Recovery", "Safe conclusion"],
      rows: [
        [
    ...
    },
    {
      id: "dynamic",
      type: "callout",
      title: "Dynamic facts reviewed 14 August 2026",
      body:
