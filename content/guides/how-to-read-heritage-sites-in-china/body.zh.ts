...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "别只问“真实吗”：先用本文的七个工作标签",
    },
    {
      id: "labels",
      type: "table",
      caption: "Homeground在本文中用于判断眼前物质对象的七个工作标签",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "北京中轴线南端的历史永定门建筑群在20世纪50年代被拆除；UNESCO和ICOMOS资料通常以1957年作为城门拆除年份。今天的城楼是21世纪重建，依据包括历史测绘、照片、考古工作和传统营造资料。不同工程年份对应不同阶段：重建工程于2004年正式开工；东城区资料记载2005年10月建成；由UNESCO托管的中方缔约国补充材料则记载，竣工验收备案于2007年6月15日启动。现在可见的上部城楼，不是1553年留存至今的建筑。",
    },
    {
      id: "yong-figure",
      type: "figure",
    ...
    },
    {
      ...
      type: "paragraph",
      text:
        "永定门也说明，“重建”不是建筑履历的终点。东城区2026年3月称，2005年完成的重建城楼因构件开裂、屋面渗漏和电气系统老化，开始重建后的首次系统性修缮，工程涉及屋面、木结构、墙体、油饰、消防和监测。7月的官方报道仍称其为修缮施工现场；截至8月15日没有找到完工通知。这是在保护一座现代重建建筑，不能写成“修缮明代原城楼”。",
    },
    {
      id: "yong-field",
      type: "callout",
    ...
    },
    {
      ...
      type: "heading",
      level: 2,
      text: "现场信息不清楚时，先做正确的下一步核查",
    },
    {
      id: "scenario-table",
      type: "table",
      caption: "证据不清楚时的下一步核查",
      columns: ["遇到的问题", "下一步核查", "可以安全得出的结论"],
      rows: [
        [
          "考古遗迹已经回填，现场看不见。",
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "中方补充材料——永定门重建与验收时间线",
          url: "https://whc.unesco.org/document/204904",
          publisher: "由UNESCO世界遗产中心托管的中方缔约国提交材料",
          reviewedAt: "2026-08-15",
        },
        {
