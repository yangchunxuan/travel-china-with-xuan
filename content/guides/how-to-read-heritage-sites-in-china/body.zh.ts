...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "重建或修缮过的建筑，是不是就成了“假的”？",
          answer: "不是。旧材料不是承载真实性的唯一方式，修缮也不会自动把遗产变“假”。应追问：这里表达的价值是什么；证据针对材料、设计、功能、工艺、位置还是环境；哪些部分发生过改变；由谁记录、如何记录。传统工艺可以是重要属性，但用它新做出来的构件仍然是新材料。",
        },
        {
          question: "列入世界遗产，是不是说明里面全是古代原物？",
          answer: "列入世界遗产，确认的是特定遗产及其申报价值，不等于范围内每块砖、每片瓦和每座可见建筑都是古代原物。整体尺度的判断可以确认突出普遍价值、范围、属性以及整体完整性与真实性评估，却不能确认范围内每座建筑和游客设施的年代或材料身份。",
        },
        {
          question: "北京永定门城楼是明代原建筑吗？",
          answer: "现在的城楼是21世纪重建。中轴线南端的历史永定门建筑群在20世纪50年代被拆除，UNESCO和ICOMOS资料通常以1957年为拆除年份。重建工程2004年正式开工，东城区资料记载2005年10月建成，中方补充材料记载竣工验收备案于2007年6月15日启动。",
        },
        {
          question: "箭扣长城可以去徒步吗？",
          answer: "把箭扣当作保护案例，不要当成徒步路线。怀柔区政府2026年4月27日发布的资料称，一至四期已经完成，五期仍在施工、计划于2026年底完工，六期方案设计已经启动；截至2026年8月15日，没有找到五期正式完工验收通知。普通游览应选择官方开放的长城段。",
        },
        {
          question: "殷墟的遗迹被回填了，几乎看不到东西，是不是出了问题？",
          answer: "那是保护决定。UNESCO的真实性说明写明，遗址和出土遗物会尽可能原址保护；发掘结束后，遗址可以回填保护，并在地面以植被表示，重要文物则进入博物馆获得专业保护。保护有时让证据看起来不那么壮观，却不等于证据更不真实。",
        },
        {
          question: "修缮过的城墙，用眼睛能分出哪块砖是旧的吗？",
          answer: "光看是分不出来的。绝不能只按颜色给砌体分新旧：要查构件图、材料清单或管理方说明，在证据指出之前先记录为“材料边界未确认”。箭扣的官方资料写明，旧砖经清理后重复利用，需要时也会补入相容材料，所以一块看起来旧的砖面，既不能证明年代，也不能证明是后补。",
        },
      ],
    },
    {
