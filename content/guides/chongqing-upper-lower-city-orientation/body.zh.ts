...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "重庆找路常见问题", items: [
    { question: "地图上只有两百米，为什么在重庆这么难走到？", answer: "多半因为两条街不在同一个高度。陡峭地形和密集建设让重庆成为一座三维城市，平面地图上相邻的两条街，实际可能相差数十米高度，中间还没有直达楼梯。所以一个目的地要看三组坐标：平面位置、垂直层级，以及有名称的车站出口、电梯、扶梯、桥或公共楼梯这类可用连接。" },
    { question: "李子坝真的是列车把旧楼打穿吗？", answer: "不是。重庆官方资料介绍，李子坝站与楼房采用协同设计，轨道结构和楼体结构彼此分离，以控制振动和噪声。那个著名画面是工程师面对受限地形与密集城市空间给出的解决办法，而不是后来随意把一栋旧住宅打穿。" },
    { question: "李子坝站在施工吗？", answer: "按重庆官方2026年6月13日发布的通知，是的。通知称下一阶段施工将分阶段关闭站厅、站台及1、2号出入口，预计2026年12月30日完工。这是有日期的施工通知，不是永久关闭说明；使用车站或规划观景路线前，请再次查看重庆轨道交通的现行指引。" },
    { question: "在重庆带行李箱，该按地图最短路线走吗？", answer: "通常不该。带行李、与父母同行或行动受限时，哪怕地图路线更长，也要优先选电梯、扶梯、车辆可达道路或车站出口，垂直路线的确定性比直线距离更重要。另外，一部电梯只消除其中一段爬升，不等于全程无台阶，所以要留一个道路层面的车辆备选。" },
    { question: "深夜带行李到重庆，最后一段路怎么安排？", answer: "走已经确认过、照明良好的道路层入口。没有确认开放时，不要依赖夜间商场、楼内通道、电梯或扶梯；告诉司机的也应该是道路层面的下车入口，而不是景点中心点。带大件行李时，离开酒店前先确认车辆可以到达的入口。" },
    { question: "在重庆，目的地就在正上方或正下方，该怎么办？", answer: "不要进没有标识的住宅楼梯，也不要沿机动车坡道步行。先拍下或保存当前路名，退回有人值守的车站入口、酒店前台或公共主路，再询问指定的上层或下层入口。出租车同样可能需要这个道路层面的入口，而不是景点中心点。" },
  ] },
