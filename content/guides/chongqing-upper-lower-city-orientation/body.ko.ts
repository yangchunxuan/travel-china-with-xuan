...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  {id: "three-coordinates", type: "table", caption: "충칭 목적지에는 세 가지 좌표가 있다", columns: ["좌표", "확인할 것", "흔한 실패"], rows: [
    ...
    ["세로 높이", "상부 도로, 하부 도로, 강변 또는 포디엄 층.", "지도 핀이 머리 위나 발아래에 있는데 연결 길이 보이지 않음."],
  ...
  {id: "machines-copy", type: "paragraph", text: "충칭시 공식 자료는 카이쉬안루 엘리베이터를 도시의 수직 대중교통으로 설명하고, 황관 대형 에스컬레이터가 서로 다른 높이를 잇는 규모와 역할을 기록합니다. 산지 주거지 설계 지침도 엘리베이터와 에스컬레이터를 수직 이동 기반시설로 다룹니다. 이런 사례는 충칭의 도시 구조를 이해하는 데 도움이 되지만, 특정 시설이 오늘 열려 있거나 지금 가려는 경로에 적합하다는 증거는 아닙니다."},
  ...
  {id: "dynamic-boundary", type: "callout", title: "확인일: 2026년 8월 13일", body: "여기에 든 물리적 사례는 충칭의 도시 형태를 설명할 뿐, 모든 엘리베이터·에스컬레이터·출구·통로가 열려 있다는 약속이 아닙니다. 공사와 폐쇄 상태는 바뀝니다. 당일 충칭 철도교통과 해당 시설의 최신 공지를 확인하세요.", tone: "neutral"},
  ...
  {id: "sources", type: "sources", title: "공식 및 독립 자료", items: [
    ...
    {label: "공공 엘리베이터와 황관 에스컬레이터 안전 보고", url: "https://scjgj.cq.gov.cn/zfxxgk_225/gsgg/qtgg/202504/t20250428_14564659.html", publisher: "충칭시 시장감독관리국", reviewedAt: "2026-08-13"},
