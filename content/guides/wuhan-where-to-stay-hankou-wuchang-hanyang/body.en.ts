...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "names-heading", type: "heading", level: 2, text: "Hankou is not a district; Wuchang and Hanyang are both historic town names and current districts" },
  { id: "names-copy", type: "paragraph", text: "The single most useful correction for a first-time visitor is that these three familiar names do not share the same administrative status. Wuhan's own municipal records describe the Yangtze and the Han crossing through the urban area to form the tripartite pattern of Wuchang, Hankou and Hanyang, known collectively as Wuhan's three towns. Separately, the city is divided into thirteen administrative districts, of which seven are central: Jiang'an, Jianghan, Qiaokou, Hanyang, Wuchang, Qingshan and Hongshan. Read those two lists side by side and the trap is obvious. Hanyang and Wuchang appear in both: each is a historic town name and a current district name. Hankou does not appear in the district list at all — the area people mean by Hankou is covered by Jiang'an, Jianghan and Qiaokou. And the railway station names are a third system that matches neither." },
  { id: "names-table", type: "table", caption: "Three overlapping naming systems, checked against Wuhan municipal sources and China Railway's 12306 station dictionary on 23 August 2026", columns: ["Name you will see", "What kind of name it is", "What it actually refers to"], rows: [
  ...
  { id: "river-list", type: "list", ordered: false, items: [
    ...
    "The ferry is a real crossing, not a tourist boat: the standard Yangtze crossing fare is 1.5 yuan and the trip takes roughly fifteen minutes. A Wuhan municipal report published on 6 May 2026 says the upper deck had returned after a two-year absence. It is still a working transport service, and deck access can change for safety or crowd control, so check the current notice rather than treating the view as guaranteed.",
  ]},
  ...
  { id: "facts", type: "callout", title: "Reviewed 23 August 2026", tone: "neutral", body: "Administrative divisions and the three-towns description come from Wuhan municipal sources; the district count was 13 with 7 central districts, including Wuchang and Hanyang but not Hankou. Station identities come from China Railway's live 12306 dictionary. Metro line assignments to the three stations are as stated in a 2022 municipal briefing, which also listed further lines as planned or under construction, so the network has grown since. The absence of a direct Hankou Station to Wuhan Station metro, and the 55-minute minimum, are as stated by the Wuhan Municipal Transport Bureau in January 2025 and will change when the Xingang line western extension opens. The 1.5 yuan ferry and roughly fifteen-minute crossing were documented in 2024; a Wuhan municipal report on 6 May 2026 says the upper deck had returned after a two-year absence. Re-check the current fare, schedule and deck access for your date." },
  ...
  { id: "faq", type: "faq", title: "Wuhan stay questions answered", items: [
    { question: "Should I stay in Hankou, Wuchang or Hanyang?", answer: "Pick the bank you will spend most of your days on, then the side your hardest departure leaves from; if the two conflict, the departure wins. Cross the river during the day, when crossing is cheap and frequent, rather than at 06:00 with luggage." },
    { question: "Is Wuhan on my train ticket the city or a station?", answer: "A station. China Railway's station dictionary lists Wuhan, Hankou, Wuchang and Wuhan East as four separately ticketable stations under the city of Wuhan, so a booking that says Wuhan lands you at Wuhan Station. Read the full Chinese name on the confirmed order before choosing a hotel." },
    { question: "Is there a direct metro between Hankou Station and Wuhan Station?", answer: "No. In January 2025 the Wuhan Municipal Transport Bureau stated that there is no direct metro between the two, that a passenger must change lines, and that the minimum journey is 55 minutes; the Xingang line western extension is being built to bring that under 25 minutes but is not open. If you arrive at one and depart from the other, budget that hour honestly." },
    { question: "Which metro lines cross the Yangtze in Wuhan?", answer: "Per the city's 2025 statement, Lines 2, 4, 7 and 8 run under the Yangtze. Wuhan Station is served by Lines 4 and 5, Hankou Station by Line 2 and Wuchang Station by Lines 4 and 7, according to a 2022 municipal briefing that also listed further lines as planned, so the network has grown since." },
    { question: "Is Hankou a district of Wuhan?", answer: "No. Hankou is a historic town name and a broad city area, not a current administrative district. Wuchang and Hanyang are both historic town names and current districts. Hankou Station (汉口站) is a railway station, so in a booking context the word may refer either to the wider Hankou area or specifically to the station." },
    { question: "Can I cross the Yangtze by ferry in Wuhan?", answer: "Yes. The ferry is a working crossing, not a tourist boat: the standard Yangtze crossing fare is 1.5 yuan and the trip takes roughly fifteen minutes. Deck access can change for safety or crowd control, so check the current notice rather than counting on the view." },
  ] },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    ...
    { label: "The upper ferry deck returned after a two-year absence", url: "https://tc.wuhan.gov.cn/sy/lbxw/202605/t20260506_2760485.shtml", publisher: "Wuhan municipal government portal, sourced to Changjiang Daily", reviewedAt: "2026-08-23" },
