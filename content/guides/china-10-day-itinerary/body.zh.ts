...
const body = {
    ...
    },
  {
    ...
    "items": [
      {
        "question": "10天够走北京、西安、上海吗？",
        "answer": "够。北京—西安—上海给北京3个完整游览日、西安1天、上海2天，最后一天保持灵活。去西安的明确理由是兵马俑；如果它不是重点，把这两晚留给北京或上海也很好。每加一座城市，都会分走原本留给游览的时间。"
      },
      {
        "question": "这10天是10个完整游览日吗？",
        "answer": "不是。第1天抵达、第10天离开，住宿共9晚：第1—4晚北京，第5—6晚西安，第7—9晚上海。国际飞行可能在中国行程前后另占日历日。如果你从出家门到回家总共只有10天，请先数清实际能在中国停留几天。"
      },
      {
        "question": "故宫可以当天买票吗？",
        "answer": "不可以。故宫不售当日票，通常周一闭馆，所以必须提前完成预约，必要时与其他北京游览日对调。天安门的入场规则要根据你的预约另行核对，不要默认两处用同一套安排。"
      },
      {
        "question": "这10天里能加一天苏州吗？",
        "answer": "可以，用上海那个机动日来换。默认是留在上海，补上前面没去成的地方、放慢游览或休息；改成苏州一日游，就要另行确认往返交通、当地接驳和所选景点。无论选哪种，都保留原来的上海酒店，当晚回来住第9晚，准备次日离境。"
      },
      {
        "question": "订火车票要用什么证件？",
        "answer": "用你实际随身携带的护照，并带上这本证件原件；中国铁路要求乘客使用购票证件乘车。出票前还要查实际可用交通，比较车站或机场接驳及到酒店的时间，不只看列车或飞机运行多久。"
      },
      {
        "question": "不想去西安怎么办？",
        "answer": "改走两地慢游：北京5晚＋上海4晚。舍去西安和兵马俑，换来全程只跨城一次。首尾两天仍留给抵达、离开，中间保留完整转场日。多出的住宿是用来调整节奏的，不必又全部变成新的近郊一日游。"
      }
    ]
  },
  {
