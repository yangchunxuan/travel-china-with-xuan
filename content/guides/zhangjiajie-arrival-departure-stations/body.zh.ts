  ...
  "blocks": [
    {
      "id": "lead",
      "type": "lead",
      "text": "张家界私家团从你票面上的准确机场或车站开始，通常是张家界荷花国际机场（DYG）或张家界西站。串联芙蓉镇与凤凰的7天路线，标准终点是凤凰古城站；只游张家界的路线，通常送回书面确认的张家界离开节点。最终方案还没写清终点前，不要先买最后一张不能改的交通票。"
    },
    {
      "id": "names-heading",
      "type": "heading",
    ...
    },
    {
      ...
      "columns": [
        {
          "heading": "只游张家界",
          "body": "最后送往书面确认的张家界机场或车站。下一程从张家界出发时，这样更直接。"
        },
        {
          "heading": "张家界—芙蓉镇—凤凰",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "answer": "网页路线可以从已确认的张家界机场或车站接客。具体节点、班次和行李须写入最终确认方案。"
        },
        {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "description": "以张家界为核心，最后接送按已确认的本地离开节点安排。"
        },
        {
          "label": "7天路线为什么这样排",
