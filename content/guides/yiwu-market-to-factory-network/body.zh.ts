...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  {id:"answer",type:"callout",title:"直接答案",body:"进场前只选一个产品族，从官方目录找到当前所在市场区，再跟一条证据链：陈列 → 经营主体 → 生产声明 → 样品或过程证据 → 物流路径。任何“厂家”说法在文件和必要时的授权工厂访问支持前都只是待核声明。本文解释城市系统，不推荐供应商、不替人尽调，也不保证批发结果。",tone:"decision"},
  ...
  {id:"scope",type:"comparison",title:"两种正当访问方式",leftTitle:"好奇的普通旅行者",rightTitle:"专业买家或研究者",rows:[
    {label:"问题",left:"全球小商品城市怎样组织品类与流动？",right:"一个明确产品由哪些主体承担交易和生产环节？"},
    {label:"方法",left:"一个品类、公共通道、官方解释与城市物流语境。",right:"预约、法律主体、书面规格、样品与独立尽调。"},
    {label:"边界",left:"不要假装下单来占用经营者时间。",right:"不要把城市编辑指南当成采购、法律、质量或合规意见。"}
  ]},
  {id:"prepare-heading",type:"heading",level:2,text:"准备一个产品问题"},
  {id:"prepare",type:"list",items:["选足够窄的产品族，例如“纽扣”而非“时尚”、“台灯”而非“电子产品”。这是观察工具，不是采购推荐。","用当前义乌官方目录确认对应市场区和楼层，品类分布会调整。","写下三个中性问题：这家企业做什么、这件商品在哪里生产、哪些步骤由别处完成？","保存准确市场建筑和入口中文名，庞大市场不能只靠一个总目的地地图点。","设定时间上限和出口。看清一个品类比奔跑多个区更有信息。","若确有商务交流，提前安排翻译和预约，不在入口临时招募不明身份的协助者。"]},
  {id:"field-heading",type:"heading",level:2,text:"两小时公共现场路线"},
  {id:"field",type:"list",items:["从官方信息或服务点开始，确认当日品类位置。","第一遍不驻足，观察商品怎样分组、样品怎样陈列、附近有哪些服务。","第二遍比较同品类三个商位：产品深度、定制语言和自述经营角色。","拍商品、人物、价目表或名片前先获同意；公共通道不等于商业信息可任意发布。","把一笔假设订单追到商位之外：样品、生产、检验、集货、国内移动与出口交接。","离开市场后从合法公共位置观察一个交通或物流接口，不经授权不进入仓库和装卸区。","把已经核验的陈述、销售说法和自己的解释分栏记录。"]},
  ...
  {id:"scenarios",type:"comparison",title:"观察与商业核验",leftTitle:"只有半天的设计学生",rightTitle:"已有明确产品的小企业经营者",rows:[
    {label:"有效结果",left:"理解品类、陈列和聚集怎样降低搜索成本。",right:"列出可能的交易对手和仍需完成的核验工作。"},
    {label:"证据",left:"官方区位图、现场笔记和获准照片。",right:"法律名称、书面规格、样品和独立检查的文件。"},
    {label:"停止规则",left:"观察开始重复或干扰交易就离开。",right:"不能因为城市指南解释了网络就付款或承诺。"}
  ]},
  ...
  {id:"failure",type:"table",caption:"当网络无法确认",columns:["问题","恢复动作","编辑结论"],rows:[
    ["品类搬迁或区块关闭","返回官方服务点查当前目录；只有相邻品类能回答同一问题时才替换。","记录日期，不发布过时楼层指引。"],
  ...
  {id:"verify",type:"list",items:["当前官方市场区、品类和公众开放信息","准确中文入口与现实可行的离场时间","所有被引用企业自述的角色","法律主体与品牌、商位名分开","生产地点在核实前注明为声明","每张近景商品或文件照片已获许可","没有供应商排名、获客承诺或暗示背书","任何真实交易另做专业尽调"]},
