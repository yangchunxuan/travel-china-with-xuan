...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "义乌市场常见问题", items: [
    { question: "我对接的商位就是工厂吗？", answer: "不一定。一个商位可能属于制造商、工厂的销售公司、贸易公司，也可能是其他中介，陈列规模大并不证明它自有工厂。可以直接问一句：法律卖方是商位企业、另一家贸易公司，还是制造商？再看注册企业名称和合同主体是否一致。" },
    { question: "怎么知道我要看的品类在哪栋楼？", answer: "当天向市场运营方或有人值守的官方服务点确认区块和楼层。网络目录或旧楼层图只能当线索，不能证明今天的位置。确认之后再保存准确的市场建筑和入口中文名；市场太大，只存一个总目的地的地图点不够用。" },
    { question: "义乌卖的东西都是义乌生产的吗？", answer: "不是。生产可能在义乌，也可能在金华或浙江其他地方，甚至在外省。铁路站、城区市场、仓库、物流园和工厂并不在一片步行园区里。市场优势不能证明每道工序都在本地，它的价值是让碎片化的产品和服务可搜索、可比较、可流动。" },
    { question: "在市场里该待多久，具体怎么看？", answer: "给一个品类留两小时，按公共现场路线走。先到有人值守的官方信息或服务点，请对方确认当天这个品类的位置；第一遍不驻足，看商品怎样分组、样品怎样陈列；第二遍再比较同品类的三个商位。进场前先设定时间上限和出口。" },
    { question: "在市场通道里可以拍照吗？", answer: "先获得同意再拍。拍商品、人物、价目表或名片前都要先问一句，公共通道不等于商业信息可以随便发布。接受样品或礼物，也不等于获得拍摄员工、生产过程或文件的许可；事后不要公布别人的个人联系方式。" },
    { question: "不谈生意，只是想逛逛这个市场，可以吗？", answer: "可以，按观察的方式安排。选一个品类，走公共通道，配合官方解释和城市物流语境去理解它。边界是不要假装下单来占用经营者时间；观察开始重复或干扰交易，就该离开。" },
  ] },
