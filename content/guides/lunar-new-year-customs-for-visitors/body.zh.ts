...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "2027年春节是哪一天？",
          answer: "2027年农历正月初一是2月6日，星期六（复核于2026年9月18日）。中国内地现行规定把除夕至正月初三列为春节法定节日，因此2027年的四天法定日期为2月5日至8日。更长的连休、调休上班日和春运周期，仍要等年度通知。",
        },
        {
          question: "大家都回家了，景区会没人吗？",
          answer: "不会，这不是可靠计划。上海公布2026年九天春节假期接待游客2167万人次，推出超过2570项文旅活动；文化和旅游部公布全国国内出游5.96亿人次。这些是人次不是独立人数，也不能预测下一年，但足以说明假期是把人流重新分布，而不是清空景区。",
        },
        {
          question: "春节期间餐馆和商店会关门吗？",
          answer: "有些会，但不存在一张真正有用的全国清单。政府办事机构遵循公布的放假调休，餐馆、商店、博物馆和景区则各自决定营业。大型酒店、交通设施、商场和连锁店常维持部分假期服务；家庭经营的小餐馆、洗衣店、工作室或民宿，则可能歇业、缩短营业，甚至晚于正式假期才恢复。",
        },
        {
          question: "春节期间火车票很难买吗？",
          answer: "要按“想要的那张票可能始终买不到”来安排。12306候补是继续尝试兑现，不是已经占住的座位，所以要准备一套候补未兑现也能成立的路线。春运另行公布，开始早于法定假期、结束也更晚：2026年春运40天，内地假期9天，最难买的那张票可能落在“假期”方框之外。",
        },
        {
          question: "可以参加中国家庭的年夜饭吗？",
          answer: "只有被明确邀请时才可以。餐馆的春节菜单只让你成为顾客，预订覆盖的是用餐，不包含进入家庭传统；邀请吃饭也不自动包括同行者、拍摄和所有家庭环节。如果确实受邀，请先问到达时间、家人是否知情、饮食限制、礼物和离开时间。",
        },
        {
          question: "庙会和灯会在我去的那几天会开吗？",
          answer: "要看城市、公园、博物馆、寺庙或明确主办方的有日期公告，不用转载清单。以北京2026年安排为例，不同庙会只覆盖假期中的不同日期，有些灯展延续到元宵节前后。活动名称不等于可以入场，所以要核验门票、预约、护照接纳、容量、行李和摄影规则，并在附近备一个公开活动。",
        },
      ],
    },
    {
