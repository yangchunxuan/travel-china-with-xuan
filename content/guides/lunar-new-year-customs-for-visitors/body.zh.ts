  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        ...
        "把12306候补当成继续尝试兑现，而不是已经占住的座位；做好永远未兑现的路线。",
    ...
    },
    {
      ...
      tone: "decision",
      title: "轻量核对就能保护脆弱部分",
      body: "如果日期与春节重叠，可以先提供城市、必要跨城移动和两三项不能放弃的体验。首次咨询不要发送护照、付款、医疗或详细行动信息。Homeground可以指出哪些假设需要当前来源、哪里只要简单备选，不会把春节写成一段生硬推销。"
    },
    {
      id: "internal-links",
      type: "internal-links",
