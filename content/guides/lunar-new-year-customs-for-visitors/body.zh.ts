...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      type: "callout",
      tone: "warning",
      title: "四天法定节日已确定，2027完整放假安排尚未公布",
      body: "复核于2026年9月18日：2027年农历正月初一是2月6日，星期六。中国内地现行规定把除夕至正月初三列为春节法定节日，因此2027年的四天法定日期为2月5日至8日。更长的连休、调休上班日和春运周期仍需等待年度通知。不要把香港假期或中国内地2026年的连休安排复制到2027年行程；等国务院发布年度安排后，到Homeground中国公共假期日历查看。"
    },
    {
      id: "pressure-heading",
      type: "heading",
