...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "address-heading", type: "heading", level: 2, text: "购票前先做端点表" },
  { id: "address-copy", type: "paragraph", text: "左边写准确的桂林机场、火车站、酒店或游船码头，右边写准确的阳朔酒店、阳朔站或龙头山码头。给每个方案加入第一段公路、值船或进站、主要交通、最后一段公路或步行以及返程。这样会暴露常见错误：拿铁路时刻与包车比较，却没加入两端车站接驳；或拿观光游船与公路换乘比较，却完全忽略四小时漓江体验的价值。" },
  { id: "cruise", type: "callout", title: "选择游船前先解决行李", tone: "warning", body: "官方游客须知说明，精华游船不提供行李寄存，前往出发码头和从阳朔继续前往目的地的交通也不包含在内。可询问桂林酒店是否能保管大件行李；如要单独转运行李，只能交给有名称和责任人的服务方；也可以让行李随团队走公路，另选一天乘船。不要到码头后再期待临时储物柜或车辆。" },
  { id: "mode-heading", type: "heading", level: 2, text: "测试每个方案最薄弱的一段" },
  { id: "mode-matrix", type: "table", caption: "主要交通通常不是最薄弱的一段", columns: ["方案", "最需要核对的一段", "实用备选"], rows: [
    ["铁路", "兴坪的阳朔站到准确酒店", "预订正规接站，或从原起点改走公路"],
    ["公路车辆", "车辆、上车点、行李容量和晚到接待", "由酒店协助替换，或在抵达一侧住宿"],
    ["漓江游船", "前往桂林出发码头、行李以及龙头山后的交通", "船班、天气或行李条件失败时改走公路"],
    ["班线交通", "当前运营方、准确站点、末班以及是否收行李", "有名称的正规公路车辆，而不是无标识路边揽客"],
  ]},
  { id: "return-heading", type: "heading", level: 2, text: "返程不应依赖去程体验" },
  { id: "return-plan", type: "list", ordered: true, items: ["住宿行程应确认准确上车地址和酒店接待，不能默认回到抵达点。", "一日游应按已订火车、航班或公路班次以及真实末端接驳设置离开阳朔的时间。", "把完整中文站名、码头和酒店名称离线保存，提供给司机和现场人员。", "天气改变漓江方案时，切换到预先核实的公路或铁路结构，不要没有截止时间地等待。", "不要把不可退国际航班紧接在单向观光游船和不确定的公路返程之后。"] },
  ...
  { id: "faq", type: "faq", title: "两地交通常见问题", items: [
    { question: "阳朔站是在阳朔镇上吗？", answer: "不在。阳朔站位于兴坪，并不在多数阳朔酒店旁边，所以购票前要把火车站和住宿分别定位。桂林出发站或阳朔最后一段公路接驳一旦选错，一段很短的火车也会失去优势。" },
    { question: "漓江游船多久？从哪里上船、在哪里下船？", answer: "约60公里、约4小时，单程。漓江景区官方资料说明：三星船从磨盘山客运港出发，四星船从竹江客运港出发，都在阳朔龙头山码头下船。两座桂林出发港并非同一地点，这也不是可以原路复制的往返交通。" },
    { question: "坐漓江游船时行李能寄存吗？", answer: "船上没有。官方游客须知说明，精华游船不提供行李寄存，前往出发码头和从阳朔继续前往目的地的交通也不包含在内。可以问桂林酒店能否保管大件行李；要单独转运，就只交给有名称和责任人的服务方；也可以让行李随团队走公路，另选一天乘船。" },
    { question: "从桂林到阳朔，该坐火车、坐车还是坐船？", answer: "最重视门到门和行李，就比较公路接驳；火车要等匹配好准确车站、安排好阳朔最后一段车辆再比较；想把漓江本身当成当天的体验，才选游船，而不是把它当作地图上的快速接驳。三种方案从不同地点开始和结束，不能只按一个时长排名。" },
    { question: "漓江游船需要提前买票吗？", answer: "旺季需要。官方提示建议旺季至少提前一天购票。精华游是按日期开行的观光航程，不是随到随走的交通；同一份提示还说明，前往码头和从阳朔返回的交通费不包含在船票里。所以船票、去出发码头的车和下船后的接驳要一起安排。" },
    { question: "游船当天晚上能接航班吗？", answer: "最好不要。不要把不可退国际航班紧接在单向观光游船和不确定的公路返程之后。一日游要按已订火车、航班或公路班次，加上真实的末端接驳，来定离开阳朔的时间；天气改变漓江方案时，就切换到预先核实的公路或铁路结构，不要没有截止时间地等待。" },
  ] },
