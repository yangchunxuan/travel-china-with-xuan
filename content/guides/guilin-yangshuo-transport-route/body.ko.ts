...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "이동 관련 자주 묻는 질문", items: [
    { question: "양숴역은 양숴 시내에 있나요?", answer: "아닙니다. 양숴역은 대부분의 양숴 숙소와 떨어진 싱핑에 있으므로 표를 사기 전에 역과 숙소를 따로 표시해 두세요. 구이린 출발역이나 양숴의 마지막 도로 이동이 맞지 않으면 짧은 열차 구간의 장점이 사라집니다." },
    { question: "리강 유람선은 얼마나 걸리고 어디서 타고 내리나요?", answer: "약 60km, 약 4시간의 편도 일정입니다. 리강 공식 안내에 따르면 3성급 유람선은 모판산 여객항, 4성급 유람선은 주장 여객항에서 출발하며 모두 양숴 룽터우산 선착장에 내립니다. 구이린의 두 출발항은 서로 다른 장소이고 왕복 교통편도 아닙니다." },
    { question: "리강 유람선을 타는 동안 짐을 맡길 수 있나요?", answer: "유람선에는 보관이 없습니다. 공식 안내는 핵심 유람선에 짐 보관 서비스가 없고 출발 부두까지와 양숴 이후 교통도 포함되지 않는다고 설명합니다. 구이린 호텔이 큰 가방을 맡아 주는지 묻고, 별도 수하물 운송은 이름과 책임이 명확한 업체에만 맡기거나, 짐은 일행과 도로로 옮기고 유람선은 다른 날 이용하세요." },
    { question: "구이린에서 양숴까지 열차, 차량, 유람선 중 무엇이 좋을까요?", answer: "문 앞 이동과 짐이 가장 중요하면 도로 이동을 비교하세요. 열차는 정확한 역을 맞추고 양숴에서 숙소까지 갈 차량을 정한 뒤에 비교합니다. 리강 자체를 하루의 경험으로 삼고 싶을 때 유람선을 고르고, 지도에서 빠른 셔틀처럼 보인다는 이유로 고르지는 마세요. 세 방법은 시작과 끝이 서로 달라 소요 시간 하나로 줄 세울 수 없습니다." },
    { question: "리강 유람선 표를 미리 사야 하나요?", answer: "성수기라면 미리 사는 편이 좋습니다. 공식 안내는 성수기에 적어도 하루 전 구매를 권합니다. 핵심 유람선은 아무 때나 타는 셔틀이 아니라 날짜가 정해진 관광 운항이고, 같은 안내는 선착장까지 가는 교통과 양숴에서 돌아오는 교통이 포함되지 않는다고 밝힙니다. 표와 부두까지의 이동, 하선 뒤 이동을 함께 계획하세요." },
    { question: "유람선을 탄 날 저녁 비행기를 타도 될까요?", answer: "피하는 편이 좋습니다. 환불 불가 항공편을 편도 관광선과 불확실한 도로 귀환 직후에 두지 마세요. 당일치기는 예약한 열차·항공·도로편과 실제 마지막 이동에 맞춰 양숴 출발 시각을 정하고, 날씨가 강 일정을 바꾸면 기다리지 말고 미리 확인한 도로·철도 구조로 전환합니다." },
  ] },
