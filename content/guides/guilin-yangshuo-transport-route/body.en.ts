...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "links", type: "internal-links", title: "Continue planning", items: [
    { label: "Guilin Airport or railway station arrival guide", href: "/guides/guilin-airport-or-railway-station-arrival-guide/", description: "Choose the right Guilin arrival hub before comparing the onward route." },
