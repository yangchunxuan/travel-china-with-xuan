...
const body = { schemaVersion: "1.0.0", blocks: [
  { id: "lead", type: "lead", text: "For a train journey from Guangzhou to Macau, Zhuhai Railway Station and Gongbei usually suit a Macau Peninsula hotel. Hengqin Railway Station and Hengqin Port often suit Cotai or a hotel with a confirmed connection from Macau's Hengqin LRT station. Compare the whole journey from your Guangzhou address to your Macau hotel, including luggage, the border crossing and onward transport. A late arrival or current construction can change the better route." },
  ...
  { id: "faq", type: "faq", title: "Guangzhou to Macau questions answered", items: [
    { question: "How do I get from Guangzhou to Macau by train?", answer: "Take a train from Guangzhou South to either Zhuhai Railway Station (珠海站) and cross at Gongbei to the Border Gate, or to Hengqin Railway Station (横琴站) and cross at Hengqin Port. Search 12306 for both stations on your travel date and compare the whole trip from your Guangzhou address to your Macau hotel." },
    { question: "Should I use Gongbei or Hengqin to enter Macau?", answer: "Gongbei usually suits a northern or central Macau Peninsula hotel; Hengqin often suits Cotai, Taipa or a hotel with a confirmed LRT or pickup connection. Luggage, a late arrival and current port construction can change the better choice." },
    { question: "What are the Macau border crossing hours?", answer: "When checked on 13 August 2026, Macau Customs listed the Border Gate/Gongbei crossing as 06:00–01:00 and the Hengqin Macau Port Area as open 24 hours. Eligibility, mainland-side arrangements and temporary controls still need a fresh official check, and a 24-hour port does not mean trains, the LRT and hotel shuttles also run all night." },
    { question: "How do I reach a Cotai hotel from Hengqin Port?", answer: "After immigration, follow signs to the LRT Hengqin station, ride the Hengqin Line to Lotus, then change to the Taipa Line for the station nearest your hotel. Single-journey tokens are sold at machines or counters; counters accept cards, Alipay and WeChat Pay, while machines take cash and LRT Cards." },
    { question: "Is a train ticket to Zhuhai or Hengqin also a ticket into Macau?", answer: "No. The rail ticket ends at the mainland station; you then carry your own luggage through mainland exit and Macau entry checks. Check every passport's Macau admission basis and any later mainland re-entry need against current official rules before travelling." },
  ] },
