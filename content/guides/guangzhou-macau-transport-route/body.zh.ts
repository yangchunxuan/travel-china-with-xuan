...
const body = { schemaVersion: "1.0.0", blocks: [
  { id: "lead", type: "lead", text: "选口岸路线时要同时看两头。珠海站加拱北口岸，通常更适合住澳门半岛，或者更看重车次选择的人；横琴站加横琴口岸，通常更适合住路氹、氹仔，或酒店明确能接上澳门轻轨横琴站的人。不过，广州住宿离广州南很远、行李多、到得晚，或口岸正在施工，都可能改变结论。" },
  { id: "answer", type: "callout", title: "比较完整门到门，不只比较火车", tone: "decision", body: "把全程分开计时：广州地址→广州南→铁路→去口岸→带着行李完成出入境→澳门侧交通→准确酒店。出行日期在 12306 同时搜索“珠海站”和“横琴站”，再比较完整行程，并查看口岸最新官方状态。" },
  { id: "chain-heading", type: "heading", level: 2, text: "两条主要路线" },
  { id: "chain-matrix", type: "table", caption: "铁路时间接近时，澳门酒店位置常常决定选择", columns: ["路线", "通常最适合", "额外步骤", "不能想当然"], rows: [
  ...
  { id: "scenarios", type: "table", caption: "铁路段最短，不一定全程最短", columns: ["情况", "可行选择", "原因"], rows: [
    ["两人住广州南附近，澳门住议事亭前地一带", "先查珠海站车次，经拱北/关闸前往澳门", "澳门侧从半岛北部进入；若当天车次合适，全程通常更简洁"],
    ["一家人带大箱，澳门住路氹", "比较当天直达横琴的火车，加横琴口岸/轻轨或已确认酒店接驳", "可能省掉从关闸横穿澳门，但前提是过关后的连接已落实"],
    ["较晚才从天河酒店出发", "选总余量最大的路线，不要自动认定 24 小时口岸最好", "去广州南、最后一班有用的火车和澳门侧交通，可能比口岸时间更早停止"],
  ...
  { id: "recovery-heading", type: "heading", level: 2, text: "原定路线走不通时怎么办" },
  { id: "recovery", type: "table", caption: "停在最后一个有工作人员、容易辨认的地点", columns: ["问题", "处理", "不要做"], rows: [
  ...
  { id: "verify", type: "list", items: [
    ...
    "中文车站名和口岸名已经离线保存。",
    "所有人的护照以及入澳/再次入内地文件都适用于计划路线。",
    "口岸官方页面显示当前时间、施工和客流提示。",
    "澳门酒店确认过关后的准确交通和晚到截止。",
    "行李容量和无障碍需求已经确认，而非猜测。",
    "错过最后一个有效接驳时，有珠海或广州酒店可住。"
  ]},
  { id: "help", type: "callout", title: "需要把广州地址和澳门酒店配在一起比较？", tone: "decision", body: "把日期、广州上车区域、澳门酒店、人数、行李和行动限制发给 Homeground。我们可以比较换乘次数和所需余量；铁路票量、出入境决定和口岸运营仍以官方机构为准。" },
  { id: "faq", type: "faq", title: "广州到澳门常见问题", items: [
    { question: "从广州怎么坐火车去澳门？", answer: "从广州南站乘车到珠海站、经拱北口岸过关到关闸，或乘车到横琴站、经横琴口岸过关。请在 12306 同时搜索出行当天到珠海站和横琴站的车次，再比较从广州住址到澳门酒店的完整行程。" },
    { question: "去澳门该走拱北还是横琴？", answer: "拱北通常更适合住澳门半岛北部或中部；横琴通常更适合路氹、氹仔，或已确认能接上轻轨或接送的酒店。行李多、到得晚或口岸施工都可能改变结论。" },
    { question: "澳门口岸几点开放？", answer: "2026 年 8 月 13 日核对时，澳门海关列出关闸／拱北旅客通道为 06:00–01:00，横琴口岸澳门口岸区 24 小时开放。通关资格、内地一侧安排和临时管制仍需重新核对官方信息，而且口岸 24 小时不代表列车、轻轨和酒店接驳也通宵运行。" },
    { question: "从横琴口岸怎么到路氹的酒店？", answer: "通关后按指示牌到轻轨横琴站，乘横琴线到莲花站，再换乘氹仔线到离酒店最近的车站。单程票在售票机或服务柜台购买；柜台接受银行卡、支付宝和微信支付，售票机接受现金和轻轨卡。" },
    { question: "到珠海站或横琴站的火车票能直接进澳门吗？", answer: "不能。火车票只到内地车站，之后要自己带着行李通过内地出境和澳门入境查验。出发前请按现行官方规定核对每本护照的澳门入境依据，以及之后是否需要再次进入内地。" },
  ] },
  ...
  { id: "sources", type: "sources", title: "官方来源", items: [
    ...
    { label: "头图：横琴口岸外观——Charlie fong（CC BY-SA 4.0）", url: "https://commons.wikimedia.org/wiki/File:Hengqin_Port2021.jpg", publisher: "维基共享资源", reviewedAt: "2026-08-13" },
