...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "抵达当天可以订限时门票吗？",
          answer: "国际抵达日默认应保持弹性。只有入境手续、行李、地面交通、酒店衔接和场馆入场这几环都已核清，而且错过预约的代价可以接受，才考虑安排不易替代的限时项目。任何一个关键信息未知，都应改用可替换时段，而不是把计划落地或到站时间直接当成游览开始时间。",
        },
        {
          question: "“限时预约”和“弹性时段”有什么区别？",
          answer: "限时预约绑定姓名、日期或入场时段，不易替代，并有迟到、取消或爽约后果，不能随意往后挪两个小时。弹性时段是酒店附近的一顿饭、休息、街区散步或普通商店，可以晚开始、缩短或取消，而不会伤及整趟旅行。",
        },
        {
          question: "上午就落地，下午是不是就能游览了？",
          answer: "落地只是通过了风险树的第一个节点。实际靠桥、开舱门或到站时间可能偏离计划；外国旅客仍须提交证件并接受边防检查；托运行李提取需要时间；远机位或航站楼变化会改变起点。酒店房间也未必已好，寄存同样不是自动提供。",
        },
        {
          question: "落地当天能不能订故宫？",
          answer: "如果是下午抵达的长途国际航班、还带托运行李，就不要把故宫设为抵达日的限时预约。航班、边检、行李、进城、酒店和场馆安检是一条串联风险，门票无法吸收未知延误。把参观放在完整的本地日，当天改用附近用餐、散步或休息。",
        },
        {
          question: "坐高铁抵达和坐飞机抵达，结论一样吗？",
          answer: "不一样，但也不是自动更轻松。国内铁路仍要看具体车站、证件流程和出口，只带随身行李可以删去托运行李分支。能否安排较晚的限时参观，取决于实时 12306、酒店寄存和场馆规则，所以仍以当天复核为准，而不是看时刻表。",
        },
        {
          question: "航班延误，但限时门票已经订了，怎么办？",
          answer: "在场馆官方截止时间前按官方渠道取消，再启用酒店周边的弹性模块。如果托运行李没到，要求承运人出具行李事故记录，并依适用条款约定领取或送达，不要带着未解决的行李问题冲向定时场馆。",
        },
      ],
    },
    {
