...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "打包前最常问的几个问题", items: [
    { question: "牛肉干、肉松或萨拉米可以带进中国吗？", answer: "不可以。生的或熟的肉类及肉制品都在禁止携带名录里，不论怎么包装，都不要当作食品伴手礼带。" },
    { question: "奶酪、牛奶等乳制品可以带吗？", answer: "动物源的牛奶、奶油、黄油、奶酪、酸奶和炼乳都属于名录里的乳制品。除非有明确适用于该具体产品的例外规定，否则不要带。" },
    { question: "飞机上的新鲜水果可以带过关吗？", answer: "不可以。新鲜水果和蔬菜是明确列出的植物检疫类别，落地前吃完或丢弃。" },
    { question: "罐头或真空包装的食品可以带吗？", answer: "包装不改变类别：肉罐头仍然是肉制品，动物奶罐头仍然是乳制品。工厂包装的植物类零食通常可以，但要先逐项核对配料。" },
    { question: "拿不准的东西要不要申报？", answer: "要。申报不等于允许，但对需要申报或拿不准的物品，走红色通道是正确的处理方式；之后由海关决定退运、处理、销毁还是放行。" }
  ] },
