...
const body = {
  ...
  "blocks": [
    ...
    {"id":"links","type":"internal-links","title":"继续读懂建筑遗产","items":[{"label":"苏州园林应该怎么看","href":"/zh/guides/how-to-read-a-suzhou-garden/","description":"用游览顺序、框景与借景读园林，而不是只数亭台。"},{"label":"兵马俑自由行指南","href":"/zh/guides/terracotta-warriors-without-tour/","description":"把大型考古遗址的解释和交通安排分开处理。"},{"label":"中国旅行需要导游吗","href":"/zh/guides/do-you-need-a-tour-guide-in-china/","description":"判断哪些地方值得请人讲解，哪些适合自行参观。"},{"label":"比较黄鹤楼、岳阳楼与滕王阁","href":"/zh/guides/three-literary-towers-comparison/","description":"在一座木构楼与两座现代重建之间取舍时，继续使用同样的材料证据方法。"}]},
