...
const body = {
  ...
  "blocks": [
    ...
    {"id":"faq","type":"faq","title":"看斗拱常见问题","items":[{"question":"斗拱能单独托住整座屋顶吗？","answer":"不能。斗拱在一个节点承接、传递或外挑荷载，屋顶还要靠檩和椽继续传力，下面还有台基、柱网、梁和联系构件。从台基沿一根柱追踪到屋顶，斗拱层只是这条受力路径中的一段。"},{"question":"中国木构真的一颗钉子都不用吗？","answer":"“一颗钉子都不用”不足以解释木构。传统榫卯确实是核心，但现实建筑也可能包含铁件、后加固和修补构件。不要以为每根可见木构都是原件，先看说明牌里注明的建造阶段和维修史。"},{"question":"有斗拱就一定抗震吗？","answer":"不能这样判断。联合国教科文组织说明的是整套木构技艺具有柔性和抗震特点，这可以解释体系，却不能证明某一座建筑今天处于安全状态。经历地震仍保存也不能只归因于斗拱：整体几何、榫卯、材料状态、基础、维护、旧损伤与具体震动都有关。"},{"question":"斗拱上鲜艳的彩画是原来的吗？","answer":"不一定。彩画鲜艳不代表结构更重要：装饰会跨越承重与非承重表面，也可能是后世重绘。不同部位彩画颜色或保存状态不同，只是可见事实，不能当作年代证据；建造阶段和维修史要看现场说明牌。"},{"question":"为什么转角的斗拱看起来比中间密？","answer":"因为转角要同时处理两个方向的出檐，构件也在转角改变方向。可以比较中间开间与转角，记下方向、出挑和构件密度的变化。现场若有剖面图、修缮图或模型，都比从立面猜内部构造可靠得多。"},{"question":"应县木塔是世界遗产吗？","answer":"还不是。它是中国提交的辽代木构建筑世界遗产预备名单组成部分，列入预备名单不等于已成为世界遗产。应县佛宫寺释迦塔建于1056年，申报文本描述了八角、多层、内外槽结合且斗拱类型丰富的结构，因此很适合比较不同层次与转角。"}]},
