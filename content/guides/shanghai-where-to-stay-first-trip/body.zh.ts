...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "links", type: "internal-links", title: "继续规划", items: [ { label: "上海城市总览", href: "/zh/destinations/shanghai/", description: "在敲定这类细节之前，先决定几个完整游览日、住哪一岸和走哪个门户。" },{ label: "如何判断靠近地铁", href: "/zh/guides/china-hotel-near-metro/", description: "核对准确出口和大堂步行。" }, { label: "上海选浦东机场还是虹桥机场", href: "/zh/guides/shanghai-pudong-or-hongqiao-airport/", description: "让酒店匹配正确机场接驳。" }, { label: "国际航班前中国最后一晚", href: "/zh/guides/china-last-night-before-international-flight/", description: "保护离境夜，又不浪费整天。" }, { label: "核验上海二十四小时公园", href: "/zh/guides/shanghai-24-hour-parks-reality-check/", description: "只有在核对准确区域、入口、设施和返程后，才把深夜公共空间加入行程。" }] },
