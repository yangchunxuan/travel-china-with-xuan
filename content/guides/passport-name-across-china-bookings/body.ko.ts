  ...
  "blocks": [
    {
      "id": "answer-first",
      "type": "lead",
      "text": "여행 당일 실제로 들고 갈 여권의 신원을 사용하세요. 항공권과 실명 철도표는 여행에 쓰는 유효 문서와 일치해야 합니다. 호텔과 앱은 필드를 다르게 표시할 수 있지만 별명이나 다른 문서를 써도 된다는 뜻은 아닙니다. 여권에서 하나의 원본 기록을 만들고 플랫폼 변환 증거를 보존하세요."
    },
    {
      "id": "decision-map",
      "type": "table",
