...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "列车订餐常见问题", items: [
    { question: "怎么在 12306 上给列车订餐？", answer: "打开当前的铁路 12306 餐饮入口，匹配真实车次和日期，只在它返回的配送车站和商家中选择。付款前确认乘车人、可接通的手机号、车厢和座位，保存订单记录，并留意商家是否接单。" },
    { question: "12306 订餐的截止时间是什么？", answer: "对于站外商家，列车从配送车站计划发车前 60 分钟内不能下单或取消，除非商家设置了更早的截止。这不是从你出发站开车前 60 分钟算，所以要查看配送车站的发车时间和实际商品显示的截止时间。" },
    { question: "餐食是怎么送到座位上的？", answer: "这是一场按时刻衔接的接力：商家制作餐食，车站配送人员在列车到达前通过受控交接送入，再由铁路工作人员或车站配送链送到记录的车厢和座位。无座旅客在记录的车厢等候，凭订单手机号后五位取餐。" },
    { question: "境外银行卡能付 12306 的餐费吗？", answer: "当前 12306 服务协议明确只列出支付宝和微信。上海市的一份说明提到银行卡，但那份次级说明并不约束平台，所以只以实时结算页面为准；付款无法完成时，改带一份确认过的餐食上车。" },
    { question: "改签或退票后，餐食订单会怎样？", answer: "餐食是独立订单，不会随之转到新车次。请在允许的时间窗内自行取消，新行程符合条件时再重新下单；如果没有可配送车站，就在上车前从可靠店铺买好食物。" },
  ] },
