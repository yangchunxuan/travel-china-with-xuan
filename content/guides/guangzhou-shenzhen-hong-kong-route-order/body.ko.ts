...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "one-base-heading", type: "heading", level: 2, text: "광저우의 같은 호텔을 유지할까요, 선전에서 잘까요?" },
  { id: "one-base-choice", type: "list", ordered: false, items: [
    "선전 방문을 즉흥적인 당일치기로 정했고 체크아웃을 한 번 더 피하는 것이 가장 중요하다면 광저우 호텔을 유지하세요. 큰 짐은 호텔에 두되, 이후 홍콩으로 간다면 그날 광저우로 돌아오는 길과 다음 날 아침 호텔에서 역까지 가는 추가 이동도 계산하세요.",
    "선전 관광과 이후 홍콩 이동을 함께 계획한다면 선전 숙박을 고려하세요. 광저우 → 선전에서 1박 → 홍콩으로 가면 중간에 광저우로 되돌아가지 않아도 됩니다. 호텔 변경과 짐 이동이 한 번 늘어나는 부담을 절약되는 이동과 비교하고, 실제 방문 장소와 출입경 지점에 맞춰 선전 숙박 구역을 고르세요.",
    "홍콩에서 며칠을 보낼 계획이라면 홍콩 숙박과 본토 호텔에서 매번 홍콩으로 당일치기하는 방법을 비교하세요. 출입경 절차와 교통비를 예산에 포함하고, 예약 전에 매번 본토에 재입국할 자격을 확인하세요. 객실료가 낮다는 이유만으로 전체 여행이 더 저렴하거나 편해지는 것은 아닙니다."
  ] },
  ...
  ] },
  {
    ...
    "type": "heading",
    "level": 2,
    "text": "서구룡역에서 돌아올 때는 얼마나 일찍 도착해야 할까요?"
  },
  {
    "id": "hong-kong-return",
    "type": "paragraph",
    "text": "홍콩 서구룡역에서 본토로 돌아갈 때는 신분 확인, 보안 검색과 양쪽 출입경 수속을 거칩니다. MTR의 통상 소요 안내는 약 30–45분이며, 여권 소지자나 혼잡일·막차 이용자는 여유를 더 두어야 합니다. 수속은 출발 90분 전부터 가능하고, 신분·승차권 확인은 30분 전, 승차 게이트는 5분 전에 마감됩니다. 각각 다른 기준이므로 역까지 이동과 대기 시간을 별도로 더하세요."
  },
  {
