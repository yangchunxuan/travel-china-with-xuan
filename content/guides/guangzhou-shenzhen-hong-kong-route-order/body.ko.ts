...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "동선 순서 자주 묻는 질문", items: [
    { question: "광저우, 선전, 홍콩은 어떤 순서로 가야 하나요?", answer: "항공편을 따라 한 방향으로 가세요. 광저우로 들어와 홍콩에서 나간다면 광저우→선전→홍콩, 항공편이 반대라면 역순입니다. 같은 국경 구간을 두 번 지나지 않도록 하세요." },
    { question: "광저우와 홍콩 사이에 선전에서 하룻밤 묵을 가치가 있나요?", answer: "잘라 내도 남을 구체적인 선전 우선순위가 있을 때만입니다. ‘가는 길에 있다’는 경험이 아닙니다. 체크아웃, 짐, 출입경 절차, 새 체크인을 계산하고, 그 하룻밤이 두 번째 국경 통과를 강요하거나 마지막 국제선 출발을 약하게 만들면 빼세요." },
    { question: "호텔을 바꾸지 않고 선전을 방문할 수 있나요?", answer: "네. 선전이 집중된 당일 방문이고 체크아웃을 한 번 줄이는 것이 가장 중요하다면 광저우 호텔을 유지하고 짐 보관을 확인하세요. 선전 방문과 이어지는 홍콩 구간을 함께 계획할 때만 선전에서 자세요." },
    { question: "홍콩 서구룡역에서 고속철도를 타려면 얼마나 일찍 도착해야 하나요?", answer: "MTR은 서류 확인, 보안 검색, 양쪽 출입경 심사에 보통 약 30–45분이 걸린다고 안내합니다. 절차는 출발 90분 전부터 시작할 수 있고 신분·승차권 확인은 출발 30분 전에, 탑승 게이트는 5분 전에 닫힙니다. 여권 소지자와 혼잡일·막차 승객은 시간을 더 두세요." },
    { question: "홍콩 출입경 지점은 어디를 이용해야 하나요?", answer: "철도 소요 시간만이 아니라 양쪽 숙소 문에서 고르세요. 홍콩 호텔에서 서구룡역이나 해당 출입경 지점까지, 본토 도착 지점에서 선전이나 광저우 호텔까지, 현재 서류 요건, 짐을 누가 드는지를 비교합니다. 홍콩 보안국은 여러 육로 출입경 지점을 안내하며 각각 교통과 운영 정보가 다릅니다." },
  ] },
