# Dynamic fact review — changsha-zhangjiajie-transport-route
...
Choose the base first, search the real date in 12306, then build the exact origin–arrival–hotel chain without treating the station as the park.
