...
const body = { schemaVersion: "1.0.0", blocks: [
  { id: "lead", type: "lead", text: "先选景区入口，再选交通枢纽。已经订北景区，通常从长白山站到达，第一晚住池北区或二道白河镇更直接；已经订西景区，则优先比较长白山西站和长白山机场，并住在池西区或松江河镇一侧。北景区和西景区分别运营，不是同一个游客中心的两扇门。" },
  ...
  { id: "decision-tree", type: "list", ordered: true, items: [
    ...
    "入口尚未确认：先不要购买不可退的火车票、机票和酒店。",
    "出行当天：再次核对景区运营、12306或航司记录、道路天气和最后一段正规接驳的上车点。"
  ]},
  { id: "identity-matrix", type: "table", caption: "这里说明枢纽身份，不承诺某一班车", columns: ["票面枢纽", "默认适用", "主要麻烦", "付款前确认"], rows: [
    ...
    ["长白山机场 · Changbaishan Airport", "西侧度假区或西景区", "航班延误和行李提取可能错过预约车辆", "确认航站楼接人点、深夜处理方式，以及车辆是否送到确切酒店"],
    ["延吉、长春等外部枢纽", "本地机票或车票时间不合适时的备选", "增加长距离铁路或公路段，也更容易受天气影响", "比较完整的门到门行程，并保留中途住宿，而不是只比较票价"]
  ]},
  { id: "chains-heading", type: "heading", level: 2, text: "把路线一直接到当天运营的游客中心" },
  { id: "chains", type: "comparison", title: "三种常见到达方式", columns: [
    { heading: "坐火车去北景区", items: ["火车票：长白山站", "第一晚：池北区 / 二道白河镇", "确认当前使用的北景区游客中心", "从公告指定地点进入景区正规换乘系统"] },
    { heading: "坐火车去西景区", items: ["火车票：长白山西站", "第一晚：池西区 / 松江河镇", "确认酒店或正规车辆在正确站区接人", "前往当天使用的西景区集散中心"] },
    { heading: "坐飞机去西景区", items: ["航班：长白山机场", "在司机结束等候前提取行李", "确认第一站是酒店还是西景区集散中心", "晚到时先去酒店休息"] }
  ]},
  { id: "scenario-heading", type: "heading", level: 2, text: "看起来相似，却需要不同枢纽的行程" },
  { id: "scenarios", type: "table", caption: "让第一个登山日真正可用", columns: ["旅客情况", "更稳妥的方案", "什么情况会改变结论"], rows: [
  ...
  { id: "winter", type: "callout", title: "有票不等于山路和主峰段一定开放", tone: "warning", body: "景区可能因大风、降雪、结冰或能见度调整内部交通，甚至暂停部分区域。冬季安排也会随雪季变化。前一晚和离开酒店前，都要查长白山景区官方公告以及中国气象局的预报和预警。第一晚应留在正确的一侧，不要把当天到达、上主峰和长距离离开塞进同一天。" },
  { id: "recovery-heading", type: "heading", level: 2, text: "到错一侧或道路中断时怎么办" },
  { id: "recovery", type: "table", caption: "不要为了赶当天行程而硬凑时间", columns: ["问题", "立即处理", "更稳妥的替代方案"], rows: [
    ...
    ["出现道路预警或景区停运", "服从官方公告，取消已经没有必要的车辆预约", "保留同侧酒店，等运营恢复后再安排上山"]
  ]},
  ...
  { id: "sources", type: "sources", title: "官方来源", items: [
    ...
    { label: "头图：长白山站外观——A Chinese user（CC BY-SA 4.0）", url: "https://commons.wikimedia.org/wiki/File:Exterior_of_Changbaishan_Railway_Station,_Aug_13_2022.jpg", publisher: "维基共享资源", reviewedAt: "2026-08-13" },
