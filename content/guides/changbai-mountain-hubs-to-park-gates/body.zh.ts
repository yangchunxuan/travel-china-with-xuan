...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "长白山交通常见问题", items: [
    { question: "长白山站和长白山西站是同一座车站吗？", answer: "不是。两者英文名相似，却是两座不同车站。长白山站默认适用于北景区，住池北区或二道白河镇；长白山西站默认适用于西景区，住松江河镇或池西区。订票时抄全中文站名，并让酒店确认接站区域。" },
    { question: "景区订单写“北景区”，该从哪个枢纽走？", answer: "铁路先查长白山站，住宿先查二道白河镇或池北区。先打开有日期的景区订单，把“北景区”三个字抄下来，一张天池照片说明不了入口在哪一侧。出行当天再核对一次景区运营、12306 或航司记录、道路天气和最后一段正规接驳的上车点。" },
    { question: "住在西侧滑雪度假区，又安排了一天北景区，可行吗？", answer: "西侧抵达不变，但要把北景区当天视为单独的跨区公路任务，而不是两个门之间的短程接送。天气差或入园早，可能值得提前把一晚移到池北区；这样安排是为了让第一个登山日真正可用。" },
    { question: "北景区和西景区是同一个公园的两个入口吗？", answer: "不是。北景区和西景区分别运营，不是同一个游客中心的两扇门。已经订西景区，就优先比较长白山西站和长白山机场，并住在池西区或松江河镇一侧，这样可以避免跨越山区。顺序是先选景区入口，再选交通枢纽。" },
    { question: "有景区门票就一定能上主峰吗？", answer: "不一定。景区可能因大风、降雪、结冰或能见度调整内部交通，甚至暂停部分区域，冬季安排也会随雪季变化。前一晚查一次长白山景区官方公告和中国气象局的预报与预警，第二天离开酒店前再查一次。" },
    { question: "订了西景区却到了长白山站怎么办？", answer: "先留在池北一侧，把正规跨区车辆和景区状态核实清楚。更稳妥的做法是把西景区移到另一天，或改订同侧住宿；不要在时间压力下坐来源不明的车，也不要为了赶当天行程而硬凑时间。" },
  ] },
