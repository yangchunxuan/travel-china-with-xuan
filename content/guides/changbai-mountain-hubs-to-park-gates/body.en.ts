...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Changbai Mountain hub questions", items: [
    { question: "Are Changbaishan Station and Changbaishanxi Station the same place?", answer: "No. They are two different stations despite the similar English names. 长白山站 (Changbaishan) is the useful default for the North Slope with a Chibei or Erdaobaihe base; 长白山西站 (Changbaishanxi) goes with the West Slope and a Songjianghe or Chixi base. Copy the full Chinese station name and confirm the hotel-side pickup." },
    { question: "Which hub do I use if my park booking says 北景区?", answer: "Search rail tickets to 长白山站 and lodging in 二道白河镇 or 池北区. Copy 北景区 from the dated scenic-area order rather than working from a Tianchi photo, which does not identify the slope. On the travel date, recheck scenic-area operations, the railway or airline record, road weather and the final authorised transfer pickup." },
    { question: "We are staying at the west-side ski resort but have one North Scenic Area day. Does that work?", answer: "Keep the west-side resort arrival, but treat the North Slope day as a separate cross-region road operation rather than a short hop between two gates. Bad weather or an early park entry may justify moving one night to Chibei instead. The point is to keep the first mountain day realistic." },
    { question: "Are the North and West Scenic Areas two entrances to the same park?", answer: "They are two separately operated areas, not two doors of one visitor centre. For a West Scenic Area booking, Changbaishanxi Railway Station or Changbaishan Airport with a Songjianghe or Chixi hotel normally avoids crossing the mountain region. Choosing the park entrance before the transport hub is what keeps the two sides from being mixed up." },
    { question: "Does a valid park ticket mean the summit section will be running?", answer: "No. The scenic area may adjust internal transport or suspend sections because of wind, snow, ice or visibility, and official winter arrangements change by season. Check the Changbai Mountain scenic-area notice and the China Meteorological Administration forecast and alerts the evening before, then check again before leaving the hotel." },
    { question: "I arrived at Changbaishan Station but my booking is for the West Scenic Area. What now?", answer: "Stay on the Chibei side long enough to verify a licensed cross-region vehicle and the current scenic-area status. The safer alternative is to move the West visit to another day or rebook a same-side night. Do not take an unverified car under time pressure to force the original plan into the same day." },
  ] },
