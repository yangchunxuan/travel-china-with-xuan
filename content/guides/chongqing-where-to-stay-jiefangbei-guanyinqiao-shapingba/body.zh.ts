...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "先给结论", tone: "decision", body: "第一次来、停留短且重点在渝中半岛密集景点与夜景，可优先解放碑；更想住在现代商业中心、重视餐饮购物与夜间活动，可比较观音桥；西站或西侧景点确实占据行程时，沙坪坝才更合理，不能只因为看起来“远离游客”就选。" },
  ...
  { id: "matrix", type: "table", caption: "比较每日链路，而非区域名气", columns: ["住宿区", "更适合", "主要牺牲", "预订前核对"], rows: [
    ["解放碑／渝中核心", "首次短停、洪崖洞—朝天门—半岛夜间活动", "人流、道路拥堵与容易误判的立体步行", "酒店入口层级、可用地铁出口与车辆下客点"],
    ["观音桥", "餐饮、购物与现代商业区夜生活", "前往渝中经典景点通常仍需跨区", "酒店在整个商圈的准确一侧"],
    ["沙坪坝", "重庆西站逻辑、磁器口或西侧行程", "渝中夜游后的返回更长", "准确车站与轨道连接，不把整个行政区当成一个点"]
  ]},
  ...
  { id: "fit", type: "comparison", title: "三种常见行程", columns: [
    ...
    { heading: "重视餐饮与城市生活", items: ["比较观音桥", "确认具体街区", "为渝中游览日计算交通"] },
    { heading: "西侧抵达或游览", items: ["用准确车站检验沙坪坝", "把磁器口与西侧景点集中安排", "不要每天都在渝中晚归"] }
  ]},
  ...
  { id: "facts", type: "callout", title: "动态信息核验于2026年8月12日", tone: "neutral", body: "重庆市政府英文信息仍以渝中魁星楼周边说明城市多层地形，将磁器口列于沙坪坝，并将解放碑列为活跃夜间区域。这些是地理事实；上面的住宿取舍属于Homeground编辑判断。出发前仍须用官方渠道和住宿方核对实时轨道运营、出口、道路进入与施工。" },
  ...
  { id: "sources", type: "sources", title: "官方来源与图片署名", items: [
    { label: "重庆渝中立体地形官方介绍", url: "https://english.cq.gov.cn/latestnews/Editor/202606/t20260608_15735957.html", publisher: "重庆市人民政府", reviewedAt: "2026-08-12" },
