...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "选住宿区常见问题", items: [
    { question: "第一次来重庆只住两晚，选解放碑、观音桥还是沙坪坝？", answer: "选解放碑。两三晚首次到访、要去多个渝中地标时，它能减少每天回游客核心的移动。多次在观音桥及北侧聚餐或开会，才选观音桥；磁器口加西侧日程超过一天，才选沙坪坝。解放碑的代价是人流、夜间噪音，部分地址车辆也难进。" },
    { question: "只为去磁器口，该住沙坪坝吗？", answer: "只去一次就不必。重庆官方资料确认磁器口古镇位于沙坪坝区，但一次西行不该决定每一晚的住宿；其余行程都在中心时，解放碑仍然更合适。磁器口或其他西侧安排重复出现，或者准确的抵达枢纽与酒店刚好匹配时，住沙坪坝才划算。" },
    { question: "观音桥在地图上看着居中，可以因此选它吗？", answer: "不行。全市地图上看着居中不是理由。只有餐饮、现代商业、商务地址或亲友都在两江以北，行程多次在观音桥结束，住这里才有价值。请列出最常重复的观光日、最晚夜归和离开日，比较完整路线。写着观音桥的酒店若在大商圈另一端，最后一段步行仍可能很长。" },
    { question: "地图上很近的酒店，为什么可能很难走到？", answer: "因为高度被藏起来了。重庆市官方访客资料用魁星楼说明渝中的立体地形：看似地面的地方，可能比另一条街高出许多楼层。很短的直线里可能藏着楼梯、陡路、天桥、楼内电梯，或者会随大楼一起关闭的通道。所以要先问酒店大堂开向哪条街、哪一层。" },
    { question: "订重庆酒店前，该问哪些问题？", answer: "六个：大堂开向哪条路、哪一层；带行李的车辆停在哪里；哪个地铁出口可用；路线是否穿过其他建筑；哪些房间能避开街道和夜生活噪音；所报时段前台能否处理护照。因为一栋楼能在不同高度连接多条街，中心步行地址也可能无法到门。" },
    { question: "深夜才到重庆，住哪个区会不一样吗？", answer: "可能不一样。晚到时，有人值守、道路简单的酒店可能胜过理论上最佳的区域，所以不要把不确定的晚间换乘、陡坡和自助入住压在同一晚。先用完整的机场或铁路站名比较门到门路线，再按旅行日期重查实时路线、地铁出口和物业进入方式。" },
  ] },
  { id: "links", type: "internal-links", title: "继续规划", items: [{ label: "先从重庆城市旅行指南开始", href: "/zh/destinations/chongqing/", description: "进入本专题前，先决定住几晚、住宿基地、交通门户，以及是否加入武隆或大足。" },{ label: "如何判断靠近地铁", href: "/zh/guides/china-hotel-near-metro/", description: "检验地铁出口和立体最后步行。" }, { label: "核验真正可用的无障碍酒店房", href: "/zh/guides/china-accessible-hotel-room-verification/", description: "核对立体城市中从路缘到房间的完整通路，而不只看电梯图标。" }, { label: "外国旅客能住中国任何酒店吗？", href: "/zh/guides/foreigners-china-hotel/", description: "核验具体物业在实际抵达时段的护照登记。" }, { label: "国际航班前中国最后一晚", href: "/zh/guides/china-last-night-before-international-flight/", description: "保护重庆行程之后实际机场的出境安排。" }, { label: "民宿、homestay还是酒店", href: "/zh/guides/minsu-homestay-or-hotel-china/", description: "核对小型物业真实运营。" }, { label: "一个基地还是多个住宿点", href: "/zh/guides/china-hub-and-spoke-or-multi-base-route/", description: "判断反复跨城是否值得换住宿区。" }, { label: "理解重庆的立体城市", href: "/zh/guides/chongqing-upper-lower-city-orientation/", description: "把重庆当作三维城市来读：短距离步行前先核对道路高度、车站出口和建筑入口。" }] },
