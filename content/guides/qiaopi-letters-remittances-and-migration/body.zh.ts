...
const body = {
  ...
  blocks: [
    ...
    {"id":"privacy-callout","type":"callout","title":"公开展出的仍是私人家庭记录","body":"遵守持有机构的拍摄规则，只引用解释所需的最少文字，优先使用馆方释文，不公开完整住址或可能涉及在世后人的信息。认不清的字应标作存疑，不能让 OCR 自动补成通顺故事。提名档案明确这些材料受档案和知识产权规则管理；一张照片的开放许可也不自动等于底层信件全文可以任意复用。","tone":"warning"},
    ...
    {"id":"recovery-list","type":"list","items":["手写难辨时，在允许拍摄的前提下先记标签与目录号，不凭一个字形猜全文。","币种或金额冲突时，原样保留每处记录，先查明是哪一机构、哪一栏写的再计算。","两个旧地名相近时，查馆方历史地名表或目录；现代地图可能抹掉旧行政边界。","展厅路线图属于场馆解释，具体一件仍要回到它自己的戳记和日期。","看不到原件时，数字件或复制件仍可用于内容阅读，但要注明媒介，不能声称检视过纸张、墨迹或物理叠压。","参观前向持有机构核对当前展览、证件要求、开放公告和拍摄规则；轮换与利用规则最后核对于 2026 年 8 月 13 日。"]},
