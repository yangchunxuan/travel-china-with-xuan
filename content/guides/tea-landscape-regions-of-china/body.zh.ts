...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "在杭州多出一天，值得去龙井吗？",
          answer: "值得，看点是紧凑的城市—茶园过渡。从密集城区到丘陵、茶园和生产村落，同一天就能走完，这种接近本身就是证据。出发前先确认一家机构或生产者，并保留西湖或博物馆作为不生产时的备选；即使不买茶，这一天也应该成立。",
        },
        {
          question: "去了一定能看到制茶吗？",
          answer: "没有固定时间表，当天有没有采摘或实际生产也无法保证。春季生产受品种、海拔和天气影响，茶农不会为了游客保证开工。现场确实在做时，要问清眼前是哪一步、鲜叶来自哪里，以及是在做可销售的一批茶，还是用练习材料演示。",
        },
        {
          question: "想做一次茶主题旅行，去几个产区合适？",
          answer: "选两个反差大的系统，不要匆忙集齐四地。武夷加景迈，比较精细加工与森林土地利用；龙井加安化，比较近城绿茶与紧压黑茶、运输设施。挑选的依据是你想看懂哪一种关系，而不是哪里的茶最好。",
        },
        {
          question: "古树或景迈标签能证明茶饼来源吗？",
          answer: "不能。普洱是一个很大的产区，景迈山只是其中一个边界明确的世界遗产文化景观，并不是所有普洱都来自景迈。铭牌可以证明所在位置，却不能替无关商家出售的茶饼背书，“古树茶”也不是完整溯源。购买前先记录生产者、产品名、年份或季节与批次信息。",
        },
        {
          question: "安化黑茶就是另一种普洱吗？",
          answer: "不是。二者的原料、产品、工艺史与景观都不同。安化最适合按生产链来读：茶园提供原料，初制形成黑毛茶，后续工序做出千两茶等产品，紧压与储存再把产品连到茶厂、商号、集市、山路和旧码头。",
        },
        {
          question: "参观变成纯销售怎么办？",
          answer: "回到五步核验，追问茶园身份和具体工序。对方答不上来时，仍可以把品饮当作招待，但不要把销售话术当作溯源证据。靠近遗产地喝到的一杯茶，不会自动获得遗产产地证明。",
        },
      ],
    },
    {
