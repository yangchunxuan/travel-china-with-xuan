...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "방문 전 자주 묻는 질문", items: [
    { question: "외국인도 여권으로 이화원을 예약할 수 있나요?", answer: "예약할 수 있습니다. 베이징시 공식 안내에 따르면 외국인은 이화원 위챗 계정에서 여권이나 외국인 영구거류 신분증으로 예약할 수 있습니다. 온라인 절차가 되지 않으면 유효한 여권을 가지고 입구 종합 서비스 창구에서 직원의 도움을 받아 살 수 있습니다. 예약에 쓴 원본 증명서를 챙겨 가세요." },
    { question: "처음 간다면 어느 입구가 좋을까요?", answer: "동궁문은 궁전 구역에서 장랑, 만수산, 쿤밍호로 이어지는 첫 동선에 맞지만 4호선 시위안역에서 걷는 구간이 남습니다. 북궁문은 베이궁먼역에서 바로 닿는 대신 입장하자마자 언덕을 넘을지 우회할지 정해야 하고, 넘으면 경사와 계단이 있습니다. 신건궁문은 십칠공교와 난후섬부터 봅니다." },
    { question: "통합권을 꼭 사야 하나요?", answer: "동선에 별도 유료 구역이 실제로 들어갈 때만 필요합니다. 기본 입장권으로 주요 공원에 들어가 장랑, 쿤밍호 호안, 다리와 산기슭을 볼 수 있습니다. 통합권은 현재 불향각, 덕화원, 쑤저우제, 이화원박물관 등 공원 안의 별도 유료 구역을 더합니다. 다만 입장 자격일 뿐 폐장 전에 전부 볼 수 있다는 뜻은 아닙니다." },
    { question: "이화원은 몇 시에 닫나요?", answer: "주요 공원은 성수기(4월 1일~10월 31일) 06:00~20:00이고 입장 마감은 19:00, 비수기는 06:30~19:00에 입장 마감 18:00입니다. 내부 유료 구역은 더 일찍 닫고 지정 공휴일을 빼면 보통 월요일에 휴관합니다. 늦게 공원에 들어가더라도 불향각, 박물관, 쑤저우제는 놓칠 수 있습니다." },
    { question: "유람선으로 쿤밍호를 건너갔다가 돌아올 수 있나요?", answer: "노선마다 다릅니다. 노선은 대부분 편도이고, 쑤저우제-쑤윈옌 노선은 공식적으로 돌아오는 편이 없습니다. 그래서 표를 사기 전에 부두의 출발지와 도착지를 읽어야 합니다. 현재 대형 페리는 08:30~17:30 운항하고 공식 일반 운항기는 3월 중순부터 11월 중순입니다." },
    { question: "오르막이 가장 적은 동선은 무엇인가요?", answer: "오르막이 적은 호수 동선입니다. 신건궁문으로 들어가 십칠공교, 난후섬, 동쪽 호안, 문창각 일대를 지나 동궁문으로 나가는 순서입니다. 만수산 중심 건물보다 물과 다리, 넓은 전망을 우선하는 사람에게 맞습니다. 북궁문이 자동으로 가장 편한 것은 아니며, 언덕을 넘으면 경사와 계단이 있습니다." },
  ] },
