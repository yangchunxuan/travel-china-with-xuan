...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "ticket-comparison", type: "comparison", columns: [
    ...
    { heading: "통합권", body: "현재 불향각, 덕화원, 쑤저우제, 이화원박물관 등 별도 유료 원중원 입장을 포함합니다." },
  ...
  { id: "routes", type: "table", caption: "실행 가능한 이화원 동선 두 가지", columns: ["동선", "핵심 순서", "추천 대상"], rows: [
  ...
  { id: "boat-heading", type: "heading", level: 2, text: "배는 연결 수단이지 과한 동선의 구조선이 아닙니다" },
  ...
  { id: "boat-plan-b", type: "callout", title: "모든 배 동선에는 도보 쌍둥이가 필요합니다", body: "입장 전에 같은 다음 목적지로 가는 호숫가 길을 찾아 두세요. 운항이 중단되면 다른 부두를 찾아 공원을 가로지르지 말고 도보안으로 바꾼 뒤 우선순위가 가장 낮은 유료 구역을 빼야 출구와 다음 교통을 지킬 수 있습니다.", tone: "decision" },
  ...
  { id: "final-check", type: "list", items: ["입구와 다른 출구를 중국어·영어로 저장합니다.", "불안해서 통합권을 사지 말고 실제 동선에 맞춰 표를 고릅니다.", "가장 일찍 닫는 내부 구역부터 확인합니다.", "정확한 부두 쌍으로 배 한 노선과 도보 대안을 저장합니다.", "날씨, 운항 공지, 마지막 귀가 교통을 다시 봅니다."] },
  ...
  { id: "consultation", type: "callout", title: "실제 하루에 맞는 입구가 필요하신가요?", body: "Homeground 여행 상담가는 숙소, 보행 제한, 계절, 다음 시간 지정 일정에 맞춰 동선을 점검할 수 있습니다. 보고 싶은 장소, 입장 시각, 이동 제한, 유람선이 필수인지 보너스인지 알려 주세요.", tone: "neutral" },
