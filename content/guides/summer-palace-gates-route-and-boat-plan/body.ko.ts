...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  { id: "answer-first", type: "lead", text: "외국인은 공식 채널에서 여권으로 이화원을 예약할 수 있습니다. 온라인 절차가 되지 않으면 원본 여권을 가지고 입구 종합 서비스 창구를 이용하세요. 기본표와 통합권은 실제로 걸을 동선에 맞춰 고릅니다. 동궁문은 궁전에서 호수로 이어지는 동선에 맞습니다. 북궁문은 지하철 4호선 접근은 편하지만 입장 직후 언덕을 넘을지 우회할지 결정해야 합니다. 신건궁문은 십칠공교와 호수 풍경에 가깝고, 유람선은 선택 사항입니다." },
