...
const body: StructuredPageBody = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "参观常见问题", items: [
    { question: "外籍游客能用护照预约颐和园吗？", answer: "可以。北京市官方访客指南说明，外籍游客可以在颐和园微信公众号用护照或外国人永久居留身份证预约；线上流程走不通时，官方票务说明也给出持有效护照到门区综合服务窗口由工作人员协助购票的方式。当天记得带上预约所用证件原件。" },
    { question: "第一次去颐和园该从哪个门进？", answer: "东宫门适合按宫廷区、长廊、万寿山、昆明湖的顺序理解，只是从地铁4号线西苑站还要走一段。北宫门从北宫门站直接到达，但入园就要决定翻山还是绕行，直接翻山会遇到坡道和台阶。新建宫门则从十七孔桥、南湖岛和东南湖岸开场。" },
    { question: "一定要买联票吗？", answer: "只有路线真的包含园中园时才需要。门票可以进入主园区，足够走长廊、昆明湖岸、桥梁和山脚；联票在此基础上加上官方列出的园中园，目前包括佛香阁、德和园、苏州街和颐和园博物馆。联票提供的是进入资格，不保证各处都能在关门前走完。" },
    { question: "颐和园几点关门？", answer: "主园区现行旺季（4月1日至10月31日）06:00—20:00开放，19:00停止入园；淡季06:30—19:00开放，18:00停止入园。园中园关得更早，除重点节假日外通常周一关闭，所以赶上主园区的晚入园，不等于还赶得上佛香阁、博物馆或苏州街。" },
    { question: "游船能载我横渡昆明湖再回来吗？", answer: "不是每条航线都可以，各航线多为单程。例如官方明确苏州街至宿云檐航线没有返程，所以购票前要看清码头的起点和终点。现行大型摆渡船营业时间为08:30—17:30，官方常规运营期为3月中旬至11月中旬。" },
    { question: "哪条路线爬升最少？", answer: "低爬升的湖景线：新建宫门进，走十七孔桥、南湖岛取舍、东堤、文昌阁一带，再从东宫门出。它适合更看重水面、桥梁和开阔景观，而不是非登万寿山核心建筑不可的人。北宫门并不天然等于最省体力，直接翻山会有坡道和台阶。" },
  ] },
