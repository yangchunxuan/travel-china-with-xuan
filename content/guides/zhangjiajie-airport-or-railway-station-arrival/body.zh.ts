  ...
  "blocks": [
    ...
    },
    {
      ...
      "rows": [
        [
          "山地天气、道路交接、行李与不同基地",
          "有大行李时，比较出口到车辆的距离、装卸过程及住宿道路末段，而不只比较市区与景区的公里数。",
        ...
        [
          ...
          "把天门山与森林公园预约留在抵达日之外，先保住到住宿基地的道路、入住与睡眠。",
    ...
    },
    {
      ...
      "ordered": true,
      "items": [
        "核对承运记录中的DYG、张家界站或张家界西，并把同行人实际站立地点告诉酒店。",
        "请机场或铁路人员确认只是出口不同，还是抵达了另一座设施。",
        "购买跨节点车辆前先问承运方当前预订可以怎样处理。",
        "致电准确酒店分店；只有它确认车辆、前台和可行抵达时间后才继续。",
        "已经无法满足天门山或森林公园截止时立即移动预约，不要求司机冒险赶山路。",
        "武陵源交接无法核实时，前往有人值守的市区床位，次日再重建公园行程。"
      ]
    },
    {
      "id": "changes-heading",
