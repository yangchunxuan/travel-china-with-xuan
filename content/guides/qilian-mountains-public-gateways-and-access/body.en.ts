...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Qilian access questions answered", items: [
    { question: "Where is the entrance to Qilian Mountains National Park?", answer: "There is no single entrance to look for. As of 13 August 2026, national and provincial official pages still describe it as the Qilian Mountains National Park candidate area, and the mountain system crosses Gansu and Qinghai with different managers. Choose a town first, then one named public site, and treat everything beyond its signed visitor boundary as closed unless the responsible authority explicitly opens it." },
    { question: "Is there a Qilian Mountains museum I can visit?", answer: "There is one documented public museum: Zhangye forestry authorities identify the Qilian Mountains National Park Natural Museum in Hongwansi, Sunan, as a public-education facility. A museum visit does not authorise a self-drive route into the candidate area's core or prove that every nearby road is open, so ask the venue about current hours and road conditions before travelling." },
    { question: "Can I drive into the mountains from Qilian County or Babao?", answer: "Staying in the county does not authorise unsupervised driving in protected areas. The 2019 pilot plan listed Babao and nearby Qinghai communities as proposed entrance-service locations, but that old plan does not show what is open today. Before travelling, confirm one named public venue or registered local activity for your date, and use only that confirmed venue or activity." },
    { question: "Can I visit Mati Temple, and is it part of the national park?", answer: "Mati Temple is an established scenic area, operated separately, and seeing it is not unrestricted entry to the national park. At Mati township, national and Zhangye sources document entrance-community development alongside it, and “entrance community” is a planning and service term, not an open backcountry gate. A promotional grassland name or accommodation pin is not access evidence for protected land." },
    { question: "Can I fly a drone or camp for a sunrise shot?", answer: "If an activity is prohibited, replace the activity rather than the rule. No drone means ground-level photography from a public viewpoint; no camping or fire means sleeping in a licensed town property; a closed road means the public museum or a community exhibit. If you meet wildlife, stay in the vehicle or a designated area, give the animal distance and never publish sensitive coordinates." },
    { question: "What should I put in writing when I hire a car and driver?", answer: "Write the exact destination in Chinese, including the county, township and the full venue or organiser name, because “Qilian Mountains” is not enough for a driver. Put the legal turnaround point, waiting time, what to do if mobile signal drops and the town return in writing, and request a dated notice for seasonal closure, fire control, snow and road works." },
  ] },
