...
{"id":"links","type":"internal-links","title":"把这顿饭接进整段旅程","items":[{"label":"在中国第一次吃共享餐","href":"/zh/guides/first-shared-meal-in-china/","description":"先理解通用点菜、分量和桌餐服务逻辑，再套用湘菜风味方案。"},{"label":"外国游客如何在中国付款","href":"/zh/guides/how-to-pay-in-china-as-a-tourist/","description":"选择地方小店前准备好付款备选。"},{"label":"你的中国行程是不是太赶","href":"/zh/guides/is-your-china-itinerary-too-rushed/","description":"给共享餐留出时间，不要硬塞在两张定时票之间。"}, { label: "搭配南昌拌粉和瓦罐汤", href: "/zh/guides/nanchang-breakfast-rice-noodles-clay-pot-soup/", description: "区分南昌拌粉、炒粉与汤粉，按口味和份量搭配瓦罐汤，使用现场点单语言，并处理辣度不合或汤品售罄。" }, { label: "问清酸味来自腌制还是醋", href: "/zh/guides/zhenjiang-vinegar-living-fermentation/", description: "如果醋影响这道菜，就用镇江香醋指南理解发酵与来源，但不要预设使用某一种地域调味品。" }]},
