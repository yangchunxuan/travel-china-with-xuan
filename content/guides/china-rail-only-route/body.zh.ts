...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "路线常见问题", items: [
    { question: "在中国是不是应该完全不坐国内航班？", answer: "不要在检查最弱一环之前，就把“不坐国内航班”当成原则。当城市能连成连续走廊、每段都有实用的站到站选择，而且最长转场不会吃掉核心体验时，纯铁路路线才成立。路线边缘的一段航班，可能在不把整趟旅行变成机场接力的情况下，保护中间连贯的铁路主轴。" },
    { question: "我们行李很大，这会影响纯铁路路线吗？", answer: "会。行李是铁路路线必须通过的检查之一：适合铁路的结果是全组能安全上车、存放和搬运行李；警告结果是每次换乘都依赖扶梯、紧张时间，或者行李比人手还多。先在最长或最不直接的那一段上检查这一点，再去优化容易的部分。" },
    { question: "12306的联程车票是不是就代表换乘很顺？", answer: "不是。现行规程把联程车票定义为分段购买、可在同一或同城铁路客运营业站接续的多段车票；这个定义并不表示所有接续都舒适。要搜索准确日期和车站，再加入市内进站、安检、候车、换乘和抵达交通。" },
    { question: "夜间卧铺真的能省一晚酒店吗？", answer: "纸面上能，但要先算清楚其他代价。收益是在原本睡眠的时段移动；要测试的代价是铺位类型、真实睡眠、深夜上车、清早抵达和入住前的行李。纸面省下一晚酒店、实际毁掉第二天，属于警告结果，不是节省。" },
    { question: "途中铁路区段出现异常，先做什么？", answer: "先通过12306或车站工作人员确认状态，并准备好车票和购票使用的证件，然后保护下一项固定离境。不能让可选观光和最后可行接续竞争。整条链无法继续时就停止连锁：保留当前房间或安排一晚住宿，再按已确认的次日服务重建。" },
    { question: "一段火车到底要算多少时间？", answer: "按门到门算，而不是只看列车运行时间。把每趟列车转换成完整行程：退房、市内交通、车站余量、铁路、抵达交通和入住空档。再看这一段能自然放入转场日，还是会占掉稀缺观光日的大部分。" },
  ] },
