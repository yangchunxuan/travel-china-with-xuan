  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "变脸就等于川剧吗？",
          answer: "不等于。变脸只是较大表演词汇中的一种特殊技艺，它的戏剧价值取决于角色与场景，而不是换了多少次。一次有用的初看，应该让你注意演员怎么说、怎么唱、怎么走动、怎么把角色立起来，不论当晚有没有快速换脸。",
        },
        {
          question: "每场川剧演出都会有变脸吗？",
          answer: "不一定。完整剧目或篇幅较长的制作未必有变脸；愿意为看戏做准备时，最佳选择也可能没有变脸。游客向综合节目会把短川剧片段或绝活与音乐、木偶、杂技等组合在一起，所以买票前要核对当期节目，而不是只看面具照片。",
        },
        {
          question: "没有英文字幕，能看懂吗？",
          answer: "做一点准备就能跟上。可以索取中文节目单或获准使用的梗概，入场前先认清人物名和基本冲突，再把翻译屏幕放下；机器翻译只用于定位，不是权威剧本。念白推动情节与身份，唱腔改变人物情绪，打击乐则标记出场、动作、紧张和喜剧节奏。",
        },
        {
          question: "游客向的演出是不是不够正宗？",
          answer: "这些是节目形式，不是“真假”排名。训练扎实的演员可能在不同形式中工作，游客多的场所也不能证明演员缺乏专业训练；反过来，华丽装修和“正宗变脸”四个字同样没有说明剧目。综合节目唯一不能做的，是让你声称已经看过一部完整川剧。",
        },
        {
          question: "宣传里的变脸当晚取消了怎么办？",
          answer: "先问是否公布过变更，以及售方明示的退换条款是否适用；如果决定留下，就专心看一个有名称的片段。节目调整不能否定其他演员或整种川剧，现场替换本属正常，这也是入场时值得再核对当日安排的原因。",
        },
        {
          question: "可以拍摄变脸吗？",
          answer: "只有场馆与演员允许时才可以。要遵守现场规则；别人在拍不等于你获得许可，需要图片时，授权节目册或获准的官方媒体更稳妥。本文不解释受到保护的操作机制，也不鼓励逐帧拍摄。",
        },
      ],
    },
    {
