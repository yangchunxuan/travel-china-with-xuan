# B22 image plan — why-china-museums-have-stamps
...
- Desired scene: one named museum's current, authorised visitor stamp point, with an adult's anonymous hands using a blank dedicated notebook; staff permission and exact venue/date recorded.
- Strong candidates only after written approval: Beijing Art Museum at Wanshou Temple, Xu Beihong Memorial Museum, Nanjing Museum, Jining Museum or Yiyang Museum. The current mechanism must be rechecked immediately before photography.
- Rights state: pending. Official webpages and annual-report photographs are not reuse licences.
- Caption must identify free/paid/event status only if the venue confirms it on the shoot date.

## Do not use

- A passport or visa page receiving a souvenir stamp.
- A recognisable visitor, child, staff badge, ticket barcode or payment screen.
- Screenshots from Xiaohongshu, Douyin, WeChat, news video or museum social posts.
