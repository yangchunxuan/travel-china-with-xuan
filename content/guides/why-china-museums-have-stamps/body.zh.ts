...
{"id": "scenarios-heading", "type": "heading", "level": 2, "text": "先决定自己要收集到什么程度"},
    ...
    },
    {
      ...
      items: [
        {
          question: "博物馆的纪念印章是免费的吗？",
          answer: "要看场馆，因为全国没有统一的“博物馆盖章系统”。一枚章可能免费，也可能绑定付费本册、只在活动期间出现、由商店经营，或今天已经暂停。有些机构会清楚标明免费机制；自助机器也可能是零售终端，并非免费印台。先核对场馆现状，再决定要不要专程收集。",
        },
        {
          question: "去年的帖子里有章点，现在还会有吗？",
          answer: "把它当作“这种机制存在过”的证据，不要当作今天仍然可用。已记录的案例分别来自过去的展览、工作报告和活动通知；没有场馆的新通知，就不能把它们当作2026年的章点地图。临展或限时活动的章可能已经撤走，旧社交帖子却还在。",
        },
        {
          question: "能把章盖在护照或门票上吗？",
          answer: "护照、签证、居留卡和身份证件一律不能盖，油墨、损坏或非官方印记会给重要证件带来风险。带条码、二维码或返场凭证的票，要先询问是否有指定的可撕空白区，并只用明确允许的区域，因为印章不能遮挡扫码或影响再次入场。",
        },
        {
          question: "到了博物馆怎么问哪里有章？",
          answer: "到服务台直接问：“请问现在有集章活动吗？在哪里？需要购买盖章本吗？”出发前可以在博物馆当前官网或官方账号搜索“集章”“印章”“文创”“活动”。到馆后再确认章点是免费、绑定购买、限时还是位于商店，并问清能否使用自己的本子。",
        },
        {
          question: "集章是中国的古老传统吗？",
          answer: "不是。上海博物馆的玺印篆刻馆区分了以凭信为主要功能的玺印与作为艺术形式的篆刻，这能解释为什么墨色印迹容易理解、也适合变成博物馆纸面视觉，却不能证明今天的集章活动直接源自古代仪式。2026年的跨案例研究把“护照+印章”描述为组织动线与动力的低技术工具。",
        },
        {
          question: "章点找不到，或者印迹不清楚怎么办？",
          answer: "只向服务台问一次，不要去工作人员区域寻找；也不要连续重压或自己加墨。把不完美的印迹保留为真实到访记录，或在预留处写下展厅和文物名称。排队一旦开始取代看展，就暂停集章，回到下一件已选文物。",
        },
      ],
    },
    {
