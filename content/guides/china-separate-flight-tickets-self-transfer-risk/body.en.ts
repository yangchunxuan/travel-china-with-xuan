...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions about separate tickets", items: [
    { question: "I bought both flights in one booking. Is the connection protected?", answer: "Not by itself. CAAC guidance says a through itinerary contains two or more flights on the same ticket number, and requires sellers to tell passengers whether multiple booked flights are through flights. Non-through flights are usually issued independently under separate contracts, so a disruption to one does not automatically change the other, and each ticket follows its own carrier conditions." },
    { question: "Will my checked bag go all the way to the final destination?", answer: "Only if the seller says so in writing. Ask whether checked baggage is accepted through to the final destination and save the written product description; do not infer it from airline alliance, shared branding or airport layout. If the answer is conditional or unclear, price the journey as separate contracts and assume you may need to collect bags and re-check." },
    { question: "How much time should I leave between two separately ticketed flights?", answer: "There is no universal number. Start with all mandatory processing time, meaning deplaning, formalities, bags, transfer, check-in, security and gate access, then add operational uncertainty for the route and season from current airport and carrier information, and recovery time if the next viable flight is infrequent. A long nominal gap is weak if there is no later option." },
    { question: "The booking site advertises a self-transfer guarantee. Can I rely on it?", answer: "Read its exact eligibility, notification and evidence requirements before acting on it. A marketed self-transfer guarantee is the seller's own product, so check what it requires of you at the moment of disruption, and save carrier messages, receipts and the original product description for any claim. Coverage is determined by their terms." },
    { question: "My first flight is delayed and I will miss the second. What now?", answer: "Verify the first flight's status with its carrier, then contact the second carrier or seller before its check-in cut-off. Explain that the tickets are separate and ask for the available paid or discretionary options; do not claim automatic protection. Compare the last viable same-day alternative with an overnight and next-day departure, and save carrier messages and receipts." },
    { question: "Can I use a same-day self-transfer before my international flight home?", answer: "Avoid it. When a connection precedes an international departure, one domestic disruption can lose the most expensive ticket, so the better option is to arrive in the departure city the previous day. If failure would threaten the final international departure, move the first flight to the previous day rather than arguing over minutes." },
  ] },
