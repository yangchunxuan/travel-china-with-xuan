...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "分开出票常见问题", items: [
    { question: "两段机票是一次下单买的，接续就受保护吗？", answer: "不一定。民航局提示：同一客票号码上的两个及以上航班属于联程，销售多个航程时也应明确告知是否为联程。非联程航班通常独立出票、对应不同运输合同，一段发生异常不会自动改变另一张票，每张票分别适用各自承运人条件。单一结算页面或一个代理订单号本身不足以证明联程。" },
    { question: "托运行李会直接挂到最终目的地吗？", answer: "只有销售方书面说明了才算。要直接问托运行李是否能到最终目的地，并保存书面产品说明，不要根据联盟、共同品牌或机场布局推断。答案带条件或不清楚时，就按独立合同计价，并假设需要提取行李后重新托运；同日间隔紧张时，提取和重托会制造硬截止时间。" },
    { question: "两张独立机票之间应该留多长时间？", answer: "没有统一数字。先加入所有强制流程：下机、手续、行李、转移、值机、安检与到达登机口；再根据路线和季节，用当前机场及承运人信息加入运营不确定性；后续可用航班稀少时还要加入恢复时间。名义间隔很长但没有后续选择，仍然脆弱。" },
    { question: "平台宣传的自转机保障能靠得住吗？", answer: "行动前先读清楚它的适用条件、通知时限和证据要求。代理平台宣传的自转机保障是销售方自己的产品，要看清异常发生时它对你有什么要求；同时保存承运人消息、收据和原始产品说明，以备申请。是否覆盖由各自条款决定。" },
    { question: "第一段延误，肯定会错过第二段，怎么办？", answer: "先向首段承运人核实状态，再在第二段值机截止前联系其承运人或销售方，明确说明是分开出票，询问付费或酌情方案，不要声称自动受保护。然后比较当天最后可行备选，以及住宿一晚、次日出发，并保存承运人消息和收据。" },
    { question: "回程国际航班前能不能安排同日自转机？", answer: "不建议。接续后是国际离境时，一次国内异常可能损失最贵的票，更好的方案是前一天抵达离境城市。若失败会危及最终国际离境，应把首段移到前一天，而不是争论多留几十分钟。" },
  ] },
