...
const body: StructuredPageBody = {
    ...
    },
    {
      ...
      rows: [
        ...
        [
          ...
          "除了看，也要听和感受：叶上雨声、水声或水面波动、树荫与反光，在无花时同样构成景。",
        ],
        [
          "题名、匾额与楹联",
  ...
  },
  {
    ...
    },
    {
      ...
      items: [
        {
          question: "第一次去苏州，最该看哪座园林？",
          answer: "看你想理解什么：拙政园看大面积水景构图，留园看游廊与庭院，网师园看紧凑的宅园一体，狮子林看可以穿行的石灰岩假山。这是四种特点，不是排名。",
        },
        {
          question: "半天只看一座园林够吗？",
          answer: "够。把一座园林当成主角，留时间坐在水边、回望游廊，只有另一座能提供不同体验时才加。预订前先查园林管理方当天的封闭区域和施工通知。",
        },
        {
          question: "联合国教科文组织的“苏州古典园林”包括几座？",
          answer: "九座。1997 年列入四座，2000 年增补五座：拙政园、留园、网师园、环秀山庄、沧浪亭、狮子林、艺圃、耦园和退思园。",
        },
        {
          question: "“借景”是什么意思？",
          answer: "把园外的元素——远处的塔、邻家的树线、天空或声音——纳入园内构图。它常被和“框景”混淆：框景是园内由门洞或窗户截出的一幅画面。",
        },
        {
          question: "苏州园林的假山为什么要像山？",
          answer: "中国园林是一个缩影：叠石代表山脉，小池代表大水，小树暗示森林。人工堆叠的假山并不假装是天然地貌，关键在于它能否令人信服地营造体量、纵深和不断变化的视角。",
        },
      ],
    },
    {
