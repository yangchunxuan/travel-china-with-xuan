...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "西安住宿常见问题", items: [
    { question: "第一次去西安该住哪里？", answer: "围绕古城核心和市中心夜晚的短期首访，住钟楼附近。只有当某座城门正好对应火车到站、计划景点或有车辆可达的安静小巷时，才选其他城门；当大雁塔、城南博物馆或反复的城南夜晚比古城更重要时，选大雁塔。" },
    { question: "“城墙内”这个描述够用吗？", answer: "不够。永宁门附近、火车站一侧、西侧城门或城内小巷的住宿会形成完全不同的日程。要问最近的是哪座具名城门，以及你的路线是跨墙、穿墙还是从城门通过。" },
    { question: "钟楼附近有地铁吗？", answer: "有。西安政府游客信息把钟楼定位在四条古城大街的交汇处，并列出地铁 2 号线钟楼站。但这不代表每家名字里带“钟楼”的酒店都靠近车站，或带着行李容易到达。" },
    { question: "要住在大雁塔附近吗？", answer: "当大雁塔、城南博物馆或城南夜晚反复出现时可以。西安官方信息把大雁塔定位在地铁大雁塔站，4 号线连接主要景点和铁路车站。问自己 21:30 会累在哪里：如果好几个晚上都在大雁塔一带结束，就住城南，因为为一个例外的夜晚打一次车，比每晚跨城返回容易。" },
    { question: "选西安酒店要按兵马俑的集合点来吗？", answer: "不要。兵马俑在西安市区之外，可以通过不同的公共、私人或团队方式到达，先确定方式和真实出发点。当前的大巴集合点不是长期住在钟楼的理由。" },
  ] },
  { id: "links", type: "internal-links", title: "继续规划", items: [ { label: "西安城市总览", href: "/zh/destinations/xian/", description: "在敲定这类细节之前，先决定住几晚、以哪里为基地和下一站去哪。" }, { label: "查看西安 5 天私家路线", href: "/zh/tours/xian-terracotta-warriors-5-day-private-tour/", description: "四晚固定一个西安住宿基地，串联城墙、大雁塔、兵马俑与回民街。" },{ label: "不跟团游兵马俑", href: "/zh/guides/terracotta-warriors-without-tour/", description: "选择并保护真实郊外日程。" }, { label: "如何判断靠近地铁", href: "/zh/guides/china-hotel-near-metro/", description: "核对出口与最后步行。" }, { label: "核验真正可用的无障碍酒店房", href: "/zh/guides/china-accessible-hotel-room-verification/", description: "检验路缘、入口、电梯、房间和浴室的完整链条。" }, { label: "外国旅客能住中国任何酒店吗？", href: "/zh/guides/foreigners-china-hotel/", description: "核验具体物业的护照登记执行和故障恢复。" }, { label: "国际航班前中国最后一晚", href: "/zh/guides/china-last-night-before-international-flight/", description: "从实际国际出境机场倒推，而不是只看城市名称。" }, { label: "民宿、homestay还是酒店", href: "/zh/guides/minsu-homestay-or-hotel-china/", description: "核验传统风格物业运营。" }, { label: "读懂一段中国城墙", href: "/zh/guides/chinese-city-walls-gates-and-urban-order/", description: "分清原存、保护性修缮、复建与考古遗存，再把城门和街道放回完整的城市系统中理解。" }, { label: "规划陕西历史博物馆", href: "/zh/guides/shaanxi-history-museum-booking-and-collection-plan/", description: "用外籍护照预约，分清小寨本馆与秦汉馆，并按 90 分钟或深度版本安排西安馆藏参观。" }] },
