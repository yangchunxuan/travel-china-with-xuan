...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "出发前常见问题", items: [
    { question: "去苏北黄海湿地，应该住在哪里？", answer: "先选一种公众湿地体验，再住到它附近。想去条子泥，东台最实用；想理解麋鹿保护，大丰更合适；想先看黄海湿地博物馆、再另行安排丹顶鹤湿地生态旅游区，盐城市区更方便。不要因为两个地方都在黄海地图上，就顺手再塞进一段海岸。" },
    { question: "条子泥、麋鹿园和丹顶鹤区，一天能全部走完吗？", answer: "不要这样安排。这些地点属于同一个保护故事，却不是一个能步行连通的公园；只有一天时，不要把两个相距很远的海岸产品硬拼在一起，除非有书面车程、当前开放确认和天黑前返程。稳妥的做法是只去一个公众区域，留在管理线路内，再回到同一个基地。" },
    { question: "冬天来就一定能看到野生丹顶鹤吗？", answer: "不一定。丹顶鹤湿地生态旅游区只是大保护区的一部分，冬季也不保证看到野生丹顶鹤。野生动物会自由移动，任何负责任的向导都不能保证某种鸟、某群鸟、潮汐奇观或近距离相遇。先选栖息地和学习体验，再把每次目击当作额外收获。" },
    { question: "这处世界遗产是一个能一路走通的大公园吗？", answer: "不是。UNESCO 的中国黄（渤）海候鸟栖息地由多个分离的组件组成，不是一条连续的游客栈道；世界遗产边界里也可能包含不向普通游客开放的栖息地。用 UNESCO 地图理解保护系统，出发前再向当前场地管理方确认哪些区域对游客开放。" },
    { question: "遇上下雨，或者没看到鸟，这一天怎么办？", answer: "把这一天移到室内，不要为了救行程硬走海岸。可以去黄海湿地博物馆，并问当前管理方稍后是否还有安全窗口。目标物种没出现时，就观察栖息地、常见物种、痕迹和解说，把环境条件记下来，不要让司机去搜索没有标识的保护区道路。" },
    { question: "在这里观鸟要守哪些规矩？", answer: "留在指定道路、栈道和观鸟屋，现场标识和工作人员的指示优先于观鸟 App。不要播放鸟鸣、不要飞无人机、不要打强光、不要投喂、不要追近；压低说话声，鸟飞走时不要跟上去。盐城滨海湿地条例禁止猎捕、捡蛋和破坏鸟巢，巢址和敏感的实时坐标也不要公开。" },
  ] },
