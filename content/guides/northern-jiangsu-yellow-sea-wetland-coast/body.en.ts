...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Questions before a Yellow Sea wetland trip", items: [
    { question: "Where should I stay for the Yellow Sea wetlands?", answer: "Choose one public wetland experience and sleep near it. Dongtai is the practical base for the Tiaozini coast, Dafeng is the base for the Chinese Milu Park, and Yancheng city works for the Yellow Sea Wetland Museum and a separately arranged visit toward the Red-crowned Crane Wetland Ecotourism Area. Do not add a second coast merely because both appear on a Yellow Sea map." },
    { question: "Can I do Tiaozini, the Milu Park and the crane area in one day?", answer: "Plan against it. These places belong to one larger conservation story, but they are not one walkable park, and with only one day you should never join two distant coastal products without written drive times, current opening confirmation and a protected daylight return. Visit one public component, stay inside its managed route and return to the same base." },
    { question: "Will I see red-crowned cranes if I come in winter?", answer: "Treat it as possible rather than promised. The Red-crowned Crane Wetland Ecotourism Area is only part of a much larger reserve, and winter does not guarantee a wild crane sighting. Wildlife is free-moving, so no responsible guide can promise a named bird, flock, tide spectacle or close encounter. Choose the habitat and the learning first." },
    { question: "Is the World Heritage site one big park I can walk through?", answer: "No. UNESCO's Migratory Bird Sanctuaries along the Coast of Yellow Sea–Bohai Gulf are made of separate components, not a continuous visitor promenade, and a World Heritage boundary can include habitat with no general visitor access. Use UNESCO maps to understand the conservation system, then ask the current site management which areas are open to visitors." },
    { question: "What should I do if it rains or the birds do not appear?", answer: "Move the day indoors rather than forcing the coast. Use the Yellow Sea Wetland Museum and ask the current coastal management whether a later safe window exists. If a target species is absent, observe habitat, common species, tracks and interpretation and log the conditions, instead of asking a driver to search unmarked reserve roads." },
    { question: "What are the rules for watching birds here?", answer: "Stay on designated roads, boardwalks and hides, and let signs and staff instructions override a birding app. Use no playback, drones, spotlights, feeding or close pursuit, keep voices low and let birds move away without following them. Yancheng's coastal-wetland regulation prohibits hunting, egg collection and nest damage, and sensitive real-time coordinates should not be published." },
  ] },
