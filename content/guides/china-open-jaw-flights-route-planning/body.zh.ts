...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "可以从一座中国城市入境、从另一座城市离境吗？",
          answer: "中国出境入境管理法本身没有规定普通访客必须从入境机场原路离境，它要求经对外国人开放的口岸出入境并接受边防检查。真正决定这条路线的，是你本人使用的入境依据：某种签证、免签政策或口岸签发证件，可能限定入境口岸、停留区域或离境口岸。",
        },
        {
          question: "一进一出两座城市，就符合 240 小时过境免签吗？",
          answer: "不符合。“本国 → 中国 → 本国”不符合这项政策要求的第三国（地区）逻辑，只把中国境内的入境城市和离境城市改成两个地方，也修不好这一点。官方条件包括符合资格的旅客、适用口岸、已确认的前往第三国（地区）安排，以及在允许区域内活动。",
        },
        {
          question: "买两张独立单程票，和开口程一样吗？",
          answer: "不一样。两张无关的机票通常不会互相保护，各自的改签、退票和行李规则也不同。两张独立机票之间的自行转机，除非书面票规另有说明，否则由旅客自己承担风险。比价时要把它标成独立机票风险，不能当成和开口程等价的产品。",
        },
        {
          question: "最低价写着北京，指的是 PEK 还是 PKX？",
          answer: "要看机票上的具体代码。北京可能显示 PEK 或 PKX，上海可能是 PVG 或 SHA，成都可能是 CTU 或 TFU；最低票价有时对应更难到达的机场、更差的出发时刻，甚至需要跨机场转移。请搜索机票上写明的机场代码，不要只搜城市名。",
        },
        {
          question: "行程要跨机场，需要自己取行李重新托运吗？",
          answer: "默认要自己提取行李再重新托运。除非航空公司针对该行程明确确认，涉及跨机场的行程都要这样准备。还要按实际出发时段估算酒店到航站楼的时间，并加上值机截止时间；上海机场自己的旅客信息也把浦东与虹桥作为两座不同机场。",
        },
        {
          question: "开口程更贵，贵多少还算划算？",
          answer: "只值它省掉的那部分：返程交通、接驳、可能多出的酒店、损失的可用时间和中断风险。不要套用统一的“每小时价值”，先把回头路标成四分之一天、半天或一整天，再由同行人决定这段损失值多少钱。",
        },
        {
          question: "应该先到哪座中国城市？",
          answer: "没有哪一座中国城市天然应该永远放在开头或结尾。用“多城市”搜索把两个方向都查一遍：A 进 B 出，再查 B 进 A 出。地理上很顺的路线，也可能因为深夜落地之后紧接固定早班活动而变得不可靠。",
        },
      ],
    },
    {
