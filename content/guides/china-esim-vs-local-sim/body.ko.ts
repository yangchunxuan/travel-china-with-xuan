...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      id: "faq",
      type: "faq",
      title: "연결 준비 자주 묻는 질문",
      items: [
        {
          question: "중국을 여행하려면 중국 전화번호가 꼭 필요한가요?",
          answer: "꼭 필요하지는 않습니다. 배달, 시설, 계정 또는 연락 상대가 본토 음성이나 SMS를 요구할 때 현지 번호가 유용하지만, 모든 여행 업무의 필수 조건은 아닙니다. 공식 모바일 결제 안내는 주요 결제 앱이 해외 또는 중국 전화번호를 받을 수 있다고 설명하지만 개별 은행, 가맹점과 인증 흐름은 다를 수 있습니다. 어떤 업무가 번호를 요구하는지 먼저 적어 보세요.",
        },
        {
          question: "중국 본토 밖에서 산 iPhone으로 중국에서 eSIM을 쓸 수 있나요?",
          answer: "가능할 수 있지만 여행 eSIM에 한합니다. 휴대전화가 본토 통신사 발급 eSIM을 활성화하지 못해도 글로벌 사업자는 중국 본토용 여행 데이터 eSIM을 판매할 수 있습니다. Apple은 현재 특정 중국 본토 판매 iPhone 모델에 대해서만 본토 통신사 eSIM을 안내하며, 본토 밖에서 산 iPhone에는 본토 통신사 프로필을 설치할 수 없다고 설명합니다.",
        },
        {
          question: "중국에서 SIM 카드를 사려면 여권이 필요한가요?",
          answer: "필요하며 원본 여권을 가져가야 합니다. 개통에는 실명 등록이 필요하고 복사본만으로는 신원 확인이 끝나지 않을 수 있습니다. 외국 여권을 처리한다고 확인한 중국이동·중국연통·중국전신 직영 영업점을 이용하세요. 베이징 공식 안내에는 공항 서비스 카운터도 있지만 위치와 운영시간을 다시 확인해야 합니다.",
        },
        {
          question: "여행 eSIM에는 +86 번호와 문자 기능이 포함되나요?",
          answer: "대개 포함되지 않습니다. 여행 eSIM은 데이터 전용이 많아 +86 번호·음성·SMS가 없을 수 있고, 활성화·라우팅·핫스폿·앱 동작은 상품별로 다릅니다. 본토 통신사 SIM은 보통 현지 번호와 일반 통신 서비스를 제공합니다. 데이터 용량만으로 번호나 음성 서비스를 추정하지 마세요.",
        },
        {
          question: "현지에 도착했는데 eSIM이 연결되지 않으면 어떻게 하나요?",
          answer: "프로필을 반복 삭제하지 말고 단계별로 확인하세요. 데이터 회선, 사업자가 요구한 로밍, APN, 자동·수동 망 선택과 활성화 시점을 점검한 뒤 Wi-Fi로 스크린샷과 주문 번호를 보내 지원에 문의합니다. 공항 Wi-Fi 안내, 하루 로밍권, 동행자 핫스폿 또는 오프라인 주소 중 하나를 도착 대안으로 준비해 활성화 실패가 첫 이동까지 막지 않게 하세요.",
        },
        {
          question: "기존 회선에서 로밍 요금이 생기지 않게 하려면 어떻게 하나요?",
          answer: "두 회선에 이름을 붙인 뒤 셀룰러 데이터, 데이터 전환, 기본 음성, 기본 SMS의 네 설정을 확인하세요. 자동 데이터 전환이 비싼 기존 회선으로 트래픽을 옮길 수 있으면 끄세요. 해외 SMS 수신 요금을 기존 통신사에 확인하고, 통화를 받거나 다시 거는 데는 다른 요금이 적용될 수 있음을 기억하세요.",
        },
      ],
    },
    {
