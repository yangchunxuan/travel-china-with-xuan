...
const body: StructuredPageBody = {
  ...
  "blocks": [
    ...
    },
    {
      ...
      "type": "callout",
      "title": "첫 계획이 실패하면",
      "body": "eSIM 메뉴가 없으면 정확한 기기판과 잠금 상태를 다시 확인한 뒤 물리 SIM, 로밍, 포켓 Wi-Fi 또는 호환 예비폰으로 바꾸세요. 현지 SIM 개통 실패는 공식 영업점에서 여권 입력을 확인합니다. 데이터는 되지만 특정 앱이 안 되면 앱 또는 라우팅 문제로 따로 진단해야 하며 모든 eSIM이나 현지 SIM의 공통 결과로 일반화하지 마세요.",
      "tone": "warning"
    },
    {
      "id": "scope-boundary",
