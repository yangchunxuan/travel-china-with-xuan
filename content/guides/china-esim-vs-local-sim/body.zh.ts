...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "在中国旅行必须有中国内地手机号吗？",
          answer: "不是必须的。快递、场馆、账号或联系人明确要求中国内地语音或短信时，本地号码会有帮助，但它不是所有旅行任务的前提。官方移动支付指引说明，主要支付应用可以用境外或中国手机号注册，不过具体银行、商户和验证流程仍可能不同。先写清楚究竟是哪项任务必须用本地号。",
        },
        {
          question: "在中国内地以外买的 iPhone，能在中国用 eSIM 吗？",
          answer: "可能，但只能是旅行 eSIM。即使手机不能开通内地运营商发行的 eSIM，国际服务商仍可能出售用于中国内地的旅行数据 eSIM。Apple 目前只为特定中国内地销售的 iPhone 型号说明内地运营商 eSIM，并注明中国内地以外购买的 iPhone 不能安装内地运营商配置。",
        },
        {
          question: "在中国办 SIM 卡要带护照吗？",
          answer: "要带原护照。开户需要实名登记，只有复印件通常不能完成身份核验。选择中国移动、中国联通或中国电信确认可办理外国护照的自营营业厅；北京官方指南也列出机场服务柜台，但地点和营业时间仍需实时核对。",
        },
        {
          question: "旅行 eSIM 会给我 +86 号码和短信功能吗？",
          answer: "常常不提供。旅行 eSIM 常见产品只有流量，不一定有 +86 号码、语音或短信；激活、路由、热点和应用表现取决于具体产品。内地运营商 SIM 通常提供本地号码和普通运营商服务。不能从流量额度推断带号码、语音或短信。",
        },
        {
          question: "落地后 eSIM 连不上网，应该怎么办？",
          answer: "不要反复删除配置，按层次排查。先检查数据线路、服务商要求的数据漫游、APN、自动或手动选网和激活时间，再用 Wi-Fi 联系客服，附上截图和订单号。同时保留一种抵达备用方式：机场 Wi-Fi 说明、一日漫游包、同行人热点或离线地址，避免激活失败连第一段接送都无法完成。",
        },
        {
          question: "怎样避免原号码线路产生漫游费？",
          answer: "先给两条线路命名，再检查蜂窝数据、数据切换、默认语音和默认短信四项设置。如果自动数据切换可能把流量转到昂贵的原线路，就把它关闭。向原运营商确认境外收短信是否收费，并注意接听或回拨电话可能使用另一套资费。",
        },
      ],
    },
    {
