...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  {id: "suffix-rule", type: "callout", title: "Treat every qualifier as part of the station name", body: "When a direction or another qualifier appears in the official station name, copy the full name—and the Chinese characters where available—from the 12306 result or booking confirmation into the hotel route and taxi destination. ‘East’, ‘West’, ‘South’, ‘North’ and ‘New’ can identify entirely different stations.", tone: "warning"},
