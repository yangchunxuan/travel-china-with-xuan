...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "车站选择常见问题", items: [
    { question: "为什么中国的高铁站常常离市中心很远？", answer: "因为选址要同时平衡铁路走向和运力、建设与拆迁条件、本地接驳，有时还包括城市发展目标，每座城市的取舍不同。国家指引要求新建车站尽量位于中心城区或靠近建成区，因此站址在郊外本身并不代表规划成功。对旅行者真正有用的做法，是比较准确车站到酒店门口的完整链路。" },
    { question: "站名里的“东、西、南、北”重要吗？", answer: "重要，它们可能指向完全不同的车站。官方站名里只要出现方位或其他限定词，就从12306查询结果或订单确认中抄下完整名称；能看到中文时也一并保存中文站名，用于酒店路线和出租车目的地。不要仅凭非官方译名推断另一座车站。" },
    { question: "带大件行李、同行者走得慢，会影响选哪个车站吗？", answer: "订票前先确认端到端的无台阶路线。个别车站地图上有电梯，不代表每次换乘都能无障碍完成；走出站台、搬运行李、换乘等待和最后一段交通也都会变长。住老城酒店、带家庭行李又深夜抵达时，中心车站或运行稍慢的列车，门到门反而可能更优。" },
    { question: "已经订了不方便的车站，能改在同城另一座车站上车吗？", answer: "不要这样假设。先在官方12306订单中查看当前可用的处理方式。如果保留原票，保存准确车站及酒店名称和中文地址，确认末班公共交通与道路备选，并提前出发。抵达后若原定接驳失败，请向车站工作人员询问当前正规的出租车或网约车上客点。" },
    { question: "列车在末班地铁之后到达怎么办？", answer: "先核实夜间仍在运营的接驳，或直接计算道路接送。抵达端还要加入走出站台、搬运行李、换乘等待和最后一段到酒店的交通。如果地铁需要两次长距离换乘，可以比较更靠中心的车站或直接道路接驳。" },
    { question: "怎样比较两个车站方案？", answer: "先从实际列车查询结果抄下完整出发站和到达站名称，再在酒店实际入口与准确铁路车站之间规划路线，使用真实的地铁、公交站点或已确认的车辆上下客区。一个车站中心坐标不是门到门终点。还要加入酒店退房、进站安检、站内步行和合理缓冲。" },
  ] },
