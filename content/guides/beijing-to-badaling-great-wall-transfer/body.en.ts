...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "Badaling transfer questions answered", items: [
    { question: "How do I get from Beijing to Badaling by public transport?", answer: "There are several routes and they leave from different Beijing hubs. High-speed rail is worth checking when Qinghe or Beijing North fits your hotel and the exact date has usable trains. S2 suburban rail currently starts at Nankou, and Bus 877 currently starts near Beitucheng metro station. Start with the hotel-to-hub leg, not the smallest vehicle-time number." },
    { question: "Does Bus 877 to Badaling still leave from Deshengmen?", answer: "No. Beijing Bus moved Route 877 from Deshengmen to Beitucheng on March 27, 2025, as checked on August 13, 2026. Older instructions naming Deshengmen are out of date, so save the Beitucheng departure point in Chinese and recheck schedules, fares and operating days before travel." },
    { question: "Does the S2 train to Badaling still start at Huangtudian?", answer: "Not any more. Beijing's transport authority says the S2 line has started at Nankou since October 25, 2025, as checked on August 13, 2026. Nankou is a separate station with limited frequency and queues, so compare the dated timetable against Bus 877 and high-speed rail before committing to it." },
    { question: "How long does a day trip to Badaling take?", answer: "Count five legs, not one ride time: hotel or airport to the correct terminal; waiting, security or queue margin; the scheduled vehicle and its delay exposure; the arrival point to your chosen entrance and the uphill movement; then descent, regrouping and the last safe return. This guide gives no single figure, because the number that decides the day is your own hotel-to-hotel chain." },
    { question: "Do I need my passport to book the train to Badaling?", answer: "Yes, when the rail product requires identity information. Enter the passport details exactly as the system accepts them and carry that same document, and leave time for staffed assistance if the automated gate does not read it. A screenshot of another traveller's ticket, a translated station nickname or a payment receipt is not a substitute for the valid order and travel document." },
    { question: "What time should we leave the Wall to get back to Beijing?", answer: "Set a leave-the-wall time based on the last safe return option, not on closing time. Save the path from the wall back to the correct rail stop or bus queue before you climb, because a smooth outbound does not make the return obvious. A dinner, train or flight afterwards turns a small delay into a larger failure." },
  ] },
