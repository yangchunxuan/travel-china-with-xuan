...
const body: StructuredPageBody = {schemaVersion: "1.0.0", blocks: [
  ...
  {id: "role-heading", type: "heading", level: 2, text: "Decide what each city adds before opening 12306"},
  {id: "role-table", type: "table", caption: "What makes each coastal city worth keeping", columns: ["City", "Distinct role", "Sign that it is becoming repetitive"], rows: [
    ["Qingdao", "Major arrival/departure gateway; old-city streets and Zhanqiao can lead into a long urban coast toward Badaguan and the modern bay.", "You only plan a beach, one seafood meal and generic night lights—experiences the other cities can also provide."],
    ["Yantai", "Zhifu's compact port-history axis, including Yantai Hill, Chaoyang Street and Suochengli, plus a city identity tied to the north coast and wine.", "You are staying outside Zhifu only for another long promenade, with no port-history or wine-related purpose."],
  ...
  {id: "scenarios", type: "table", caption: "Traveller scenarios and the cities they keep", columns: ["Traveller", "Keep", "Cut or condition"], rows: [
    ["First China coast trip, arriving by air and continuing inland", "Qingdao plus either Yantai or Weihai", "Cut the third city unless it adds a named experience; protect the onward rail day."],
  ...
  {id: "rail-workflow", type: "list", items: [
    ...
    "Search Weihai Station and Weihai North separately. Match the arrival to the final hotel and coastal plan, not merely the shortest train result.",
    ...
    "Keep a later departure in reserve or be willing to shorten the previous city's final activity."
  ]},
  {id: "station-table", type: "table", caption: "Station choice changes the city experience", columns: ["Station pair", "Use it to ask", "Common planning error"], rows: [
    ...
    ["Intermediate station such as Muping", "Is the station genuinely near my named eastern-Yantai plan and does my chosen train stop?", "Using a current promotional journey as if every train and visitor should do the same."]
  ]},
  {id: "city-execution-heading", type: "heading", level: 2, text: "Give each retained city one coherent day"},
  ...
  {id: "cut-table", type: "table", caption: "How to decide which city to leave out", columns: ["Constraint", "Leave a city out when", "What remains"], rows: [
    ...
    ["Poor weather across the peninsula", "A city has no indoor, historical or culinary reason to stay once the sea view disappears.", "The stop with a museum, old-city axis or easier onward rail."],
    ["Older parents, children or heavy luggage", "The station–hotel–coast sequence needs repeated long road transfers.", "One longer base and a deliberate day, not three short check-ins."],
    ...
    ["Same photo brief in two cities", "Both plans are beach, sunset and a photogenic road.", "The city with the better transport fit; give the remaining city a different purpose."]
  ]},
  {id: "failure", type: "callout", title: "If a rail leg or coast closes, shorten the arc", body: "No useful direct train: check the other station pair, then consider deleting the weakest city rather than building an uncertain road transfer. Strong wind, rain or seasonal access control: move the day toward old streets, a museum or food; do not chase a closed auxiliary road. Missed train: use official 12306 change/refund rules and ask staff at the station for help. Never protect all three city names at the expense of a safe onward connection.", tone: "warning"},
  {id: "final-check", type: "list", items: [
    ...
    "Seasonal coastal controls and weather are checked again before travel.",
    "One city is marked as removable if rail or weather changes."
  ]},
  { id: "faq", type: "faq", title: "Questions travellers ask about the three-city coast arc", items: [
    { question: "Do I have to visit all three of Qingdao, Yantai and Weihai?", answer: "Only when each city does a job the others cannot. Qingdao is the strongest rail and air gateway, with a coast that runs from the old city to the modern bay; Yantai holds Zhifu's port-history axis and its wine identity; Weihai is a smaller-scale coastal base. If two stops both mean walking the waterfront and eating seafood, remove one." },
    { question: "What order should I travel the three cities in?", answer: "Qingdao to Yantai to Weihai, or the reverse. Choose the open end first: when flight and onward-rail options allow, arrive in Qingdao and leave from Weihai or Yantai, or run the route the other way. That builds one rail arc instead of three separate returns, and every leg is searched by exact station rather than by city name." },
    { question: "Is 'Qingdao' one station when I search for a train?", answer: "No. Search Qingdao Station and Qingdao North separately. The first can suit the old-city side; the second may offer a stronger network but creates a city transfer. Yantai and Yantai South, and Weihai and Weihai North, split the same way. Match the arrival to the final hotel and the next day's coastal plan, not merely the shortest train result." },
    { question: "What do I do if the weather turns bad on the coast?", answer: "Turn the day toward old streets, a museum or food. Strong wind, rain or seasonal access control closes coastal options, and a closed auxiliary road is not worth chasing. If a city has no indoor, historical or culinary reason to stay once the sea view disappears, that is the city to leave out of the arc." },
    { question: "Can I drive or cycle the coastal road at Banyue Bay in Weihai?", answer: "Not always. In 2026, parts of the Banyue Bay Huancheng Road auxiliary line had seasonal vehicle and bicycle restrictions, and on-site controls decide the usable route. For Weihai, choose either central historical and harbour context or one outdoor coastal segment, then check seasonal coastal controls and the weather again before you travel." },
    { question: "What should I actually do in Yantai with one day?", answer: "Start at Yantai Hill or the port edge, walk Chaoyang Street, then Suochengli, and then decide whether the evening stays in Zhifu. Current city sources position these as one historical port-city area. Record the final station transfer before you add the last waterfront walk: the final photograph is expendable, the train is not." },
  ] },
  ...
  {id: "sources", type: "sources", title: "Official sources reviewed on 13 August 2026", items: [
    ...
    {label: "Hero image: Qingdao Railway Station, photographed by Windmemories on 30 July 2024", url: "https://commons.wikimedia.org/wiki/File:20240730_Qingdao_Railway_Station_01.jpg", publisher: "Wikimedia Commons / Windmemories", reviewedAt: "2026-08-13"},
