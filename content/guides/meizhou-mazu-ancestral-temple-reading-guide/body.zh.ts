...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          question: "湄洲妈祖祖庙是千年古建筑吗？",
          answer: "眼前这片建筑群不是。祖庙官方沿革写明：今天所见的西轴线，主要来自20世纪80年代起的重建，至1994年全部建成；新建南轴线1998年开工，2002年建成。这些日期并不抹掉这处地点更早的历史，只是说明机构的延续和可见建筑的年代是两回事。",
        },
        {
          question: "参观当天会有妈祖仪式吗？",
          answer: "没有通知就不能假定有。UNESCO的说明举了庙会、规模较小的礼敬、供品和巡游等共同体实践为例，它解释的是项目的广度，不是祖庙2026年的活动日历。某场具体活动是否对访客开放，要看主办方带日期的最新通知。",
        },
        {
          question: "祖庙里可以拍照吗？",
          answer: "到场后先问负责机构。复核于2026年8月15日的官方页面，没有给出覆盖普通动线、室内摄影、视频、闪光灯、脚架、无人机与仪式旁观的完整现行规则。官网没写不等于允许；旧照片有Commons许可，也不等于现在拿到了场地方的拍摄许可。",
        },
        {
          question: "有人拿着香和供品排队，访客可以跟着排吗？",
          answer: "除非工作人员明确引导，否则请留在队列外。不要把这条队伍当成游客体验或开放参与的环节；参与应当来自清楚的邀请或现场指引，而不是跟着做。现场一旦变得拥挤、安静或排起队伍，就主动后退，共同体的使用优先于你的观察清单。",
        },
        {
          question: "“祖庙”指一座殿，还是整片建筑群？",
          answer: "指整片建筑群，而且这个名字不只用来指建筑。祖庙官网把建筑群定位在湄洲岛北部宫下村，并分别介绍西轴线和南轴线；所以“湄洲妈祖祖庙”既可以指机构，也可以指它的信仰共同体和它管理的完整建筑群。确认机构名称的牌子，不能顺便给下一扇门里的材料断代。",
        },
        {
          question: "妈祖真有其人吗？",
          answer: "资料把这件事放在信仰传统里，而不是已核实的传记。UNESCO写妈祖“被相信”曾在10世纪生活于湄洲岛；中国非遗与祖庙则叙述救助、离世和建庙纪念。转述时带上“信众相信”“传统叙述”，既说明这段知识属于谁，也不会把它写成世俗史。",
        },
      ],
    },
    {
