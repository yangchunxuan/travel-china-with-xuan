...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "运河常见问题", items: [
    { question: "大运河是一条封存起来的古河吗？", answer: "不是。沿线既有受保护的船闸和桥梁，也有仍在运行的航道、更新后的滨水空间、住宅和店铺。到了现场先分清眼前属于遗产、运行系统还是当代街区，再看水路如何继续影响城市生活，别把每一段热闹河岸都当成未经改变的历史。" },
    { question: "现在还能看到运河上跑货船吗？", answer: "部分河段可以。据交通运输部资料，苏北运河仍是重要货运走廊，岸上能看到商船、船闸和等待区。观察只能在合法公共区域进行，作业码头不是景点。现场没有船，就看船闸和系泊设施，再查官方航运资料，别预设一定能遇上船。" },
    { question: "到了发现河岸封闭怎么办？", answer: "改走最近的合法过河通道和平行街道，再看官方地图或博物馆。防洪、施工或活动都可能封闭河岸，但即使不能贴着水走，也能看懂街区之间怎么连接。水岸过度商业化时，就退回普通的服务型街道，或换到另一处有据可查的河段。" },
    { question: "想看大运河，该去哪一段？", answer: "按你想看的关系选河段。想看仍在运行的航运，去苏北的运河城市，留意商船、船闸和作业岸线与公共岸线的分隔；想读城市史，去杭州拱宸桥及周边的桥边街区；想看都市水岸，去北京通州运河区域；想看小城的交换网络，就选一处经核实的运河镇或市场街。" },
    { question: "在现场该怎么读一个运河街区？", answer: "从官方遗产或交通资料能核对名称的河段、桥梁、船闸或码头开始。先读水面十分钟：水流、船型、岸线处理和闸门；再走一次合法过河通道，然后沿一两条垂直于河道的街走进街区，不要一直停在景观步道上。这套方法按两小时安排。" },
    { question: "可以拍运河边的居民和工人吗？", answer: "要谨慎。不要侵扰性拍摄居民；近距离拍摄居民和工作人员前，先弄清同意与隐私的边界。居民巷道不是布景，作业码头也不是景点，只在合法公共区域观察，别走进作业区。" },
  ] },
