...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  { id: "faq", type: "faq", title: "운하 관련 자주 묻는 질문", items: [
    { question: "대운하는 통째로 보존된 옛 물길인가요?", answer: "아닙니다. 긴 수계에는 보호 대상인 갑문과 다리, 지금도 화물을 나르는 항로, 재정비된 산책로, 주택과 상점이 겹쳐 있습니다. 눈앞의 장면이 어느 층위의 증거인지 먼저 구분한 다음, 물길이 이동과 동네 생활을 지금도 어떻게 바꾸는지 읽으세요. 활기찬 강변을 모두 변하지 않은 역사라고 부를 수는 없습니다." },
    { question: "대운하에서 지금도 화물선을 볼 수 있나요?", answer: "일부 구간에서는 볼 수 있습니다. 장쑤 북부처럼 합법적인 전망 지점이 확인된 항로에서는 바지선의 흐름과 갑문·항만 체계, 육상 물류와의 연결을 볼 수 있습니다. 작업 선박과 갑문은 공개된 지점에서만 관찰하고, 배가 보이지 않으면 갑문과 제방, 창고와 도로 접속을 읽으면 됩니다." },
    { question: "도착했는데 수변이 닫혀 있으면 어떻게 하나요?", answer: "안전한 다리 전망과 수직 거리 관찰로 바꾸고 공식 공지를 확인하세요. 공사나 홍수 관리로 수변이 닫혀도 운하가 도시 이동과 관리에 만드는 경계는 읽을 수 있습니다. 관광 상업만 두드러질 때는 한 블록 뒤의 평행 거리와 대중교통 연결을 비교하세요." },
    { question: "대운하는 어디에서 보는 게 좋을까요?", answer: "보고 싶은 관계를 먼저 정하세요. 현재의 화물 항운은 장쑤 북부처럼 합법적 전망 지점이 확인되는 항로에서, 강남 도시 조직은 쑤저우·항저우의 공개 수변과 오래된 가로망이 만나는 구간에서 잘 보입니다. 제국 수도와 수운의 종점은 베이징 통저우처럼 운하 북단과 현대 수변이 겹치는 구간, 보존과 재생의 긴장은 박물관과 산업 유산, 새 수변 공원이 가까운 구간이 맞습니다." },
    { question: "운하 동네를 걸으며 어떻게 읽나요?", answer: "공식 명칭과 등재 또는 보호 지위를 확인한 다리·갑문·부두 흔적 한 곳에서 시작하세요. 같은 자리에서 물길 폭과 제방, 선박과 횡단 방식을 기록하고, 다리 하나를 건넌 뒤 운하와 수직인 거리로 10~15분 이동합니다. 이 현장 읽기는 90분 기준입니다." },
    { question: "운하변 주민과 작업자를 촬영해도 되나요?", answer: "조심해야 합니다. 주민을 전시물처럼 촬영하지 말고, 주민과 작업자를 가까이 찍을 때는 동의와 사생활 원칙을 먼저 확인하세요. 주민의 사생활을 존중하고 작업 구역에는 들어가지 않으며 합법적인 공개 지점에서만 관찰합니다." },
  ] },
