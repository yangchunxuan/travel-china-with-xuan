...
const body = {schemaVersion:"1.0.0",blocks:[
  ...
  {id:"answer",type:"callout",title:"세 개의 운하를 함께 읽기",body:"① UNESCO 등재 구성 요소와 보호 범위, ② 현재 작동하는 항운·수리 체계, ③ 물과 관계를 맺는 오늘의 거리와 생활을 구분하라. 한 도시에서 세 층위가 모두 선명한 짧은 구간을 고르면, 여러 ‘수향마을’을 수집하는 것보다 운하를 더 정확히 이해할 수 있다.",tone:"decision"},
  ...
  {id:"change",type:"comparison",title:"두 가지 잘못된 기대를 피하기",leftTitle:"박제된 유산을 기대할 때",rightTitle:"진짜 운하 도시를 읽을 때",rows:[
    {label:"변화",left:"현대식 제방, 아파트, 도로를 방해물로 본다.",right:"어떤 기능이 남고 무엇이 재편되었는지 질문한다."},
    {label:"일상",left:"노점이나 빨래 같은 장면을 ‘진정성’의 증거로 소비한다.",right:"주민의 사생활을 존중하고 공공 공간의 이용 패턴을 관찰한다."},
    {label:"해석",left:"옛 분위기만으로 역사성을 판단한다.",right:"명판, 유산 목록, 도시 계획과 운영 자료로 층위를 확인한다."}
  ]},
  ...
  {id:"scenarios",type:"comparison",title:"관심에 따라 시간을 배분하기",leftTitle:"도시사에 관심 있는 첫 방문자",rightTitle:"현대 인프라에 관심 있는 재방문자",rows:[
    {label:"핵심",left:"다리·옛 가로망·시장 관계가 읽히는 도심 구간",right:"공개 지점에서 현대 항운과 수변 재편을 볼 수 있는 구간"},
    {label:"보조",left:"지역 박물관 또는 공식 유산 해설",right:"항운·수리 자료와 합법적인 갑문·선박 관찰"},
    {label:"피할 것",left:"비슷한 상업화 수변을 여러 곳 반복",right:"항만이나 통제 구역에 접근해 ‘더 진짜’인 장면을 찾는 행동"}
  ]},
