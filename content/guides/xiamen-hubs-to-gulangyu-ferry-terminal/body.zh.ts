...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "faq", type: "faq", title: "上船前常见问题", items: [
    { question: "鼓浪屿的船票在哪里买？", answer: "用厦门轮渡当前指引的官方渠道。FAQ引导游客通过微信公众号xmferry或支付宝生活号“屿见厦门轮渡”购票。先选定航线、读取订单上两端完整码头名，再计算厦门机场、厦门站或厦门北站的接驳。不要因为旧地图上某个市区码头更近就自行替换。" },
    { question: "可以提前多久买票？检票什么时候停止？", answer: "预售与检票规则核验于2026年8月13日：预售期为15天（含乘船当日），每天9:00开放第15日船票；开航前20分钟开始检票、前10分钟停止检票。官网同页仍有较旧说法，因此付款前应再次核对当前渠道与航线。" },
    { question: "船票包含返程吗？", answer: "通常包含：去程票一般含20天内一次符合当期游客航线规则的免费返程，但这不等于预订了固定返程船班，也不能永久固定码头。要把返程当成一次新的运营核查：核对所选日期的实时返程码头、排队或班次规则，并设置最晚可接受的离岛时间。" },
    { question: "购票用的护照号码无法在线核验怎么办？", answer: "携带护照原件到人工售票处核验证件并取票。值船时携带同一本护照和订单记录，并把每位同行者的证件状态放进同一张清单。不要根据搜索结果截图或未付款购物车做计划，要打开已经完成的订单逐项读取。" },
    { question: "上午的航班或火车，应该订哪班船？", answer: "选更晚的船班，并明确留出延误余量。取行李、出站和道路拥堵都不在船期内，而开航前10分钟就停止检票。傍晚抵达时保留厦门本岛住宿：错过船班后，可能已没有合理的当日上岛方案。" },
    { question: "岛上码头会有车或人帮忙搬行李吗？", answer: "除非住宿按日期确认，否则不要这样假设。鼓浪屿最后一段主要是步行与行李问题：把准确抵达码头发给酒店，询问建议步行路线，并确认是否真的提供行李协助。石板巷、台阶、雨水和人流会让很短的距离变得困难。" },
  ] },
