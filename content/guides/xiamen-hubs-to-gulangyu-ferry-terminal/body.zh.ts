...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "answer", type: "callout", title: "先买日期明确的船票，再连接枢纽", tone: "decision", body: "通过厦门轮渡官方游客购票渠道选择有余位航线，并读取两端完整码头名；之后再计算厦门机场、厦门站或厦门北站的接驳。不要因为旧地图上某个市区码头更近就自行替换。" },
  ...
  { id: "matrix", type: "table", caption: "船票决定码头", columns: ["起点", "主要摩擦", "保护"], rows: [
    ...
    ["厦门酒店", "地图距离短也可能有道路与人流摩擦", "看票面码头，不搜“最近轮渡”"],
  ]},
  ...
  { id: "chain", type: "list", ordered: true, items: ["抵达枢纽到票面码头准确入口。", "证件/船票核验与运营方要求的提前量。", "指定船班到指定岛上码头。", "码头到住宿的步行与行李。", "返程船、内地后续交通与天气备选。"] },
  ...
  { id: "facts", type: "callout", title: "动态交通信息核验于2026年8月12日", tone: "neutral", body: "厦门轮渡运营官方游客购票渠道并发布航线/码头信息，同时提醒防范非官方转售。航线、班次、码头、办理、身份规则、票价、行李与天气运营都会变化，以出发日期票面为准。" },
  ...
  { id: "sources", type: "sources", title: "官方来源与图片署名", items: [
    { label: "官方游客购票与航线", url: "https://xmferry.com/wybm/wshlk/xchgpp/index.htm", publisher: "厦门轮渡有限公司", reviewedAt: "2026-08-12" },
    { label: "官方码头航线指引", url: "https://www.xmferry.com/xwzx/zxgg/25004.htm", publisher: "厦门轮渡有限公司", reviewedAt: "2026-08-12" },
    { label: "官方防转售提醒", url: "https://www.xmferry.com/xwzx/zxgg/22943.htm", publisher: "厦门轮渡有限公司", reviewedAt: "2026-08-12" },
