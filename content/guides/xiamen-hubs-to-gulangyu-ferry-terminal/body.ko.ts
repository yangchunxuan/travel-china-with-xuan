...
const body = { schemaVersion: "1.0.0", blocks: [
  { id: "lead", type: "lead", text: "샤먼에서 구랑위로 갈 때 네 이름이 맞아야 한다. 중국 본토 도착 지점, 표의 샤먼 터미널, 표의 섬 선착장과 숙소다. 공항에서 배까지 하나만 풀어도 잘못된 배를 탈 수 있다." },
  { id: "answer", type: "callout", title: "날짜가 정해진 배를 먼저 사고 교통을 연결한다", tone: "decision", body: "샤먼 페리 공식 관광객 구매 채널에서 좌석이 있는 노선을 고르고 양쪽 터미널명을 읽는다. 그 뒤 샤먼공항, 샤먼역 또는 샤먼북역에서의 이동을 계산한다. 오래된 지도에서 가까워 보이는 시내 선착장으로 바꾸지 않는다." },
  { id: "matrix-heading", type: "heading", level: 2, text: "출발 지점이 중국 본토 이동을 바꾼다" },
  { id: "matrix", type: "table", caption: "배표가 터미널을 결정한다", columns: ["출발", "주요 부담", "보호"], rows: [
    ["샤먼공항", "항공 지연, 짐 찾기, 도로와 수속 마감", "늦은 배나 샤먼섬 숙박 대안"],
  ...
  { id: "chain", type: "list", ordered: true, items: ["도착 지점에서 표의 터미널 정확한 입구까지.", "신분/표 확인과 운영사가 요구하는 여유.", "이름이 적힌 배로 이름이 적힌 섬 선착장까지.", "선착장에서 숙소까지 실제 도보와 짐.", "귀환 배, 중국 본토 후속 교통과 날씨 대안."] },
  { id: "groups", type: "comparison", title: "짐이 섬 도착을 바꾼다", columns: [
    { heading: "당일, 가벼운 짐", items: ["더 많이 걸을 수 있음", "귀환 좌석 계속 확인", "예약 이름 준비"] },
    { heading: "섬 호텔", items: ["호텔 추천 선착장 문의", "짐 도움은 별도 확인", "차량이 배를 만난다고 가정하지 않기"] },
  ...
  { id: "recovery", type: "table", caption: "거리 안내보다 운영사 기록을 사용", columns: ["문제", "대응"], rows: [
    ...
    ["항공/열차 지연", "페리 공식 변경 채널을 사용하고 샤먼섬 숙박 보호"],
  ...
  { id: "help", type: "callout", title: "도착 지점과 배를 맞출까요?", tone: "decision", body: "날짜, 항공편이나 열차, 표의 양쪽 터미널, 섬 호텔, 인원과 짐을 보내 주세요. Homeground는 환승과 복구 여유를 확인할 수 있으며 좌석은 공식 운영사가 관리합니다." },
  { id: "links", type: "internal-links", title: "계속 계획하기", items: [
    { label: "중국 고속철도 첫 이용 안내", href: "/ko/guides/china-high-speed-train-first-time-guide/", description: "배 환승 전 철도 도착을 준비합니다." },
    { label: "국제선 전 중국에서의 마지막 밤", href: "/ko/guides/china-last-night-before-international-flight/", description: "섬에서 돌아오는 연결을 보호합니다." },
    { label: "중국 일정이 너무 빠듯한가요?", href: "/ko/guides/is-your-china-itinerary-too-rushed/", description: "철도, 도로와 배 마감을 압축하지 않습니다." },
  ...
  { id: "sources", type: "sources", title: "공식 출처와 사진 표기", items: [
    ...
    { label: "대표 사진: HualinXMN의 크루즈센터 버스 구역, CC BY 4.0, 일부 자름", url: "https://commons.wikimedia.org/wiki/File:Cruise_Center_Bus_Station(Xiamen)._20190203.jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-12" },
  ]},
