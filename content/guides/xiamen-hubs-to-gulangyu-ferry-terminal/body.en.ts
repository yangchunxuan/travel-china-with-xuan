...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "order-copy", type: "paragraph", text: "Open the completed order and read the sailing date, departure time, full mainland terminal, island arrival pier and traveller document. Do not plan from a search-results screenshot or an unfinished shopping cart. If the passport number used for purchase cannot be verified online, take the original passport to a manual ticket counter for document verification and ticket collection. Keep that passport and the order record available at check-in, and put every traveller's document status in one group checklist." },
  ...
  { id: "facts", type: "callout", title: "Passport handling rechecked August 31, 2026; advance sales and check-in checked August 13, 2026", tone: "neutral", body: "The current FAQ directs online buyers to the official WeChat or Alipay channel; foreign visitors can enter passport details through a verified Alipay account. If the passport number used for purchase cannot be verified online, the FAQ directs the traveller to a manual ticket counter to present the original document for verification and collect the ticket. The sales window is 15 days including the sailing date, with day 15 opening at 09:00. Check-in starts 20 minutes before departure and closes 10 minutes before it. A dated outbound ticket normally includes one free return within 20 days on an eligible current visitor route, but it does not reserve a return sailing or permanently guarantee a pier. The same FAQ contains older answers, so confirm the live channel and route before paying." },
  ...
  { id: "faq", type: "faq", title: "Questions travellers ask before the ferry", items: [
    { question: "Where do I buy the ferry ticket to Gulangyu?", answer: "Through Xiamen Ferry's current official visitor channel. Its FAQ directs travellers to the xmferry WeChat account or the Alipay service account 屿见厦门轮渡. Choose a route there, read both full terminal names on the order, and only then work out the transfer from Xiamen Airport, Xiamen Station or Xiamen North. Do not substitute a downtown pier because an old map looks closer." },
    { question: "How far ahead can I book, and when does check-in close?", answer: "As checked on August 13, 2026, the sales window is 15 days including the sailing date, with day 15 opening at 09:00, and check-in starts 20 minutes before departure and closes 10 minutes before it. The same FAQ still carries older answers, so check the current channel and route again before paying." },
    { question: "Is the return trip included in the ticket?", answer: "Usually yes — a dated outbound ticket normally includes one free return within 20 days on an eligible current visitor route. It does not reserve a return sailing or permanently fix a pier. Treat the return as a new operating check: look at the live return pier arrangement and any queue or sailing rule on the chosen day, and set a latest acceptable island departure." },
    { question: "What if the passport number used for the purchase will not verify online?", answer: "Take the original passport to a staffed ticket counter for document checking and ticket collection. Keep that same passport and the order record with you at check-in, and put every traveller's document status on one group checklist. Do not plan from a search-results screenshot or an unpaid cart — open the completed order and read it line by line." },
    { question: "My flight lands in the morning — which sailing should I book?", answer: "Book a later sailing with an explicit delay allowance. Baggage, leaving the terminal and road congestion all sit outside the ferry timetable, and check-in closes 10 minutes before departure. If you arrive in the late afternoon, keep a Xiamen-island hotel option, because missing the boat can leave no workable way onto the island that day." },
    { question: "Will a car or a porter meet me at the Gulangyu pier?", answer: "Do not assume so unless the accommodation confirms it for that date. Gulangyu's final leg is mainly a walking-and-luggage problem. Send the hotel the exact arrival pier, ask for its recommended walking approach and check whether any luggage help is actually provided. Stone lanes, steps, rain and crowds can turn a short distance into a difficult arrival." },
  ] },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    { label: "Official online-purchase FAQ: current channels, passport verification and return validity", url: "https://xmferry.com/wybm/wshlk/wlgpp/index.htm", publisher: "Xiamen Ferry Co.", reviewedAt: "2026-08-31" },
