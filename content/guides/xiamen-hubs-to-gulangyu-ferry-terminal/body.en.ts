...
const body = { schemaVersion: "1.0.0", blocks: [
  ...
  { id: "order-copy", type: "paragraph", text: "Open the completed order and read the sailing date, departure time, full mainland terminal, island arrival pier and traveller document. Do not plan from a search-results screenshot or an unfinished shopping cart. If online passport verification fails or the system requires manual verification, follow the official FAQ: take the original passport to a staffed ticket window for on-site verification and ticket collection. Keep that passport and the order record available at check-in, and put every traveller's document status in one group checklist." },
  ...
  { id: "facts", type: "callout", title: "Passport window flow checked August 23; other transport facts checked August 13, 2026", tone: "neutral", body: "The current FAQ directs online buyers to the official WeChat or Alipay channel; foreign visitors can enter passport details through a verified Alipay account. If a passport cannot be verified online or requires manual handling, the traveller must take the original passport to a staffed ticket window for on-site verification and ticket collection. The sales window is 15 days including the sailing date, with day 15 opening at 09:00. Check-in starts 20 minutes before departure and closes 10 minutes before it. A dated outbound ticket normally includes one free return within 20 days on an eligible current visitor route, but it does not reserve a return sailing or permanently guarantee a pier. The same FAQ contains older answers, so confirm the live channel and route before paying." },
  ...
  { id: "sources", type: "sources", title: "Official sources and image credit", items: [
    { label: "Official online-purchase FAQ: current channels, passport verification at a staffed ticket window and return validity", url: "https://xmferry.com/wybm/wshlk/wlgpp/index.htm", publisher: "Xiamen Ferry Co.", reviewedAt: "2026-08-23" },
