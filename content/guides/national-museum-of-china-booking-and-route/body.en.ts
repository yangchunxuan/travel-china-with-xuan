...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    { id: "faq", type: "faq", title: "National Museum questions answered", items: [
      { question: "How do I book the National Museum of China with a foreign passport?", answer: "Reserve the free basic admission through the museum's official website or official WeChat channels within seven days of the visit, entering passport details exactly as printed. Real-name booking needs a valid identity document, and the same original passport must be shown at entry." },
      { question: "When are National Museum of China reservations released?", answer: "New inventory is released daily at 17:00 Beijing time, and the museum divides entry into three time windows. For a fixed Beijing day, be ready at release rather than assuming same-day entry." },
      { question: "Which entrance do visitors use at the National Museum of China?", answer: "Booked visitors enter through the North Gate visitor entrance during their reserved window. Do not walk to the ceremonial west facade seen in many photographs as if it were the public entrance." },
      { question: "What are the National Museum's opening hours and closing day?", answer: "The standing rule is 09:00–17:00 with last admission at 16:00; from 1 June to 31 October the museum currently extends closing to 17:30 and last admission to 16:30. It normally closes on Mondays unless an official holiday notice says otherwise. These facts were checked on 12 August 2026, so reopen the official Visit page before relying on them." },
      { question: "Does a National Museum reservation include Tiananmen Square?", answer: "No. The museum controls only its own reservation and North Gate entry; Tiananmen Square and nearby monuments can use separate access rules and security arrangements. Check any other place on its own official channel and allow for security routing around the square." },
    ] },
