...
const body: StructuredPageBody = {
  ...
  blocks: [
    ...
    { id: "faq", type: "faq", title: "국가박물관 자주 묻는 질문", items: [
      { question: "외국 여권으로 중국 국가박물관을 어떻게 예약하나요?", answer: "방문일 7일 이내에 박물관 공식 웹사이트나 공식 위챗 채널에서 무료 기본 관람을 예약하고 여권 정보를 인쇄된 그대로 입력하세요. 실명 예약에는 유효한 신분증이 필요하며 입장 시 예약에 쓴 같은 여권 원본을 제시해야 합니다." },
      { question: "국가박물관 예약은 언제 열리나요?", answer: "매일 베이징 시간 17:00에 새 예약분이 풀리며 입장은 세 개의 시간대로 나뉩니다. 베이징 일정이 고정돼 있다면 당일 입장을 기대하지 말고 예약이 열리는 시간에 준비하세요." },
      { question: "국가박물관은 어느 입구로 들어가나요?", answer: "예약 관람객은 예약 시간대에 북문 관람객 입구로 들어갑니다. 사진에 자주 나오는 서쪽 의전용 정면을 공개 입구로 여기고 가지 마세요." },
      { question: "국가박물관의 개관 시간과 휴관일은 어떻게 되나요?", answer: "기본은 09:00–17:00, 마지막 입장 16:00입니다. 6월 1일부터 10월 31일까지는 현재 17:30 폐관, 16:30 마지막 입장으로 연장됩니다. 공식 공휴일 공지가 따로 없으면 보통 월요일에 휴관합니다. 2026년 8월 12일 확인한 내용이므로 출발 전 공식 관람 안내 페이지를 다시 여세요." },
      { question: "국가박물관 예약에 톈안먼광장이 포함되나요?", answer: "아닙니다. 박물관은 자체 예약과 북문 입장만 관리하며 톈안먼광장과 주변 기념 시설은 별도의 출입 규칙과 보안 절차를 둘 수 있습니다. 다른 장소는 각자의 공식 채널에서 확인하고 광장 주변의 보안 우회 시간을 두세요." },
    ] },
