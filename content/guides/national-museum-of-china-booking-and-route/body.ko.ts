...
const body: StructuredPageBody = {
  schemaVersion: "1.0.0",
  blocks: [
    { id: "answer-first", type: "lead", text: "중국국가박물관은 톈안먼광장을 걷다가 즉흥적으로 들어가는 곳이 아니라 예약·입구·관람 범위를 미리 정해야 하는 박물관입니다. 당일 지참할 신분증으로 무료 기본 관람을 예약하고, 지정 시간에 북문 관람객 입구로 가세요. 안에서는 중심 전시 하나와 보조 주제 하나만 고르는 편이 좋습니다. 건물 전체를 한 번에 보려는 계획은 실용적이지 않으며, 박물관 예약이 톈안먼 주변의 다른 시설 예약까지 대신하지도 않습니다." },
    ...
    { id: "separate-systems", type: "callout", title: "박물관과 톈안먼 예약은 하나가 아닙니다", body: "중국국가박물관은 자체 예약과 북문 입장을 운영합니다. 톈안먼광장과 주변 기념 시설은 별도 출입·보안 규정을 쓸 수 있습니다. 박물관 확인서는 박물관만 보장하므로 다른 장소는 각각 공식 채널을 확인하고 광장 주변 보안 동선에도 시간을 남겨 두세요.", tone: "warning" },
    ...
    { id: "route-list", type: "list", items: [
      ...
      "초기 문명 유물 하나, 제국 시대 유물군 하나, 이번 여행의 다른 도시와 연결되는 유물 하나처럼 세 정거장을 미리 정하세요.",
      "두 번째 주제로 가기 전에 앉아서 쉬세요. 10분의 회복이 급히 한 전시실을 더 보는 것보다 집중력을 지켜 줍니다.",
      "남은 시간에는 현재 특별전 하나나 근현대 주제 하나만 더 보고, 공식 폐관 시각보다 일찍 출구로 움직이세요.",
    ] },
    { id: "paid-exhibitions", type: "callout", title: "무료 입장과 유료 특별전은 다릅니다", body: "기본 관람은 무료 예약이지만 일부 특별전은 별도 요금과 구매 규정이 있습니다. 해당 전시의 공식 공지를 읽으세요. 기본 박물관에 유료표가 필요하다고 오해하거나 무료 예약에 모든 특별전이 포함된다고 가정해서는 안 됩니다.", tone: "neutral" },
    ...
    { id: "final-check", type: "callout", title: "전날 밤 다섯 가지만 확인하세요", body: "예약 날짜와 시간대, 여권 표기, 북문, 당일 운영 공지, 하나의 중심 전시입니다. 이 다섯 가지가 명확하면 방문은 실행 가능해집니다. 불명확하다면 전시실 이름을 더 붙여도 해결되지 않습니다.", tone: "decision" },
    { id: "internal-links", type: "internal-links", title: "베이징 일정에 연결하기", items: [
      ...
      { label: "외국인을 위한 자금성 방문 안내", href: "/ko/guides/forbidden-city-for-foreign-visitors/", description: "고궁박물원의 표와 입구 과정을 중국국가박물관 예약과 분리합니다." },
    ...
    { id: "sources", type: "sources", title: "확인한 공식·이미지 출처", items: [
      ...
      { label: "대표 사진: Daniel Case의 중국국가박물관 서쪽 정면, CC BY-SA 3.0, 크롭 및 WebP 변환", url: "https://commons.wikimedia.org/wiki/File:National_Museum_of_China_west_facade,_straight_view.jpg", publisher: "Wikimedia Commons", reviewedAt: "2026-08-12" },
    ] },
  ],
};
