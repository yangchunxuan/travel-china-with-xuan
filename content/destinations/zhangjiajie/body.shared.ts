...
const copies = {
  ...
  ko: {
    lead: "장가계는 입구 하나인 공원 하나가 아닙니다. 목적지 이름에는 도시 관문, 무릉원과 국가삼림공원, 시내 옆 천문산, 다른 방향의 대협곡이 함께 들어갑니다. 첫 여행은 온전한 관광일 3일이 가장 잘 맞으며, 어떤 체계에 그날을 주고 어느 숙소 거점이 첫 출발을 지킬지가 핵심입니다.",
    answerTitle: "예약 화면의 숙박일이 아니라 온전한 관광일을 세세요",
    answerBody: "온전한 2일은 큰 하나를 빼야 합니다. 3일은 보통 국가삼림공원 2일과 천문산 또는 명확한 대안을 담습니다. 4일은 날씨 회복, 느린 이동 또는 독립된 장소 하나를 더합니다. 도착·출발 조각은 산악 관광일이 아닙니다.",
    fitHeading: "장가계가 맞는 여행자",
    ...
    fitRows: [
      ...
      ["매우 짧은 중국 일정", "장가계가 진짜 우선순위일 때만 가능", "항공·철도·호텔 이동·산악 접속을 관광일에 숨기지 않기"],
    ],
    daysHeading: "온전한 2·3·4일의 의미",
    daysColumns: ["온전한 날", "현실적인 형태", "밖에 둘 것"],
    daysRows: [
      ["2", "국가삼림공원 큰 하루와 천문산, 또는 선택적 공원 2일", "대협곡·봉황·모든 상부 구역 완성 약속"],
      ["3", "공원 2일과 천문산; 첫 여행의 가장 강한 기본값", "대협곡 덧붙이기와 보호되지 않은 출발"],
      ["4", "날씨 회복, 느린 속도 또는 별도로 고른 대협곡/문화 하루", "추가 하루를 네 번째 혼잡 목록으로 만들기"],
    ],
    baseHeading: "매일 아침 첫 과제로 숙소 거점을 고르세요",
    baseColumns: ["거점", "가장 좋은 경우", "대가"],
    baseRows: [
      ["무릉원", "이른 국가삼림공원 출발과 연속 2일", "DYG·장가계서역·천문산 시내 체계에서 멂"],
      ["장가계 시내", "천문산, 늦은 도착, 이른 출발과 관문", "무릉원 공원 시작 전 도로 이동 소모"],
      ["두 거점", "숙박이 충분해 공원과 시내 과제를 모두 보호", "체크아웃·짐·인계; 절약 이동이 더 클 때만"],
    ],
    gatewayHeading: "정확한 관문으로 들어오고 나가세요",
    gatewayIntro: "DYG 공항과 장가계서역은 모두 시내 쪽이며 무릉원 공원 입구가 아닙니다. 실제 호텔 프런트, 시각, 짐과 합법적인 이동에 도착을 연결하세요. 늦은 도착은 다음 2일이 무릉원이어도 시내 1박을 정당화할 수 있습니다.",
    gatewayColumns: ["관문", "역할", "흔한 실패"],
    gatewayRows: [
      ["DYG 허화공항", "긴 육상 이동을 없애는 항공편", "공항을 삼림공원 입구로 생각"],
      ["장가계서역", "시내 쪽 고속철·지역 철도 관문", "열차 도착을 무릉원 호텔 도착으로 계산"],
      ["도로 이동", "관문·시내·무릉원 마지막 연결", "무허가 픽업 또는 중국어 주소 없는 모호한 호텔 이름"],
    ],
    systemsHeading: "하나의 명소로 합치면 안 되는 네 이름",
    systemsColumns: ["체계", "맡는 것", "혼동 금지"],
    systemsRows: [
      ["장가계 국가삼림공원 / 무릉원 핵심", "여러 게이트, 계곡, 상부 고원, 셔틀·엘리베이터·케이블카", "천문산 또는 대협곡"],
      ["천문산", "시내 쪽 독립 티켓·교통 체계와 큰 시간 블록", "무릉원의 천자산"],
      ["장가계 대협곡", "다른 방향의 유리다리와 협곡 체계", "천문산 유리잔도"],
      ["봉황", "별도 고성 목적지와 다음 동선 결정", "장가계 안의 저녁 동네"],
    ],
    ...
    links: [
      ...
      ["고령 여행자와 장가계 계획", "zhangjiajie-older-travellers", "탑승·보행·대기와 회복 선택."],
      ["장가계 야간 공연 비교", "best-zhangjiajie-night-show", "숙소 거점·종료 시각·낮 체력으로 선택."],
    ],
    stayReadingTitle: "전국 숙박 owner로 마지막 확인을 마치세요",
    stayLinks: [
      ["‘교통과 가까움’이 실제로 편리한지 확인", "china-hotel-near-metro", "역이나 교통 근처라는 표시도 출구·도로·승하차 지점·로비까지 확인하세요. 지도 핀은 장가계 마지막 이동을 증명하지 않습니다."],
    ...
    quoteTitle: "장가계 후보 숙소를 사람과 함께 확인하고 싶다면",
    ...
    onwardRows: [
      ["봉황", "고성의 저녁과 다음 아침이 실제 우선순위", "별도 교통과 보통 1박 필요; 공원 연장이 아님"],
    ...
    recheckHeading: "모든 장가계 여행 전에 재확인하세요",
    recheckItems: ["각 관광 상품의 정확한 이름, 여권 조건, 첫 입구, 시간대와 포함 항목.", "여행일의 셔틀·엘리베이터·케이블카 운행; 도식은 실시간 개방 증거가 아님.", "호텔 출발 전 날씨·가시거리·낙뢰·정비·임시 폐쇄.", "정확한 DYG 터미널 또는 장가계서역 열차와 올바른 호텔 지점까지 마지막 이동.", "야간 공연 장소·프로그램·종료 시각과 거점 귀환 교통.", "봉황·창사 또는 긴 다음 이동을 약속하기 전 실제 표."],
    faqHeading: "자주 묻는 질문",
    faqs: [
      ["첫 여행은 며칠인가?", "온전한 관광일 3일이 가장 강한 기본값입니다. 2일은 큰 제외가 필요하고 4일은 날씨 회복·느린 이동·별도 명소를 삽니다."],
      ["시내 또는 무릉원?", "무릉원은 공원 이른 출발, 시내는 천문산·관문·늦은 도착에 맞습니다. 절약 이동이 짐 이동보다 클 때만 두 거점입니다."],
      ["천문산과 천자산은 같은가?", "아닙니다. 천문산은 시내 쪽 별도 체계이고 천자산은 무릉원 상부 구역입니다."],
      ["유리다리는 국가삼림공원 안인가?", "아닙니다. 다른 방향의 대협곡 체계이며 천문산 유리잔도는 또 다릅니다."],
      ["봉황을 저녁에 잠깐 더할 수 있나?", "대개 솔직한 ‘잠깐’이 아닙니다. 별도 이동과 저녁, 가능하면 다음 아침을 줘야 가치가 생깁니다."],
      ["시내 마지막 밤이 국제선 출발을 지켜 주나?", "일부 구간만 보호합니다. 시내 숙박은 이른 DYG 항공편이나 장가계서역 출발 위험을 줄일 수 있지만 DYG가 모든 국제선 출발의 해답은 아닙니다. 국제선이 다른 공항에서 출발한다면 실제 공항·터미널·체크인 마감에서 거꾸로 계산해 공항 쪽 추가 완충 숙박이 필요한지 판단하세요. 날짜가 정해진 포지셔닝 표, 호텔 인계와 대안을 다시 확인하세요."],
    ],
