...
const body = {
  ...
  blocks: [
    ...
    },
    {
      ...
      "type": "paragraph",
      "text": "这个纯市区例子以解放碑住宿为起点，要求两天都没有抵离交通占用。第一天留在渝中，第二天过江后只走南岸的一个片区。午餐和休息已经算进行程，武隆、大足或另一套跨城拍照路线需要另外留日子。"
    },
    {
      "id": "two-complete-days-plan",
      "type": "table",
      "caption": "初次到访：两个完整白天怎样走",
      "columns": [
        "时段",
        "第 1 天：渝中，回到解放碑结束",
        "第 2 天：弹子石与南滨路，在南岸结束"
      ...
      "rows": [
        [
          "上午",
          "从解放碑纪念碑出发，前往十八梯上方入口，再沿老街向下逛。若不想爬回去，提前约好从下方街区乘车返回。",
          "从酒店乘车到弹子石老街上方入口，沿院落与街巷向南滨路一侧下行。先确定从上往下走，再与司机确认下车口。"
        ],
        [
          "午餐与午后",
          "在十八梯附近午餐，或乘车回解放碑吃饭并在酒店休息。炎热或下雨时，这一段留作完整的室内休息。",
          "在弹子石片区午餐，再按当天开放情况参观弹子石广场的重庆市规划展览馆，用城市与山水展陈理解眼前天际线。离开酒店前确认当天入馆安排。"
        ],
        [
          "傍晚前",
          "乘车到朝天门，短走滨水区域看两江交汇。和司机约具体入口或可停靠路段，半岛尖端的地图点不是车辆接人点。",
          "继续留在南岸，只选一段南滨路滨水步行，之后坐下来喝茶或咖啡。若想登弹子石较高处看景，把额外上坡作为主动选择。"
        ],
        [
          "晚上与终点",
          "晚餐后看洪崖洞外观夜景，先确认进出是在上层道路还是滨江道路。再从允许停靠的接人点乘车回解放碑；人流管控影响通行时，用晚餐收尾，不为一张特定照片排长队。",
          "在弹子石／南滨路片区吃江景晚餐，当天在同一南岸片区约好的路边接人点结束，再乘车回酒店。不必追加游船或南山绕行才算玩完整天。"
        ]
      ]
    },
    {
      ...
      "type": "paragraph",
      "text": "向下走可以少爬坡，但仍有台阶，也会增加膝盖负担。台阶吃力时，取消十八梯完整下行与弹子石整段山坡，只在已确认可达的同一层短逛，以车辆连接片区，并保留坐着看江景。不要默认地图上的电梯开放且能连接你需要的两个入口。规划展览馆通常周一闭馆，遇到周一可保留弹子石、较长午餐与滨水段；持续下雨或酷热时缩短户外部分。也可把两天对调，让展览馆落在开放日。"
    },
    {
      id: "heading-017",
      type: "heading",
