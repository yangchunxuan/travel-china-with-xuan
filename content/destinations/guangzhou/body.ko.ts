...
const body = {
  ...
  blocks: [
    ...
    },
    {
      id: "airport-1",
      type: "paragraph",
      text: "오래된 광저우 정보에서 가장 빨리 낡는 항목입니다. 2026년 5월 7일부터 바이윈의 국내 항공사 11곳이 제1터미널에서 제3터미널로 옮겼고, 약 22년간 운영된 T1은 개보수를 위해 여객 운영을 중단했습니다. 재개장 일자는 발표되지 않았으므로 재개장을 전제로 계획할 수 없습니다. 동시에 T1과 연결된 지하철 공항남역과 도시간철도 바이윈공항남역도 여객 취급을 멈췄습니다.",
    },
    {
      id: "airport-table",
      type: "table",
