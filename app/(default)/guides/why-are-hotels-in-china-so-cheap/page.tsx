...
const guide = getGuideEntry("why-are-hotels-in-china-so-cheap", "en");
...
export default function WhyAreHotelsInChinaSoCheapPage() {
  return <ChinaHotelValueGuidePage locale="en" />;
}
