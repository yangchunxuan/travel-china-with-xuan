...
const guide = getGuideEntry("do-you-need-a-tour-guide-in-china", "en");
...
export default function DoYouNeedATourGuideInChinaPage() {
  return <ChinaTourGuideDecisionPage locale="en" />;
}
