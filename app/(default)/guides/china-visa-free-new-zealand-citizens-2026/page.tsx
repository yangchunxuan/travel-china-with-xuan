...
import { NzVisaFreeGuidePage } from "../../../../components/NzVisaFreeGuidePage";
import {
  getGuideEntry,
...
export default function ChinaVisaFreeForNewZealandCitizensPage() {
  return <NzVisaFreeGuidePage />;
}
