...
import { CanadaVisaFreeGuidePage } from "../../../../components/CanadaVisaFreeGuidePage";
import {
  getGuideEntry,
...
export default function ChinaVisaFreeForCanadianCitizensPage() {
  return <CanadaVisaFreeGuidePage />;
}
