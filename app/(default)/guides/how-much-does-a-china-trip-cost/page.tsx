...
const guide = getGuideEntry("how-much-does-a-china-trip-cost", "en");
...
export default function HowMuchDoesAChinaTripCostPage() {
  return <ChinaTripCostGuidePage locale="en" />;
}
