...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: { absolute: author.copy.title }, description: author.copy.introduction, alternates: { canonical: author.path, languages: { ...getEditorialAuthorLanguagePaths(), "x-default": "/studio/evan/" } }, openGraph: { type: "profile", title: author.copy.title, description: author.copy.introduction, url: author.path, images: [author.image.src] } };
}
