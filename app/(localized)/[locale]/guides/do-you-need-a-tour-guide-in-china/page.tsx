...
import { ChinaTourGuideDecisionPage } from "../../../../../components/ChinaTourGuideDecisionPage";
import {
  getGuideEntry,
...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("do-you-need-a-tour-guide-in-china", locale);
...
export default async function LocalizedDoYouNeedATourGuideInChinaPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <ChinaTourGuideDecisionPage locale={locale} />;
}
