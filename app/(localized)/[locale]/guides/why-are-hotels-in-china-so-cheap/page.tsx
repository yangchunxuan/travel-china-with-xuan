...
import { ChinaHotelValueGuidePage } from "../../../../../components/ChinaHotelValueGuidePage";
import {
  getGuideEntry,
...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("why-are-hotels-in-china-so-cheap", locale);
...
export default async function LocalizedWhyAreHotelsInChinaSoCheapPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <ChinaHotelValueGuidePage locale={locale} />;
}
