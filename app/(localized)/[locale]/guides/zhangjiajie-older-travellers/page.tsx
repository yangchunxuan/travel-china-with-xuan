...
import { ZhangjiajieOlderTravellersPage } from "../../../../../components/ZhangjiajieOlderTravellersPage";
import {
  getGuideEntry,
...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("zhangjiajie-older-travellers", locale);
...
export default async function LocalizedZhangjiajieOlderTravellersRoute({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <ZhangjiajieOlderTravellersPage locale={locale} />;
}
