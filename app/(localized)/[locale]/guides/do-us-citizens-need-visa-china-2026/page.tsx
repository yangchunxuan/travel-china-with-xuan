...
import { UsChinaVisaPage } from "../../../../../components/UsChinaVisaPage";
import {
  getGuideEntry,
...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("do-us-citizens-need-visa-china-2026", locale);
...
export default async function LocalizedUsChinaVisaRoute({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <UsChinaVisaPage locale={locale} />;
}
