...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("how-much-does-a-china-trip-cost", locale);
...
export default async function LocalizedHowMuchDoesAChinaTripCostPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <ChinaTripCostGuidePage locale={locale} />;
}
