...
import { KevinPreparationStoryPage } from "../../../../../components/KevinPreparationStoryPage";
import {
  getGuideEntry,
...
export async function generateMetadata({
  ...
  const guide = getGuideEntry("kevin-before-the-hotel-pickup", locale);
...
export default async function LocalizedKevinPreparationStoryRoute({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return <KevinPreparationStoryPage locale={locale} />;
}
