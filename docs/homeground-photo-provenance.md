...
## Southwest route cluster guide heroes (September 1, 2026)

These three release-candidate heroes are real photographs. Two come from
Wikimedia Commons under the stated share-alike licences; one comes from the
project owner's organised local material library, which the owner authorised
for Homeground website use. That project-entry permission is not independent
proof of the original photographer's copyright and must be re-cleared before
paid advertising, print, resale or partner distribution. Processing was limited
to conventional crop, resize and WebP encoding. This batch therefore contains
**0 / 3 AI-generated or AI-assisted images**.

| Guide and role | Original source, place, creator and rights | Source SHA-256 | Published derivative and SHA-256 | Evidence boundary |
| --- | --- | --- | --- | --- |
| `chengdu-chongqing-zhangjiajie-route-order` — hero | `/Users/yangchunxuan/Desktop/Facebook图片素材/重庆优选素材/05_重庆桥梁与城市交通/重庆北站_01.jpg`; Chongqing North Railway Station North Square; organised local material authorised by the project owner for Homeground website use; original photographer copyright not independently established | `725fef9706cd8e6e19ef4466da2f75058e1072a056b740ee7db2defe2db0920a` | `public/images/guides/chengdu-chongqing-zhangjiajie-route-order/hero-1600.webp`; 1600 × 1000; `4fcdbce160c72c08bc12f40cd8f246f787b4009729d8e12674a6dd2e203601a7` | Identifies Chongqing North as one possible real node only. It proves no dated service, universal station pair, city order or traveller-specific route. |
| `chengdu-chongqing-station-pair` — hero | [Chengdu East Railway Station](https://commons.wikimedia.org/wiki/File%3AChengdu_East_Railway_Station.JPG), Chenghua District, Chengdu; Fxqf; 2011-09-28; [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0) | `bd7ab439dfcdca357f01e4928c0febc06ac381f2997f8ff99700faf5483375e9` | `public/images/guides/chengdu-chongqing-station-pair/hero-1600.webp`; 1600 × 1000; `b1fefabfea85de835cffb6888d899dbe517600ba620e065a01678d09379268dd` | Identifies Chengdu East only. It proves no current train, entrance, timetable or best Chengdu–Chongqing station pair. |
| `chongqing-zhangjiajie-transport-route` — hero | [Wulingyuan, Zhangjiajie, Hunan 20230702](https://commons.wikimedia.org/wiki/File:Wulingyuan,_Zhangjiajie,_Hunan_20230702.jpg), Wulingyuan; 颐园居; 2023-07-02; [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) | `8cec249aad0695295a7130506b01c8eca5f3ec8abb960b36013e5db62e603f83` | `public/images/guides/chongqing-zhangjiajie-transport-route/hero-1600.webp`; 1600 × 1000; `5e22b15fe7c289f5383b25a0a9ac1760e06b13f54302d341ff7c378623d43a05` | Destination context only. It shows the Wulingyuan landform and proves no station, train, road transfer, pickup point or current transport operation. The website derivative is a source-only 16:10 crop and resize with no generated fill. |
