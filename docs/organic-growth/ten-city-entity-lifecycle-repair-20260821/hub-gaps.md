...
Checked on 2026-08-21 against `origin/main@ef1898745a3c7a6e7cd308aa341c352f24fe9d01`, which merged PR #74 head `b66fc6cbca6f040a65db0d7e3727e3b2dac24580`. The formal baseline contains seven published Hubs; this repair protects all seven and keeps Chongqing, Guilin and Shenzhen outside runtime.

An owner counts only when it has a distinct canonical task and complete trilingual runtime or content in the layer being assessed. A guide that merely mentions the city does not count. Owner sufficiency is necessary for a new Hub, but it does not by itself create a runtime route or alter the established seven-Hub publication set.
...
Quality debt, not a withdrawal reason: no Hangzhou stay-area owner, only one reused Hero, no explanatory body figures, and weaker photographer metadata than the older published-city asset records. Preserve the real `datePublished: "2026-08-20"` and strengthen the live page in place.

## Zhangjiajie — published
...
Quality debt, not a withdrawal reason: one Hero cannot explain gates, ticket systems, the city/Wulingyuan base decision or gateway transfers. Add an independent Hub source/asset ledger and body-image layer to the live page; do not identify a precise gate or plateau from the generic peak-forest Hero.
...
| Hangzhou | Pass | Pass | Partial | Pass | Published; strengthen in place |
| Zhangjiajie | Pass at 10 in current main | Pass | Partial | Pass | Published; strengthen in place |
