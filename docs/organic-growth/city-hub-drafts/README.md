...
3. **Station facts refreshed against primary sources.** Xi'an East Railway
   ...
   Government). Shanghai Songjiang Station is identified as the 2024 rename of
   Songjiang South, and Shanghai East Railway Station is named explicitly as a
   station that has *not* opened, with its stated July 2027 target, so it
   cannot enter a live itinerary by accident.
