...
Live/governance sync checked at: `2026-08-21` (Asia/Shanghai), against `origin/main@ef1898745a3c7a6e7cd308aa341c352f24fe9d01`. This remains a design-stage source pack. Every future article still needs a release-day readback and its own `source-log.md`; a URL's presence here does not authorize an evergreen claim.
...
## Published-page evidence from the 2026-08-21 live sync

Each linked locale returned HTTP `200` on `2026-08-21`, and each exact URL appeared in the live [sitemap](https://homegroundchina.com/sitemap.xml), which also returned HTTP `200`. This proves publication state, not the continuing accuracy of every dynamic transport fact.

| PR #74 identity | EN | ZH | KO | Network disposition |
|---|---|---|---|---|
| `destination-zhangjiajie` | [EN](https://homegroundchina.com/destinations/zhangjiajie/) | [ZH](https://homegroundchina.com/zh/destinations/zhangjiajie/) | [KO](https://homegroundchina.com/ko/destinations/zhangjiajie/) | `PUBLISHED`; transport-network Hub |
| `zhangjiajie-national-forest-park-tickets-and-entrances` | [EN](https://homegroundchina.com/guides/zhangjiajie-national-forest-park-tickets-and-entrances/) | [ZH](https://homegroundchina.com/zh/guides/zhangjiajie-national-forest-park-tickets-and-entrances/) | [KO](https://homegroundchina.com/ko/guides/zhangjiajie-national-forest-park-tickets-and-entrances/) | `PUBLISHED`; transport-network park owner |
| `chongqing-railway-station-selector` | [EN](https://homegroundchina.com/guides/chongqing-railway-station-selector/) | [ZH](https://homegroundchina.com/zh/guides/chongqing-railway-station-selector/) | [KO](https://homegroundchina.com/ko/guides/chongqing-railway-station-selector/) | `PUBLISHED`; transport-network rail owner |
| `destination-hangzhou` | [EN](https://homegroundchina.com/destinations/hangzhou/) | [ZH](https://homegroundchina.com/zh/destinations/hangzhou/) | [KO](https://homegroundchina.com/ko/destinations/hangzhou/) | `PUBLISHED`; transport-network Hub |
| `china-online-arrival-card` | [EN](https://homegroundchina.com/guides/china-online-arrival-card/) | [ZH](https://homegroundchina.com/zh/guides/china-online-arrival-card/) | [KO](https://homegroundchina.com/ko/guides/china-online-arrival-card/) | `PUBLISHED`; PR #74 identity outside this transport network |

The repository Search Map still carried older `inProduction` / `not-published` rows for these identities at the sync baseline. That is a shared governance-backfill issue; live readback is the publication evidence for this package.
...
| ID | Official source | Supports | Limitation / trigger |
|---|---|---|---|
| `GZ-1` | [Guangzhou official English portal: T1 airlines moved and Airport South stops suspended from 7 May 2026](https://www.eguangzhou.gov.cn/gzlatest/content/post_42957.html) | T1 passenger operations stopped; T2/T3 carry passengers; Metro Airport South and intercity Baiyun Airport South do not stop under the dated change | Reopen on every publication date; a later airport/transport notice overrides this dated baseline |
| `GZ-1B` | [Guangzhou official English portal: T1 closure follow-up and T3 passenger guide](https://www.eguangzhou.gov.cn/gzlatest/content/post_43024.html) | Official follow-up context for T1 closure and T3 passenger handling | Does not freeze airline allocations, shuttle hours or later construction |
| `GZ-1C` | [Baiyun Airport: terminal and transfer guide](https://www.baiyunairport.com/byairport-web/guide/terminals?urlKey=terminals) | Official current entry point for terminal identity and wrong-terminal movement | Page availability/content can change; it was not reliably fetchable during the 2026-08-21 audit, so recheck rather than infer |
| `GZ-1D` | [Baiyun Airport: ground transport](https://www.baiyunairport.com/byairport-web/traffic/index?urlKey=to-from-airport) | Official current entry point for metro/intercity/road and inter-terminal access | Rendered a maintenance page during the 2026-08-21 audit; use the next available current official notice on publication day |
| `GZ-2` | [Guangzhou Government: 2026 railway-diagram and Guangzhou/Guangzhou Baiyun role change](https://www.gz.gov.cn/zwfw/zxfw/jtfw/content/post_10648700.html) | Dated Guangzhou/Guangzhou Baiyun railway-station role adjustment | Not a permanent direction/frequency table; use 12306 for the ticket date |
...
Dynamic claims to log: whether T1 and both Airport South stops remain suspended, current T2/T3 passenger handling, flight/terminal assignment, inter-terminal recovery route, metro/intercity access, five-station roster/roles, 12306 examples, border/port handoff and construction. The existing Guangzhou airport owner already covers the 7 May transition and recovery; this ledger calls for publication-day verification, not a corrective rewrite.
...
| `ZJJ-5` | [Hunan Department of Culture and Tourism: official two- and three-day Wulingyuan routes](https://whhlyt.hunan.gov.cn/whhlyt/wldh2022touristroute/202209/t20220907_28658210.html) | Official route/base relationship context | Not a transport timetable or guarantee that every attraction element operates |
