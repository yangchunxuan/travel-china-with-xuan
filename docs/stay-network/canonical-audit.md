...
| Zhangjiajie | Published by PR #74 | city/Wulingyuan/sight-order orientation | **Hub section + FAQ**, with execution in existing base owner |
| Hangzhou | Published by PR #74 | West Lake sides, Lingyin/Longjing and East-station buffer | **Hub section + FAQ**; broad stay task already owned |
...
Hubs answer the broad task without splitting authority. Hangzhou's published
Hub body already owns the same scope. Guilin's draft
