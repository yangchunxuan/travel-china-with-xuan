...
This branch adds conditional decision copy and links to seven published Hubs;
...
Hangzhou and Zhangjiajie were published by PR #74. Recording that release state
does not move their factual `sourceReviewedDate`: it is a lifecycle correction,
not a new review of transport, attraction or gateway claims.
