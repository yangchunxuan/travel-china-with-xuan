...
Status: **STAY AND HOTEL CONVERSION NETWORK READY — CENTRAL REVIEW REQUIRED**

Snapshot date: 2026-08-20 (Asia/Shanghai)
...
The audited main branch contains five previously published city Hubs plus
Hangzhou and Zhangjiajie runtime integrations from PR #74; this audit does not
claim that those two new routes have already been deployed publicly.
