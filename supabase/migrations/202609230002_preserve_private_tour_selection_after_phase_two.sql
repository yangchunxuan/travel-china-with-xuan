-- Apply after both the phase-two product expansion and six-traveller price migration.
-- Both earlier migrations replace this whole function; their separate cases must
-- coexist so a later production rollout cannot revoke a published selection.
begin;
