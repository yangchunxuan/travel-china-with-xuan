-- Forward migration for the published Zhangjiajie–Furong Town–Fenghuang product.
-- The original definitions remain complete for fresh databases; this migration
-- applies the same allowlist expansion to databases that already ran them.
